...
-- right/left
AQOptionsLEFTTEXT = ""..WHITE.."AtlasQuest面板显示位置在"..RED.."左"..WHITE..".";
AQOptionsRIGHTTEXT = ""..WHITE.."AtlasQuest面板显示位置在"..RED.."右"..WHITE..".";
...
Inst1Quest7_Note = "巴隆斯·阿历克斯顿在暴风城 "..YELLOW.."49,30"..WHITE.."."
...
Inst2Quest4PreQuest_HORDE = "有"

--QUEST 5 horde

Inst2Quest5_HORDE = "5. 清除变异者"
Inst2Quest5_HORDE_Level = "21"
Inst2Quest5_HORDE_Attain = "15"
...
Inst4Quest16PreQuest = "有"

--QUEST 1 Horde

Inst4Quest1_HORDE = "1. 能量石"
Inst4Quest1_HORDE_Level = "36"
Inst4Quest1_HORDE_Attain = "31"
...
Inst4Quest2_HORDE_Folgequest = "有, 远赴铁炉堡"
--
...
Inst5Quest5_Note = "征服者派隆是副本门口外面的一个火元素精英. 在 黑石深渊地图的 "..YELLOW.."[24]"..WHITE.."  黑石深渊副本入口地图的 "..YELLOW.."[1]"..WHITE.." ."
...
Inst5Quest7_Note = "你可以从 "..YELLOW.."[8]"..WHITE.." 的宝箱里找到山脉之心. 你必须打开黑色宝库所有的小宝箱出来boss之后才能拿到钥匙."
...
Inst5Quest8_Location = "奥拉留斯 (燃烧平原 "..YELLOW.."84,68"..WHITE..")"
...
Inst5Quest10 = "10. 弄皱的便笺 (奥妮克希亚-系列任务)"
...
Inst5Quest10_Note = "这个任务是 弄皱的便笺 触发的。温德索尔元帅 在 "..YELLOW.."[4]"..WHITE..".副本里和外的所有黑铁矮人都有很大几率掉落."
...
Inst5Quest11 = "11. 一丝希望 (奥妮克希亚-系列任务)"
...
Inst5Quest11_Note = "温德索尔元帅 在 "..YELLOW.."[4]"..WHITE..".\n傀儡统帅阿格曼奇 在 "..YELLOW.."[14]"..WHITE..", 安格弗将军 在 "..YELLOW.."[13]"..WHITE.."."
...
Inst5Quest12 = "12. 冲破牢笼！ (奥妮克希亚-系列任务)"
...
Inst5Quest12_Note = "温德索尔元帅 在 "..YELLOW.."[4]"..WHITE..".\n如果你清掉法律之环一圈的怪 ("..YELLOW.."[6]"..WHITE..") 和通向副本门口的怪的话会轻松很多. 麦克斯韦尔元帅在 燃烧平原 摩根的岗哨 ("..YELLOW.."84,68"..WHITE..")"
...
Inst5Quest13_Note = "此系列任务始于 卡拉然·温布雷 (灼热峡谷; "..YELLOW.."39,38"..WHITE..").\n 贝尔加 在 "..YELLOW.."[11]"..WHITE.."."
...
Inst5Quest14_Note = "前导任务始于 皇家历史学家阿克瑟努斯 (丹莫罗 - 铁炉堡; 38,55)。卡兰·巨锤位于 "..YELLOW.."[2]"..WHITE.."."
...
Inst5Quest15_Location = "国王麦格尼·铜须 (丹莫罗 - 铁炉堡 "..YELLOW.."39,55"..WHITE..")"
Inst5Quest15_Note = "公主茉艾拉·铜须 位于 [21]。战斗中她可能会治疗达格兰。试着尽可能打断她。但是一定不能让她死掉，否则你的任务将会失败！与她交谈过后，你还要回到麦格尼·铜须那儿去。"
...
Inst5Quest16_Note = "完成这个任务之后你就可以从 天痕 旁边的传送石进入熔火之心.\n熔火碎片在 "..YELLOW.."[23]"..WHITE.."."
...
Inst5Quest17_Location = "法尔林·树影 (厄运西; "..YELLOW.."图书馆 [1] "..WHITE..")"
...
Inst5Quest18_Note = "这个任务会是你学会如何熔炼黑铁矿石. 材料如下: 2个 [红宝石], 20个 [金锭], 10个 [真银锭]. 完成之后，你过你有 [黑铁矿石] 你可以在黑熔炉 "..YELLOW.."[22]"..WHITE.." 熔炼黑铁."
...
Inst5Quest11_HORDE_Note = "征服者派隆是副本门口外面的一个火元素精英. 在 黑石深渊地图的 "..YELLOW.."[24]"..WHITE.."  黑石深渊副本入口地图的 "..YELLOW.."[1]"..WHITE.." ."
...
Inst5Quest13_HORDE_Location = "暗法师薇薇安·拉格雷 <卡加斯远征军> (荒芜之地 - 卡加斯; "..YELLOW.."2,47"..WHITE..")"
...
Inst8Quest1_Note = "你可以在 "..YELLOW.."[7]"..WHITE.." and "..YELLOW.."[8]"..WHITE.."附近找到石板."
...
Inst8Quest2_Note = "你可以在 "..YELLOW.."[15]"..WHITE.."知道座狼幼崽."
...
Inst8Quest3_Note = "你可以在 "..YELLOW.."[11]"..WHITE.."附近找到蜘蛛卵."
...
Inst8Quest4_Note = "烟网蛛后 在 "..YELLOW.."[11]"..WHITE..". 如果中毒后解除，那么任务就会失败."
...
Inst8Quest5_Note = "哈雷肯 在 "..YELLOW.."[15]"..WHITE.."."
...
Inst8Quest6_Location = "瓦罗什 (黑石塔下： "..YELLOW.."[2]"..WHITE..")"
Inst8Quest6_Note = "要得到瓦罗什的蟑螂，你必须首先杀死乌洛克 "..YELLOW.."[13]"..WHITE..". 要完成召唤，你需要长矛和 欧莫克大王的头颅 "..YELLOW.."[6]"..WHITE..". 长矛在 "..YELLOW.."[4]"..WHITE..". 在召唤出乌洛克之前，会出现几群食人魔，你可以用长矛来杀害它们."
...
Inst8Quest7_Location = "比修 (黑石塔下： "..YELLOW.."[3]"..WHITE..")"
Inst8Quest7_Note = "你可以在前往烟网蛛后的路上找到比修的装置 ("..YELLOW.."[11]"..WHITE..").\n你可以找到麦克斯韦元帅在燃烧平原摩根的岗哨： ("..YELLOW.."84,58"..WHITE..")."
...
Inst8Quest8_Note = "指挥官沃恩在"..YELLOW.."[8]"..WHITE..", 欧莫克大王在 "..YELLOW.."[6]"..WHITE.." 维姆萨拉克 在 "..YELLOW.."[17]"..WHITE.."."
...
Inst8Quest9_Location = "维埃兰 (黑石塔下; "..YELLOW.."[1]"..WHITE..")"
Inst8Quest9_Note = "燃棘宝钻从欧莫克大王 ("..YELLOW.."[6]"..WHITE.."), 尖石宝钻从指挥官沃恩 ("..YELLOW.."[8]"..WHITE.."), 血斧宝钻从维姆萨拉克 ("..YELLOW.."[17]"..WHITE..") 原始晋升印章是黑石塔所有小怪掉落，完成这个之后你就能得到黑上钥匙."
...
Inst8Quest10_Location = "达基萨斯将军的命令 (掉落自 维姆萨拉克 "..YELLOW.."[11]"..WHITE..")"
Inst8Quest10_Note = "麦克斯韦尔元帅 (燃烧平原--摩根的岗哨; "..YELLOW.."84,58"..WHITE..")"
Inst8Quest10_Prequest = "无"
Inst8Quest10_Folgequest = "有, 达基萨斯将军之死 (黑上任务)"
-- No Rewards for this quest
...
Inst8Quest13_Note = "暗影猎手沃什加斯 在"..YELLOW.."[7]"..WHITE.."."
...
Inst8Quest14_Location = "人类的残骸 (黑下; "..YELLOW.."[9]"..WHITE..")"
Inst8Quest14_Note = "煅造任务，确保从人类残骸附近拿到 这个板甲手套.，交给 玛雷弗斯·暗锤(冬泉谷 - 永望镇; "..YELLOW.."61,39"..WHITE.."). "
...
Inst8Quest5_HORDE_Note = "哈雷肯 在 "..YELLOW.."[15]"..WHITE.."."
...
Inst8Quest7_HORDE_Note = "比修 在  "..YELLOW.."[3]"..WHITE.."."
...
Inst8Quest8_HORDE_Location = "比修 (黑石塔下; "..YELLOW.."[3]"..WHITE..")"
Inst8Quest8_HORDE_Note = "你可以在在通往烟网蛛后的路上找到比修的装置 "..YELLOW.."[11]"..WHITE.."."
...
Inst8Quest10_HORDE_Note = "奥妮克希亚 钥匙前续! 指挥官沃恩在"..YELLOW.."[8]"..WHITE..", 欧莫克大王在 "..YELLOW.."[6]"..WHITE.." 维姆萨拉克 在 "..YELLOW.."[17]"..WHITE.."黑石文件 在3个boss的其中一个边上."
Inst8Quest10_HORDE_Prequest = "无"
Inst8Quest10_HORDE_Folgequest = "有, 伊崔格的智慧  -> 为部落而战(黑上任务)"
--
...
Inst9Quest1_Location = "奥比 (黑石塔上; "..YELLOW.."[6]"..WHITE..")"
Inst9Quest1_Note = "你可以在竞技场边上的房间找到 奥比 "..YELLOW.."[6]"..WHITE..". 它呆在一个突出物上面.\n哈尔琳在 冬泉谷 ("..YELLOW.."54,51"..WHITE.."). 在冬泉谷的洞里的最里面通过站在传送符文上从而到她身边."
...
Inst9Quest2_Location = "芬克·恩霍尔 (黑石塔上; "..YELLOW.."[7]"..WHITE..")"
Inst9Quest2_Note = "芬克·恩霍尔会在拨完比斯的皮后出现. 玛雷弗斯·暗锤 在 冬泉谷 - 永望镇 ("..YELLOW.."61,38"..WHITE..")."
Inst9Quest2_Prequest = "无"
Inst9Quest2_Folgequest = "有, 艾博希尔之眼, 炽热板甲护手"
-- No Rewards for this quest
...
Inst9Quest3_Folgequest = "Yes, 莱尼德·巴萨罗梅 -> 贝蒂娜·比格辛克 (Scholomance)"
...
Inst9Quest4_Note = "你可以找到艾博希尔 在 "..YELLOW.."[1]"..WHITE.."."
...
Inst9Quest5_Note = "达基萨斯将军 在 "..YELLOW.."[8]"..WHITE.."."
Inst9Quest5_Prequest = "有, 达基萨斯将军的命令 (黑下任务)"
...
Inst9Quest6_Note = "你可以接到这个任务的前续任务，从  雷明顿·瑞治维尔伯爵  (暴风城 - 暴风要塞; "..YELLOW.."74,30"..WHITE.."). 末日扣环在 烈焰之父 的房间 "..YELLOW.."[2]"..WHITE.." 在一个箱子里."
...
Inst9Quest7_Note = "联盟 奥妮克希亚 钥匙任务的最后一步."
...
Inst9Quest8_Location = "黑手的命令 ，从副本外面的"
Inst9Quest8_Note = "黑翼之巢 的进门任务.你可以在黑石塔副本的门口右侧附近找到裂盾军需官，宝珠就在达基萨斯将军身后 "
...
Inst9Quest11_Note = "煅造任务，古拉鲁克在 "..YELLOW.."[4]"..WHITE.."."
...
Inst9Quest5_HORDE_Note = "你可以从幽暗城的 药剂师金格 接到前续任务 ("..YELLOW.."50,68"..WHITE.."). 黑暗石板在 烈焰之父的房间 ("..YELLOW.."[2]"..WHITE..")."
...
Inst9Quest6_HORDE_Note = "奥妮克希亚钥匙任务. 大酋长雷德·黑手 在 "..YELLOW.."[5]"..WHITE.."."
...
Inst9Quest8_HORDE_Note = "黑龙门的最后一步."
Inst9Quest8_HORDE_Prequest = "Yes, 埃博斯塔夫 -> 龙骨试炼..."
...
Inst10Quest1_Note = "普希林 在 "..YELLOW.."厄运东"..WHITE.." 的 "..YELLOW.."[1]"..WHITE..". 你一和它说话它就跑，但是最后会停下并可以被攻击在 "..YELLOW.."[2]"..WHITE..". 它还会掉落月牙钥匙，也就是厄运倍和西的钥匙."
...
Inst10Quest2_Note = "蕾瑟塔蒂丝 在 "..YELLOW.."厄运东"..WHITE.." 的 "..YELLOW.."[3]"..WHITE..". 前续任务可以从  铁炉堡的 信使考雷·落锤 接到"
...
Inst10Quest3_Note = "奥兹恩 在 "..YELLOW.."厄运东"..WHITE.." 的 "..YELLOW.."[5]"..WHITE..". 前续任务同样来自拉比恩·萨图纳."
...
Inst10Quest2_HORDE_Note = "蕾瑟塔蒂丝 在 "..YELLOW.."厄运东"..WHITE.." 的 "..YELLOW.."[3]"..WHITE..". 前续任务接自 奥格瑞玛的 公告员高拉克."
...
Inst11Quest1_Location = "破碎的陷阱 ( "..YELLOW.."厄运北"..WHITE..")"
...
Inst11Quest2_Location = "诺特·希姆加克 (厄运北; "..YELLOW.."[4]"..WHITE..")"
Inst11Quest2_Note = "可重复任务，食人魔鞣酸可以从"..YELLOW.."[4] (上层)"..WHITE.."附近得到."
...
Inst11Quest3_Location = "诺特·希姆加克 ( "..YELLOW.."厄运北 [4]"..WHITE..")"
...
Inst11Quest4_Location = "克罗卡斯 (  "..YELLOW.."厄运北, [5]"..WHITE..")"
Inst11Quest4_Note = "王子在  "..YELLOW.."厄运西"..WHITE.." 的 "..YELLOW.."[7]"..WHITE..". 力量护手 在王子附近的一个箱子里，交任务时你也必须确保你有‘当国王真好’这个buff."
...
Inst12Quest1_Note = "卡里尔·温萨鲁斯 在 "..YELLOW.."图书馆 (厄运西)"..WHITE.."."
...
Inst12Quest2_Location = "辛德拉古灵 (厄运之槌; "..YELLOW.."西, [1] (above)"..WHITE..")"
Inst12Quest2_Note = "水晶塔北被标记为 "..BLUE.."[B]"..WHITE..". 伊莫塔尔 在 "..YELLOW.."[6]"..WHITE..", 托塞德林王子 在 "..YELLOW.."[7]"..WHITE.."."
...
Inst12Quest3_Location = "辛德拉古灵 (  "..YELLOW.."厄运之槌西, [1] (above)"..WHITE..")"
...
Inst12Quest4_Note = "术士的史诗战马任务的最后一步. 首先你需要杀掉伊莫塔尔。然后你可以召唤。 准备20个以上的灵魂碎片是必须的，你必须消耗碎片才能维持法阵.杀死恐惧战马后，和马的灵魂对话即可完成任务。"
Inst12Quest4_Prequest = "有, 末日蜡烛 (通灵学院)"
...
Inst12Quest1_HORDE_Note = "卡里尔·温萨鲁斯 在 "..YELLOW.."图书馆 (厄运西)"..WHITE.."."
...
Inst14Quest1_Note = ""
Inst14Quest1_Prequest = "Yes, Eye of the Emberseer (UBRS)"
...
Inst15Quest1_Location = "Kel'Thuzad (Naxx; "..YELLOW.."green 2"..WHITE..")"
Inst15Quest1_Note = "Father Inigo Montoy (EPL; "..YELLOW.."81,58"..WHITE..")"
...
Inst19Quest2_Note = "法师职业任务，书也在图书馆里"
...
Inst19Quest3_Location =  "虔诚的莱雷恩 (希尔斯布莱德 - 南海镇; "..YELLOW.."51,58 "..WHITE..")"
Inst19Quest3_Note ="此系列任务始于 克罗雷修士 (暴风城; 42,24)。\n 大检察官怀特迈恩 和 血色十字军指挥官莫格莱尼 在 "..YELLOW.."血色修道院：教堂 [2]"..WHITE..",赫洛德 在 "..YELLOW.."血色修道院：军械库[1]"..WHITE.."，  驯犬者洛克希 在 "..YELLOW.."血色修道院：图书馆 [1]"..WHITE.."."
...
Inst19Quest1_HORDE_Location = "大药剂师法拉尼尔  (幽暗城; "..YELLOW.."48,69 "..WHITE..")"
...
Inst19Quest2_HORDE_Location = "帕科瓦·芬塔拉斯 (幽暗城; "..YELLOW.."57,65 "..WHITE..")"
Inst19Quest2_HORDE_Note = "此系列任务始于 多恩·平原行者 (千针石林 (53,41).\n 书在血色修道院图书馆里。"
...
Inst19Quest5_HORDE_Note = "大检察官怀特迈恩 和 血色十字军指挥官莫格莱尼 在 "..YELLOW.."血色修道院：教堂 [2]"..WHITE..",赫洛德 在 "..YELLOW.."血色修道院：军械库[1]"..WHITE.."，  驯犬者洛克希 在 "..YELLOW.."血色修道院：图书馆 [1]"..WHITE.."."
...
Inst57Quest1_Location = "虔诚的莱雷恩 (希尔斯布莱德 - 南海镇; "..YELLOW.."51,58 "..WHITE..")"
Inst57Quest1_Note = "此系列任务始于 克罗雷修士 (暴风城; 42,24).\n大检察官怀特迈恩 和 血色十字军指挥官莫格莱尼 在 "..YELLOW.."血色修道院：教堂 [2]"..WHITE..",赫洛德 在 "..YELLOW.."血色修道院：军械库[1]"..WHITE.."，  驯犬者洛克希 在 "..YELLOW.."血色修道院：图书馆 [1]"..WHITE.."."
Inst57Quest1_Prequest ="有，安东修士 -> 血色之路（任务领取地点在凄凉之地前哨站，任务要杀的骷髅兵在地图底部中间偏右的一个山谷里面）"
...
Inst57Quest1_HORDE_Location = "大药剂师法拉尼尔  (幽暗城; "..YELLOW.."48,69 "..WHITE..")"
...
Inst57Quest2_HORDE_Location = "瓦里玛萨斯  (幽暗城; "..YELLOW.."56,92 "..WHITE..")"
Inst57Quest2_HORDE_Note = "大检察官怀特迈恩 和 血色十字军指挥官莫格莱尼 在 "..YELLOW.."血色修道院：教堂 [2]"..WHITE..",赫洛德 在 "..YELLOW.."血色修道院：军械库[1]"..WHITE.."，  驯犬者洛克希 在 "..YELLOW.."血色修道院：图书馆 [1]"..WHITE.."."
...
Inst58Quest1_Location = "虔诚的莱雷恩 (希尔斯布莱德 - 南海镇; "..YELLOW.."51,58 "..WHITE..")"
Inst58Quest1_Note = "此系列任务始于 克罗雷修士 (暴风城; 42,24).\n大检察官怀特迈恩 和 血色十字军指挥官莫格莱尼 在 "..YELLOW.."血色修道院：教堂 [2]"..WHITE..",赫洛德 在 "..YELLOW.."血色修道院：军械库[1]"..WHITE.."，  驯犬者洛克希 在 "..YELLOW.."血色修道院：图书馆 [1]"..WHITE.."."
Inst58Quest1_Prequest = "有，安东修士 -> 血色之路（任务领取地点在凄凉之地前哨站，任务要杀的骷髅兵在地图底部中间偏右的一个山谷里面）"
Inst58Quest1_Folgequest = "无"
Inst58Quest1PreQuest = "有"
--
...
Inst58Quest1_HORDE_Location = "大药剂师法拉尼尔  (幽暗城; "..YELLOW.."48,69 "..WHITE..")"
...
Inst58Quest2_HORDE_Location = "瓦里玛萨斯  (幽暗城; "..YELLOW.."56,92 "..WHITE..")"
...
Inst59Quest1_HORDE_Location =  "沃瑞尔·森加斯 (血色修道院: 墓地)"
Inst59Quest1_HORDE_Note = "沃瑞尔·森加斯就位于血色修道院墓地前部。 南希在奥特兰克山脉(31,32)。 她有戒指。"
...
Inst59Quest2_HORDE_Location = "大药剂师法拉尼尔  (幽暗城; "..YELLOW.."48,69 "..WHITE..")"
...
Inst20Quest10_Note = "你需要超维度幽灵显形器才能看到伯德雷。库尔莫克在 "..YELLOW.."[7]"..WHITE.."."
...
Inst22Quest12_Note = "伊思达·哈尔蒙就站在斯坦索姆副本门口. 你需要超维度幽灵显形器才能看到伊思达·哈尔蒙. 联盟这个任务的前续任务接自 德莉亚娜 (铁炉堡 "..YELLOW.."43,52"..WHITE..") , 部落的接自莫克瓦尔 (奥格瑞玛 "..YELLOW.."38,37"..WHITE..").\n这个同时也是45分钟DK任务."
...
Inst22Quest13_Note = "你需要超维度幽灵显形器才能看到伯德雷.你可以从 寻找安泰恩 任务得到超维度幽灵显形器."
...
Inst22Quest14_Note = "你需要超维度幽灵显形器才能看到伯德雷.你可以从 寻找安泰恩 任务得到超维度幽灵显形器."
Inst22Quest14_Prequest = "有, 更多重要的材料"
Inst22Quest14_Folgequest = "有, 最后的准备 ("..YELLOW.."[黑上任务]"..WHITE..")"
...
Inst22Quest16_Note = "T黑衣守卫铸剑师在 "..YELLOW.."[15]"..WHITE.."."
...
Inst22Quest17_Note = "红衣铸锤师 在 "..YELLOW.."[8]"..WHITE.."."
...
Inst22Quest18_HORDE_Note = "前续任务也是从它这里接。拉姆斯登 在 "..YELLOW.."[18]"..WHITE.."."
Inst22Quest18_HORDE_Prequest = "有,  讨厌的蝙蝠."
...
Inst23Quest1_Location = "Ossirian the Unscarred (AQ20; "..YELLOW.."6"..WHITE..")"
Inst23Quest1_Note = "Commander Mar'alith (Silithus; "..YELLOW.."49,34"..WHITE..")"
Inst23Quest1_Prequest = "无"
Inst23Quest1_Folgequest = "无"

--Quest 1 Horde
Inst23Quest1_HORDE = "1. The Fall of Ossirian"
Inst23Quest1_HORDE_Attain = "60"
Inst23Quest1_HORDE_Level = "60"
Inst23Quest1_HORDE_Aim = "Deliver the Head of Ossirian the Unscarred to Commander Mar'alith at Cenarion Hold in Silithus."
Inst23Quest1_HORDE_Location = "Ossirian the Unscarred (AQ20; "..YELLOW.."6"..WHITE..")"
Inst23Quest1_HORDE_Note = "Commander Mar'alith (Silithus; "..YELLOW.."49,34"..WHITE..")"
Inst23Quest1_HORDE_Prequest = "无"
Inst23Quest1_HORDE_Folgequest = "无"
...
--Quest 12 Alliance
Inst25Quest12 = "12. 更好的材料 (德鲁伊职业任务)"
...
Inst25Quest12_Note = "德鲁伊职业任务. 腐烂藤蔓掉落自 阿塔拉利恩 "..YELLOW.."[1]"..WHITE.." ，必须正确的破解雕像群的秘密"
...
--Quest 13 Alliance
Inst25Quest13 = "13. 神庙中的绿龙 (猎人职业任务)"
...
Inst25Quest13_Note = "猎人职业任务. 摩弗拉斯 在"..YELLOW.."[5]"..WHITE.."."
...
--Quest 14 Alliance
Inst25Quest14 = "14. 毁灭摩弗拉斯 (法师职业任务)"
Inst25Quest14_Level = "52"
Inst25Quest14_Attain = "50"
Inst25Quest14_Aim = "从摩弗拉斯身上取回奥术碎片，然后返回大法师克希雷姆那儿."
Inst25Quest14_Location = "大法师克希雷姆，摩弗拉斯 在(艾萨拉; "..YELLOW.."29,40"..WHITE..")"
Inst25Quest14_Note = "法师职业任务 "..YELLOW.."[5]"..WHITE.."."
...
--Quest 15 Alliance
Inst25Quest15 = "15. 摩弗拉斯之血 (牧师职业任务)"
...
Inst25Quest15_Note = "牧师职业任务， 摩弗拉斯 在"..YELLOW.."[5]"..WHITE..". Greta Mosshoof is at Felwood - Emerald Sanctuary ("..YELLOW.."51,82"..WHITE..")."
...
--Quest 16 Alliance
Inst25Quest16 = "16. 碧蓝钥匙 (盗。。不，潜行者职业任务)"
...
Inst25Quest16_Note = "潜行者职业任务，摩弗拉斯 掉落钥匙 "..YELLOW.."[5]"..WHITE..". Lord Jorach Ravenholdt is at Alterac Mountains - Ravenholdt ("..YELLOW.."86,79"..WHITE..")."
...
--Quest 17 Alliance
Inst25Quest17 = "17. 铸造力量之石 (圣骑士职业任务)"
...
Inst25Quest17_HORDE_Location = "希尔瓦娜斯·风行者 (Undercity - Royal Quarter; "..YELLOW.."59,94"..WHITE..")"
Inst25Quest17_HORDE_Note = ""
Inst25Quest17_HORDE_Prequest = "有，前往亡灵壁垒  -> 仇恨的证明 ->  女妖之王的智慧"
...
Inst26Quest1_Location = "C'Thun (AQ40; "..YELLOW.."9"..WHITE..")"
Inst26Quest1_Note = "Caelestrasz (AQ40; "..YELLOW.."2*"..WHITE..")"
...
Inst26Quest2_Aim = "Caelestrasz (AQ40; "..YELLOW.."2*"..WHITE..")"
Inst26Quest2_Location = "C'Thun (AQ40; "..YELLOW.."9"..WHITE..")"
Inst26Quest2_Note = "Anachronos (Tanaris; "..YELLOW.."65,49"..WHITE..")"
Inst26Quest2_Prequest = "C'Thun's Legacy"
Inst26Quest2_Folgequest = "无"

--Quest 1 Horde
Inst26Quest1_HORDE = "1. C'Thun's Legacy"
Inst26Quest1_HORDE_Attain = "60"
Inst26Quest1_HORDE_Level = "60"
Inst26Quest1_HORDE_Aim = "Take the Eye of C'Thun to Caelastrasz in the Temple of Ahn'Qiraj."
Inst26Quest1_HORDE_Location = "C'Thun (AQ40; "..YELLOW.."9"..WHITE..")"
Inst26Quest1_HORDE_Note = "Caelestrasz (AQ40; "..YELLOW.."2*"..WHITE..")"
Inst26Quest1_HORDE_Prequest = "无"
Inst26Quest1_HORDE_Folgequest = "The Savior of Kalimdor"

--Quest 2 Horde
Inst26Quest2_HORDE = "2. The Savior of Kalimdor"
Inst26Quest2_HORDE_Attain = "60"
Inst26Quest2_HORDE_Level = "60"
Inst26Quest2_HORDE_Aim = "Caelestrasz (AQ40; "..YELLOW.."2*"..WHITE..")"
Inst26Quest2_HORDE_Location = "C'Thun (AQ40; "..YELLOW.."9"..WHITE..")"
Inst26Quest2_HORDE_Note = "Anachronos (Tanaris; "..YELLOW.."65,49"..WHITE..")"
Inst26Quest2_HORDE_Prequest = "C'Thun's Legacy"
Inst26Quest2_HORDE_Folgequest = "无"
...
Inst27Quest7_Prequest = "有, The Brassbolts Brothers"
...
Inst27Quest6_HORDE_Level = "47"
Inst27Quest6_HORDE_Attain = "42"
...
Inst28Quest2_Level = "58"
Inst28Quest2_Aim = "Bring the Heart of Hakkar to Molthor on Yojamba Isle."
Inst28Quest2_Location = "Hakkar (Zul'Gurub; "..YELLOW.."11"..WHITE..")"
...
Inst29Quest9_Location = "脏兮兮的戒指 (random drop from Gnomereagan)"
Inst29Quest9_Note = "这个戒指可以在 清洁器 5200型 中情节，位置在 "..YELLOW.."[2]"..WHITE.."."
Inst29Quest9_Prequest = "No"
Inst29Quest9_Folgequest = "Yes, 戒指归来"
-- No Rewards for this quest
...
Inst29Quest10_Location = "闪亮的金戒指 (从脏兮兮的戒指中)"
Inst29Quest10_Note = "把它交给 塔瓦斯德·基瑟尔 (铁炉堡 - 秘法区; "..YELLOW.."36,3"..WHITE..")."
...
Inst29Quest5_HORDE_Location = "闪亮的金戒指 (从脏兮兮的戒指任务中得到)"
Inst29Quest5_HORDE_Note = "把戒指交给 诺格 (奥格瑞玛 - 荣誉谷; "..YELLOW.."75,25"..WHITE..")."
...
Inst37General = {
    {
    "哨长加尔戈玛",
    "哨长加尔戈玛是你在地狱火城墙碰到的第一个Boss。他带着2个地狱火岗哨。对付他的方法是要么干掉他的随从要么控制住他的随从，因为如果不这么做他们会治疗哨长加尔戈玛。让护甲最高的远程队员站在离加尔戈玛最远的位置，因为他会对最远的队员冲锋。他对布衣的伤害没有那么强，不过最好还是让护甲比较高的队员来承受伤害。",
    RED .. "致死打击：" .. WHITE .. " 哨长加尔戈玛有时候会给MT以致死打击减少10%的治疗效果并可以叠加，但是不需要2T因为他实在太容易死了",
    },

    {
    "无疤者奥莫尔",
    "奥莫尔会对玩家释放背叛光环：每秒钟对15码以内的队员造成360到440点暗影伤害。受到光环影响的可以远离队友",
    ...
    "瓦兹德(): 你瞧不起它？\n" .. RED .. "纳杉（龙息术）" .. WHITE .. ": 纳杉会对它的前面目标造成面火焰伤害。 坦克应该把它拉的背离队友。\n" .. RED .. "纳杉（火焰弹）" .. WHITE .. ": 纳赞会向玩家扔火球，造成2000左右伤害，并在周围造成每秒600的火焰伤害。 每个人都一定要远离火圈!",
    },
};
...
Inst37Quest1_Note = "冈尼在("..YELLOW.."56, 67"..WHITE.."). 要接到这个任务，你必须完成邪恶的咒语这个任务，这个任务的起始任务是知己知彼，起始NPC是 荣耀堡的远征军指挥官达纳斯·托尔贝恩; "..YELLOW.."57, 67"..WHITE..")"
Inst37Quest1_Prequest = "有，邪恶的咒语"
Inst37Quest1_Folgequest = "有，愤怒之心(鲜血熔炉任务)"
Inst37Quest1PreQuest = "有"
Inst37Quest1FQuest = "有"
--
...
Inst37Quest2_Location = "不祥的信件 (瓦兹德掉落; "..YELLOW.."[地狱火城墙]"..WHITE..")"
Inst37Quest2_Note = "瓦兹德掉落。  远征军指挥官达纳斯·托尔贝恩在 "..YELLOW.."57, 67"..WHITE.."."
Inst37Quest2_Prequest = "无"
Inst37Quest2_Folgequest = "有,鲜血就是生命(鲜血熔炉)"
...
Inst37Quest1_HORDE_Note = "卡萨雷兹在("..YELLOW.."55, 36"..WHITE.."). 要接到这个任务，你必须完成 机甲残骸这个任务，从你在诅咒之地接到跨越黑暗之门的任务开始的一连串连续任务。"
Inst37Quest1_HORDE_Prequest = "有, 机甲残骸"
Inst37Quest1_HORDE_Folgequest = Inst37Quest1_Folgequest
Inst37Quest1PreQuest_HORDE = Inst37Quest1PreQuest
Inst37Quest1FQuest_HORDE = Inst37Quest1FQuest
--
...
Inst37Quest2_HORDE_Aim = "把不详的信件交给地狱火半岛--萨尔玛内的纳兹格雷尔"
Inst37Quest2_HORDE_Location = Inst37Quest2_Location
Inst37Quest2_HORDE_Note = "瓦兹德掉落. 纳兹格雷尔在 "..YELLOW.."55, 36"..WHITE..""
...
Inst38General = {
    {
    "制造者",
    "很简单的BOSS，坦克拉住然后杀了就可以了",
    RED .. "击退" .. WHITE .. "近距离击退攻击，打击所有近战范围内的玩家，似乎有仇恨减少的效果。\n" .. RED .. "精神控制" .. WHITE .. ": 控制一个玩家并且能提高被控制玩家的伤害。",
    },

    {
    "布洛戈克",
    "比较难的战斗，当你打开屋子里的摇杆时就触发了战斗。BOSS前会依次出现4波四周监牢里的被关押兽人，而且一波比一波厉害。而且中间你不能停止战斗，所以可以最后留一个怪一直变羊控制来让大家缓慢恢复。",
   RED .. "4波怪:" .. WHITE .. " 第一波是4个普通的怪, 二波是3个普通怪一个精英怪, 三波是各2个, 最后是1个普通3个精英.\n" .. RED .. "毒性之箭:" .. WHITE .. " 对所有他面前的玩家喷射毒箭.\n" .. RED .. "毒性之云:" .. WHITE .. " 向一个玩家投掷一个毒性炸弹，造成少量伤害，但是对炸弹四周的玩家造成每秒650的伤害，一定要躲开",
    ...
    {
    "击碎者克里丹",
    "最后一个BOSS但是并不似很难。战斗会在你攻击他周围的怪之后开始，当全部5个怪消灭之后就会开始与BOSS的战斗",
   RED .. "周围小怪:" .. WHITE .. " 它们会释放一个是你受到暗影伤害提高1000点的魔法，一定要及时解除\n" .. RED .. "群体暗影箭:" .. WHITE .. " 群体暗影箭，没有诅咒的情况下造成并不是很高的伤害.\n" .. RED .. "爆炸:" .. WHITE .. " 每过几秒boss会喊 '靠近点!' 这时停止攻击. 几秒后会发生爆炸，对周围玩家造成4000多的火焰伤害. 如果看见喊话就跑远点吧.",
    },
};
...
Inst38Quest2_Note = "走到最终BOSS房间即可完成任务。远征军指挥官达纳斯·托尔贝恩在 "..YELLOW.."57, 67"..WHITE.."."
Inst38Quest2_Prequest = "有, 削弱城墙"
Inst38Quest2_Folgequest = "无"
Inst38Quest2PreQuest = "有"
--
...
Inst38Quest2_HORDE_Note = "走到最终BOSS房间即可完成任务。"
...
Inst42Quest4_Aim = "从水术师瑟丝比娅身上取得一份地狱土壤交给韦恩避难所的韦恩."
...
--Quest 9 Alliance
Inst53Quest9 = "9. 大师的露台"
Inst53Quest9_Level = "70"
Inst53Quest9_Attain = "70"
Inst53Quest9_Aim = "前往卡拉赞的大师的露台并阅读麦迪文的日记。完成任务后带着麦迪文的日记回到大法师奥图鲁斯那里."
...
Inst53Quest10_Folgequest = "有, 朋友的协助"
-- No Rewards for this quest

--Quest 11 Alliance
Inst53Quest11 = "11. 朋友的协助"
...
Inst53Quest11_Note = "卡琳娜·拉瑟德 (Area 52; "..YELLOW.."32,63"..WHITE..")"
...
Inst53Quest12_Prequest = "有, 朋友的协助"
...
--Quest 2 Alliance
Inst61Quest2 = "2. 卡尔萨斯和绿色魔球"
Inst61Quest2_Level = "70"
Inst61Quest2_Attain = "70"
Inst61Quest2_Aim = "把绿色球体带给沙塔斯城的阿达尔."
Inst61Quest2_Location = "绿色魔球 (掉落)"
Inst61Quest2_Note = "绿色魔球由 卡尔萨斯 逐日者掉落"..YELLOW.."[4]"..WHITE.."."
...
Inst61Quest3_Note = "要进去时光之穴--海加尔之战，这个任务是必须完成的. 卡尔萨斯 逐日者 在 "..YELLOW.."[4]"..WHITE.."."
...
Inst62Quest1_Location = "希瑞 (影月谷; "..YELLOW.."65,44"..WHITE..")."
Inst62Quest1_Note = ""
...
Inst62Quest2_Note = "阿卡玛之影 在 "..YELLOW.."[1]"..WHITE.."."
Inst62Quest2_Prequest = "有,寻找灰舌"
Inst62Quest2_Folgequest = "有,背叛者的倒下 "
-- No Rewards for this quest

--Quest 3 Alliance
Inst62Quest3 = "3. 背叛者的倒下"
