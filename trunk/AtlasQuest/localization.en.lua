...
Inst76Quest2_Note = "This daily quest can only be completed on Heroic difficulty.\n\nThe Ahn'kahet Brazier is behind Herald Volazj at "..YELLOW.."[4]"..WHITE..". The corpse has a 1 hour duration timer and will disappear if you leave the instance while alive."
...
Inst80Quest2_Note = "Drakuru's Brazier is behind The Prophet Tharon'ja at "..YELLOW.."[5]"..WHITE..". Enduring Mojo drops inside Drak'Tharon Keep."
