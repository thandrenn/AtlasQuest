...
Inst14Quest2_Note = "Люцифрон находится около "..YELLOW.."[1]"..WHITE..", Сульфурон около "..YELLOW.."[8]"..WHITE..", Гееннас около "..YELLOW.."[3]"..WHITE.." и Шаззрах около "..YELLOW.."[5]"..WHITE..". Yfuhflf jgbcfyf d rdtcnt 'Награда для героя'."
