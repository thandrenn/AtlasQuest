...
Inst5Quest8_Location = "Marschall Maxwell (Schwarzfelstiefen; "..YELLOW.."hinter [16]"..WHITE..")"
...
Inst5Quest8_HORDE_Location = "Kriegsherr Bluthauer (Schwarzfelstiefen; "..YELLOW.."hinter [16]"..WHITE..")"
