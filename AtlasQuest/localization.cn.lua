...
-- Simplified Chinese Localization for WotLK and TBC China by Yeachan & Ananhaid
...
Inst5Quest13_Prequest = "无瑕之焰 -> 烈焰精华"
...
Inst5Quest14_Prequest =  "索瑞森废墟"
Inst5Quest14_Folgequest = "卡兰的故事 -> 糟糕的消息 -> 王国的命运 -> 语出惊人的公主"
...
Inst5Quest15_Prequest = "糟糕的消息"
Inst5Quest15_Folgequest = "语出惊人的公主"
...
Inst5Quest17_Folgequest = "各个职业的职业任务（T0.5升级任务）"
-- No Rewards for this quest
...
Inst5Quest19_Folgequest = "侮辱科林·烈酒"
-- No Rewards for this quest
...
Inst9Quest9_Prequest = "瓦塔拉克护符的右瓣（"..YELLOW.."黑石塔下层"..WHITE.."）"
Inst9Quest9_Folgequest = "瓦塔拉克公爵"
...
Inst9Quest10_Prequest = "最后的准备"
Inst9Quest10_Folgequest = "向伯德雷回复 "
...
Inst39Quest6_Prequest = "能源舰的热源（"..YELLOW.."能源舰"..WHITE.."）和 魔语辞典（"..YELLOW.."暗影迷宫"..WHITE.."）"
...
Inst69Quest3_Location = "克罗米 (旧斯坦索姆; "..YELLOW.."[??]"..WHITE..")"
Inst69Quest3_Note = "暂无说明."
...
Inst69Quest4_Location = "克罗米 (旧斯坦索姆; "..YELLOW.."[??]"..WHITE..")"
Inst69Quest4_Note = "玛尔加尼斯 在 "..YELLOW.."[4]"..WHITE.."."
...
Inst72Quest2_Note = "研究笔记在通向大魔导师泰蕾丝塔"..YELLOW.."[6]"..WHITE.."的大厅的地上."
...
Inst72Quest3_Note = "在阿诺玛鲁斯 "..YELLOW.."[1]"..WHITE.."的位置附近的平台边缘使用使用交叉空间重塑器."
...
Inst72Quest5_Note = "晶化保卫者掉落奥术古树碎片."
...
Inst73Quest2_Note = "英雄日常任务.\n\n魔网调谐器掉落自 魔网守护者埃雷苟斯 "..YELLOW.."[2]"..WHITE.."."
...
Inst73Quest4_Location = "贝加里斯塔兹 (魔枢: 魔环; "..YELLOW.."[3]"..WHITE..")"
Inst73Quest4_Note = "贝加里斯塔兹在你击败 审讯者达库斯 "..YELLOW.."[1]"..WHITE.."后出现."
...
Inst73Quest5_Location = "贝加里斯塔兹的影像 (魔枢: 魔环; "..YELLOW.."[3]"..WHITE..")"
Inst73Quest5_Note = "贝加里斯塔兹在你击败 审讯者达库斯 "..YELLOW.."[1]"..WHITE.."后出现."
...
Inst73Quest6_Location = "贝加里斯塔兹的影像 (魔枢: 魔环; "..YELLOW.."[2]"..WHITE..")"
Inst73Quest6_Note = "埃雷苟斯 在 "..YELLOW.."[2]"..WHITE..". 莱洛拉斯 在 (北风苔原 - 永生之盾; "..YELLOW.."33.2, 34.4"..WHITE..")."
...
Inst76Quest4_Note = "无面者和传令官沃拉兹 在 "..YELLOW.."[4]"..WHITE.."."
...
Inst80Quest2_Note = "达库鲁的火盆在先知萨隆亚"..YELLOW.."[4]"..WHITE.."的身后. 副本里所有怪都掉落耐久魔精."
...
Inst80Quest3_Note = "库尔基是被网住的倒霉蛋之一，在 托尔戈 "..YELLOW.."[1]"..WHITE.."的右边楼梯上."
...
Inst80Quest4_Location = "库尔基 (达克萨隆要塞; "..YELLOW.."[??]"..WHITE..")"
Inst80Quest4_Note = "召唤者诺沃斯 在 "..YELLOW.."[2]"..WHITE..". 马克 在 (灰熊丘陵 - 岩石之泉; "..YELLOW.."16.6, 48.1"..WHITE..")"
...
Inst81Quest2_Note = "副本里有足够的石板，5人小队绰绰有余."
...
Inst81Quest3_Note = "迦尔达拉 在 "..YELLOW.."[4]"..WHITE.."."
...
Inst83Quest1_Aim = "在风暴之眼战场中获得一场胜利，然后向任意联盟主城或沙塔斯城中的联盟准将复命."
