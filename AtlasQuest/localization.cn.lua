...
Inst43General = {
   ...
   RED .. "瞄准射击" .. WHITE .. "：没有被近距离坦克吸引住时会使用这一技能，对布衣可以造成2000点以上伤害。\n" .. RED .. "多重射击" .. WHITE .. "：对若干随机队员射击，造成2000 - 2500点奥术伤害。\n" .. RED .. "冰冻陷阱" .. WHITE .. "：会冰冻所有队员3秒，然后拉开距离。",
    ...
    {
    "黑色阔步者",
    "分散站位是避免闪电伤害的关键。但是真正造成伤害的是漂浮术和静电充能。静电充能每次伤害为750，除非得到治疗，玩家会被杀死。如果可能的话，安排好第二治疗和第二坦克。这一首领的战斗比起该地下城中之前的战斗来说相对困难。",
...
Inst68Story = "在最新的2.4版本《决战太阳之井》中，燃烧军团的恶魔领主基尔加丹将从太阳之井中重返世界，他的栖身之地将成为一个全新的25人地下城：太阳之井高地。"
...
Inst69Story = "旧斯坦索姆是时光之穴又一个新的地下城。在这个故事里，你将帮助阿尔萨斯王子从瘟疫中净化这座城市，也正是这一次战役，让年轻的阿尔萨斯开始堕落入黑暗的深渊，当然，这一切都是巫妖王邪恶计划的一部分。"
...
Inst76Quest1_Note = "英雄日常任务。\n\n安卡赫特火盆在传令官沃拉兹的身后"..GREEN.."[1']"..WHITE.."。尸体持续1小时时间，如果你离开地下城的话尸体会消失。"
...
Inst80Story = "达克萨隆要塞座落在灰熊丘陵的西北部，是古代冰霜巨魔王国的要塞。亡灵天灾赶走了曾经在这里生活的巨魔并占领了这个要塞，控制了通往祖达克的道路。这个地下城到处充满了被亡灵控制的各种怪物和机关。你要去探索这个庞大的地下城，查找是什么原因使冰霜巨魔放弃了他们的家园逃往他处。"
...
Inst80Quest1_Note = "达库鲁的火盆在先知萨隆亚的身后"..GREEN.."[3']"..WHITE.."。地下城里所有怪都掉落耐久魔精。"
...
Inst81Story = "古达克是冰霜巨魔的首都，座落在祖达克的这个地下城，有3个入口，通往城市的中心。阿卡里从这里，控制着他的王国祖达克。他指挥着巨魔，与亡灵天灾战斗。这个王国各处都体现出冰霜巨魔的智慧成就，包括与亡灵天灾的战斗方式，这能够给我们一些启迪。"
Inst81Caption = "古达克"
Inst81QAA = "3 个任务"
Inst81QAH = "3 个任务"
Inst81General = {
    ...
    {
    "莫拉比",
    "这个首领是地下城中最简单的一个了，一场木桩战，首领的变形可以被打断，因此尽量打断吧。不过即使没有打断让首领变身成功，其伤害也只增加25%而已，其本身攻击并不高，所以基本上没有威胁。",
...
Inst81Quest1_Note = "地下城里有足够的石板，5人小队绰绰有余。前置任务”核实情况“并非必要的。"
...
Inst82Story = "紫罗兰监狱是一个5人地下城，座落在漂浮的城市达拉然。玛利苟斯手下的蓝龙军团用魔法建立了一个传送门，出口就在这里，它们试图从这里冲出去来毁灭这个城市。肯瑞托的精英守卫们正顽强抵抗者蓝龙军团的猛烈攻击，当然，他们需要勇士的帮助。"
Inst82Caption = "紫罗兰监狱"
Inst82QAA = "2 个任务"
Inst82QAH = "2 个任务"
Inst82General = {
    {
    "埃雷克姆",
    "跟 TBC 时光之穴 - 黑暗沼泽（18波）很像的地下城。三只首领的前面2只，是从以下6个“随机”挑出2个出来。只有第三只，最后的首领是固定的塞安妮苟萨。埃雷克姆攻略：这首领会连带着2个护卫（76级精英44,004 HP；英雄，80级精英63,000 HP）尽量打断它的治疗链、消掉它们的嗜血术。先打死他2个护卫后，首领会狂怒。英雄难度下，或许就先打死一只护卫，留下一只，再打首领，最后才杀死留下的护卫。",
...
Inst85Story = "阿尔卡冯的宝库是冬涌湖战场的一个团队地下城，胜利一方才能进入这个地下城。"
...
Inst90Quest2_Note = "进入下一个地下城或离开地下城之前，完成任务于吉安娜·普罗德摩尔 "..YELLOW.."[3]"..WHITE.."。\n\n完成此任务需要进入萨隆矿坑。"
