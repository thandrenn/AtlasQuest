...
Inst14Quest2_Prequest = "Агент Гидраксиса"
...
Inst76Quest2_Note = "Это задание выполняется в героическом режиме сложности.\n\nАн'кахетская жаровня находится рядом с Глашатаем Волажем"..YELLOW.."[4]"..WHITE..". Cмерть первого пака у входа (из которого берется труп) установит таймер на один час."
...
Inst80Quest2_Note = "Жаровня Дракуру находится около Пророка Тарон'джи "..YELLOW.."[5]"..WHITE..". Настои терпения падают в Крепости Драк'Тарон."
