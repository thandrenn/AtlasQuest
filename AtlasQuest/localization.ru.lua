...
Inst33Quest2_Location = "Лейтенант Ротимер (Стальгорн - The Commons; "..YELLOW.."30,62"..WHITE..")"
...
Inst33Quest3_Note = "Знамя Грозовой Вершины находится в Icewing Cavern "..YELLOW.."[11]"..WHITE.." в Альтеракская долина - Северная карта. Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe предшествующее задание is not necessary to obtain this quest."
