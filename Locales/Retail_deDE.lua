...
local AQ_CLASSREWARDS = " Variiert für jede Klasse"
...
L["Quest_27790_Location"] = "Leutnant Horatio Laine (Todesmine; "..GREEN.."[1']"..PREV..")";
L["Quest_27790_Note"] = "Diese Quest bekommst Du automatisch nachdem Du den Mastraum betreten hast.\n\n'Kapitän' Krümel ist der finale Endboss (auf normal) und ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_27842_Location"] = "Kagtha (Todesminen; "..GREEN.."[1']"..PREV..")";
L["Quest_27842_Note"] = "Glubtok ist bei "..YELLOW.."[1]"..PREV..".";

L["Quest_27844_Name"] = "Verräter!!!";
L["Quest_27844_Objective"] = "Besiegt Helix Ritzelbrecher.";
L["Quest_27844_Location"] = "Slinky Scharfklinge (Todesminen; "..GREEN.."[1']"..PREV..")";
...
L["Quest_27847_Location"] = "Fräulein Fiasko (Todesminen; "..GREEN.."[1']"..PREV..")";
...
L["Quest_27848_Location"] = "Kagtha (Todesminen; "..GREEN.."[1']"..PREV..")";
...
L["Quest_27850_Location"] = "Kagtha (Todesminen; "..GREEN.."[1']"..PREV..")";
...
L["Quest_26872_Location"] = "Nalpak (Höhlen des Wehklagens; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_26873_Location"] = "Nalpak (Höhlen des Wehklagens; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_26870_Location"] = "Ebru (Höhlen des Wehklagens; "..BLUE.."Eingang"..PREV..")";
L["Quest_26870_Note"] = "Lady Anacondra ist bei "..YELLOW.."[1]"..PREV..", Lord Kobrahn ist bei "..YELLOW.."[3]"..PREV..", Lord Pythas ist bei "..YELLOW.."[4]"..PREV.." und Lord Serpentis ist bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_26878_Location"] = "Tonga Runentotem (Nördliches Brachland - Das Wegekreuz; "..YELLOW.."49.4, 58.6"..PREV..")";
L["Quest_26878_Note"] = "Nalpak befindet sich in (Höhlen des Wehklagens; "..GREEN.."[1']"..PREV..")";
...
L["Quest_30995_Location"] = "SI:7-Feldkommandant Dirken (Flammenschlund; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30998_Location"] = "Hochzauberin Aryna (Flammenschlund; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30996_Location"] = "Hochzauberin Aryna (Flammenschlund; "..BLUE.."Eingang"..PREV..")";
L["Quest_30996_Note"] = "Dunkelschamane Koranthal befindet sich bei "..YELLOW.."[2]"..PREV.." und Lavawache Gordoth befindet sich bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_31037_Location"] = "Garrosh Höllschrei (Orgrimmar - Das Tal der Stärke; "..YELLOW.."48.2, 70.6"..PREV..")\nBaine Bluthuf (Donnerfels - Anhöhe der Ältesten; "..YELLOW.."60.6, 51.6"..PREV..")\nFürstin Sylvanas Windläufer (Unterstadt - Das königliche Viertel; "..YELLOW.."58.6, 93.0"..PREV..")";
...
L["Quest_30984_Location"] = "Kommandant Bagran (Flammenschlund; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30969_Location"] = "Herbeirufer Xorenth (Flammenschlund; "..GREEN.."1'"..PREV..")";
...
L["Quest_30983_Location"] = "Herbeirufer Xorenth (Flammenschlund; "..GREEN.."1'"..PREV..")";
L["Quest_30983_Note"] = "Dunkelschamane Koranthal befindet sich bei "..YELLOW.."[2]"..PREV.." und Lavawache Gordoth befindet sich bei "..YELLOW.."[4]"..PREV..".";

L["Quest_27672_Name"] = "Die Kammer von Khaz'mul";
L["Quest_27672_Objective"] = "Besiegt Ironaya.";
L["Quest_27672_Location"] = "Oberausgrabungsleiter Durdin (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27672_Note"] = "Ironaya ist bei "..YELLOW.."[3]"..PREV..". Um die Kammer zu öffnen, besorge zuerst das Medaillon von Gni'kiv aus der Baelogs Truhe bei "..YELLOW.."[1]"..PREV.." und dem Schaft von Tsol von Revelosh bei "..YELLOW.."[2]"..PREV..".\n\nDu kannst diese Quest annehmen und die nächste die vom Questlog kommt akzeptieren.";
...
L["Quest_27677_Location"] = "Oberausgrabungsleiter Durdin (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27677_Note"] = "Archaedas ist bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_27673_Location"] = "Kand Sandsucher (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27673_Note"] = "Der Obsidiankraftkern droppt von den Obsidianschildwache bei "..YELLOW.."[4]"..PREV.." und der Titankraftkern vom Uralter Steinbewahrer bei "..YELLOW.."[5]"..PREV..".";

L["Quest_27676_Name"] = "Hinter verschlossenen Türen";
L["Quest_27676_Objective"] = "Tötet Galgann Feuerhammer.";
L["Quest_27676_Location"] = "Olga Runenschwur (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27676_Note"] = "Galgann Feuerhammer ist bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_2278_Location"] = "Die Platinscheiben (Uldaman; "..GREEN.."[2']"..PREV..")";
...
L["Quest_2280_Location"] = "Die Platinscheiben (Uldaman; "..GREEN.."[2']"..PREV..")";
...
L["Quest_27679_Location"] = "Oberster Prüfer Tae'thelan Blutwächter (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27679_Note"] = "Ironaya ist bei "..YELLOW.."[3]"..PREV..". Um die Kammer zu öffnen, besorge zuerst das Medaillon von Gni'kiv aus der Baelogs Truhe bei "..YELLOW.."[1]"..PREV.." und dem Schaft von Tsol von Revelosh bei "..YELLOW.."[2]"..PREV..".\n\nDu kannst diese Quest annehmen und die nächste die vom Questlog kommt akzeptieren.";
...
L["Quest_27680_Location"] = "Oberster Prüfer Tae'thelan Blutwächter (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27680_Note"] = "Archaedas ist bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_27682_Location"] = "Aoren Sonnenglanz (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27682_Note"] = "Der Obsidiankraftkern droppt von den Obsidianschildwache bei "..YELLOW.."[4]"..PREV.." und der Titankraftkern vom Uralter Steinbewahrer bei "..YELLOW.."[5]"..PREV..".";

L["Quest_27681_Name"] = "Hinter verschlossenen Türen";
L["Quest_27681_Objective"] = "Tötet Galgann Feuerhammer.";
L["Quest_27681_Location"] = "Lidia Sonnenglanz (Uldaman; "..BLUE.."Eingang"..PREV..")";
L["Quest_27681_Note"] = "Galgann Feuerhammer ist bei "..YELLOW.."[6]"..PREV..".";

L["Quest_27565_Name"] = "Ins Gefängnis";
L["Quest_27565_Objective"] = "Findet Kevin Dawson.";
L["Quest_27565_Location"] = "Jalinda Sprig (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27565_Note"] = "Kevin Dawson ist auf dem Weg zum Gefängnis bei "..GREEN.."[2']"..PREV..".";
...
L["Quest_27567_Location"] = "Kevin Dawson (Schwarzfelstiefen; "..GREEN.."[2']"..PREV..")";
L["Quest_27567_Note"] = "Verhörmeisterin Gerstahn ist bei "..YELLOW.."[1]"..PREV..".";
L["Quest_27567_PreQuest"] = "Ins Gefängnis";

L["Quest_27603_Name"] = "Das versiegelte Tor";
L["Quest_27603_Objective"] = "Tötet Bael'gar.";
L["Quest_27603_Location"] = "Tinkee Kesseldampf (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27603_Note"] = "Bael'gar ist bei "..YELLOW.."[4]"..PREV..".";

L["Quest_27568_Name"] = "Schattenschmiede unterwandern";
L["Quest_27568_Objective"] = "Sprecht mit Ausgrabungsleiter Seymour.";
L["Quest_27568_Location"] = "Oralius (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27568_Note"] = "Ausgrabungsleiter Seymour ist bei "..GREEN.."[3']"..PREV..".";
...
L["Quest_27569_Location"] = "Mayara Wolkenglanz (Schwarzfelstiefen; "..GREEN.."[7']"..PREV..")";
L["Quest_27569_Note"] = "General Zornesschmied ist bei "..YELLOW.."[10]"..PREV.." und Golemlord Argelmach ist bei "..YELLOW.."[11]"..PREV..". Diese Quest führt dich zu Mayara Wolkenglanz bei "..GREEN.."[7']"..PREV..".";
...
L["Quest_27571_Location"] = "Mayara Wolkenglanz (Schwarzfelstiefen; "..GREEN.."[7']"..PREV..")";
L["Quest_27571_Note"] = "Alle drei sind im Grimmigen Säufer zu finden bei "..YELLOW.."[12]"..PREV..", "..YELLOW.."[13]"..PREV.." und "..YELLOW.."[14]"..PREV..". Diese Quest bringt dich in die Nähe von Gebirgsjäger Orfus "..YELLOW.."[10']"..PREV..".";
...
L["Quest_27573_Location"] = "Gebirgsjäger Orfus (Schwarzfelstiefen; "..GREEN.."Nähe [10']"..PREV..")";
L["Quest_27573_Note"] = "Botschafter Flammenschlag ist bei "..YELLOW.."[15]"..PREV.." und Un'rel ist bei "..YELLOW.."[16]"..PREV..". Diese Quest führt dich zu Marschall Maxwell gerade hinaus "..GREEN.."[11']"..PREV..".";
...
L["Quest_27578_Location"] = "Marschall Maxwell (Schwarzfelstiefen; "..GREEN.."[11']"..PREV..")";
L["Quest_27578_Note"] = "Imperator Dagran Thaurissan ist bei "..YELLOW.."[18]"..PREV..". Diese Quest bringt dich zurüch zu Marschall Maxwell.";
...
L["Quest_27596_Location"] = "Maxwort Funkelglanz (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27596_Note"] = "Das Herz des Berges ist im Gewölbe bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_28393_Location"] = "Ander Germaine (Sturmwind - Altstadt; "..YELLOW.."79.8, 69.5"..PREV..")";
L["Quest_28393_Note"] = "Dies ist eine Kriegerklassenquest. Die optionale Vorquest startet bei jedem Kriegerlehrer in den Haupstädten.\n\nGeneral Zornesschmied ist bei "..YELLOW.."[10]"..PREV.." und die Brandwachenzerstörer sind auf dem Weg zum Boss.";
...
L["Quest_28401_Location"] = "Scharfseherin Umbrua (Sturmwind - Zwergendistrikt; "..YELLOW.."65.9, 31.4"..PREV..")";
...
L["Quest_28399_Location"] = "Demisette Cloyce (Sturmwind - Das Magierviertel; "..YELLOW.."39.7, 84.5"..PREV..")";
...
L["Quest_28406_Location"] = "Lord Tony Romano (Sturmwind - Altstadt; "..YELLOW.."79.6, 61.2"..PREV..")";
...
L["Quest_28394_Location"] = "Wulf Hansreim (Sturmwind - Altstadt; "..YELLOW.."79.5, 70.9"..PREV..")";
L["Quest_28394_Note"] = "Dies ist eine Jägerklassenquest. Die optionale Vorquest startet bei jedem Jägerlehrer in den Hauptstädten.\n\nDie Blaupausen eines Elementargolems droppt vom Golem Lord Argelmach bei "..YELLOW.."[11]"..PREV.." und die Elementarmodule von den in der Nähe befindlichen Golems.";
...
L["Quest_28398_Location"] = "Maginor Dumas (Sturmwind - Magierviertel; "..YELLOW.."49.5, 87.0"..PREV..")";
...
L["Quest_28328_Location"] = "Hohepriesterin Laurena (Sturmwind - Kathedralenplatz; "..YELLOW.."49.7, 44.9"..PREV..")";
...
L["Quest_28405_Location"] = "Lord Grayson Schattenbruch (Sturmwind - Kathedralenplatz; "..YELLOW.."52.7, 45.1"..PREV..")";
L["Quest_28405_Note"] = "Dies ist eine Paladinklassenquest. Die optionale Vorquest startet bei jedem Paladinlehrer in den Hauptstädten.\n\nDer schwarze Amboss ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_7848_Location"] = "Lothos Felsspalter (Schwarzfels; "..YELLOW.."Boden der niedrigen Ketten"..PREV..")";
L["Quest_7848_Note"] = "Nach Beendigung dieser Quest, kannst du den Stein in der Nähe von Lothos Felsspalterbenutzen, um in den Geschmolzenen Kern zu gelangen.\nDu kannst das Kernfragment in der Nähe von "..BLUE.."[E]"..PREV.." finden, sehr nahe am am Portal zum Geschmolzenen Kern.";
...
L["Quest_12491_Location"] = "Düsterbräus Düsterbräu ( droppt von Coren Düsterbräu bei "..YELLOW.."[12]"..PREV..")";
L["Quest_12491_Note"] = "Coren Düsterbräu ist nur während des Braufestes in den Schwarzfelstiefen. Dieser Questgegenstand droppt nur einmal pro Charakter.\n\nIpfelkofer Eisenfass ist ist auf dem Braufestplatz bei (Dun Morogh; "..YELLOW.."55.1, 38.1"..PREV..").";
...
L["Quest_44952_Location"] = "Wixxrak (Winterquell - Ewigen Warte; "..YELLOW.."60.2, 50.2"..PREV..")";
L["Quest_44952_Note"] = "Schmiedekunstquest.  Der Kern von Bael'Gar droppt bei "..YELLOW.."[4]"..PREV..", Der Kern von Roccor bei "..YELLOW.."[2]"..PREV.." und die Essenz von Magmus bei "..YELLOW.."[18]"..PREV..".  Die Schwarze Schmiede ist bei "..GREEN.."['12]"..PREV..".";
L["Quest_44952_RewardText"] = "1";

L["Quest_27579_Name"] = "Ins Gefängnis";
L["Quest_27579_Objective"] = "Findet Lexlort.";
L["Quest_27579_Location"] = "Thal'trak Ehrenhauer (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27579_Note"] = "Lexlort ist auf den Weg zum Gefängnis bei "..GREEN.."[2']"..PREV..".";
...
L["Quest_27581_Note"] = "Verhörmeisterin Gerstahn ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_27582_Location"] = "Galamav der Schütze (Schwarzfelstiefen; "..BLUE.."Eingang"..PREV..")";
L["Quest_27582_Note"] = "Razal'hieb ist bei "..GREEN.."[3']"..PREV..".";
...
L["Quest_27585_Location"] = "Razal'hieb (Schwarzfelstiefen; "..GREEN.."[3']"..PREV..")";
L["Quest_27585_Note"] = "General Zornesschmied ist bei "..YELLOW.."[10]"..PREV.." und Golemlord Argelmach ist bei "..YELLOW.."[11]"..PREV..". Diese Quest führt dich zu Hierophantin Theodora Mulvadania bei "..GREEN.."[7']"..PREV..".";
...
L["Quest_27589_Location"] = "Hierophantin Theodora Mulvadania (Schwarzfelstiefen; "..GREEN.."[7']"..PREV..")";
L["Quest_27589_Note"] = "Alle drei sind im Grimmigen Säufer zu finden bei "..YELLOW.."[12]"..PREV..", "..YELLOW.."[13]"..PREV.." und "..YELLOW.."[14]"..PREV..". Diese Quest bringt dich in die Nähe von Donnerherz "..GREEN.."[10']"..PREV..".";
...
L["Quest_27591_Location"] = "Donnerherz (Schwarzfelstiefen; "..GREEN.."[10']"..PREV..")";
L["Quest_27591_Note"] = "Botschafter Flammenschlag ist bei "..YELLOW.."[15]"..PREV.." und Un'rel ist bei "..YELLOW.."[16]"..PREV..". Diese Quest führt dich zu Kriegsherr Bluthauer bei "..GREEN.."[11']"..PREV..".";
...
L["Quest_27593_Location"] = "Kriegsherr Bluthauer (Schwarzfelstiefen; "..GREEN.."[11']"..PREV..")";
L["Quest_27593_Note"] = "Imperator Dagran Thaurissan ist bei "..YELLOW.."[18]"..PREV..". Diese Quest bringt dich zurüch zu Kriegsherr Bluthauer.";
...
L["Quest_28457_Location"] = "Grezz Zornfaust (Orgrimmar - Tal der Ehre; "..YELLOW.."73.7, 45.6"..PREV..")";
...
L["Quest_28465_Location"] = "Kardris Traumsucher (Orgrimmar - Tal der Weisheit; "..YELLOW.."39.5, 47.0"..PREV..")";
...
L["Quest_28459_Location"] = "Zevrost (Orgrimmar - Kluft der Schatten; "..YELLOW.."49.0, 55.3"..PREV..")";
...
L["Quest_28463_Location"] = "Gordul (Orgrimmar - Kluft der Schatten; "..YELLOW.."44.8, 61.3"..PREV..")";
...
L["Quest_28461_Location"] = "Ormak Grimmschlag (Orgrimmar - Tal der Ehre; "..YELLOW.."64.0, 32.7"..PREV..")";
...
L["Quest_28458_Location"] = "Ureda (Orgrimmar - Kluft der Schatten; "..YELLOW.."51.3, 72.3"..PREV..")";
...
L["Quest_28474_Location"] = "Dunkle Klerikerin Cecille (Orgrimmar - Tal der Stärke; "..YELLOW.."48.7, 72.8"..PREV..")";
...
L["Quest_28473_Location"] = "Meister Pyreanor (Orgrimmar - Tal der Stärke; "..YELLOW.."49.2, 71.3"..PREV..")";
...
L["Quest_28466_Location"] = "Sonnenläufer Atohmo (Orgrimmar - Tal der Weisheit;"..YELLOW.."45.2, 53.7"..PREV..")";
...
L["Quest_12492_Location"] = "Düsterbräus Düsterbräu ( droppt von Coren Düsterbräu bei "..YELLOW.."[12]"..PREV..")";
L["Quest_12492_Note"] = "Coren Düsterbräu ist nur während des Braufestes in den Schwarzfelstiefen. Dieser Questgegenstand droppt nur einmal pro Charakter.\n\nZapfus Schwindelfass ist auf dem Braufestplatz bei (Durotar; "..YELLOW.."41.6, 18.5"..PREV..").";
...
L["Quest_7781_Location"] = "Kopf von Nefarian (droppt von Nefarian; "..YELLOW.."[9]"..PREV..")";
L["Quest_7781_Note"] = "König Varian Wrynn ist in (Sturmwind - Burg Sturmwind; "..YELLOW.."85.7, 31.8"..PREV.."). Die Folgequest schickt euch zu Feldmarschall Afrasiabi (Sturmwind - Tal der Helden; "..YELLOW.."67,72"..PREV..") für die Belohnung.";
...
L["Quest_7783_Location"] = "Kopf von Nefarian (droppt von Nefarian; "..YELLOW.."[9]"..PREV..")";
L["Quest_7783_Note"] = "Garrosh Höllschrei ist bei (Orgrimmar - Tal der Stärke; "..YELLOW.."48.2, 70.6"..PREV..").\n\nDie Folgequest schickt euch zu Oberanführer Runthak (Orgrimmar - Tal der Stärke; "..YELLOW.."51.3, 83.2"..PREV..") für die Belohnung.";
...
L["Quest_26897_Location"] = "Shindrell Feuerflink (Eschental; Stützpunkt an der Grotte; "..YELLOW.."18.2, 20.4"..PREV..").";
L["Quest_26897_Note"] = "Schildwache Aluwyn befindet sich am "..BLUE.."Eingang"..PREV.." der Instanz.";

L["Quest_34672_Name"] = "Der Aufstieg von Aku'mai";
L["Quest_34672_Objective"] = "Tötet Aku'mai den Verschlinger.";
L["Quest_34672_Location"] = "Schildwache Aluwyn (Tiefschwarze Grotte; "..BLUE.."Eingang"..PREV..")";
L["Quest_34672_Note"] = "Aku'mai ist der Endboss, er befindet sich bei "..YELLOW.."[8]"..PREV..". Schildwache Aluwyn erscheint nachdem der Endboss besiegt wurde.";
...
L["Quest_34673_Location"] = "Zeya (Tiefschwarze Grotte; "..BLUE.."Eingang"..PREV..")";
L["Quest_34673_Note"] = "Aku'mai ist der Endboss, er befindet sich bei "..YELLOW.."[8]"..PREV..". Zeya erscheint nachdem der Endboss besiegt wurde.";
...
L["Quest_27470_Location"] = "Aufseher Schlickfaust (Sengende Schlucht - Thoriumspitze; "..YELLOW.."38.2, 27.0"..PREV..")";
L["Quest_27470_Note"] = "Acride ist innerhalb der Instanz bei "..GREEN.."[1']"..PREV..".";

L["Quest_27471_Name"] = "Schwarzfelsanomalie";
L["Quest_27471_Objective"] = "Findet Acride.";
L["Quest_27471_Location"] = "Helendis Flusshorn (Brennende Steppe - Morgens Wacht; "..YELLOW.."73,4, 66,3"..PREV..")";
L["Quest_27471_Note"] = "Acride ist innerhalb der Instanz bei "..GREEN.."[1']"..PREV..".";

L["Quest_27469_Name"] = "Freunde auf der anderen Seite";
L["Quest_27469_Objective"] = "Findet Acride.";
L["Quest_27469_Location"] = "Struppiger John (Brennende Steppe - Flammenkamm; "..YELLOW.."54.2, 23.9"..PREV..")";
L["Quest_27469_Note"] = "Acride ist innerhalb der Instanz bei "..GREEN.."[1']"..PREV..".";
...
L["Quest_27440_Location"] = "Acride (Schwarzfelsspitze; "..GREEN.."[1']"..PREV..")";
L["Quest_27440_Note"] = "Kriegsmeister Voone ist bei "..YELLOW.."[3]"..PREV..", Hochlord Omokk ist bei "..YELLOW.."[1]"..PREV..", und Oberanführer Wyrmthalak ist bei "..YELLOW.."[8]"..PREV.." innerhalb der unteren Schwarzfelsspitze.";
...
L["Quest_27129_Location"] = "Telaron Windsegler (Feralas - Träumers Ruh; "..YELLOW.."50.6, 17.0"..PREV..")";
...
L["Quest_27107_Location"] = "Botschafter Dagg'thol (Düsterbruch - Ost; "..BLUE.."Eingang"..PREV..")";
L["Quest_27107_Note"] = "Pusillin ist links vom Eingang bei "..GREEN.."[1']"..PREV..". Nachdem Du mit ihm gesprochen hast, mußt Du ihn jagen und seine Freunde bekämpfen bei "..GREEN.."[2']"..PREV..".";

L["Quest_27108_Name"] = "Lethtendris' Netz";
L["Quest_27108_Objective"] = "Beschafft Lethtendris' Netz.";
L["Quest_27108_Location"] = "Botschafter Dagg'thol (Düsterbruch - Ost; "..BLUE.."Eingang"..PREV..")";
L["Quest_27108_Note"] = "Lethtendris ist bei "..YELLOW.."[1]"..PREV.." auf einer erhöhten Plattform am Ende der Rampe.";

L["Quest_27105_Name"] = "Ein ungebetener Gast";
L["Quest_27105_Objective"] = "Findet die Hydrobrutessenz.";
L["Quest_27105_Location"] = "Furgus Wucherborke (Düsterbruch - Ost; "..BLUE.."Eingang"..PREV..")";
L["Quest_27105_Note"] = "Hydrobrut ist bei "..YELLOW.."[2]"..PREV..".";

L["Quest_27104_Name"] = "Alzzin der Wildformer";
L["Quest_27104_Objective"] = "Tötet Zevrim Dornhuf und Alzzin den Wildformer.";
L["Quest_27104_Location"] = "Furgus Wucherborke (Düsterbruch - Ost; "..BLUE.."Eingang"..PREV..")";
L["Quest_27104_Note"] = "Zevrim Dornhuf ist bei "..YELLOW.."[3]"..PREV.." und Alzzin den Wildformer ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_27103_Location"] = "Furgus Wucherborke (Düsterbruch - Ost; "..BLUE.."Eingang"..PREV..")";
L["Quest_27103_Note"] = "Benutze das Requiliar der Reinheit nachdem Du Alzzin den Wildformer besiegt hast bei "..YELLOW.."[4]"..PREV..". Nur 5 Splitter erscheinen und Du kannst alle aufnehmen, also greife schnell zu.";

L["Quest_27130_Name"] = "Wucherborke retten";
L["Quest_27130_Objective"] = "Sprecht mit Furgus Wucherborke.";
L["Quest_27130_Location"] = "Hadoken Flinkschreiter (Feralas - Camp Mojache; "..YELLOW.."74.8, 42.6"..PREV..")";
...
L["Quest_27133_Location"] = "Shandris Mondfeder (Feralas - Mondfester Feste; "..YELLOW.."46.0, 49.0"..PREV..")";
...
L["Quest_27118_Location"] = "Eine beschädigte Falle (Düsterbruch - Nord; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_27119_Location"] = "Knot Zwingenschraub (Düsterbruch - Nord; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_27114_Location"] = "Stampfer Kreeg (Düsterbruch - Nord; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_27134_Location"] = "Orhan Ogerklinge (Feralas - Festung der Steinbrecher;"..YELLOW.."51.8, 48.0"..PREV..")";
...
L["Quest_27128_Location"] = "Oger der Steinbrecher (Düsterbruch - Nord; "..BLUE.."Eingang"..PREV..")";
L["Quest_27128_Note"] = "König Gordok ist bei "..YELLOW.."[6]"..PREV..".\n\nJe mehr der folgenden NPCs (Wache Mol'dar, Stampfer Kreeg, Wache Fengus, Wache Slip'kik und Hauptmann Kromcrush) am Leben bleiben, desto besseren Loot und Quests bekommst du nachdem König Gordok besiegt wurde. Denke daran mit Cho'Rush dem Beobachter am Ende des Zugangs zum Tributkasten zu sprechen.";
...
L["Quest_27131_Location"] = "Telaron Windsegler (Feralas - Träumers Ruh; "..YELLOW.."50.6, 17.0"..PREV..")";
...
L["Quest_27112_Location"] = "Estulan (Düsterbruch - West; "..BLUE.."Eingang"..PREV..")";
L["Quest_27112_Note"] = "Magister Kalendris ist bei "..YELLOW.."[2]"..PREV.." und Illyana Rabeneiche ist bei "..YELLOW.."[3]"..PREV..".";

L["Quest_27113_Name"] = "Der Uralte Shen'dralar";
L["Quest_27113_Objective"] = "Sprecht mit dem Uralten Shen'dralar.";
L["Quest_27113_Location"] = "Estulan (Düsterbruch - West; "..BLUE.."Eingang"..PREV..")";
L["Quest_27113_Note"] = "Der Uralte Shen'dralar ist bei "..GREEN.."[4']"..PREV.." auf der oberen Plattform.";

L["Quest_27109_Name"] = "Windschiefe Verteidiger";
L["Quest_27109_Objective"] = "Tötet Tendris Wucherborke.";
L["Quest_27109_Location"] = "Behüter der Shen'dralar (Düsterbruch - West; "..BLUE.."Eingang"..PREV..")";
L["Quest_27109_Note"] = "Tendris Wucherborke ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_27110_Location"] = "Uralte Shen'dralar (Düsterbruch - West; "..GREEN.."[4']"..PREV..")";
L["Quest_27110_Note"] = "Die Pylonen sind gekennzeichnet als "..GREEN.."[2']"..PREV..". Immol'thar ist bei "..YELLOW.."[4]"..PREV..", Prinze Tortheldrin ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_27111_Location"] = "Uralte Shen'dralar (Düsterbruch - West; "..GREEN.."[4']"..PREV..")";
...
L["Quest_27132_Location"] = "Hadoken Flinkschreiter (Feralas - Camp Mojache; "..YELLOW.."74.8, 42.6"..PREV..")";
...
L["Quest_27697_Note"] = "Lord Schlangenzunge ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_27698_Note"] = "Noxxion ist bei "..YELLOW.."[1]"..PREV.." und Schlingenwurzler ist bei "..YELLOW.."[2]"..PREV..".";

L["Quest_27692_Name"] = "Prinzessin Theradras";
L["Quest_27692_Objective"] = "Tötet Prinzessin Theradras.";
L["Quest_27692_Location"] = "Du bekommst diese Quest automatisch, nachdem Du am Wasserfall im Bereich "..BLUE.."[C]"..PREV.." betritts.";
L["Quest_27692_Note"] = "Prinzessin Theradras ist bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_7786_Location"] = "Hochlord Demitrian (Silithus; "..YELLOW.."29.6, 10.6"..PREV..")";
L["Quest_7786_Note"] = "Teil des Gesegnete Klinge des Windsuchers Questreihe. Die startet nachdem Du die linke oder rechte Hälfte der Fesseln des Windsuchers von Garr bei "..YELLOW.."[4]"..PREV.." oder Baron Geddon bei "..YELLOW.."[6]"..PREV.." erhälst. Spreche mit Hochlord Demitrian um die Questreihe zu starten. Essenz des Feuerfürsten droppt von Ragnaros bei "..YELLOW.."[10]"..PREV..". Nach abgeben dieses Teils, wird Prinz Donneraan erscheinen und Du mußt ihn töten. Dieser ist ein 40'er Schlachtzugsboss.";
L["Quest_7786_PreQuest"] = "Untersuchung des Gefäßes ("..YELLOW.."Obere Schwarzfelsspitze"..PREV..")";
...
L["Quest_7604_Location"] = "Lokhtos Düsterfeilsch (Schwarzfelstiefen; "..GREEN.."[8']"..PREV..")";
L["Quest_7604_Note"] = "Du benötigst einen Sulfuronblock um den Vertrag von Lokhtos zu erhalten. Dieser droppt von Golemagg der Verbrenner im Geschmolzener Kern bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_24428_Location"] = "Kopf von Onyxia (droppt von Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_24428_Note"] = "Zardeth der schwarzen Klaue ist bei (Sturmwind - Zum geschlachteten Lamm; "..YELLOW.."40.2, 84.4"..PREV.."). Nur eine Person im Schlachtzug kann den Kopf an sich nehmen und diese Quest kann nur einmal abgeschlossen werden.";
...
L["Quest_24429_Location"] = "Kopf von Onyxia (droppt von Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_24429_Note"] = "Neeru Feuerklinge ist bei (Orgrimmar - Die Kluft des Schattens; "..YELLOW.."50.0, 60.0"..PREV.."). Nur eine Person im Schlachtzug kann den Kopf an sich nehmen und diese Quest kann nur einmal abgeschlossen werden.";
...
L["Quest_27063_Location"] = "Telaron Windsegler (Feralas - Täumers Ruh; "..YELLOW.."50.6,17.0 "..PREV..")";
...
L["Quest_33513_Location"] = "Koristrasza (Hügel der Klingenhauer; "..BLUE.."Eingang"..PREV..")";
L["Quest_33513_Note"] = "Aarux erscheint bei "..YELLOW.."[1]"..PREV.." nach der Benutzung der riesen Glocke. Mordresh ist bei "..YELLOW.."[2]"..PREV.." und Mushlump ist bei "..YELLOW.."[3]"..PREV..".  Koristrasza erscheint kurze Zeit später nachdem Mushlump besiegt wurde, um diese Quest abgeben zu können.";

L["Quest_33514_Name"] = "Das Ritual";
L["Quest_33514_Objective"] = "Tötet Amnennar den Kältebringer.";
L["Quest_33514_Location"] = "Koristrasza (Hügel der Klingenhauer; "..BLUE.."Eingang"..PREV..")";
L["Quest_33514_Note"] = "Amnennar der Kältebringer ist der Endboss bei "..YELLOW.."[4]"..PREV..". Koristrasza erscheint nachdem der Endboss besiegt wurde, um diese Quest angeben zu können.";
...
L["Quest_27062_Location"] = "Kanati Grauwolke (Tausend Nadeln - Der Westliche Gipfel; "..YELLOW.."11.0,11.2 "..PREV..")";
...
L["Quest_26908_Location"] = "Mahka (Südliches Brachland; "..YELLOW.."45.0,85.4"..PREV..")";
L["Quest_26908_Note"] = "Auld Steinkeil ist innerhalb der Instanz (Kral der Klingenhauer; "..BLUE.."Eingang"..PREV..")";

L["Quest_26907_Name"] = "Macht sie nieder!";
L["Quest_26907_Objective"] = "Tötet Jäger Knochenhauer, Roogug und Oberanführer Rammhauer.";
L["Quest_26907_Location"] = "Auld Steinkeil (Kral der Klingenhauer; "..BLUE.."Eingang"..PREV..")";
L["Quest_26907_Note"] = "Jäger Knochenhauer ist bei "..YELLOW.."[1]"..PREV..", Roogug ist bei "..YELLOW.."[2]"..PREV.." und Oberanführer Rammhauer ist bei "..YELLOW.."[3]"..PREV..".   Du kannst diese Quest am Ende der Instanz abgeben nachdem der Endboss besiegt wurde.";
...
L["Quest_26901_Location"] = "Auld Steinkeil (Kral der Klingenhauer; "..BLUE.."Eingang"..PREV..")";
L["Quest_26901_Note"] = "Häufchen Kralguano droppt vom Groyat der blinde Jäger bei "..YELLOW.."[4]"..PREV..".   Du kannst diese Quest am Ende der Instanz abgeben nachdem der Endboss besiegt wurde.";
L["Quest_26901_PreQuest"] = "Agamaggan";

L["Quest_26906_Name"] = "Agamaggan";
L["Quest_26906_Objective"] = "Sprecht mit dem Geist von Agamaggan.";
L["Quest_26906_Location"] = "Auld Steinkeil (Kral der Klingenhauer; "..BLUE.."Eingang"..PREV..")";
L["Quest_26906_Note"] = "Geist von Agamaggan ist bei "..GREEN.."[1']"..PREV..", hintert Groyat der blinde Jäger.";
...
L["Quest_26905_Location"] = "Geist von Agamaggan (Kral der Klingenhauer; "..GREEN.."[1']"..PREV..")";
L["Quest_26905_Note"] = "Charlga Klingenflanke ist bei "..YELLOW.."[5]"..PREV..".  Der Geist von Agamaggan erscheint nachdem der Endboss besiegt wurde.";
...
L["Quest_31513_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Kloster; "..GREEN.."1'"..PREV..")";
L["Quest_31513_Note"] = "Die erste Klinge ist bei "..YELLOW.."[1]"..PREV..". Die zweite Klinge befindet sich am Brunnen im Kapellengarten, auf den Weg zum nächsten Boss, dort kannst Du auch die Quest abgeben.";
...
L["Quest_31515_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Kloster; "..GREEN.."1'"..PREV..")";
L["Quest_31515_Note"] = "Die erste Klinge ist bei "..YELLOW.."[1]"..PREV..". Die zweite Klinge befindet sich am Brunnen im Kapellengarten, auf den Weg zum nächsten Boss, dort kannst Du auch die Quest abgeben.";
...
L["Quest_31514_Note"] = "Hochinquisitorin Weißsträhne ist bei "..YELLOW.."[3]"..PREV..". Nach Beendigung der Quest, wird Lilian Voss erscheinen um die Quest abgeben zu können.";
...
L["Quest_31516_Note"] = "Hochinquisitorin Weißsträhne ist bei "..YELLOW.."[3]"..PREV..". Nach Beendigung der Quest, wird Lilian Voss erscheinen um die Quest abgeben zu können.";
...
L["Quest_31490_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Hallen; "..GREEN.."1'"..PREV..")";
...
L["Quest_31495_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Hallen; "..GREEN.."1'"..PREV..")";
...
L["Quest_31493_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Hallen; "..GREEN.."1'"..PREV..")";
L["Quest_31493_Note"] = "Der Kodex des Kreuzzugs droppt von Flammenwirker Koegler bei "..YELLOW.."[4]"..PREV..".";

L["Quest_31497_Name"] = "Im Namen von Sicherheit und Ordnung (Heroisch)";
L["Quest_31497_Objective"] = "Holt Euch den Kodex des Kreuzzugs.";
L["Quest_31497_Location"] = "Vermummte Kreuzfahrerin (Scharlachrote Hallen; "..GREEN.."1'"..PREV..")";
L["Quest_31497_Note"] = "Der Kodex des Kreuzzugs droppt von Flammenwirker Koegler bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_31440_Location"] = "Sprechender Schädel (Scholomance; "..GREEN.."1'"..PREV..")";
L["Quest_31440_Note"] = "- 'Im Schatten des Lichts' ist bei "..YELLOW.."[1]"..PREV..".\n- 'Kel'Thuzads tiefgründiges Wissen' ist bei "..YELLOW.."[2]"..PREV..".\n- 'Verbotene Riten und andere nekromantische Rituale' ist am Ende des Raums hinter "..YELLOW.."[3]"..PREV..".\n- 'Der dunkle Zauberfoliant' ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_31442_Location"] = "Sprechender Schädel (Scholomance; "..GREEN.."1'"..PREV..")";
L["Quest_31442_Note"] = "- 'Im Schatten des Lichts' ist bei "..YELLOW.."[1]"..PREV..".\n- 'Kel'Thuzads tiefgründiges Wissen' ist bei "..YELLOW.."[2]"..PREV..".\n- 'Verbotene Riten und andere nekromantische Rituale' ist am Ende des Raums hinter ";

L["Quest_31447_Name"] = "Dem Leiden ein Ende";
L["Quest_31447_Objective"] = "Tötet Dunkelmeister Gandling.";
L["Quest_31447_Location"] = "Sprechender Schädel (Scholomance; "..GREEN.."1'"..PREV..")";
L["Quest_31447_Note"] = "Dunkelmeister Gandling ist bei "..YELLOW.."[6]"..PREV..".";

L["Quest_31448_Name"] = "Dem Leiden ein Ende (Heroisch)";
L["Quest_31448_Objective"] = "Tötet Dunkelmeister Gandling.";
L["Quest_31448_Location"] = "Sprechender Schädel (Scholomance; "..GREEN.."1'"..PREV..")";
L["Quest_31448_Note"] = "Dunkelmeister Gandling ist bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_28756_Location"] = "Lord Raymond George (Östliche Pestländer - Kapelle des Hoffnungsvollen Lichts; "..YELLOW.."76.0, 51.0"..PREV..")";
L["Quest_28756_Note"] = "Blutrippe ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_27917_Location"] = "Rudelführer Ivar Blutfang (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27917_Note"] = "Baron Ashbury ist bei "..YELLOW.."[1]"..PREV..".\n\nRudelführer Ivar Blutfang erscheint in der Halle wenn Baron Ashbury getötet wurde.";
...
L["Quest_27920_Location"] = "Rudelführer Ivar Blutfang (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27920_Note"] = "Baron Silberlein ist bei "..YELLOW.."[2]"..PREV.." und Kommandant Grüntal ist bei "..YELLOW.."[3]"..PREV..".\n\nRudelführer Ivar Blutfang erscheint auf dem Gehweg wenn Kommandant Grüntal getötet wurde.";
...
L["Quest_27921_Location"] = "Rudelführer Ivar Blutfang (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27921_Note"] = "Lord Walden ist bei "..YELLOW.."[4]"..PREV..".\n\nRudelführer Ivar Blutfang erscheint auf dem Torweg wenn Lord Walden getötet wurde.";
...
L["Quest_27968_Location"] = "Rudelführer Ivar Blutfang (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27968_Note"] = "Lord Godfrey ist bei "..YELLOW.."[5]"..PREV..".\n\nRudelführer Ivar Blutfang befindet sich unter der Torwegführung zum Raum von Lord Godfrey.";
...
L["Quest_27356_Location"] = "Loganaar (Mondlichtung - Nachthafen; "..YELLOW.."52.4, 40.6"..PREV..")";
L["Quest_27356_Note"] = "Waldens Elixiere droppt bei "..YELLOW.."[4]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Narianna (Mondlichtung - Nachthafen; "..YELLOW.."53.2, 42.6"..PREV.."). Die Vorquest startet bei Celestine Erntedank (Sturmwind; "..YELLOW.."57.6, 24.8"..PREV..").";
...
L["Quest_27344_Location"] = "Wulf Hansreim (Sturmwind - Altstadt; "..YELLOW.."79.0, 71.0"..PREV..")";
L["Quest_27344_Note"] = "Godfreys Kristallzielfernrohr droppt bei "..YELLOW.."[5]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Frederick Ofner (Sturmwind - Handelsdiskrikt; "..YELLOW.."58.6, 69.0"..PREV.."). Die Vorquest startet bei Vord (Exodar - Händlertreppe; "..YELLOW.."47.2, 88.4"..PREV..").";
...
L["Quest_27354_Location"] = "Maginor Dumas (Sturmwind - Magierviertel; "..YELLOW.."49.2, 87.6"..PREV..")";
L["Quest_27354_Note"] = "Silberleins verzauberter Kristall droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Lucan Cordell (Sturmwind - Magierviertel; "..YELLOW.."53.0, 74.2"..PREV.."). Die Vorquest startet bei Tarelvir (Darnassus - Tempel des Mondes; "..YELLOW.."37.6, 80.0"..PREV..").";
...
L["Quest_27343_Location"] = "Lord Grayson Schattenbruch (Sturmwind - Kathedralenplatz; "..YELLOW.."52.6, 45.0"..PREV..")";
L["Quest_27343_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Therum Tiefenschmied (Sturmwind - Zwergendiskrikt; "..YELLOW.."63.4, 37.2"..PREV.."). Die Vorquest startet bei Rukua (Darnassus - Tempel des Mondes; "..YELLOW.."42.8, 77.6"..PREV..").";
...
L["Quest_27361_Location"] = "Hohepriesterin Laurena (Sturmwind - Kathedralenplatz; "..YELLOW.."49.6, 44.8"..PREV..")";
L["Quest_27361_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Lucan Cordell (Sturmwind - Magierviertel; "..YELLOW.."53.0, 74.2"..PREV.."). Die Vorquest startet bei Caedmos (Exodar - Halle des Lichts; "..YELLOW.."38.8, 51.0"..PREV..").";
...
L["Quest_27362_Location"] = "Tyrande Wisperwind (Darnassus - Tempel des Mondes; "..YELLOW.."43.0, 77.8"..PREV..")";
L["Quest_27362_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Lucan Cordell (Sturmwind - Magierviertel; "..YELLOW.."53.0, 74.2"..PREV.."). Die Vorquest startet bei Hohepriester Rohan (Eisenschmiede - Mystikerviertel; "..YELLOW.."24.8, 8.4"..PREV..").";
...
L["Quest_27363_Location"] = "Chefchirurg Schnittflick (Sturmwind - Zwergendistrikt; "..YELLOW.."63.0, 34.2"..PREV..")";
L["Quest_27363_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Lucan Cordell (Sturmwind - Magierviertel; "..YELLOW.."53.0, 74.2"..PREV.."). Die Vorquest startet bei Hohepriester Rohan (Eisenschmiede - Mystikerviertel; "..YELLOW.."24.8, 8.4"..PREV..").";
...
L["Quest_27351_Location"] = "Lord Tony Romano (Sturmwind - Altstadt; "..YELLOW.."79.6, 61.2"..PREV..")";
L["Quest_27351_Note"] = "Grüntals Wetzstein droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Therum Tiefenschmied (Sturmwind - Zwergenviertel; "..YELLOW.."63.4, 37.2"..PREV.."). Die Vorquest startet bei Hulfdan Schwarzbart (Eisenschmiede - Düstere Viertel; "..YELLOW.."50.8, 15.2"..PREV..").";
...
L["Quest_27353_Location"] = "Scharfseherin Umbrua (Sturmwind - Tal der Helden; "..YELLOW.."67.4, 89.2"..PREV..")";
L["Quest_27353_Note"] = "Waldens Talisman droppt bei "..YELLOW.."[4]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Therum Tiefenschmied (Sturmwind - Zwergenviertel; "..YELLOW.."63.4, 37.2"..PREV.."). Die Vorquest startet bei Scharfseher Javad (Eisenschmiede - Große Schmiede; "..YELLOW.."55.2, 29.0"..PREV..").";
...
L["Quest_27355_Location"] = "Demisette Cloyce (Sturmwind - Magierviertel; "..YELLOW.."39.4, 84.8"..PREV..")";
L["Quest_27355_Note"] = "Die Finstere Kugel droppt bei "..YELLOW.."[5]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Lucan Cordell (Sturmwind - Magierviertel; "..YELLOW.."53.0, 74.2"..PREV.."). Die Vorquest startet bei Alexander Calder (Eisenschmiede - Düstere Viertel; "..YELLOW.."50.2, 7.4"..PREV..").";
...
L["Quest_27337_Location"] = "Ander Germaine (Sturmwind - Altstadt; "..YELLOW.."79.4, 69.0"..PREV..")";
L["Quest_27337_Note"] = "Das Schwert der Familie Silberlein droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Therum Tiefenschmied (Sturmwind - Zwergenviertel; "..YELLOW.."63.4, 37.2"..PREV.."). Die Vorquest startet bei Behomat (Exodar - Händlertreppe; "..YELLOW.."55.4, 81.8"..PREV..").";
...
L["Quest_24745_Location"] = "Droppt vom Apotheker Hummel (Burg Schattenfang; "..YELLOW.."[1]"..PREV..")";
L["Quest_24745_Note"] = "Diese Quest ist für das Event Liebe ist in der Luft.\n\nInspektor Snip Schnappholz ist bei (Sturmwind - Handelsdiskrikt; "..YELLOW.."61.6, 75.2"..PREV..").";

L["Quest_27974_Name"] = "Dies ist unser Land";
L["Quest_27974_Objective"] = "Tötet Baron Ashbury.";
L["Quest_27974_Location"] = "Todespirscherkommandant Belmont (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27974_Note"] = "Baron Ashbury ist bei "..YELLOW.."[1]"..PREV..".\n\nTodespirscherkommandant Belmont erscheint auf dem Torweg wenn Lord Walden getötet wurde.";
...
L["Quest_27988_Location"] = "Todespirscherkommandant Belmont (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27988_Note"] = "Baron Silberlein ist bei "..YELLOW.."[2]"..PREV.." und Kommandant Grüntal ist bei "..YELLOW.."[3]"..PREV..".\n\nTodespirscherkommandant Belmont erscheint auf dem Gehweg wenn Kommandant Grüntal getötet wurde.";
...
L["Quest_27996_Location"] = "Todespirscherkommandant Belmont (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27996_Note"] = "Lord Walden ist bei "..YELLOW.."[4]"..PREV..".\n\nTodespirscherkommandant Belmont erscheint auf dem Torweg wenn Lord Walden getötet wurde.";
...
L["Quest_27998_Location"] = "Todespirscherkommandant Belmont (Burg Schattenfang; "..GREEN.."[1']"..PREV..").";
L["Quest_27998_Note"] = "Lord Godfrey ist bei "..YELLOW.."[5]"..PREV..".\n\nTodespirscherkommandant Belmont befindet sich unter der Torwegführung zum Raum von Lord Godfrey.";
...
L["Quest_27404_Location"] = "Loganaar (Mondlichtung - Nachthafen; "..YELLOW.."52.4, 40.6"..PREV..")";
L["Quest_27404_Note"] = "Waldens Elixiere droppt bei "..YELLOW.."[4]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Narianna (Mondlichtung - Nachthafen; "..YELLOW.."53.2, 42.6"..PREV.."). Die Vorquest startet bei Sesebi (Orgrimmar - Tal der Geister; "..YELLOW.."35.0, 67.6"..PREV..").";
...
L["Quest_27395_Location"] = "Ormak Grimmschlag (Orgrimmar - Tal der Ehre; "..YELLOW.."63.8, 32.8"..PREV..")";
L["Quest_27395_Note"] = "Godfreys Kristallzielfernrohr droppt bei "..YELLOW.."[5]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei Apolos (Unterstadt - Kriegsviertel; "..YELLOW.."49.6, 29.0"..PREV..").";
...
L["Quest_27400_Location"] = "Ureda (Orgrimmar - Kluft der Schatten; "..YELLOW.."61.3, 72.5"..PREV..")";
L["Quest_27400_Note"] = "Silberleins verzauberter Kristall droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Inethven (Silbermond - Sonnenzornturm; "..YELLOW.."59.0, 19.6"..PREV..").";
...
L["Quest_27403_Location"] = "Sonnenläufer Atohmo (Orgrimmar - Tal der Weisheit; "..YELLOW.."45.2, 53.4"..PREV..")";
L["Quest_27403_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei Aponi Lichtmähne (Donnerfels - Anhöhe der Jäger; "..YELLOW.."63.2, 79.8"..PREV..").";
...
L["Quest_27434_Location"] = "Meister Pyreanor (Orgrimmar - Tal der Stärke; "..YELLOW.."49.2, 71.2"..PREV..")";
L["Quest_27434_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei Aponi Lichtmähne (Donnerfels - Anhöhe des Jägers; "..YELLOW.."63.2, 79.8"..PREV..").";
...
L["Quest_27441_Location"] = "Bruder Silberheil (Orgrimmar - Tal der Geister; "..YELLOW.."37.8, 87.4"..PREV..")";
L["Quest_27441_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei ?? (Orgrimmar - ??; "..YELLOW.."??, ??"..PREV..").";
...
L["Quest_27436_Location"] = "Schattenwandler Zuru (Orgrimmar - Tal der Weisheit; "..YELLOW.."35.4, 69.2"..PREV..")";
L["Quest_27436_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Aldrae (Silbermond - Sonnenzornturm; "..YELLOW.."53.2, 26.6"..PREV..").";
L["Quest_27436_RewardText"] = "1";
L["Quest_27436_PreQuest"] = "Sucht den Schattenläufer auf";

L["Quest_27435_Name"] = "Der Stab eines Sehers";
L["Quest_27435_Objective"] = "Seherin Liwatha (Orgrimmar - Tal der Weisheit; "..YELLOW.."45.4, 53.4"..PREV..")";
L["Quest_27435_Location"] = "Loganaar (Mondlichtung - Nachthafen; "..YELLOW.."52.4, 40.6"..PREV..")";
L["Quest_27435_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Seher Beryl (Donnerfels - Anhöhe der Ältesten; "..YELLOW.."75.4, 28.0"..PREV..").";
...
L["Quest_27439_Location"] = "Tyelis (Orgrimmar - Tal der Stärke; "..YELLOW.."49.0, 71.0"..PREV..")";
L["Quest_27439_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Seher Beryl (Donnerfels - Anhöhe der Ältesten; "..YELLOW.."75.4, 28.0"..PREV..").";
...
L["Quest_27437_Location"] = "Dunkle Klerikerin Cecille (Orgrimmar - Tal der Stärke; "..YELLOW.."48.2, 72.8"..PREV..")";
L["Quest_27437_Note"] = "Das heilige Symbol des Kommandanten droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Aldrae (Silbermond - Sonnenzornturm; "..YELLOW.."53.2, 26.6"..PREV..").";
...
L["Quest_27396_Location"] = "Gordul (Orgrimmar - Kluft der Schatten; "..YELLOW.."44.8, 61.3"..PREV..")";
L["Quest_27396_Note"] = "Grüntals Wetzstein droppt bei "..YELLOW.."[3]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei  Zelanis (Silbermond - Mördergasse; "..YELLOW.."79.6, 52.0"..PREV..").";
...
L["Quest_27397_Location"] = "Kardris Traumsucher (Orgrimmar - Tal der Weisheit; "..YELLOW.."39.0, 47.4"..PREV..")";
L["Quest_27397_Note"] = "Waldens Talisman droppt bei "..YELLOW.."[4]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei Beram Himmelsjäger (Donnerfels - Anhöhe der Geister; "..YELLOW.."22.2, 19.0"..PREV..").";
...
L["Quest_27402_Location"] = "Zevrost (Orgrimmar - Kluft der Schatten; "..YELLOW.."49.0, 55.3"..PREV..")";
L["Quest_27402_Note"] = "Die Finstere Kugel droppt bei "..YELLOW.."[5]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Godan (Orgrimmar - Kluft der Schatten; "..YELLOW.."53.4, 49.4"..PREV.."). Die Vorquest startet bei Zanien (Silbermond - Mördergasse; "..YELLOW.."73.2, 45.2"..PREV..").";
...
L["Quest_27365_Location"] = "Grezz Zornfaust (Orgrimmar - Tal der Ehre; "..YELLOW.."73.6, 45.6"..PREV..")";
L["Quest_27365_Note"] = "Das Schwert der Familie Silberlein droppt bei "..YELLOW.."[2]"..PREV..". Die anderen Materialien können überall in der Instanz dropppen.\n\nKehre danach zurück zu Saru Stahlzorn (Orgrimmar - Tal der Ehre; "..YELLOW.."76.2, 34.6"..PREV.."). Die Vorquest startet bei Alsudar die Bastion (Silbermond - Platz de Weltenwanderer; "..YELLOW.."81.6, 38.2"..PREV..").";
...
L["Quest_14483_Location"] = "Droppt vom Apotheker Hummel (Burg Schattenfang; "..YELLOW.."[1]"..PREV..")";
L["Quest_14483_Note"] = "Diese Quest ist für das Event Liebe ist in der Luft.\n\nErmittler Snip Schnappbolz ist bei (Orgrimmar - Tal der Stärke; "..YELLOW.."51.0, 75.3"..PREV..").";

L["Quest_27422_Name"] = "Eine Stadt unter Belagerung";
L["Quest_27422_Objective"] = "Sprecht mit Rottenkommandant Steinberster.";
L["Quest_27422_Location"] = "Argentumoffizier Irizarry (Östliche Pestländer - Nordpassturm; "..YELLOW.."51.6,21.2"..PREV..")";
...
L["Quest_27192_Location"] = "Rottenkommandant Steinberster (Stratholm - Der Kreuzzüglerpass; "..BLUE.."Eingang"..PREV..").";
L["Quest_27192_Note"] = "Fras Siabi erscheint bei der Benutzung seines Briefkastens bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_28755_Location"] = "Lord Raymond George (Östliche Pestländer - Kapelle des hoffnungsvollen Lichts; "..YELLOW.."76.0,51.0"..PREV..")";
L["Quest_28755_Note"] = "Das Buch ist bei "..YELLOW.."[5]"..PREV..".\n\nDies ist eine wiederholbare Ruffarmquest für die Argentumdämmerung. Die Vorquest startet bei Fiona (Östliche Pestländer - Fionas Karawane; "..YELLOW.."9.0, 66.4"..PREV..".";
...
L["Quest_27305_Location"] = "Kreuzzugskommandant Eligor Morgenbringer (Stratholm - Der Kreuzzüglerpass; "..BLUE.."Eingang"..PREV..").";
L["Quest_27305_Note"] = "Das Bild ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_27223_Location"] = "Kreuzzugskommandant Eligor Morgenbringer (Stratholm - Der Kreuzzüglerpass; "..BLUE.."Eingang"..PREV..").";
L["Quest_27223_Note"] = "Der Unverziehene ist bei "..YELLOW.."[1]"..PREV.." und Timmy der Grausame ist bei "..YELLOW.."[2]"..PREV..".";

L["Quest_27185_Name"] = "Die Wettstreiter ausmerzen";
L["Quest_27185_Objective"] = "Tötet den purpurroten Hammerschmied.";
L["Quest_27185_Location"] = "Meisterhandwerker Wilhelm (Stratholme - Der Kreuzzüglerpass; "..BLUE.."Eingang"..PREV..").";
L["Quest_27185_Note"] = "Auferstandener Hammerschmied erscheint bei"..YELLOW.."[3]"..PREV.." beim benutzen der funkelnden Papieren auf den Boden";

L["Quest_27208_Name"] = "Der Schreckenslord Balnazzar";
L["Quest_27208_Objective"] = "Tötet Balnazzar.";
L["Quest_27208_Location"] = "Kreuzzugskommandant Eligor Morgenbringer (Stratholm - Der Kreuzzüglerpass; "..BLUE.."Eingang"..PREV..").";
L["Quest_27208_Note"] = "Schreckenslord Balnazzar ist bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_27230_Location"] = "Meisterhandwerker Wilhelm (Stratholme - Der Spießrutenlauf; "..GREEN.."[1']"..PREV..")";
L["Quest_27230_Note"] = "Schwertschmied der schwarzen Wache erscheint bei "..YELLOW.."[1]"..PREV.." beim anklicken der funkelnden Papieren auf den Boden.";

L["Quest_27359_Name"] = "Verstärkung der Argentumdämmerung";
L["Quest_27359_Objective"] = "Erhaltet 4 Essenzen einer Banshee.";
L["Quest_27359_Location"] = "Erzmagierin Angela Dosantos (Stratholm - Der Spießrutenlauf; "..GREEN.."[1']"..PREV..")";
...
L["Quest_27228_Location"] = "Kreuzzugskommandant Eligor Morgenbringer (Stratholm - Der Spießrutenlauf; "..GREEN.."[1']"..PREV..")";
L["Quest_27228_Note"] = "Ramstein der Verschlinger ist bei "..YELLOW.."[5]"..PREV..".";

L["Quest_27227_Name"] = "Baron Aurius Totenschwur";
L["Quest_27227_Objective"] = "Tötet Baron Aurius Totenschwur.";
L["Quest_27227_Location"] = "Kreuzzugskommandant Eligor Morgenbringer (Stratholm - Der Spießrutenlauf; "..GREEN.."[1']"..PREV..")";
L["Quest_27227_Note"] = "Baron Aurius Totenschwur ist bei "..YELLOW.."[6]"..PREV..".";

L["Quest_27352_Name"] = "Flüssiges Gold";
L["Quest_27352_Objective"] = "Findet eine Phiole mit Weihwasser von Stratholme.";
L["Quest_27352_Location"] = "Rottenkommandant Steinberster (Stratholme - Der Spießrutenlauf; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_27733_Location"] = "Schützenkommandant Coe (Verlies; "..GREEN.."[1']"..PREV..")";
L["Quest_27733_Note"] = "Randolph Moloch ist bei "..YELLOW.."[1]"..PREV..".";

L["Quest_27737_Name"] = "Lasst das Feuer Euch erretten!";
L["Quest_27737_Objective"] = "Beschafft Fürst Gluthitzes Feuerkern.";
L["Quest_27737_Location"] = "Schwester Lillian (Verlies; "..GREEN.."[3']"..PREV..")";
L["Quest_27737_Note"] = "Fürst Gluthitze ist bei "..YELLOW.."[3]"..PREV..".";

L["Quest_27739_Name"] = "Der König der Gnolle";
L["Quest_27739_Objective"] = "Besiegt Hogger.";
L["Quest_27739_Location"] = "Aufseher Thelwasser (Verlies; "..GREEN.."[2']"..PREV..")";
L["Quest_27739_Note"] = "Hogger ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_27915_Location"] = "Lord Itharius (Sümpfe des Elends - Der Tempel von Atal'Hakkar; "..YELLOW.."54.0, 79.6"..PREV..")";
L["Quest_27915_Note"] = "Lord Itharius (Tempel von Atal'Hakkar; "..GREEN.."[1']"..PREV..")";
...
L["Quest_27633_Location"] = "Lord Itharius (Der Tempel von Atal'Hakkar; "..BLUE.."Eingang"..PREV..")";
L["Quest_27633_Note"] = "Avatar von Hakkar ist bei "..YELLOW.."[1]"..PREV..".";

L["Quest_27604_Name"] = "Jammal'an der Prophet";
L["Quest_27604_Objective"] = "Erbeutet den Kopf von Jammal'an dem Propheten.";
L["Quest_27604_Location"] = "Lord Itharius (Der Tempel von Atal'Hakkar; "..BLUE.."Eingang"..PREV..")";
L["Quest_27604_Note"] = "Jammal'an dem Propheten ist bei "..YELLOW.."[2]"..PREV..".";

L["Quest_27605_Name"] = "Eranikus";
L["Quest_27605_Objective"] = "Tötet Eranikus.";
L["Quest_27605_Location"] = "Lord Itharius (Der Tempel von Atal'Hakkar; "..BLUE.."Eingang"..PREV..")";
L["Quest_27605_Note"] = "Eranikus Schemen ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_8802_Note"] = "Anachronos (Tanaris - Höhlen der Zeit; "..YELLOW.."64.2,51.2"..PREV..")";
...
L["Quest_8784_Note"] = "Wird bei Andorgos (Tempel von Ahn'Qiraj; "..GREEN.."[1']"..PREV..") abgegeben.";
...
L["Quest_8579_Location"] = "Kandrostrasz (Tempel von Ahn'Qiraj; "..GREEN.."[1']"..PREV..").";
...
L["Quest_25556_Location"] = "Trenton Lichthammer (Tanaris - Sandmarter Wache; "..YELLOW.."42.4,24.0"..PREV..")";
L["Quest_25556_Note"] = "Mazoga ist in der Instanz Zul'Farrak am Eingang.\n\nDie Vorquest startet bei Mazoga (Tanaris - Zul'Furrak; "..YELLOW.."42.2, 23.8"..PREV..").";
...
L["Quest_27068_Location"] = "Mazogas Geist (Zul'Farrak; "..BLUE.."Eingang"..PREV..").";
L["Quest_27068_Note"] = "Häuptling Ukorz Sandskalp ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_27076_Location"] = "Tran'rek (Zul'Farrak; "..BLUE.."Eingang"..PREV..")";
L["Quest_27076_Note"] = "Weegli Lunte ist bei "..YELLOW.."[2]"..PREV..", Nekrum den Ausweider und Schattenpriester Sezz'ziz sind bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_27071_Location"] = "Mazogas Geist (Zul'Farrak; "..BLUE.."Eingang"..PREV..").";
L["Quest_27071_Note"] = "Theka den Märtyrer ist bei "..YELLOW.."[3]"..PREV..",Hexendoktor Zum'rah ist bei "..YELLOW.."[5]"..PREV..",Antu'sul ist bei "..YELLOW.."[6]"..PREV.." und Ruuzlu ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_27070_Location"] = "Chefingenieur Bilgenritzel (Zul'Farrak; "..BLUE.."Eingang"..PREV..")";
L["Quest_27070_Note"] = "Die Tiara der Tiefen droppt von Hydromantin Velratha bei "..YELLOW.."[2]"..PREV.." und Gahzrilla's elektrisierte Schuppe von Gahz'rilla bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_26943_Location"] = "Skuerto (Arathihochland - Die Zuflucht; "..YELLOW.."40.2,49.0"..PREV..")";
...
L["Quest_26944_Location"] = "Wulfred Harrys (Nördliches Schlingendorntal - Fort Livingston; "..YELLOW.."53.2,66.2"..PREV..")";
...
L["Quest_26939_Location"] = "Mör'dok (Gnomeregan; "..BLUE.."Eingang"..PREV..")";
L["Quest_26939_Note"] = "Verflüssigte Ablagerung ist bei "..YELLOW.."[2]"..PREV..".Gebe die Quest bei Bi'ay Bäräkuss "..GREEN.."[3']"..PREV.." ab.";
...
L["Quest_26941_Location"] = "Bi'ay Bäräkuss (Gnomeregan; "..GREEN.."[3']"..PREV..")";
L["Quest_26941_Note"] = "Elektrokutor 6000 ist bei "..YELLOW.."[3]"..PREV..".Gebe die Quest bei Fähs "..GREEN.."[4']"..PREV.." ab.";
...
L["Quest_26942_Location"] = "Fähs (Gnomeregan; "..GREEN.."[4']"..PREV..")";
L["Quest_26942_Note"] = "Robogenieur Thermadraht ist bei "..YELLOW.."[5]"..PREV..".Gebe die Quest bei Hann Ibal "..GREEN.."[5']"..PREV.." ab.";
...
L["Quest_2945_Note"] = "Der Ring kann mit dem Funkelmat 5200 in der Sauberen Zone bei "..GREEN.."[2']"..PREV.." gereinigt werden.";
...
L["Quest_2947_Note"] = "Kann bei Talvash del Kissel (Eisenschmiede - Mystikerviertel; "..YELLOW.."36.0,4.2"..PREV..") abgegeben werden. Die Folgequest, um den Ring zu verbessern, ist optional.";
...
L["Quest_50338_Location"] = "Mör'dok (Gnomeregan; "..BLUE.."Eingang"..PREV..")";
L["Quest_50338_Note"] = "Verflüssigte Ablagerung ist bei "..YELLOW.."[2]"..PREV..".Gebe die Quest bei Bi'ay Bäräkuss "..GREEN.."[3']"..PREV.." ab.";
L["Quest_50338_FollowQuest"] = "Das G-Team";

L["Quest_50337_Name"] = "Das G-Team";
L["Quest_50337_Objective"] = "Tötet den Elektrokutor 6000.";
L["Quest_50337_Location"] = "Bi'ay Bäräkuss (Gnomeregan; "..GREEN.."[3']"..PREV..")";
L["Quest_50337_Note"] = "Elektrokutor 6000 ist bei "..YELLOW.."[3]"..PREV..".Gebe die Quest bei Fähs "..GREEN.."[4']"..PREV.." ab.";
...
L["Quest_50336_Location"] = "Fähs (Gnomeregan; "..GREEN.."[4']"..PREV..")";
L["Quest_50336_Note"] = "Robogenieur Thermadraht ist bei "..YELLOW.."[5]"..PREV..".Gebe die Quest bei Hann Ibal "..GREEN.."[5']"..PREV.." ab.";
...
L["Quest_2949_Note"] = "Der Ring kann mit dem Funkelmat 5200 in der Sauberen Zone bei "..GREEN.."[2']"..PREV.." gereinigt werden.";
...
L["Quest_2950_Note"] = "Kann bei Nogg (Orgrimmar - Die Gasse; "..YELLOW.."56.6,56.8"..PREV..") abgegeben werden. Die Folgequest, um den Ring zu verbessern, ist optional.";
...
L["Quest_29543_Location"] = "Unteroffizier Altumus (Höllenfeuerhalbinsel - Ehrenfeste; "..YELLOW.."61.6,60.8"..PREV..")";
L["Quest_29543_Note"] = "Vorhutsspäher Chadwick ist bei (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29594_Location"] = "Vorhutsspäher Chadwick (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
L["Quest_29594_Note"] = "Die Vorräte sind alle bei "..YELLOW.."[1]"..PREV.." auf den Weg verteilt.";
...
L["Quest_29529_Location"] = "Vorhutsspäher Chadwick (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
L["Quest_29529_Note"] = "Omor ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29528_Location"] = "Vorhutsspäher Chadwick (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29542_Note"] = "Steingardist Stok'ton ist bei (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29593_Location"] = "Steingardist Stok'ton (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
L["Quest_29593_Note"] = "Die Vorräte sind alle bei "..YELLOW.."[1]"..PREV.." auf den Weg verteilt.";
...
L["Quest_29530_Location"] = "Steingardist Stok'ton (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
L["Quest_29530_Note"] = "Omor ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29527_Location"] = "Steingardist Stok'ton (Höllenfeuerbollwerk; "..BLUE.."Eingang"..PREV..")";
L["Quest_29527_Note"] = "Wachhabenden Gargolmar ist bei "..YELLOW.."[1]"..PREV.." und Vazruden den Herold und Vazrudens Drachen Nazan sind bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29538_Location"] = "Gunny (Blutkessel; "..BLUE.."Eingang"..PREV..")";
L["Quest_29538_Note"] = "Alle Orks im Blutkessel können die Phiolen droppen die Spritze droppt vom Schöpfer bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29539_Location"] = "Gunny (Blutkessel; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29535_Location"] = "Caza'rez (Blutkessel; "..BLUE.."Eingang"..PREV..")";
L["Quest_29535_Note"] = "Alle Orks im Blutkessel können die Phiolen droppen die Spritze droppt vom Schöpfer bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29536_Location"] = "Caza'rez (Blutkessel; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29537_Location"] = "Caza'rez (Blutkessel; "..BLUE.."Eingang"..PREV..")";
L["Quest_29537_Note"] = "Keli'dan der Zerstörer ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29689_Location"] = "Truppenkommandant Danath Trollbann (Höllenfeuerhalbinsel - Ehrenfeste; "..YELLOW.."56.6,66.6"..PREV..")";
L["Quest_29689_Note"] = "Vorhutsspäher Chadwick (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29649_Location"] = "Vorhutsspäher Chadwick (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29649_Note"] = "Nachdem Großhexenmeister Nethekurse bei "..YELLOW.."[1]"..PREV.." getötet wurde, droppt er ein Amulett. Das Amulett muss bei einer der Kohlenpfannen in der Nähe seines Throns benutzt werden, um die Teufelsglut zu erhalten.";
...
L["Quest_29654_Location"] = "Vorhutsspäher Chadwick (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29654_Note"] = "Kriegshäuptling Kargath Messerfaust ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29656_Location"] = "Vorhutsspäher Chadwick (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29656_Note"] = "Kriegshetzer O'mrogg ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29652_Location"] = "Vorhutsspäher Chadwick (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29688_Location"] = "Schattenjäger Ty'jin (Höllenfeuerhalbinsel - Thrallmar; "..YELLOW.."55.0, 36.2"..PREV..")";
L["Quest_29688_Note"] = "Steingardist Stok'ton (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29650_Location"] = "Steingardist Stok'ton (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29650_Note"] = "Nachdem Großhexenmeister Nethekurse bei "..YELLOW.."[1]"..PREV.." getötet wurde, droppt er ein Amulett. Das Amulett muss bei einer der Kohlenpfannen in der Nähe seines Throns benutzt werden, um die Teufelsglut zu erhalten.";
...
L["Quest_29653_Location"] = "Steingardist Stok'ton (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29653_Note"] = "Kriegshäuptling Kargath Messerfaust ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29655_Location"] = "Steingardist Stok'ton (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29655_Note"] = "Kriegshetzer O'mrogg ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29651_Location"] = "Steingardist Stok'ton (Zerschmetterten Hallen; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_11003_Note"] = "Nur eine Person im Schlachtzug kann den Kopf erhalten, um die Quest zu starten. Nazgrel befindet sich bei "..YELLOW.."55.0, 36.0"..PREV..".";
...
L["Quest_29566_Location"] = "Ysiel Windsänger (Zangamarschen - Zuflucht des Cenarius; "..YELLOW.."78.4,62"..PREV..")";
L["Quest_29566_Note"] = "Behüterin Jhang ist innerhalb Instanz (Sklavenunterkünfte; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_29563_Location"] = "Behüterin Jhang (Sklavenunterkünften; "..BLUE.."Eingang"..PREV..").";
L["Quest_29563_Note"] = "Naturalist Biss ist bei "..GREEN.."[3']"..PREV.." und Jäter Gründaum ist bei "..GREEN.."[1']"..PREV..".";

L["Quest_29564_Name"] = "Der betrogene Bruder";
L["Quest_29564_Objective"] = "Tötet Mennu den Verräter und kehrt zu Nahuud zurück.";
L["Quest_29564_Location"] = "Behüterin Jhang (Sklavenunterkünften; "..BLUE.."Eingang"..PREV..").";
L["Quest_29564_Note"] = "Mennu der Verräter ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29565_Location"] = "Behüterin Jhang (Sklavenunterkünften; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_13431_Note"] = "Das Erdensiegel droppt von Gruul bei "..YELLOW.."[2]"..PREV..", und das Flammensiegel droppt von Schrecken der Nacht in "..YELLOW.."[5]"..PREV..".";
...
L["Quest_29616_Location"] = "Ysiel Windsänger (Zangamarschen - Zuflucht desCenarius; "..YELLOW.."78.4,62"..PREV..")";
L["Quest_29616_Note"] = "Behüterin Jhang befindet sich innerhalb Instanz (Dampfkammer; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_29613_Location"] = "Behüterin Jhang (Dampfkammer; "..BLUE.."Eingang"..PREV..").";
L["Quest_29613_Note"] = "Kriegsherr Kalithresh ist bei "..YELLOW.."[3]"..PREV..". Denkt dran, die Tanks zu zerstören, wenn Kalithresh sie benutzt.";
...
L["Quest_29614_Location"] = "Naturalist Biss (Dampfkammer; "..BLUE.."Eingang"..PREV..").";
L["Quest_29614_Note"] = "Sumpfoberanführer ist im ersten Bereich der Instanz nahe dem Eingang. Die Aussätziger des Echsenkessels befinden sich beim Boss Robogenieur Dampfhammer bei "..YELLOW.."[2]"..PREV..", dieser droppt das Verstrahltes Zahnrad.";
...
L["Quest_29615_Location"] = "Windrufer Klaue (Dampfkammer; "..BLUE.."Eingang"..PREV..").";
L["Quest_29615_Note"] = "Hydromantin Thespia ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_10885_Note"] = "Diese Aufgabe muss auf dem Schwierigkeitsgrad 'Heroisch' abgeschlossen werden. Murmur ist bei "..YELLOW.."[4]"..PREV..". Kalithreshs Dreizack droppt in der Dampfkammer.\n\nDiese Quest wurde benötigt, um die Festung der Stürme zu betreten, ist aber nicht mehr nötig.";
...
L["Quest_10667_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."78,39"..PREV..")";
L["Quest_10667_Note"] = "Hydromantin Thespia ist bei "..YELLOW.."[1]"..PREV..".\n\nDer Gegenstand droppt im normalen und heroischen Modus.";
L["Quest_10667_PreQuest"] = "Frisch von der Mechanar ("..YELLOW.."FdS: Die Mechanar"..PREV..") & Encyclopaedia Daemonica ("..YELLOW.."Auch: Schattenlabyrinth"..PREV..")";
...
L["Quest_29571_Location"] = "Elementarist Morgh (Nagrand; "..YELLOW.."60.4,22.4"..PREV..")";
L["Quest_29571_Note"] = "Behüterin Jhang (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_29570_Location"] = "Behüterin Jhang (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
L["Quest_29570_Note"] = "Erdbinder Rayge ist bei "..GREEN.."[1']"..PREV..", Windrufer Klaue ist bei "..YELLOW.."[3]"..PREV..".";

L["Quest_29568_Name"] = "Ein notwendiges Übel";
L["Quest_29568_Objective"] = "Tötet Hungarfenn und kehrt zu Naturalist Biss zurück.";
L["Quest_29568_Location"] = "Naturalist Biss (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
L["Quest_29568_Note"] = "Hungarfenn ist bei "..YELLOW.."[1]"..PREV..".";

L["Quest_29567_Name"] = "Tötet die Mutter";
L["Quest_29567_Objective"] = "Tötet Hungarfenn und kehrt zu Naturalist Biss zurück.";
L["Quest_29567_Location"] = "T'shu (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
L["Quest_29567_Note"] = "Schattenmutter ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29691_Location"] = "T'shu (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_29692_Location"] = "T'shu (Tiefensumpf; "..BLUE.."Eingang"..PREV..").";
...
L["Quest_11369_Location"] = "Windhändler Zhareem (Shattrath - Unteres Viertel; "..YELLOW.."75.0,37.0"..PREV..")";
L["Quest_11369_Note"] = "Diese Aufgabe muss auf dem Schwierigkeitsgrad 'Heroisch' abgeschlossen werden.\n\nDie Schattenmutter ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29595_Location"] = "Großvater Aldrimus (Wälder von Terokkar; "..YELLOW.."35.0,65.2"..PREV..")\nGroßvater Aldrimus erscheint erst wenn Du die Questen absolviert hast die mit Ha'lei beginnen bei (Wälder von Terokkar; "..YELLOW.."35.0,65.2"..PREV..").";
...
L["Quest_29596_Location"] = "Draeneigeist (Auchenaikrypta; "..BLUE.."Eingang"..PREV..").";
L["Quest_29596_Note"] = "Exarch Maladarr ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29590_Location"] = "Draeneigeist (Auchenaikrypta; "..BLUE.."Eingang"..PREV..").";
L["Quest_29590_Note"] = "Shirrak den Totenwächter ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_10167_Note"] = "Exarch Maladarr ist bei "..YELLOW.."[2]"..PREV..". D'ore erscheint, wenn Exarch Maladarr getötet wurde.";
...
L["Quest_10168_Note"] = "D'ore erscheint, wenn Exarch Maladarr getötet wurde. Mutter Kashur ist bei (Nagrand; "..YELLOW.."26,61"..PREV.."). Man sollte in einer Gruppe aus 3 oder mehr Spielern sein, bevor man die getrübten Geister anspricht.";
...
L["Quest_29583_Location"] = "Eckert (Wälder von Terokkar - Allerias Feste; "..YELLOW.."57.6, 53.4"..PREV..")";
...
L["Quest_29574_Location"] = "Mamdy der 'Ologe' (Managruft; "..BLUE.."Eingang"..PREV..")";
L["Quest_29574_Note"] = "Pandemonius ist bei "..YELLOW.."[1]"..PREV.." und Tavarok ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29573_Location"] = "Konstrukteur Morphalius (Managruft; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29575_Location"] = "Konstrukteur Morphalius (Managruft; "..BLUE.."Eingang"..PREV..")";
L["Quest_29575_Note"] = "Nexusprince Shaffar ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_10977_Location"] = "Bild von Kommandant Ameer (Schergrat - Landeplatz von Bash'ir; "..YELLOW.."52,15"..PREV..").";
...
L["Quest_10180_Location"] = "Oloraak (Shattrath - Unteres Viertel; "..YELLOW.."58.0, 15.4"..PREV..")";
...
L["Quest_29605_Location"] = "Isfar (Sethekkhallen; "..BLUE.."Eingang"..PREV..")";
L["Quest_29605_Note"] = "Dunkelwirker Syth ist bei "..YELLOW.."[1]"..PREV..". Lakka ist in einem Käfig in demselben Raum.";
...
L["Quest_29607_Location"] = "Händler Vijaad (Sethekkhallen; "..YELLOW.."[1]"..PREV..")";
...
L["Quest_29642_Location"] = "Spionagemeisterin Mehlisah Hochkrone (Shattrath - Terrasse des Lichts; "..YELLOW.."50.4,45.2"..PREV..")";
...
L["Quest_29640_Location"] = "Spionin Grik'tha (Schattenlabyrinth; "..BLUE.."Eingang"..PREV..")";
L["Quest_29640_Note"] = "To'gun ist bei "..GREEN.."[1']"..PREV..", im Gang hinter Botschafter Höllenschlund.";
...
L["Quest_29641_Location"] = "Spion To'gun (Schattenlabyrinth; "..GREEN.."[1']"..PREV..")";
L["Quest_29641_Note"] = "Seeleninstrumente sind die dunkelvioletten Kugeln, die in der Instanz verteilt zu finden sind. Spionagemeisterin Mehlisah Hochkrone ist in (Shattrath - Terrasse des Lichts; "..YELLOW.."51,45"..PREV..")";
...
L["Quest_29645_Location"] = "Feldkommandeur Mahfuun (Schattenlabyrinth; "..BLUE.."Eingang"..PREV..")";
L["Quest_29645_Note"] = "Die Ritulisten der Kabale sind auf den Weg zum Botschafter Höllenschlund bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_10649_Note"] = "Schwarzherz der Hetzer ist bei "..YELLOW.."[2]"..PREV..". Dies ist der letzte Teil einer Questreihe, die im Schattenmondtal bei "..YELLOW.."61.2,29.2"..PREV.." für Aldor und bei "..YELLOW.."55.8,58.2"..PREV.." für Seher startet.";
...
L["Quest_29643_Location"] = "Feldkommandeur Mahfuun (Schattenlabyrinth; "..BLUE.."Eingang"..PREV..")";
L["Quest_29643_Note"] = "Der Kodex des Blutes ist direkt vor Großmeister Vorpil bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29644_Location"] = "Kodex des Blutes (Schattenlabyrinth; "..YELLOW.."[3]"..PREV..")";
L["Quest_29644_Note"] = "Murmur ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10666_Location"] = "David Wayne (Wälder von Terokkar - Waynes Zuflucht; "..YELLOW.."77.4,38.6"..PREV..").";
...
L["Quest_13432_Location"] = "Soridormi (Tanaris - Höhlen der Zeit; "..YELLOW.."59.0, 53.8"..PREV.."). Sie läuft in dem Bereich umher.";
L["Quest_13432_Note"] = "Kael'thas Sonnenwanderer ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10944_Note"] = "Akama ist bei (Schattenmondtal - Kerker des Wächters; "..YELLOW.."58.0, 48.2"..PREV..").\n\nDiese Quest ist Teil der Zugangsquestreihe des Schwarzen Tempels, die bei Anachoret Ceyla (Schattenmondtal - Altar der Sha'tar; "..YELLOW.."62.6, 28.4"..PREV..") für die Aldor und Arkanist Thelis (Schattenmondtal - Sanktum der Sterne; "..YELLOW.."56.2, 59.6"..PREV..") für die Seher startet.";
...
L["Quest_10296_Location"] = "Andormu (Tanaris - Höhlen der Zeit; "..YELLOW.."58,54"..PREV..")";
...
L["Quest_10297_Location"] = "Sa'at (Der schwarze Morast; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_10947_Location"] = "Akama (Schattenmondtal - Kammer des Wächters; "..YELLOW.."58,48"..PREV..")";
L["Quest_10947_Note"] = "Teil der Vorquestreihe zum Schwarzen Tempel. Furor Winterfrost ist bei "..YELLOW.."[1]"..PREV..".";
L["Quest_10947_PreQuest"] = "Die List der Aschenzungen ("..YELLOW.."FdS: Festung der Stürme"..PREV..")";
...
L["Quest_10282_Location"] = "Andormu (Tanaris - Höhlen der Zeit; "..YELLOW.."58,54"..PREV..")";
...
L["Quest_29599_Location"] = "Thrall (Vorgebirge des alten Hügellands; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_29674_Note"] = "Zereketh der Unabhängige ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29675_Note"] = "Zornseher Soccothrates ist bei "..YELLOW.."[3]"..PREV.." und Dalliah die Verdammnisverkünderin ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29681_Note"] = "Herold Horizontiss ist bei "..YELLOW.."[4]"..PREV..". Die Quest kannst du nach seinen Tod abgeben im Questfenster ";
...
L["Quest_11389_Location"] = "Netherpirscher Mah'duun (Shattrath - Unteres Viertel; "..YELLOW.."75.2, 37.6"..PREV..")";
...
L["Quest_29660_Note"] = "Kommandantin Sarannis ist bei "..YELLOW.."[1]"..PREV..", Hochbotaniker Freywinn ist bei "..YELLOW.."[2]"..PREV..", und Dorngrin der Hüter ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29667_Note"] = "Laj ist bei "..YELLOW.."[4]"..PREV.." die ganzen Mobs die Du töten mußt befinden sich auf den Weg zu Ihr.";
...
L["Quest_29669_Note"] = "Warpzweig ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_10704_Location"] = "A'dal (Shattrath - Terasse des Lichts; "..YELLOW.."54.6, 44.6"..PREV..")";
L["Quest_10704_Note"] = "Das obere Schlüsselfragment droppt von Pathaleon dem Kalkulator bei "..YELLOW.."[5]"..PREV..". Das untere Fragment droppt in der Botanika.";
...
L["Quest_10704_FollowQuest"] = "Herold der Verdammnis ("..YELLOW.."TK: Die Arkatraz"..PREV..")";
...
L["Quest_10257_Location"] = "Erzmagier Vargoth (Nethersturm - Dorf Kirin'Var; "..YELLOW.."58.4, 86.6"..PREV..")";
...
L["Quest_29659_Note"] = "Der Behälter der Legion ist bei "..GREEN.."[1']"..PREV.." und öffnet sich nachdem die Torwächter bei "..YELLOW.."[1]"..PREV.." und "..YELLOW.."[2]"..PREV.." getötet wurden.";
...
L["Quest_29657_Note"] = "Mechanolord Kapazitus ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29658_Note"] = "Pathaleon der Kalkulator ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_11387_Location"] = "Netherpirscher Mah'duun (Shattrath - Unteres Viertel; "..YELLOW.."75.2, 37.6"..PREV..")";
...
L["Quest_10946_Location"] = "Akama (Schattenmondtal - Kammer des Wächters; "..YELLOW.."58.0, 48.2"..PREV..")";
L["Quest_10946_Note"] = "Teil der Vorquestreihe zum Schwarzen Tempel.";
L["Quest_10946_PreQuest"] = "Das gefährdete Geheimnis ("..YELLOW.."Höhle des Schlangenschreins"..PREV..")";
L["Quest_10946_FollowQuest"] = "Ein Artefakt aus der Vergangenheit ("..YELLOW.."Hyjalgipfel"..PREV..")";
...
L["Quest_11007_Location"] = "Tiefgrüne Sphäre (droppt von Kael'thas Sonnenwanderer bei "..YELLOW.."[4]"..PREV..")";
L["Quest_11007_Note"] = "A'dal ist in (Shattrath - Terrasse des Lichts; "..YELLOW.."54.6, 44.6"..PREV..").";
...
L["Quest_10958_Note"] = "Der Geist von Olum ist hinter dem Eingang des Schwarzen Tempels rauf und dann links bei "..GREEN.."[1']"..PREV..". Er teleportiert Dich zu Seher Kanai, sobald Du den Obersten Kriegsfürst Naj'entus bei "..YELLOW.."[2]"..PREV.." und Supremus bei "..YELLOW.."[3]"..PREV.." getötet hast.";
...
L["Quest_10957_Location"] = "Seher Kanai (Der Schwarze Tempel; "..GREEN.."[2']"..PREV..").";
L["Quest_10957_Note"] = "Akamas Schemen ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_10959_Location"] = "Seher Kanai (Der Schwarze Tempel; "..GREEN.."[2']"..PREV..").";
L["Quest_10959_Note"] = "Illidan Sturmgrimm ist bei "..YELLOW.."[9]"..PREV..".";
...
L["Quest_29186_Location"] = "Hexendoktor T'wansi (Zul'Aman; "..BLUE.."Eingang"..PREV..")";
L["Quest_29186_Note"] = "Hexlord Malacrass ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_29217_Location"] = "Blutwache Hakkuz (Zul'Aman; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_11196_Location"] = "Vol'jin (Zul'Aman; "..BLUE.."Eingang"..PREV..")";
L["Quest_11196_Note"] = "Daakara ist der Endboss, bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_29682_Location"] = "Exarch Larethor (Terrasse der Magister; "..BLUE.."Eingang"..PREV..")";
L["Quest_29682_Note"] = "Exarch Larethor ist innerhalb der Instanz bei "..BLUE.."Eingang"..PREV..".\n\nDie Vorquest gibt es entweder von Adyen dem Lichtwächter (Shattrath - Aldorhöhe; "..YELLOW.."30.6,34.4"..PREV..") oder Dathris Sonnensturm (Shattrath - Sehertreppe; "..YELLOW.."54.4,80.6"..PREV..").";
...
L["Quest_29684_Location"] = "Exarch Larethor (Terrasse der Magister; "..BLUE.."Eingang"..PREV..")";
L["Quest_29684_Note"] = "Tyrith ist innerhalb der Instanz bei "..GREEN.."[1']"..PREV..".";
...
L["Quest_11490_Location"] = "Tyrith (Terrasse der Magister; "..GREEN.."[1']"..PREV..")";
L["Quest_11490_Note"] = "Die Seherkugel ist bei "..GREEN.."[2']"..PREV..". Nach der Sequenz erscheint Kalecgos, um die nächste Quest zu starten.";
...
L["Quest_29685_Location"] = "Kalecgos (Terrasse der Magister; "..GREEN.."[2']"..PREV..")";
L["Quest_29685_Note"] = "Prinz Kael'thas Sonnenwanderer ist bei "..YELLOW.."[4]"..PREV..". Nach Abschluss des Quests ist es möglich die Instanz im heroischen Modus zu absolvieren.\n\nLarethor ist bei (Insel von Quel'Danas - Sammelpunkt der Zerschmetterten Sonne; "..YELLOW.."47,31"..PREV..").";
...
L["Quest_29686_Location"] = "Exarch Larethor (Terrasse der Magister; "..BLUE.."Eingang"..PREV..")";
L["Quest_29686_Note"] = "Vexallus ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29687_Location"] = "Exarch Larethor (Terrasse der Magister; "..BLUE.."Eingang"..PREV..")";
L["Quest_29687_Note"] = "Selin Feuerherz ist bei "..YELLOW.."[1]"..PREV.." and Priesterin Delrissa ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_24553_Location"] = "Halduron Wolkenglanz (Insel von Quel'danas; "..YELLOW.."44.5, 45.5"..PREV..")";
L["Quest_24553_Note"] = "Wenn Du den Sonnenbrunnenplateau betritts, bist Du in einer Phasenverschiebung und mußt nicht gegen irgendwelche Mobs und Bosse kämpfen. Der Sonnenbrunnen ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_24564_Location"] = "Halduron Wolkenglanz (Insel von Quel'danas; "..YELLOW.."44.5, 45.5"..PREV..")";
L["Quest_24564_Note"] = "Wenn Du den Sonnenbrunnenplateau betritts, bist Du in einer Phasenverschiebung und mußt nicht gegen irgendwelche Mobs und Bosse kämpfen. Der Sonnenbrunnen ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_13149_Location"] = "Chromie (Das Ausmerzen von Stratholme; "..GREEN.."[1']"..PREV..")";
L["Quest_13149_Note"] = "Die Kisten findet man in der Nähe der Häuser entlang des Weges nach Stratholm. Nach Beendigung der Aufgabe kannst Du die Quest bei Chromi "..GREEN.."[1']"..PREV.." abgeben.";
...
L["Quest_13151_Location"] = "Chromie (Das Ausmerzen von Stratholme; "..GREEN.."[1']"..PREV..")";
L["Quest_13151_Note"] = "Mal'Ganis ist bei "..YELLOW.."[5]"..PREV..". Chromie erscheint nachdem Mal'Ganis besiegt worden ist.";
...
L["Quest_11251_Location"] = "Kundschafterin Valory (Heulender Fjord - Valgarde; "..YELLOW.."56.0, 55.8"..PREV..")";
...
L["Quest_29763_Location"] = "Verteidiger Mordun (Burg Utgard; "..BLUE.."Eingang"..PREV..")";
L["Quest_29763_Note"] = "Ingvar der Brandschatzer ist bei "..YELLOW.."[3]"..PREV..".\n Die Vorquest ist Optional.";
...
L["Quest_29764_Location"] = "Verteidiger Mordun (Burg Utgard; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29803_Location"] = "Verteidiger Mordun (Burg Utgard; "..BLUE.."Eingang"..PREV..")";
L["Quest_29803_Note"] = "Prinz Keleseth ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_11262_Location"] = "Dunkelläuferin Marrah (Burg Utgarde; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_13206_Location"] = "Dunkelläuferin Marrah (Burg Utgarde; "..BLUE.."Eingang"..PREV..")";
L["Quest_13206_Note"] = "Ingvar der Brandschatzer ist bei "..YELLOW.."[3]"..PREV..".\n Die Vorquest ist Optional.";
...
L["Quest_30112_Location"] = "Dunkelläuferin Marrah (Burg Utgarde; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_13131_Location"] = "Brigg Kleinkeul (Turm Utgarde; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_13132_Location"] = "Brigg Kleinkeul (Turm Utgarde; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29864_Location"] = "Argentumbeichtpatin Blondlocke (Turm Utgarde; "..BLUE.."Eingang"..PREV..")";
L["Quest_29864_Note"] = "Svala Grabesleid ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_13094_Location"] = "Abbild von Kriegsmagierin Kaitlyn (Nexus; "..BLUE.."Eingang"..PREV..")\n oder Bibliothekarin Serrah (Boreanische Tundra - Transitusschild; "..YELLOW.."33.4, 34.3"..PREV..")";
L["Quest_13094_Note"] = "Das Forschungsergebnissbuch liegt auf dem Boden in der Halle auf den Weg zum Großmagistrix Telestra bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_11905_Location"] = "Abbild von Kriegsmagierin Kaitlyn (Nexus; "..BLUE.."Eingang"..PREV..")\n oder Erzmagier Berinand (Boreanische Tundra - Transitusschild; "..YELLOW.."32.9, 34.3"..PREV..")";
L["Quest_11905_Note"] = "Benutze den interdimensionalen Refabrikator am Ende der Plattform von Anomaluson, bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_11911_Location"] = "Abbild von Kriegsmagierin Kaitlyn (Nexus; "..BLUE.."Eingang"..PREV..")\n oder Erzmagier Berinand (Boreanische Tundra - Transitusschild; "..YELLOW.."32.9, 34.3"..PREV..")";
...
L["Quest_11973_Location"] = "Abbild von Kriegsmagierin Kaitlyn (Nexus; "..BLUE.."Eingang"..PREV..")\n oder Raelorasz (Boreanische Tundra - Transitusschild; "..YELLOW.."33.2, 34.4"..PREV..")";
L["Quest_11973_Note"] = "Keristrasza ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_13095_Location"] = "Abbild von Kriegsmagierin Kaitlyn (Nexus; "..BLUE.."Eingang"..PREV..")\n oder Bibliothekarin Serrah (Boreanische Tundra - Transitusschild; "..YELLOW.."33.4, 34.3"..PREV..")";
L["Quest_13095_Note"] = "Das Forschungsergebnissbuch liegt auf dem Boden in der Halle auf den Weg zum Großmagistrix Telestra bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_13124_Note"] = "Belgaristrasz wird nach der Niedelage von Drakos der Befrager erscheinen bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_13128_Note"] = "Leywächter Eregos ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29811_Location"] = "Pionier A'zak (Azjol-Nerub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29811_Note"] = "Krik'thir der Torwächter ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29808_Location"] = "Pionier A'zak (Azjol-Nerub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29808_Note"] = "Die Eier der Geiselneruber sind im ersten Raum überall verteilt, beim ersten Boss, Krik'thir der Torwächter bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29807_Location"] = "Pionier A'zak (Azjol-Nerub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29807_Note"] = "Anub'arak ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_29825_Location"] = "Seher Ixit (Ahn'kahet; "..BLUE.."Eingang"..PREV..")";
L["Quest_29825_Note"] = "Urahne Nadox ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29826_Location"] = "Seher Ixit (Ahn'kahet; "..BLUE.."Eingang"..PREV..")";
L["Quest_29826_Note"] = "Die Augen von Taldram und die Knochenschinder sind alle auf den Weg zum Boss Prinz Taldaram bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_13187_Location"] = "Seher Ixit (Ahn'kahet; "..BLUE.."Eingang"..PREV..")";
L["Quest_13187_Note"] = "Die Vergessenen und Herald Volazj sind bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_29850_Location"] = "Kaldir Eisenbann (Die Hallen des Steins; "..BLUE.."Eingang"..PREV..")";
L["Quest_29850_Note"] = "Die dunklen Runenriesen sind alle in der Nähe des Eingangs, Krystallus ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_29848_Location"] = "Kaldir Eisenbann (Die Hallen des Steins; "..BLUE.."Eingang"..PREV..")";
L["Quest_29848_Note"] = "Maid der Trauer ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_13207_Location"] = "Brann Bronzebart (Die Hallen des Steins; "..GREEN.."[2']"..PREV..")";
L["Quest_13207_Note"] = "Folgt Brann Bronzebart in den naheliegenden Raum bei "..YELLOW.."[3]"..PREV.." und beschützt ihn vor die Mobwellen während er an der Steintafel arbeitet. Nach seinem Erfolg , kann der Tribunalkasten rechts neben der Steintafel geöffnet werden.\n\nSprecht ihn erneut an und er rennt aus dem Raum raus zu"..YELLOW.."[4]"..PREV..". Du mußt ihm nicht folgen, er wartet dort auf dich. Ist Sjonnir der Eisenformer besiegt kann Du die Quest bei Brann Bronzebart abgegeben.";
...
L["Quest_29863_Location"] = "König Jokkum (Die Sturmgipfel - Dun Niffelem; "..YELLOW.."65.4, 60.2"..PREV..")";
L["Quest_29863_Note"] = "Sturmbote Eljrrin (Hallen der Blitze; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29861_Location"] = "Sturmbote Eljrrin (Hallen der Blitze; "..BLUE.."Eingang"..PREV..")";
L["Quest_29861_Note"] = "Loken ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_29862_Location"] = "Sturmbote Eljrrin (Hallen der Blitze; "..BLUE.."Eingang"..PREV..")";
L["Quest_29862_Note"] = "General Bjarngrim ist bei "..YELLOW.."[1]"..PREV..", er wandert den Weg lang. Sturmgeschmiedeter Taktiker und Heiler sind beim General Bjarngrim verteilt.";
...
L["Quest_29860_Location"] = "Sturmbote Eljrrin (Hallen der Blitze; "..BLUE.."Eingang"..PREV..")";
L["Quest_29860_Note"] = "Volkhan ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_24579_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_12037_Location"] = "Mack (Grizzly Hügel - Granitquell; "..YELLOW.."16.6, 48.1"..PREV..")";
...
L["Quest_13129_Location"] = "Kurzel (Feste Drak'Tharon; "..BLUE.."Eingang"..PREV..")";
L["Quest_13129_Note"] = "Novos der Beschwörer ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29828_Location"] = "Kurzel (Feste Drak'Tharon; "..BLUE.."Eingang"..PREV..")";
L["Quest_29828_Note"] = "König Dred ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_30120_Location"] = "Abbild von Drakuru (Feste Drak'Tharon; "..BLUE.."Eingang"..PREV..")";
L["Quest_30120_Note"] = "Drakuru's Kohlenbecken ist hinter dem Propheten Tharon'ja bei "..GREEN.."[3']"..PREV..". Ausdauermojos droppen innerhalb Drak'Tharons Feste.";
...
L["Quest_29836_Location"] = "Chronist To'kini (Zul Drak - Zim'Torga "..YELLOW.."16.6, 48.1"..PREV..")";
L["Quest_29836_Note"] = "Chronistin Bah'kini ist bei "..BLUE.."Ausgang"..PREV..".";

L["Quest_29833_Name"] = "Offene Rechnungen";
L["Quest_29833_Objective"] = "Har'koa möchte, dass Ihr mit Tol'mar in Gundrak sprecht.";
L["Quest_29833_Location"] = "Har'koa (Zul Drak - Altar von Har'koa "..YELLOW.."63.6, 70.2"..PREV..")";
...
L["Quest_29844_Location"] = "Tol'mar (Gundrak; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29834_Location"] = "Tol'mar (Gundrak; "..BLUE.."Eingang"..PREV..")";
L["Quest_29834_Note"] = "Slad'ran ist bei "..YELLOW.."[1]"..PREV..", Moorabi ist bei "..YELLOW.."[3]"..PREV.." und Gal'darah ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_29839_Location"] = "Tol'mar (Gundrak; "..BLUE.."Eingang"..PREV..")";
L["Quest_29839_Note"] = "Fragment des Kolosses der Drakkari droppt von den Drakkari Kolossen bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_29829_Location"] = "Rhonin (Dalaran - Die Violette Zitadelle; "..YELLOW.."31.0, 48.6"..PREV..")";
L["Quest_29829_Note"] = "Leutnant Sinclari ist in (Die Violette Festung; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_29830_Location"] = "Leutnant Sinclari (Die Violette Festung; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_13372_Location"] = "Schlüssel der fokussierenden Iris (droppt von Sapphiron; "..YELLOW.."Frostwyrmhöhle [1]"..PREV..")";
L["Quest_13372_Note"] = "Alexstrasza ist bei (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV.."). Die Folgequest öffnet die Instant Der Nexus: Auge der Ewigkeit für den normalen 10 Mann Raid.";
...
L["Quest_13375_Note"] = "Alexstrasza ist bei (Drachenöde - Wyrmruhtempel; "..YELLOW.."59.8, 54.6"..PREV.."). Die Folgequest öffnet die Instant Der Nexus: Auge der Ewigkeit für den Heroischen 25 Mann Raid.";
...
L["Quest_24580_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24582_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24581_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24583_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_13607_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13609_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13610_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13606_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13611_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
L["Quest_13611_Note"] = "Mimiron ist bei "..YELLOW.."Der Funke der Imagination [15]"..PREV..". Mimiron muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13614_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13816_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13822_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13823_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13821_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_13824_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
L["Quest_13824_Note"] = "Mimiron ist bei "..YELLOW.."Der Funke der Imagination [15]"..PREV..". Mimiron muss im harten Modus gelegt werden um das Siegel zu bekommen.";
...
L["Quest_13818_Location"] = "Ausgrabungsleiter Doren (Ulduar - Die Vorkammer; "..GREEN.."[6']"..PREV..")";
...
L["Quest_24585_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24587_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
L["Quest_24587_Note"] = "Ignis der Meister des Eisenwerks ist bei "..YELLOW.."Die Belagerung [3]"..PREV..".\n\nDiese wöchentliche Quest kann von einem Schlachtzug jeglicher Schwierigkeitsstufe oder Größe abgeschlossen werden.";
...
L["Quest_24588_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24589_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_24499_Location"] = "Lady Jaina Prachtmeer (Die Seelenschmiede; "..BLUE.."Eingang"..PREV..")";
L["Quest_24499_Note"] = "Gebe die Quest bei Lady Jaina Prachtmeer ab, bei "..YELLOW.."[2]"..PREV.." bevor du die Instanz verläßt.\n\nSchließe die Quest erfolgreich ab um in die Grube von Saron zu gelangen.";
...
L["Quest_24476_Note"] = "Der Schmelztiegel der Seelen ist bei "..YELLOW.."[2]"..PREV..", am Ende der Instanz.";
...
L["Quest_24511_Location"] = "Fürstin Sylvanas Windläufer (Die Seelenschmiede; "..BLUE.."Eingang"..PREV..")";
L["Quest_24511_Note"] = "Gebe die Quest bei Fürstin Sylvanas Windläufer ab, bei "..YELLOW.."[2]"..PREV.." bevor du die Instanz verläßt.\n\nSchließe die Quest erfolgreich ab um in die Grube von Saron zu gelangen.";
...
L["Quest_24560_Note"] = "Der Schmelztiegel der Seelen ist bei "..YELLOW.."[2]"..PREV..", am Ende der Instanz.";
...
L["Quest_24498_Location"] = "Lady Jaina Prachtmeer (Grube von Saron; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24461_FollowQuest"] = "Die Klinge tempern ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24682_Location"] = "Fürstin Sylvanas Windläufer (Die Seelenschmiede; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_24507_Location"] = "Fürstin Sylvanas Windläufer (Grube von Saron; "..GREEN.."[1']"..PREV..")";
...
L["Quest_24712_Location"] = "Fürstin Sylvanas Windrunner (Grube von Saron; "..YELLOW.."[1]"..PREV..")";
...
L["Quest_24712_FollowQuest"] = "Frostgram ("..YELLOW.."Hallen der Reflexion"..PREV..")";
...
L["Quest_24559_FollowQuest"] = "Die Klinge tempern ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24480_PreQuest"] = "Die Klinge tempern ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24713_Location"] = "Fürstin Sylvanas Windläufer (Grube von Saron; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_24561_PreQuest"] = "Die Klinge tempern ("..YELLOW.."Die Seelenschmiede"..PREV..")";
...
L["Quest_24590_Location"] = "Erzmagier Lan'dalock (Dalaran - Die Violette Festung; "..YELLOW.."57.6, 66.4"..PREV..")";
...
L["Quest_26013_Note"] = "Wächterin des Sanktum Xerestrasza ist innerhalb des Rubin Sanktum bei dem 2. Nebenboss Baltharus der Kriegsjünger bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_26034_Note"] = "Halion ist der Hauptboss bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_28732_Location"] = "Pip Quickwit (Berg Hyjal - Der Aschenzirkel; "..YELLOW.."42.6, 28.1"..PREV..")";
L["Quest_28732_Note"] = "Die Maulwurfmaschine ist in der Nähe von "..YELLOW.."42.8, 28.9"..PREV..". Diese Quest bringt dich zu Pip Quickwit innerhalb der Schwarzfelshöhlen am Eingang bei "..GREEN.."[1']"..PREV..".";
...
L["Quest_28735_Location"] = "Pip Quickwit (Schwarzfelshöhlen; "..GREEN.."[1']"..PREV..")";
L["Quest_28735_Note"] = "Rom'ogg Knochenbrecher ist der erste Boss, bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_28737_Note"] = "Corla, Botin des Zwielichts ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_28738_Note"] = "Karsh Stahlbieger ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_28740_Note"] = "Bella ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_28741_Note"] = "Aszendentenfürst Obsidius ist bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_28834_Location"] = "Kapitän Taylor (Thron der Gezeiten; "..BLUE.."Eingang"..PREV..")";
L["Quest_28834_Note"] = "Erunak Steinsprecher ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_28836_Location"] = "Kapitän Taylor (Thron der Gezeiten; "..BLUE.."Eingang"..PREV..")";
L["Quest_28836_Note"] = "Lady Naz'jar ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_28833_Location"] = "Legionär Nazgrim (Thron der Gezeiten; "..BLUE.."Eingang"..PREV..")";
L["Quest_28833_Note"] = "Erunak Steinsprecher ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_28843_Location"] = "Legionär Nazgrim (Thron der Gezeiten; "..BLUE.."Eingang"..PREV..")";
L["Quest_28843_Note"] = "Lady Naz'jar ist bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_28866_Location"] = "Sturmruferin Mylra (Tiefenheim; "..YELLOW.."64.5, 82.2"..PREV..")";
...
L["Quest_28815_Location"] = "Erdwächterin Yrsa (Der steinerne Kern; "..BLUE.."Eingang"..PREV..")";
L["Quest_28815_Note"] = "Die Dokumente liegen auf den Boden vor dem Boss Corborus, bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_28814_Location"] = "Erdwächterin Yrsa (Der steinerne Kern; "..BLUE.."Eingang"..PREV..") , normal bekommst du die Quest automatisch nachdem Du die Dokumente aufgehoben hast.";
L["Quest_28814_Note"] = "Hohepriesterin Azil ist bei "..YELLOW.."[4]"..PREV.." und die ergebenen Anhänger sind überall auf den Weg zu ihr verteilt. Diese Quest bringt dich zurück zur Erdwächterin Yrsa am Eingang der Instanz.";
...
L["Quest_28824_Location"] = "Therazane (Tiefenheim - Therazanes Thron; "..YELLOW.."56.3, 12.8"..PREV..")";
L["Quest_28824_Note"] = "Ozruk ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_28760_Location"] = "Itesh (Vortexgipfel; "..BLUE.."Eingang"..PREV..")";
L["Quest_28760_Note"] = "Asaad ist der finale Boss, bei "..YELLOW.."[3]"..PREV..". Die Vorquest ist optional. Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_28779_Location"] = "Itesh (Vortexgipfel; "..BLUE.."Eingang"..PREV..")";
L["Quest_28779_Note"] = "Großwesir Ertan ist der erste Boss, bei "..YELLOW.."[1]"..PREV..". Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_28852_Location"] = "Velastrasza (Grim Batol; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_28853_Location"] = "Scharfseher Tooranu (Grim Batol; "..BLUE.."Eingang"..PREV..")";
L["Quest_28853_Note"] = "Drahga Schattenbrennerist bei "..YELLOW.."[3]"..PREV..". Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_28854_Location"] = "Unheilsflamme (Grim Batol; "..BLUE.."Eingang"..PREV..")";
L["Quest_28854_Note"] = "Erudax ist bei "..YELLOW.."[4]"..PREV..". Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_28654_Location"] = "Brann Bronzebart (Uldum - Wiege der Uralten; "..YELLOW.."44.9, 67.4"..PREV..")";
...
L["Quest_28746_Location"] = "Brann Bronzebart (Hallen des Ursprungs; "..GREEN.."[2']"..PREV..")";
L["Quest_28746_Note"] = "Der Kontrollraum der Titanen ist zugänglich nachdem Anraphet besiegt wurde, bei "..YELLOW.."3"..PREV..".";
...
L["Quest_28753_Location"] = "Brann Bronzebart (Uldum - Wiege der Uralten; "..YELLOW.."44.9, 67.4"..PREV..")";
L["Quest_28753_Note"] = "Isiset ist bei "..YELLOW.."[4]"..PREV..", Ammunae ist bei "..YELLOW.."[5]"..PREV..", Setesh ist bei "..YELLOW.."[6]"..PREV..", und Rajh ist bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_28870_Location"] = "König Phaoris (Uldum - Ramakahen; "..YELLOW.."54.9, 32.8"..PREV..")";
...
L["Quest_28781_Location"] = "Hauptmann Hadan (Verlorene Stadt der Tol'vir; "..BLUE.."Eingang"..PREV..")";
L["Quest_28781_Note"] = "General Husam ist bei "..YELLOW.."[1]"..PREV..". Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_28783_Location"] = "Hauptmann Hadan (Verlorene Stadt der Tol'vir; "..BLUE.."Eingang"..PREV..")";
L["Quest_28783_Note"] = "Siamat ist bei "..YELLOW.."[4]"..PREV..". Diese Quest bringt dich zurück zum Eingang.";
...
L["Quest_29172_Location"] = "Blutschlächterin T'ara (Zul'Gurub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29172_Note"] = "Die Blütenflügelschwarmkönigin kann im Wasser links vom Eingang gefunden werden. Tor-Tun der Schläfer ist bei "..YELLOW.."[6]"..PREV.." und der Gahz'rankas verlorener Nachwuchs kann gefunden werden in den verschiedenen Gewässern.";
...
L["Quest_29175_Location"] = "Blutschlächterin T'ara (Zul'Gurub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29175_Note"] = "Gub ist bei "..YELLOW.."[3]"..PREV.." und der Meisterkoch der Gurubashi ist im nördlichen Teil der Instanz.";
...
L["Quest_29242_Location"] = "Briney Schraubschneider (Zul'Gurub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29242_Note"] = "Benutze das  mysteriöse Schmuckstück bei "..YELLOW.."[12]"..PREV.." um den Boss zu rufen und die Quest abzuschließen.";
...
L["Quest_29173_Location"] = "Blutschlächterin T'ara (Zul'Gurub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29173_Note"] = "Kaulema der Beweger ist bei "..YELLOW.."[7]"..PREV..", Mor'Lek der Zerleger ist bei "..YELLOW.."[10]"..PREV.." und Mortaxx der Totenglocke ist bei "..YELLOW.."[13]"..PREV..".";
...
L["Quest_29153_Location"] = "Aufseher Klunkerknall (Zul'Gurub; "..BLUE.."Eingang"..PREV..")\nBaron Revilgaz (Das Schlingendornkap - Beutebucht; "..YELLOW.."41.0, 73.0"..PREV..")";
L["Quest_29153_Note"] = "Diese Quest kann innerhalb der Instanz angenommen werden oder am Ende der Questreihe bei der Tafel des Heldenaufrufs in Sturmwind und Ogrimmar.  Das Artefakt ist bei "..YELLOW.."[17]"..PREV..".";
...
L["Quest_29241_Location"] = "Blutschlächterin Zala (Zul'Gurub; "..BLUE.."Eingang"..PREV..")";
L["Quest_29241_Note"] = "Jin'do der Götterbrecher ist bei "..YELLOW.."[17]"..PREV..".";
...
L["Quest_29251_Location"] = "Aufseher Klunkerknall (Zul'Gurub; "..BLUE.."Eingang"..PREV..")\nBaron Revilgaz (Das Schlingendornkap - Beutebucht; "..YELLOW.."41.0, 73.0"..PREV..")";
L["Quest_29251_Note"] = "Diese Quest kann innerhalb der Instanz angenommen werden oder am Ende der Questreihe bei der Tafel des Heldenaufrufs in Sturmwind und Ogrimmar.  Das Artefakt ist bei "..YELLOW.."[17]"..PREV..".";
...
L["Quest_29135_Location"] = "Anachronos (Tanaris - Höhlen der Zeit; "..YELLOW.."58.0, 56.0"..PREV..")";
L["Quest_29135_Note"] = "Das Immerglut droppt von den Bossen in den Feuerlanden.\n\nDie Sande der Zeit kann gekauft werden bei Yasmin (Uldum - Oasis von Vir'sar; "..YELLOW.."26.6, 7.2"..PREV..")";
...
L["Quest_29234_Location"] = "Kalecgos (Hyjal - Nordrassil; "..YELLOW.."62.2, 23.2"..PREV..")";
...
L["Quest_29270_Location"] = "Kalecgos (Boreanische Tundra - Kaltarra; "..YELLOW.."31.0, 24.0"..PREV..")";
...
L["Quest_29307_Location"] = "Kalecgos (Boreanische Tundra - Kaltarra; "..YELLOW.."23.2, 22.8"..PREV..")";
...
L["Quest_30095_Location"] = "Coridormi (Sturmwind - Magiersanktum; "..YELLOW.."49.4, 87.4"..PREV..")";
...
L["Quest_30096_Location"] = "Nozdormu (Endzeit; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30097_Location"] = "Alurmi (Endzeit; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30094_Location"] = "Ziradormi (Orgrimmar - Tal der Stärke; "..YELLOW.."48.8, 70.4"..PREV..")";
...
L["Quest_30098_Location"] = "Nozdormu (Brunnen der Ewigkeit; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30099_Location"] = "Nozdormu (Brunnen der Ewigkeit; "..BLUE.."Eingang"..PREV..")";
L["Quest_30099_Note"] = "Die drei Portale können im großen Gebiet nach dem Eingang gefunden werden mit Massen von Dämonen die da rumlaufen. Jedes Portal ist auf eine anderen Seite des Raumes. Nach dem deaktivieren der drei Portale, erscheint Peroth'arn bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_30100_Location"] = "Nozdormu (Brunnen der Ewigkeit; "..BLUE.."Eingang"..PREV..")";
L["Quest_30100_Note"] = "Königen Azshara ist bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_30101_Location"] = "Nozdormu (Brunnen der Ewigkeit; "..BLUE.."Eingang"..PREV..")";
L["Quest_30101_Note"] = "Mannoroth ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_30104_Location"] = "Alurmi (Brunnen der Ewigkeit; "..BLUE.."Eingang"..PREV..")";
L["Quest_30104_Note"] = "Die ersten zwei findest du auf den Weg durch die Instanz. Hauptmann Varo'then ist am Ende der Instanz bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_30102_Location"] = "Chromie (Brunnen der Ewigkeit; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_30103_Location"] = "Thrall (Stunde des Zwielichts; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30105_Location"] = "Droppt von Arcurion (Stunde des Zwielichts; "..YELLOW.."[1]"..PREV..")";
L["Quest_30105_Note"] = "Erzbischof Benedictus ist der Zwielichtprophet und ist bei "..YELLOW.."[3]"..PREV..").";
...
L["Quest_29801_Location"] = "Lord Afrasastrasz (Drachenseele; "..BLUE.."Eingang"..PREV..")";
L["Quest_29801_Note"] = "Dies ist eine Schurkenquest. Diese und folgenden Questen können nicht mit dem Raidfinder angeschlosssen werden. Hagara die Sturmbinderin ist bei "..YELLOW.."[4]"..PREV..". Es können mehrer Schurken in einem Schlachtzug dabei sein nur muß der Boss zwischendurch resettet werden.";
...
L["Quest_30107_Location"] = "Furion (Vorgebirge des Hügellands - Rabenholdtanwesen; "..YELLOW.."71.4, 45.6"..PREV..")";
...
L["Quest_30116_Location"] = "Furion (Vorgebirge des Hügellands - Rabenholdtanwesen; "..YELLOW.."71.4, 45.6"..PREV..")";
...
L["Quest_30118_Location"] = "Furion (Vorgebirge des Hügellands - Rabenholdtanwesen; "..YELLOW.."71.4, 45.6"..PREV..")";
...
L["Quest_31357_Location"] = "Sinan die Träumerin (Mogu'shanpalast; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_31360_Location"] = "Sinan die Träumerin (Mogu'shanpalast; "..BLUE.."Eingang"..PREV..")";
L["Quest_31360_Note"] = "Xin der Waffenmeister ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_31031_Location"] = "Ban Bärenherz (Kun-Lai-Gipfel - Shado-Pan-Kloster; "..YELLOW.."36.6, 47.9"..PREV..")";
L["Quest_31031_Note"] = "Ban Bärenherz (Shado-Pan-Kloster; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_30757_Location"] = "Ban Bärenherz (Shado-Pan-Kloster; "..BLUE.."Eingang"..PREV..")";
L["Quest_30757_Note"] = "Taran Zhu ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_31342_Location"] = "Meister Schneewehe (Shado-Pan-Kloster - Versiegelte Kammer; "..BLUE.."70.0, 49.4"..PREV..")";
L["Quest_31342_Note"] = "Das Sha der Gewalt ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_30085_Location"] = "Chen Sturmbräu (Tal der vier Winde - Brauerei Sturmbräu; "..YELLOW.."36.0, 68.8"..PREV..")";
L["Quest_30085_Note"] = "Yan-Zhu der Dekantierte ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_31327_Location"] = "Chen Sturmbräu (Brauerei Sturmbräu; "..BLUE.."Eingang"..PREV..")";
L["Quest_31327_Note"] = "Yan-Zhu der Dekantierte ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_31324_Location"] = "Tantchen Sturmbräu (Brauerei Sturmbräu; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_33024_Location"] = "Sungshin Eisentatz (Tal der Vier Winde - Halbhügel "..YELLOW.."53.6, 51.2"..PREV..")";
...
L["Quest_31355_Location"] = "Priesterin Sommerblatt (Tempel der Jadeschlange; "..BLUE.."Eingang"..PREV..")";
L["Quest_31355_Note"] = "Der Weise Mari ist bei "..YELLOW.."[1]"..PREV..".\n Lehrensucher Steinschritt ist bei "..YELLOW.."[2]"..PREV..".\n Liu Flammenherz ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_31356_Location"] = "Meister Windstark (Tempel der Jadeschlange; "..BLUE.."Eintgang"..PREV..")";
L["Quest_31356_Note"] = "Das Sha des Zweifels ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_33020_Location"] = "Lin Chao-Wei (Zeitlose Insel - Alt Pi'Jiu "..YELLOW.."41.0, 73.8"..PREV..")";
L["Quest_33020_Note"] = "Das Sha des Zweifels ist bei "..YELLOW.."[4]"..PREV..".Direkt neben dem Sha des Zorns liegt die Schriftrolle die Du anklicken mußt.\n\nDie Vorquest startet auf der Zeitlosen Insel bei "..YELLOW.."52.0, 46.0"..PREV..".";
...
L["Quest_33107_Location"] = "Lin's Familienschriftrolle (Tempel der Jadeschlange; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_31363_Location"] = "Bogenmeisterin Li (Das Tor der Untergehenden Sonne; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_31364_Location"] = "Bogenmeisterin Li (Das Tor der Untergehenden Sonne; "..BLUE.."Eingang"..PREV..")";
L["Quest_31364_Note"] = "Raigonn ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_31365_Location"] = "Shado-Master Chum Kiu (Belagerung des Niuzaotempels; "..BLUE.."Eingang"..PREV..")";
...
L["Quest_31366_Location"] = "Shado-Master Chum Kiu (Belagerung des Niuzaotempels; "..BLUE.."Eingang"..PREV..")";
L["Quest_31366_Note"] = "Schwadronsführer Ner'onok ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_32599_Location"] = "Lady Jaina Prachtmeer (Insel des Donners - Violette Erhebung; "..YELLOW.."63.2, 72.2"..PREV..")";
L["Quest_32599_Note"] = "Diese Quest bekommst du nachdem Du einen ehrfürchtigen Ruf bei der Offensive der Kirin Tor erlangt hast. Nach dem Sieg von Lei Shen bei "..YELLOW.."[12]"..PREV..", warte einen kleinen Moment und aktiviere dann den Stab auf der Plattform um diese Quest zu beenden.";
...
L["Quest_32715_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Monara befindet sich bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_32714_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  No'ku Sturmsprecher befindet sich bei "..YELLOW.."[2]"..PREV..".";
...
L["Quest_32713_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Krankenstein befinden sich bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_32716_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Starrendes Auge und Fokussiertes Auge befinden sich bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_32711_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Erzritualist Kelada befindet sich bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_32710_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Fleisch'rok den Verpesteten befindet sich bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_32712_Note"] = "Diese Quest kann auf jeder Schwierigkeitsstufe abgeschlossen werden.  Zao'cho befindet sich bei "..YELLOW.."[6]"..PREV..".";
...
L["Quest_32589_Location"] = "Lor'themar Theron (Insel des Donners - Morgensucher Kap; "..YELLOW.."32.6, 35.4"..PREV..")";
L["Quest_32589_Note"] = "Diese Quest bekommst du nachdem Du einen ehrfürchtigen Ruf bei den Sonnenhäscheranstum erlangt hast. Nach dem Sieg von Dunkler Animus bei "..YELLOW.."[9]"..PREV..", benutze den abgestimmten Kristall und erhalte dann Dein Questgegenstand.";
...
L["Quest_33147_Location"] = "Lehrensucher Cho (Schlacht um Orgrimmar; "..YELLOW.."[14}"..PREV..")";
...
L["Quest_33138_Location"] = "Lehrensucher Cho (Tal der Ewigen Blüte - Mogu'shan Palast; "..YELLOW.."67.4, 45.6"..PREV..")";
...
L["Quest_33337_Location"] = "Kairoz (Zeitlose Insel - Der Hof der Erhabenen; "..YELLOW.."34.6, 53.6"..PREV..")";
...
L["Quest_33375_Location"] = "Kairoz (Zeitlose Insel - Der Hof der Erhabenen; "..YELLOW.."34.6, 53.6"..PREV..")";
...
L["Quest_33376_Location"] = "Kairoz (Zeitlose Insel - Der Hof der Erhabenen; "..YELLOW.."34.6, 53.6"..PREV..")";
...
L["Quest_33377_Location"] = "Kairoz (Zeitlose Insel - Der Hof der Erhabenen; "..YELLOW.."34.6, 53.6"..PREV..")";
...
L["Quest_37146_Note"] = "Die Alptraumglocke befindet sich, in der mitte des Ganges, links an der Wand zwischen dem zweiten "..YELLOW.."[2]"..PREV.." und dem dritten "..YELLOW.."[3]"..PREV.." Boss.";
...
L["Quest_37232_Note"] = "Nur im heroischen Modus.  Die Seelenschnittklinge kann am Brunnen rechts von der ersten Kreuzung gefunden werden "..YELLOW.."[3]"..PREV.." Boss.\n\nDu musst den Endboss Teron'gor bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37154_Note"] = "Nur im heroischen Modus.  Das Seelengeflecht befindet sich auf der linken Seite der Plattform mit dem ersten Boss bei "..YELLOW.."[1]"..PREV..".\n\nDu musst den Endboss Teron'gor bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37233_Note"] = "Nur im heroischen Modus.  Das Seelengeflecht befindet sich auf der linken Seite der Plattform mit dem ersten Boss bei "..YELLOW.."[1]"..PREV..".\n\nDu musst den Endboss Teron'gor bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_36316_Location"] = "Reshad (Spitzen von Arak - Terrokversteck; "..YELLOW.."46.5, 46.6"..PREV..")";
...
L["Quest_37147_Note"] = "Der Windsturm in der Flasche befindet sich auf der Plattform vom dritten Boss bei "..YELLOW.."[3]"..PREV..".\n\nDu musst den Endboss obersten Weisen Viryx bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37142_Note"] = "Wenn Du den Pfad zum Sklavenwächter Crushto lang gehst bei "..YELLOW.."[2]"..PREV..", der Ogerbaumstamm befindet sich in einer kleinen Nische bevor Du den Bossraum betritts.\n\nDu musst den Endboss Gug'rokk bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37153_Note"] = "Nur im heroischen Modus.  Olafs Schild befindet sich auf den Weg zum Boss Magmolatus "..YELLOW.."[1]"..PREV..", auf der Höhe zum Tunnel um zu den Boss zu gelangen.\n\nDu musst den Endboss Gug'rokk bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37229_Note"] = "Nur im heroischen Modus.  Olafs Schild befindet sich auf den Weg zum Boss Magmolatus "..YELLOW.."[1]"..PREV..", auf der Höhe zum Tunnel um zu den Boss zu gelangen.\n\nDu musst den Endboss Gug'rokk bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37155_Note"] = "Nur im heroischen Modus.  Der Messingkompass liegt auf dem Boden vorne an Fässern in der Nähe vom ersten Boss bei "..YELLOW.."[1]"..PREV..".\n\nDu musst den Endboss Skulloc bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37231_Note"] = "Nur im heroischen Modus.  Der Messingkompass liegt auf dem Boden vorne an Fässern in der Nähe vom ersten Boss bei "..YELLOW.."[1]"..PREV..".\n\nDu musst den Endboss Skulloc bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37150_Note"] = "Du kannst das winzige Pfauenküken auf den Boden finden südlich vom Xeritac's Baus bei den Koordinaten "..YELLOW.."55.4, 22.6"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37227_Note"] = "Du kannst das winzige Pfauenküken auf den Boden finden südlich vom Xeritac's Baus bei den Koordinaten "..YELLOW.."55.4, 22.6"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37166_Note"] = "Nur im heroischen Modus.  Das überwuchte Artefakt ist südlich Teil der Instanz bei den Koordinaten "..YELLOW.."61.1, 66.3"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37241_Note"] = "Nur im heroischen Modus.  Das überwuchte Artefakt ist südlich Teil der Instanz bei den Koordinaten "..YELLOW.."61.1, 66.3"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37165_Note"] = "Nur im heroischen Modus.  Der seltsam leuchtende Wedel ist im grünen Wäldchen bei den Koordinaten "..YELLOW.."64.6, 21.0"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37240_Note"] = "Nur im heroischen Modus.  Der seltsam leuchtende Wedel ist im grünen Wäldchen bei den Koordinaten "..YELLOW.."64.6, 21.0"..PREV..".\n\nDu musst den Endboss Yalnu bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_36813_Note"] = "Der Ausgelaugter immergrüner Samen droppt vom Trash auf den Weg zu Bleichborke bei "..YELLOW.."[1]"..PREV..".\n\nForschung des Phylarchen ist im Haus in der Nähe von Erzmagierin Sol "..YELLOW.."[3]"..PREV.." bei den Koordinaten "..YELLOW.."62.4, 37.6"..PREV..".\n\nXeri'tacs Giftdrüse droppt von Xeri'tac bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_37167_Note"] = "Nur im heroischen Modus.  Die riesige Waffenkiste ist auf den Weg zum ersten Boss bei den Koordinaten "..YELLOW.."53.3, 39.1"..PREV..".\n\nDu musst den Endboss Himmelsfürstin Tovra bei "..YELLOW.."[3]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37242_Note"] = "Nur im heroischen Modus.  Die riesige Waffenkiste ist auf den Weg zum ersten Boss bei den Koordinaten "..YELLOW.."53.3, 39.1"..PREV..".\n\nDu musst den Endboss Himmelsfürstin Tovra bei "..YELLOW.."[3]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37151_Note"] = "Nur im heroischen Modus.  Du findest die eiserne Autokanone nach der Vernichtung des zweiten Bosses bei "..YELLOW.."[2]"..PREV..".\n\nDu musst den Endboss Himmelsfürstin Tovra bei "..YELLOW.."[3]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37209_Note"] = "Nur im heroischen Modus.  Du findest die eiserne Autokanone nach der Vernichtung des zweiten Bosses bei "..YELLOW.."[2]"..PREV..".\n\nDu musst den Endboss Himmelsfürstin Tovra bei "..YELLOW.."[3]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37149_Note"] = "Der Leerentorschlüssel ist ziemlich in der vom Eingang der Instanz.  Dieser befindet sich auf einem Sockel in einem Zimmer kurz nach den ersten Stufen bei den Koordinaten "..YELLOW.."37.4, 51.7"..PREV..".\n\nDu musst den Endboss Ner'zhul bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37245_Note"] = "Der Leerentorschlüssel ist ziemlich in der vom Eingang der Instanz.  Dieser befindet sich auf einem Sockel in einem Zimmer kurz nach den ersten Stufen bei den Koordinaten "..YELLOW.."37.4, 51.7"..PREV..".\n\nDu musst den Endboss Ner'zhul bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37164_Note"] = "Nur im heroischen Modus.  Der Silberspitzenpfeil befindet sich auf dem Altar nachdem Du Nhallish besiegt hast bei "..YELLOW.."[2]"..PREV..".\n\nDu musst den Endboss Ner'zhul bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37239_Note"] = "Nur im heroischen Modus.  Der Silberspitzenpfeil befindet sich auf dem Altar nachdem Du Nhallish besiegt hast bei "..YELLOW.."[2]"..PREV..".\n\nDu musst den Endboss Ner'zhul bei "..YELLOW.."[4]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37161_Note"] = "Nur im heroischen Modus.  Finkles verbesserten Kürschner ist auf dem Boden in der Nähe von Knochen in dem Raum wo sich der zweite Boss Kyrak"..YELLOW.."[2]"..PREV.." befindet.\n\nDu musst den Endboss Kriegsfürstin Zaela bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37236_Note"] = "Nur im heroischen Modus.  Finkles verbesserten Kürschner ist auf dem Boden in der Nähe von Knochen in dem Raum wo sich der zweite Boss Kyrak"..YELLOW.."[2]"..PREV.." befindet.\n\nDu musst den Endboss Kriegsfürstin Zaela bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37162_Note"] = "Nur im heroischen Modus.  Die abgestoßene Drachenklaue ist vor dem Tor in dem Raum wo Du gegen Kommandant Tharbek "..YELLOW.."[3]"..PREV.." kämpfst.\n\nDu musst den Endboss Kriegsfürstin Zaela bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37237_Note"] = "Nur im heroischen Modus.  Die abgestoßene Drachenklaue ist vor dem Tor in dem Raum wo Du gegen Kommandant Tharbek "..YELLOW.."[3]"..PREV.." kämpfst.\n\nDu musst den Endboss Kriegsfürstin Zaela bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_37179_Note"] = "Nur im heroischen Modus.  Der eiserne Miniaturstern ist im großen Raum bevor Du zum Endboss gelangst bei den Koordinaten "..YELLOW.."34.3, 54.2"..PREV..".\n\nDu musst den Endboss Kriegsfürstin Zaela bei "..YELLOW.."[5]"..PREV.." besiegen, um diese Quest abzuschließen.";
...
L["Quest_39500_Location"] = "Erzmagier Khadgar (Höllenfeuerzitadelle "..BLUE.."EINGANG"..PREV..")";
...
L["Quest_39501_Location"] = "Erzmagier Khadgar (Höllenfeuerzitadelle "..BLUE.."EINGANG"..PREV..")";
...
L["Quest_39830_Location"] = "Mama Buddel (Dalaran; "..YELLOW.."46.2, 26.4"..PREV..")";
...
L["Quest_44400_Location"] = "Leutnant Sinclari (Dalaran - Die Violette Festung; "..YELLOW.."66.3, 68.0"..PREV..")";
...
L["Quest_40878_Location"] = "Didi Biegezange (Dalaran - Handelsmarkt der Magier; "..YELLOW.."38.6, 25.0"..PREV..")";
...
L["Quest_44887_Location"] = "Erzmagier Khadgar (Dalaran - Violette Zitadelle; "..YELLOW.."28.8, 48.6"..PREV..")";
...
L["Quest_38965_Location"] = "Wache der Violetten Festung (Dalaran - Die Violette Festung; "..YELLOW.."65.2, 67.4"..PREV..")";
...
L["Quest_43487_Location"] = "Delas Mondfang (Dalaran - Netherlichttempel "..YELLOW.."44.8, 22.7"..PREV..")";
...
L["Quest_43506_Location"] = "Odyn (Himmelsfeste; "..YELLOW.."58.4, 82.8"..PREV..")";
L["Quest_43506_Note"] = "Kriegerquest.  Diese bekommst Du nach Abschluß der Quest Dämonische Runen.  Lord Kur'talos Rabenkrone und Dantalionax sind die letzen Bosse der Instanz, bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_40559_Location"] = "Jonas Timotheus (Dalaran; "..YELLOW.."39.8, 35.0"..PREV..")";
...
L["Quest_43493_Location"] = "Lord Grayson Schattenbruch (Östliche Pestländer - Das Sanktum des Lichts; "..YELLOW.."76.8, 50.8"..PREV..")";
...
L["Quest_42678_Location"] = "Valeera Sanguinar (Dalaran - Die Halle der Schatten; "..YELLOW.."42.2, 77.0"..PREV..")";
...
L["Quest_42098_Location"] = "Ritssyn Flammengroll (Schreckensnarbe; "..YELLOW.."55.6, 37.2"..PREV..")";
...
L["Quest_43314_Location"] = "Erste Arkanistin Thalyssra (Suramar - Meredii; "..YELLOW.."36.4, 46.8"..PREV..")";
L["Quest_43314_Note"] = "Berater Melandrus ist bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_40882_Location"] = "Hobart Wurfhammer (Dalaran; "..YELLOW.."38.6, 26.2"..PREV..")";
L["Quest_40882_Note"] = "Ingineursquest.  Der arkane Kompressor droppt vom Patrouillenoffizier Gerdo  bei "..YELLOW.."[1]"..PREV..".";
...
L["Quest_38799_Location"] = "Teufelsschmiedin Nal'ryssa (Suramar; "..YELLOW.."30.0, 53.4"..PREV..")";
L["Quest_38799_Note"] = "Bergbauquest. Der Siegelring droppt vom Schemen von Xavius bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_40567_Location"] = "Tyrande Wisperwind (Val'sharah - Der Tempel der Elune; "..YELLOW.."53.6, 55.8"..PREV..")";
L["Quest_40567_Note"] = "Diese Quest bekommst Du nach Beendigung der Questreihe von Ysera und Malfurion.  Das Schemen von Xavius ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_39882_Location"] = "Nalamya (Val'sharah - Tempel von Elune; "..YELLOW.."54.4, 57.6"..PREV..")";
L["Quest_39882_Note"] = "Verzauberungsquest.  Die Questreihe startet mit der Quest 'Elementare Kräfte' und 'Nichts verschwenden', beide bekommst Du von Guron Zweischwanz (Hochberg - Donnertotem; "..YELLOW.."44.4, 44.2"..PREV.."). Erzdruide Glaidalis ist der erste Boss.  Diese Quest kannst Du beenden auf Normale und Heroische Schwierigkeit.  Die Belohnung lehrt Dich 'Seegen des Plünderes'.";
...
L["Quest_41169_Location"] = "Brann Bronzebart (Val'sharah; "..YELLOW.."61.2, 87.9"..PREV..")";
...
L["Quest_43572_Location"] = "Salanar der Reiter (Schwarze Festung; "..YELLOW.."98.8, 59.2"..PREV..")";
...
L["Quest_44076_Location"] = "Schimmer von Aessina (Smaragdgrüne Traumpfad; "..YELLOW.."40.8, 58.6"..PREV..")";
L["Quest_44076_Note"] = "Druidenkampagne.  Normale oder Heroische Schwierigkeit.  Die Essenz des Nachwachsens droppt vom zweiten Boss, Eichenherz.  Dann besiegt das Schmen von Xavius um die Quest zu beenden.  Gebe die Quest ab bei Bewahrer Remulos im Hain der Träume ; "..YELLOW.."44.8, 50.6"..PREV..".";
...
L["Quest_42654_Location"] = "Halduron Wolkenglanz (Hochberg - Volltrefferhütte; "..YELLOW.."42.8, 6.0"..PREV..")";
...
L["Quest_38286_Location"] = "Prinz Farondis (Aszuna - Das Wegekreuz; "..YELLOW.."61.6, 41.0"..PREV..")";
...
L["Quest_42213_Location"] = "Golganneths Gezeitenstein (Azsharas Zorn; "..YELLOW.."[5]"..PREV..")";
...
L["Quest_40668_Location"] = "Senegos (Azsuna - Azurschwingen Rast; "..YELLOW.."48.2, 25.6"..PREV..")";
L["Quest_40668_Note"] = "Diese Quest kann nur auf dem Schwierigkeitsgrad Mythisch erledigt werden.   Dies ist ein Teil der Artefaktwaffe Questreihe.  Das Herz von Zin'Azshari droppt vom Endboss, bei "..YELLOW.."[5]"..PREV..".";
...
L["Quest_43378_Location"] = "Yalia Weisenwisper (Azsuna; "..YELLOW.."47.0, 44.0"..PREV..")";
...
L["Quest_44282_Location"] = "Amal'thazad (Schwarze Festung; "..YELLOW.."57.8, 31.8"..PREV..")";
...
L["Quest_44077_Location"] = "Avatar von Aviana (Smaragdgrüne Traumpfad; "..YELLOW.."30.6, 51.6"..PREV..")";
...
L["Quest_42707_Location"] = "Erzmagier Khadgar (Hallen des Wächters; "..YELLOW.."71.4, 56.0"..PREV..")";
...
L["Quest_42984_Location"] = "Elementaristin Janai (Der Mahlstrom; "..YELLOW.."29.4, 77.4"..PREV..")";
...
L["Quest_41059_Location"] = "Melba (Hallen der Tapferkeit; "..YELLOW.."??"..PREV..")";
L["Quest_41059_Note"] = "Mönchquest.  Odyns Kessel ist im Herzen der Feste, ein Zimmer mit langen Tischen.  Die Quest bringt dich zu Eisenkörper Ponshu (Wandernde Insel - Tempel der fünf Sonnenaufgänge; "..YELLOW.."51.4, 48.6"..PREV..").";
...
L["Quest_40072_Location"] = "Havi (Sturmheim - Die Hallen der Tapferkeit; "..YELLOW.."70.2, 69.2"..PREV..")";
L["Quest_40072_Note"] = "Besiegt die Aegis von Aggramar am Ende der Instant bei "..YELLOW.."[5]"..PREV..".  Wenn Du die Instant verlässt bevor Du die Aegis bestiegen hast, musst Du die Instant von vorne beginnen.";
...
L["Quest_43349_Location"] = "Die Aegis von Aggramar (Die Hallen der Tapferkeit; "..YELLOW.."[5]"..PREV..")";
...
L["Quest_40877_Location"] = "Hobart Wurfhammer (Dalaran; "..YELLOW.."38.4, 25.0"..PREV..")";
L["Quest_40877_Note"] = "Ingenieursquest.  Wird nach Abschluss anderer Ingenieursquesten zugänglich.  Odyn ist der Endboss bei "..YELLOW.."[5]"..PREV..".  Die Belohnung lehrt Dir eine neue Ingenieursvorlage.";
...
L["Quest_45422_Note"] = "Karazhan Einstimmungsquestreihe.  Benötigt Mythisch oder Mythisch+ Schwierigkeit.  Gottkönig Skovald ist bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_44886_Note"] = "Karazhan Einstimmungsquestreihe.  Erzmagier Khadgar ist in Dalaran - Violette Zitadelle; "..YELLOW.."28.8, 48.6"..PREV..".";
...
L["Quest_39904_Location"] = "Tigrid die Verzaubernde (Sturmheim; "..YELLOW.."39.4, 42.6"..PREV..")";
...
L["Quest_43377_Location"] = "Alonsus Faol (Netherlichttempel; "..YELLOW.."51.2, 48.4"..PREV..")";
...
L["Quest_40561_Location"] = "Jonas Timotheus (Dalaran; "..YELLOW.."39.8, 35.0"..PREV..")";
...
L["Quest_38974_Location"] = "Leyweberin Tellumi (Sturmheim; "..YELLOW.."65.6, 56.2"..PREV..")";
...
L["Quest_44075_Location"] = "Echo von Ashamane (Smaragdgrüne Traumpfad; "..YELLOW.."31.2, 36.8"..PREV..")";
L["Quest_44075_Note"] = "Druidenquest.  Normale oder Heroische Schwierigkeit.  Fenryr ist der dritte Boss.  Beende die Dungeon um die Quest abzuschließen.   Diese Quest bringt dich zu Bewahrer Remulos im Smaragdgrünen Traumpfad bei; "..YELLOW.."44.8, 50.6"..PREV..".";
...
L["Quest_43586_Location"] = "Odyn (Die Himmelsfeste; "..YELLOW.."58.4, 82.8"..PREV..")";
L["Quest_43586_Note"] = "Kriegerquest. Teil der Ordenshallenquestreihe. Helya ist der Endboss bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_43604_Location"] = "Droppt vom König Ymiron (Der Seelenschlund; "..YELLOW.."[1]"..PREV..")";
L["Quest_43604_Note"] = "Kriegerquest. Kehrt zu Odyn zurück (Die Himmelsfeste; "..YELLOW.."58.4, 82.8"..PREV..").  Die Belohung ist Ymiron als Begleiter in deiner Ordenshalle.";
...
L["Quest_43253_Location"] = "Valeera Sanguinar (Dalaran - Ordenshalle der Schurken; "..YELLOW.."40.6, 76.0"..PREV..")";
...
L["Quest_43596_Location"] = "Havi (Sturmheim - Valdisdall; "..YELLOW.."60.2, 50.8"..PREV..")";
L["Quest_43596_Note"] = "Helya ist der Endboss in der Seelenschmiede bei "..YELLOW.."[3]"..PREV..".";
...
L["Quest_38532_Location"] = "Barm Steinbrecher (Hochberg; "..YELLOW.."55.2, 84.2"..PREV..")";
...
L["Quest_40560_Location"] = "Jonas Timotheus (Dalaran; "..YELLOW.."39.8, 35.0"..PREV..")";
...
L["Quest_43574_Location"] = "Salanar der Reiter (Schwarze Festung; "..YELLOW.."98.8, 59.2"..PREV..")";
...
L["Quest_39781_Location"] = "Mayla Hochberg (Hochberg - Donnertotem; "..YELLOW.."52.5, 65.8"..PREV..")";
L["Quest_39781_Note"] = "Der Hammer von Khaz'goroth ist hinter dem Endboss bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_42454_Location"] = "Hammer von Khaz'goroth (Neltharions Hort; "..YELLOW.."[]"..PREV..")";
...
L["Quest_41188_Location"] = "Lessah Mondwasser (Hochberg - Donnertotem; "..YELLOW.."45.8, 44.4"..PREV..")";
L["Quest_41188_Note"] = "Archäologiequest. Das Artefakt ist im Raum vom Endboss bei "..YELLOW.."[4]"..PREV..".";
...
L["Quest_43571_Location"] = "Salanar der Reiter (Schwarze Festung; "..YELLOW.."98.8, 59.2"..PREV..")";
...
L["Quest_44074_Location"] = "Sohn von Ursoc (Smaragdgrüne Traumpfad; "..YELLOW.."34.4, 62.0"..PREV..")";
L["Quest_44074_Note"] = "Druidenquest.  Normale oder Heroische Schwierigkeit.  Die Essenz der Hartnäckigkeit droppt vom ersten Boss.  Beende die Dungeon um die Quest abzuschließen.   Die Quest bringt dich zurück zum Bewahrer Remulos im Hain der Träume; "..YELLOW.."44.8, 50.6"..PREV..".";

L["Quest_42990_Name"] = "Das irdene Amulett";
L["Quest_42990_Objective"] = "Holt das irdene Amulett von Dargrul dem Unterkönig zurück.";
L["Quest_42990_Location"] = "Elementaristin Janai (Der Mahlstrom; "..YELLOW.."29.4, 77.4"..PREV..")";
...
L["Quest_42491_Location"] = "Arkanistin Valtrois (Suramar - Shal'aran; "..YELLOW.."37.0, 46.2"..PREV..")";
...
L["Quest_44486_Location"] = "Teufelsversehrter Foliant (Das Verlies der Wächterinnen - Kärker des Verräters; "..YELLOW.."[5]"..PREV..")";
L["Quest_44486_Note"] = "Kehrt zurück zu Robert Newhearth in Dalaran - Die Violette Zitadelle ("..YELLOW.."25.6, 45.0"..PREV..").";
...
L["Quest_39341_Note"] = "Alchemiequest.  Nimm eine Portion Skaggldrynk mit Dir.  Wird von einem Alchemisten hergestellt.  Töte die ersten beiden Bosse und benutze dann den Tiegel hinter Inquisitor Foltyrium "..YELLOW.."[2]"..PREV.." Nähe der Tür.  Die Tür öffnet sich und Du kannst dann Grimoira töten.";
...
L["Quest_39343_Location"] = "Grimoira (Das Verlies der Wächterinnen; "..YELLOW.."[2]"..PREV..")";
L["Quest_39343_Note"] = "Alchemiequest.  Nach der Tötung von Grimoira hinter der geheimen Tür, wirst Du dies Quest von Grimoira erhalten.  Diese bringt Dich zurück zu Deucus Valdera in Dalaran ("..YELLOW.."41.4, 32.8"..PREV..").";
...
L["Quest_41630_Location"] = "Abbild von Kalec (Dalaran; "..YELLOW..""..PREV..")";
...
L["Quest_44286_Location"] = "Lord Thorval (Eiskronen Zitadelle; "..YELLOW.."52.6, 14.6"..PREV..")";
...
L["Quest_42752_Location"] = "Belath Dämmerklinge (Mardum, Die Teufelshammer; "..YELLOW.."57.6, 53.4"..PREV..")";
...
L["Quest_42660_Location"] = "Kira Zornseele (Schreckensnarbe; "..YELLOW.."56.0, 35.4"..PREV..")";
...
L["Quest_44283_Location"] = "Malfurion Sturmgrimm (Der Smaragdgrüne Alptraum; "..GREEN.."[1']"..PREV..")";
L["Quest_44283_Note"] = "Besiege Cenarius bei "..YELLOW.."[6]"..PREV.." um eine Essenz der Klarheit zu sammeln.  Nach dem sammeln von 4 Essenzen, kannst du bei Malfurion die Fähigkeit einschalten alle Bosse zu überspringen und gleich zu Cenarius zu gelangen.";
...
L["Quest_44284_Location"] = "Malfurion Sturmgrimm (Der Smaragdgrüne Alptraum; "..GREEN.."[1']"..PREV..")";
L["Quest_44284_Note"] = "Besiege Cenarius bei "..YELLOW.."[6]"..PREV.." um eine Essenz der Klarheit zu sammeln.  Nach dem sammeln von 4 Essenzen, kannst du bei Malfurion die Fähigkeit einschalten alle Bosse zu überspringen und gleich zu Cenarius zu gelangen.";
...
L["Quest_44285_Location"] = "Malfurion Sturmgrimm (Der Smaragdgrüne Alptraum; "..GREEN.."[1']"..PREV..")";
L["Quest_44285_Note"] = "Besiege Cenarius bei "..YELLOW.."[6]"..PREV.." um eine Essenz der Klarheit zu sammeln.  Nach dem sammeln von 4 Essenzen, kannst du bei Malfurion die Fähigkeit einschalten alle Bosse zu überspringen und gleich zu Cenarius zu gelangen.";
...
L["Quest_43362_Location"] = "Talwandler Farodin (Suramar; "..YELLOW.."36.8, 46.6"..PREV..")";
L["Quest_43362_Note"] = "Die geläuterte Lebensessenzen drppen von Xavius bei "..YELLOW.."[7]"..PREV..".  Um diese Quest machen zu können musst Du vorher 7000 Rufpunkte auf Respektvoll gesammelt haben bei der Fraktion Die Nachtsüchtigen.";
...
L["Quest_40042_Location"] = "Kuhuine Sanftschreiter (Dalaran; "..YELLOW.."42.8, 33.8"..PREV..")";
...
L["Quest_40159_Location"] = "Kondal Jägerschwur (Dalaran; "..YELLOW.."35.8, 28.6"..PREV..")";
...
L["Quest_42432_Location"] = "Rensar Großhuf (Der Hain der Träume; "..YELLOW.."44.8, 51.4"..PREV..")";
...
L["Quest_43520_Location"] = "Ermagier Kalec (Azsuna; "..YELLOW.."48.0, 25.6"..PREV..")";
...
L["Quest_45381_Location"] = "Erste Arkanistin Thalyssra (Die Nachtfestung; "..BLUE.."Eingang [A]"..PREV..")";
L["Quest_45381_Note"] = "Großmagistrix Elisande ist bei "..YELLOW.."[9]"..PREV..".  Wenn du diese Quest beendest, kannst du die ersten Bosse im Raid überspringen.";
...
L["Quest_45382_Location"] = "Erste Arkanistin Thalyssra (Die Nachtfestung; "..BLUE.."Eingang [A]"..PREV..")";
L["Quest_45382_Note"] = "Großmagistrix Elisande ist bei "..YELLOW.."[9]"..PREV..".  Wenn du diese Quest beendest, kannst du die ersten Bosse im Raid überspringen.";
...
L["Quest_45383_Location"] = "Erste Arkanistin Thalyssra (Die Nachtfestung; "..BLUE.."Eingang [A]"..PREV..")";
L["Quest_45383_Note"] = "Großmagistrix Elisande ist bei "..YELLOW.."[9]"..PREV..".  Wenn du diese Quest beendest, kannst du die ersten Bosse im Raid überspringen.";
...
L["Quest_45159_Location"] = "Droppt von Chronomatische Anomalie (Die Nachtfestung; "..YELLOW.."[2]"..PREV..")";
L["Quest_45159_Note"] = "Die Chance, dass dies von der Chronomatischen Anomalie droppt ist sehr gering.  Dies kann auf jeder Schwierigkeitsstufe droppen.  Bringe dies zu Dariness die Gelehrte in (Dalaran - Handelsmarkt der Magier; "..YELLOW.."40.8, 26.2"..PREV..").";
L["Quest_45159_FollowQuest"] = "Kubische Ströme";

L["Quest_45417_Name"] = "Herr des Schattenrats";
L["Quest_45417_Objective"] = "Besiegt Gul'dan.";
L["Quest_45417_Location"] = "Gul'dan ist der Endboss bei (Die Nachtfestung; "..YELLOW.."[10]"..PREV..")";
...
L["Quest_44735_Location"] = "Erzmagier Khadgar (Gebirgspass der Totenwinde - Karazhan; "..YELLOW.."47.0, 75.4"..PREV..")";
L["Quest_44735_Note"] = "Viz'aduum der Beobchter ist bei "..YELLOW.."[10]"..PREV..".  Erzmagier Khadgar erscheint nachdem der Boss besiegt wurde um die Quest dann abgeben zu können.";
...
L["Quest_44734_Location"] = "Erzmagier Khadgar (Gebirgspass der Totenwinde - Karazhan; "..YELLOW.."47.0, 75.4"..PREV..")";
...
L["Quest_45291_Location"] = "Magier Darius (Gebirgspass der Totenwinde - Karazhan; "..YELLOW.."47.0, 75.4"..PREV..")";
L["Quest_45291_Note"] = "";
...
L["Quest_45292_Note"] = "The Box of Spare Motivator Crystals is in the back left side of the room after defeating the Curator, at "..YELLOW.."[6]"..PREV..".";
...
L["Quest_45295_Note"] = "Nach Beendigung der Quest, töte Schrecken der Nacht bei "..YELLOW.."[]"..PREV.." und nehme den Gegenstandand von ihm, um die nächste Quest zu starten.";
...
L["Quest_44917_Note"] = "Viz'aduum den Beobachter ist bei "..YELLOW.."[10]"..PREV..".  Diese Quest kannst Du nach der Beendigung in Deiner Ordenshalle abgeben.";
...
L["Quest_45238_Location"] = "Dariness die Gelehrte (Dalaran - Handelsmarkt der Magier; "..YELLOW.."40.8, 26.2"..PREV..")";
L["Quest_45238_Note"] = "Der Manaschlinger ist bei "..YELLOW.."[??]"..PREV..".";
...
L["Quest_44741_Location"] = "Leyweber Tytallo (Suramar; "..YELLOW.."40.4, 69.4"..PREV..")";
...
L["Quest_44729_Location"] = "Havi (Sturmheim - Valdisdall; "..YELLOW.."60.2, 50.8"..PREV..")";
L["Quest_44729_Note"] = "Besiege Odyn bei "..YELLOW.."[3]"..PREV.." um seine Gunst zu erlangen und diese Quest zu beenden.  Kann auf jeder Schwierigkeit abgeschlossen werden.";
...
L["Quest_44868_Location"] = "Odyn (Prüfung der Tapferkeit; "..YELLOW.."[3]"..PREV..")";
L["Quest_44868_Note"] = "Helya ist bei "..YELLOW.."[5]"..PREV..".  Kann auf jeder Schwierigkeit abgeschlossen werden.";
...
L["Quest_45088_Location"] = "Odyn (Prüfung der Tapferkeit; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_45176_Location"] = "Allari die Seelenfresserin (Azsuna - Verteidigungsposten der Illidari; "..YELLOW.."43.2, 43.2"..PREV..")";
...
L["Quest_46805_Location"] = "Prophet Velen (Die Verherrten Küste - Die Retterklippe; "..YELLOW.."44.5, 63.3"..PREV..")";
...
L["Quest_46253_Location"] = "Erzmagier Khadgar (Die Verherrten Küste - Die Retterklippe; "..YELLOW.."44.6, 63.3"..PREV..")";
L["Quest_46253_Note"] = "";
...
L["Quest_47114_Location"] = "Kommandant Kammerer (Die Retterklippe; "..YELLOW.."44.6, 63.2"..PREV..")";
...
L["Quest_46244_Location"] = "Erzmagier Khadgar (Die Verherrten Küste - Die Retterklippe;"..YELLOW.."44.8, 63.2"..PREV..")";
...
L["Quest_49077_Note"] = "Nachdem Argus besiegt wurde wirst du zu einer Version der Vendikaar telepotiert im Schlachtzug.  Die Kristalle sind am selben Ort in der mitte des Schiffs.  Es erscheint auf jedem Schwierigkeitsgrad.\nMalfurion Sturmgrimm ist bei Val'sharah - Lorlathil ("..YELLOW.."54.68, 72.84"..PREV..").  Tyrande Wisperwind ist bei Val'sharah - Tempel von Elune ("..YELLOW.."53.68, 55.89"..PREV..").  Die Quest wird abgeschlossen in Mount Hyjal bei "..YELLOW.."61.30, 28.09"..PREV..".";
...
L["Quest_49901_Location"] = "König Rastakhan (Zuldazar; "..YELLOW.."42.6, 37.6"..PREV..")";
L["Quest_49901_Note"] = "Teil der Questreihe vom 'Marsch der Loas'.  Kann auf Normal oder Heroisch abgeschlossen werden.  Yazma ist der Endboss.  Gebe die Quest bei Prinzessin Talanji (Dazar'alor bei - "..YELLOW.."40.6, 69.0"..PREV..") ab.";
...
L["Quest_51516_Location"] = "Prinzessin Talanji (Zuldazar; "..YELLOW.."43.8, 39.4"..PREV..")";
...
L["Quest_52148_Location"] = "Finn Schönwind (Tiragadesund - Die Wachkuppe; "..YELLOW.."56.4, 61.6"..PREV.."), die Questabgabe erfolgt in (Boralus- Die Aschenwinddocks; "..YELLOW.."67.6, 22.2"..PREV..").";
...
L["Quest_50825_Location"] = "Bruder Pike (Sturmsangtal - Der Schrein des Sturms; "..YELLOW.."78.2, 28.8"..PREV..")";
...
L["Quest_52510_Location"] = "Bruder Pike (Sturmsangtal - Der Schrein des Sturms; "..YELLOW.."78.2, 28.8"..PREV.."), die Questabgabe erfolgt in Dungeon beim Endbosswq.";
...
L["Quest_53128_Note"] = "Gebe die Quest bei Kayla Mills (Sturmwind - Burg Sturmwind; "..YELLOW.."85.8, 24.0"..PREV..") ab.";
...
L["Quest_52153_Location"] = "Katherine Prachtmeer (Boralus - Burg Prachtmeer; "..YELLOW.."44.8, 62.6"..PREV..")";
L["Quest_52153_Note"] = "Dies ist die letze Quest der Questreihe von 'Der Stolz von Kul'Tiras'.   Die Quest bringt Dich zu Taelia (Boralus; "..YELLOW.."68.0, 22.0"..PREV..").";
...
L["Quest_53127_Note"] = "Gebe die Quest bei Isabella (Ogrimmar - Das Tal der Stärke; "..YELLOW.."44.0, 71.6"..PREV..") ab.";
...
L["Quest_53351_Location"] = "Moira Thaurissan (Sturmwind - ; "..YELLOW.."52.0, 13.8"..PREV..")";
...
L["Quest_53437_Location"] = "Handelsprinz Gallywix (Drustvar - ; "..YELLOW.."37.2, 27.0"..PREV..").";
...
L["Quest_51302_Location"] = "Titanenhüter Hezrel (Nazmir; "..YELLOW.."51.8, 65.8"..PREV..")";
L["Quest_51302_Note"] = "Dies ist Teil der 'Das Finstere Herz von Nazmir' Questreihe.  Die Quest endet bei Rokhan (Nazmir; "..YELLOW.."39.2, 78.8"..PREV..").";
...
L["Quest_52800_Location"] = "Carsten Jammerthal (Boralus - Hafenmeisterbüro; "..YELLOW.."68.0, 22.0"..PREV..")";
...
L["Quest_50990_Note"] = "Bringt das köstlichen Hühnchen zu Glotz Widrikus in (Schlingendornkap - Beutebucht; "..YELLOW.."28.2, 76.2"..PREV..")";
...
L["Quest_50639_Location"] = "Luzilla Kronsteig (Drustvar - Das Kronsteiganwesen; "..YELLOW.."32.8, 15.4"..PREV.."), die Questabgabe erfolgt in (Drustvar - Aroms Wehr; "..YELLOW.."36.0, 51.2"..PREV..").";
...
L["Quest_52486_Location"] = "Ulfar (Drustvar - Ulfars Höhle; "..YELLOW.."45.2, 45.8"..PREV.."), die Questabgabe erfolgt in (Drustvar - Aroms Wehr; "..YELLOW.."36.0, 51.2"..PREV..").";
...
L["Quest_54485_Location"] = "Halford Wyrmbann (Boralus - Die Aschenwinddocks; "..YELLOW.."69.4, 27.0"..PREV..").";
...
L["Quest_54282_Location"] = "Prinzessin Talanji (Zuldazar - ; "..YELLOW.."58.0, 21.2"..PREV..").";
L["Quest_54282_Note"] = "Besiege den Endboss und gebe die Quest bei Nathanos Pestrufer in (Dazar'alor - Der Grosse Basar; "..YELLOW.."58.4, 62.6"..PREV..") ab.";
...
L["Quest_54682_Location"] = "Xal'atath, Klinge des Schwarzen Imperiums (Sturmsangtal - Die Tiegel der Stürme; "..YELLOW.."??.?, ??.?"..PREV..").";
L["Quest_54682_Note"] = "Besiege den Endboss und gebe die Quest bei König Anduin Wrynn in (Sturmwind - Burg Sturmwind; "..YELLOW.."85.6, 31.8"..PREV..") ab.";
...
L["Quest_54683_Location"] = "Xal'atath, Klinge des Schwarzen Imperiums (Sturmsangtal - Die Tiegel der Stürme; "..YELLOW.."??.?, ??.?"..PREV..").";
L["Quest_54683_Note"] = "Besiege den Endboss und gebe die Quest bei Fürstin Sylvanas Windläufer in (Ogrimmar - Tal der Stärke; "..YELLOW.."48.4, 71.6"..PREV..") ab.";
...
L["Quest_56358_Location"] = "Lady Jaina Prachtmeer (Nazjatar - ; "..YELLOW.."50.4, 24.0"..PREV..").";
L["Quest_56358_Note"] = "Besiege den Endboss und gebe die Quest bei Lady Jaina Prachtmeer in ((Nazjatar - ; "..YELLOW.."50.4, 24.0"..PREV..") ab.";
...
L["Quest_56348_Location"] = "Ausbilder Ulooaka (Naz'jatar - Mezzamere; "..YELLOW.."38.0, 53.0"..PREV..")";
...
L["Quest_56349_Location"] = "Ausbilder Ulooaka (Naz'jatar - Mezzamere; "..YELLOW.."38.0, 53.0"..PREV..")";
...
L["Quest_56356_Note"] = "Besiege den Endboss und gebe die Quest bei Lor'themar Theron in (Nazjatar - ; "..YELLOW.."50.4, 24.0"..PREV..") ab.";
...
L["Quest_56352_Location"] = "Rolm (Naz'jatar - Neuheim; "..YELLOW.."49.2, 61.8"..PREV..")";
...
L["Quest_56351_Location"] = "Rolm (Naz'jatar - Neuheim; "..YELLOW.."49.2, 61.8"..PREV..")";
...
L["Quest_55609_Location"] = "Prinz Erazmin (Mechagon - Der Rostbolzen; "..YELLOW.."74.0, 36.8"..PREV..").";
...
L["Quest_58632_Location"] = "Magni Bronzebeard (Silithus - Herzkammer; "..YELLOW.."48.0, 61.1"..PREV..")";
...
L["Quest_60253_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60253_Note"] = "";
...
L["Quest_60057_Location"] = "Jüngerin Artemede (Bastion; "..YELLOW.."40.8, 55.2"..PREV..")";
L["Quest_60057_Note"] = "Quest bringht Dich zurück zu Kalisthene in (Bastion; "..YELLOW.."51.0, 46.8"..PREV..").";
...
L["Quest_60251_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60251_Note"] = "";
...
L["Quest_60254_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60254_Note"] = "";
...
L["Quest_60256_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60256_Note"] = "";
...
L["Quest_60250_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60250_Note"] = "";
...
L["Quest_60255_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60255_Note"] = "";
...
L["Quest_60252_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60252_Note"] = "";
...
L["Quest_60257_Location"] = "Ta'lan der Antiquar (Oribos; "..YELLOW.."51.2, 44.2"..PREV..")";
L["Quest_60257_Note"] = "";
...
L["Quest_30567_Location"] = "Gurgthock (Kun-Lai-Gipfel - Tempel des Weißen Tigers; "..YELLOW.."68.6, 48.4"..PREV..")";
...
L["Quest_31207_Location"] = "Gurgthock (Kun-Lai-Gipfel - Tempel des Weißen Tigers; "..YELLOW.."68.6, 48.4"..PREV..")";
...
L["Quest_31611_Location"] = "Braumeister Boof (Kun-Lai-Gipfel - Binan; "..YELLOW.."72.6, 93.0"..PREV..")";
...
L["Quest_31613_Location"] = "Braumeister Tzu  (Jadewald - Morgenblüte; "..YELLOW.."47.4, 37.0"..PREV..")";
...
L["Quest_31058_Location"] = "Braumeister Bo (Krasarangwildnis - Nayelilagune; "..YELLOW.."52, 76.8"..PREV..")";
...
L["Quest_32248_Location"] = "Quest startet automatisch (Krasarangwildnis - Löwenlandung; "..YELLOW.."98.2, 33.1"..PREV..")";
...
L["Quest_32251_Location"] = "Quest startet automatisch (Krasarangwildnis - Herrschaftsfeste; "..YELLOW.."10.6, 53.3"..PREV..")";
...
L["Quest_7162_Location"] = "Leutnant Haggerdin (Vorgebirge des Hügellands; "..YELLOW.."44.6, 46.2"..PREV..")";
L["Quest_7162_Note"] = "Das Banner der Sturmlanzen ist in der Eisschwingenhöhle bei (Alteractal - Nord; "..RED.."[3]"..PREV.."). Spreche später mit dem selben NPC wenn du eine Stufe des Rufs erhalten hast um ein höheres Abzeichen der Sturmlanzen zu bekommen.";
...
L["Quest_7141_Location"] = "Ausgrabungsleiter Steinhauer (Vorgebirge des Hügellands; "..YELLOW.."45.2, 45.2"..PREV..") und\n(Alteractal - Nord; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "Drek'thar ist bei (Alteractal - Süd; "..BLUE.."[B]"..PREV.."). Er muß nicht unbedingt sterben um die Quest zu beenden. Das Schlachtfeld muß von Deiner Seite her erfolgreich gewonnen werden.\nNach Abgabe der Quest spreche den NPC wieder an um die Belohnung zu erhalten.";
...
L["Quest_7121_Location"] = "Gebirgsjäger Donnerbrüll (Alteractal - Nord; "..YELLOW.."Nähe [3] vor der Brücke"..PREV..")";
L["Quest_7121_Note"] = "Der Rüstmeister der Sturmlanzen ist bei "..GREEN.."[4']"..PREV.." und versorgt Dich mit weiteren Quests.";
...
L["Quest_6982_Location"] = "Rüstmeister der Sturmlanzen (Alteractal - Nord; "..GREEN.."[4']"..PREV..").";
L["Quest_6982_Note"] = "Die Vorräte können in der Eisbeißermine gefunden werden bei (Alteractal - Süd; "..GREEN.."[1]"..PREV..").";
...
L["Quest_5892_Location"] = "Rüstmeister der Sturmlanzen (Alteractal - Nord; "..GREEN.."[4']"..PREV..").";
L["Quest_5892_Note"] = "Die Vorräte können in der Eisentiefenmine gefunden werden bei (Alteractal - Nord; "..GREEN.."[1]"..PREV..").";

L["Quest_7223_Name"] = "Rüstungsfetzen";
L["Quest_7223_Objective"] = "Bringt Murgot Tiefenschmied in Dun Baldar 20 Rüstungsfetzen.";
L["Quest_7223_Location"] = "Murgot Tiefenschmied (Alteractal - Nord; "..GREEN.."[2']"..PREV..")";
...
L["Quest_7122_Location"] = "Unteroffizier Durgen Sturmlanze (Vorgebirge des Hügellands; "..YELLOW.."43.0, 43.8"..PREV..")";
L["Quest_7122_Note"] = "Um diese Quest abzuschließen mußt Du entweder Morloch in der Eisentiefenmine bei (Alteractal - Nord; "..GREEN.."[1]"..PREV..") töten oder Taskmaster Snivvle in der Eisbeißermine bei (Alteractal - Süd; "..GREEN.."[1]"..PREV..") töten wenn diese unter der Kontrolle der Horde ist.";
...
L["Quest_7102_Location"] = "Unteroffizier Durgen Sturmlanze (Vorgebirge des Hügellands; "..YELLOW.."43.0, 43.8"..PREV..")";
...
L["Quest_7081_Location"] = "Unteroffizier Durgen Sturmlanze (Vorgebirge des Hügellands; "..YELLOW.."43.0, 43.8"..PREV..")";
...
L["Quest_7027_Location"] = "Stallmeister der Sturmlanzen (Alteractal - Nord; "..GREEN.."[3']"..PREV..")";
...
L["Quest_7026_Location"] = "Kommandant der Sturmlanzenwidderreiter (Alteractal - Nord; "..GREEN.."[6']"..PREV..")";
...
L["Quest_7386_Location"] = "Erzdruide Renferal (Alteractal - Nord; "..GREEN.."[1']"..PREV..")";
L["Quest_7386_Note"] = "Nachdem 200 Sturmkristalle abgeliefert wurden beginnt Erzdruide Renferal nach (Alteractal - Nord; "..GREEN.."[7']"..PREV..") zu laufen. Dort angekommen, beginnt er ein Ritual, wobei 10 Spieler assistieren müssen. Wenn erfolgreich, wird Ivus der Waldfürst dazu aufgefordert, in der Schlacht zu helfen.";
...
L["Quest_6881_Location"] = "Erzdruide Renferal (Alteractal - Nord; "..GREEN.."[1']"..PREV..")";
L["Quest_6881_Note"] = "Nachdem 200 Sturmkristalle abgeliefert wurden beginnt Erzdruide Renferal nach (Alteractal - Nord; "..GREEN.."[7']"..PREV..") zu laufen. Dort angekommen, beginnt er ein Ritual, wobei 10 Spieler assistieren müssen. Wenn erfolgreich, wird Ivus der Waldfürst dazu aufgefordert, in der Schlacht zu helfen.";
...
L["Quest_6942_Location"] = "Schwadronskommandant Erzrutsch (Alteractal - Nord; "..GREEN.."[5']"..PREV..")";
...
L["Quest_6941_Location"] = "Schwadronskommandant Vipore (Alteractal - Nord; "..GREEN.."[5']"..PREV..")";
...
L["Quest_6943_Location"] = "Schwadronskommandant Ichman (Alteractal - Nord; "..GREEN.."[5']"..PREV..")";
...
L["Quest_7161_Location"] = "Kriegsmeister Laggrond (Vorgebirge des Hügellands; "..YELLOW.."57.8, 33.4"..PREV..")";
L["Quest_7161_Note"] = "Das Banner der Frostwölfe befindet sich in der Höhle der Wildpfoten bei (Alteractal - Süd; "..RED.."[6]"..PREV.."). Spreche später mit dem selben NPC wenn du eine Stufe des Rufs erhalten hast um ein höheres Abzeichen der Frostwölfe zu bekommen.";
...
L["Quest_7142_Location"] = "Voggah Todesgriff (Vorgebirge des Hügellands; "..YELLOW.."58.6, 34.2"..PREV..")";
L["Quest_7142_Note"] = "Vanndar Sturmlanze ist bei (Alteractal - Nord; "..BLUE.."[B]"..PREV.."). Er muß nicht unbedingt sterben um die Quest zu beenden. Das Schlachtfeld muß von Deiner Seite her erfolgreich gewonnen werden.\nNach Abgabe der Quest spreche den NPC wieder an um die Belohnung zu erhalten.";
...
L["Quest_7123_Location"] = "Jotek (Alteractal - Süd; "..GREEN.."[2']"..PREV..")";
L["Quest_7123_Note"] = "Der Rüstmeister der Frostwölfe ist bei "..GREEN.."[4']"..PREV.."  und versorgt Dich mit weiteren Quests.";
...
L["Quest_5893_Location"] = "Rüstmeister der Frostwölfe (Alteractal - Süd; "..GREEN.."[4']"..PREV..")";
L["Quest_5893_Note"] = "Die Vorräte können in der Eisbeißermine gefunden werden bei (Alteractal - Süd; "..GREEN.."[1]"..PREV..").";
...
L["Quest_6985_Location"] = "Rüstmeister der Frostwölfe (Alteractal - Süd; "..GREEN.."[4']"..PREV..")";
L["Quest_6985_Note"] = "Die Vorräte können in der Eisentiefenmine gefunden werden bei (Alteractal - Nord; "..GREEN.."[1]"..PREV..").";
...
L["Quest_7224_Location"] = "Schmied Regzar (Alteractal - Süd; "..GREEN.."[2']"..PREV..")";
...
L["Quest_7124_Location"] = "Korporal Teeka Murrblut (Vorgebirge des Hügellands; "..YELLOW.."58.6, 34.2"..PREV..")";
L["Quest_7124_Note"] = "Um diese Quest abzuschließen mußt Du entweder Morloch in der Eisentiefenmine bei (Alteractal - Nord; "..GREEN.."[1]"..PREV..") töten oder Taskmaster Snivvle in der Eisbeißermine bei (Alteractal - Süd; "..GREEN.."[1]"..PREV..") töten wenn diese unter der Kontrolle der Allianz ist.";
...
L["Quest_7101_Location"] = "Korporal Teeka Murrblut (Vorgebirge des Hügellands; "..YELLOW.."58.6, 34.2"..PREV..")";
...
L["Quest_7082_Location"] = "Korporal Teeka Murrblut (Vorgebirge des Hügellands; "..YELLOW.."58.6, 34.2"..PREV..")";
...
L["Quest_7001_Location"] = "Stallmeisterin der Frostwölfe (Alteractal - Süd; "..GREEN.."[3']"..PREV..")";
...
L["Quest_7002_Location"] = "Wolfsreiterkommandant der Frostwölfe (Alteractal - Süd; "..GREEN.."[3']"..PREV..")";
...
L["Quest_7385_Location"] = "Primalist Thurloga (Alteractal - Süd; "..GREEN.."[2']"..PREV..")";
L["Quest_7385_Note"] = "Nachdem 150 abgeliefert wurden beginnt Primalist Thurloga nach (Alteractal - Süd; "..GREEN.."[1']"..PREV..") zu laufen. Dort angekommen, beginnt sie ein Ritual, wobei 10 Spieler assistieren müssen. Wenn erfolgreich, wird Lokholar der Eislord dazu aufgefordert, in der Schlacht zu helfen.";
...
L["Quest_6801_Location"] = "Primalist Thurloga (Alteractal - Süd; "..GREEN.."[2']"..PREV..")";
L["Quest_6801_Note"] = "Nachdem 150 abgeliefert wurden beginnt Primalist Thurloga nach (Alteractal - Süd; "..GREEN.."[1']"..PREV..") zu laufen. Dort angekommen, beginnt sie ein Ritual, wobei 10 Spieler assistieren müssen. Wenn erfolgreich, wird Lokholar der Eislord dazu aufgefordert, in der Schlacht zu helfen.";
...
L["Quest_6825_Location"] = "Schwadronskommandant Guse (Alteractal - Süd; "..GREEN.."[5']"..PREV..")";
...
L["Quest_6826_Location"] = "Schwadronskommandant Jeztor (Alteractal - Süd; "..GREEN.."[5']"..PREV..")";
...
L["Quest_6827_Location"] = "Schwadronskommandant Mulverick (Alteractal - Süd; "..GREEN.."[5']"..PREV..")";
...
L["Quest_11098_Location"] = "Yuula (Shattrath; "..YELLOW.."65,42"..PREV..")";
L["Quest_11098_Note"] = "Die Vorquest erhält man vom selben NPC. Das Schattenwindlager ist bei (Wälder von Terrokar - Schattenwindlager; "..YELLOW.."64.6,66.6"..PREV..").";
...
L["Quest_11008_Location"] = "Himmelsoffizier Doryn (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."65,66"..PREV..")";
...
L["Quest_11085_Location"] = "Gefangene Himmelswache (Wälder von Terokkar - Skettis; "..YELLOW.."[4]"..PREV..")";
L["Quest_11085_Note"] = "Diese Quest kann einmal täglich absolviert werden und ist erhältlich, sobald 'Nach Skettis!' abgeschlossen ist.\nDie Gefangene Himmelswache erscheint zufällig an einem der drei Punkte, die mit "..YELLOW.."[4]"..PREV.." markiert sind.  Das Quest kann als Gruppe erledigt werden.";
...
L["Quest_11093_Location"] = "Deesak der Tierführer der Himmelswache (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."63,66"..PREV..")";
...
L["Quest_11004_Location"] = "Severin (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11005_Location"] = "Himmelskommandant Adaris (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11005_Note"] = "Man muss Schattenwelt abgeschlossen haben, um das Elixier der Schatten zu erhalten, bevor man diese Quest absolvieren kann.\n\nKrallenpriester Ishaal ist bei "..YELLOW.."[5]"..PREV..", Krallenpriester Skizzik ist bei "..YELLOW.."[6]"..PREV.." und Krallenpriester Zellek ist bei "..YELLOW.."[7]"..PREV..".";
...
L["Quest_11021_Location"] = "Ishaals Almanach (droppt von Krallenpriester Ishaal; "..YELLOW.."[5]"..PREV..")";
L["Quest_11021_Note"] = "Himmelskommandant Adaris ist in den Wäldern von Terokkar - Schattenwindlager ("..YELLOW.."64,66"..PREV..").";
...
L["Quest_11024_Location"] = "Himmelskommandant Adaris (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11024_Note"] = "Rilak der Erlöste ist in Shattrath - Unteres Viertel ("..YELLOW.."52,20"..PREV..").";
...
L["Quest_11028_Location"] = "Rilak der Erlöste (Shattrath - Unteres Viertel; "..YELLOW.."52,20"..PREV..")";
L["Quest_11028_Note"] = "Himmelskommandant Adaris ist in den Wäldern von Terokkar - Schattenwindlager ("..YELLOW.."64,66"..PREV.."). Hazzik, der sich in der Nähe befindet, gibt euch die Folgequest.";
...
L["Quest_11056_Location"] = "Hazzik (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11056_Note"] = "Hazziks Päckchen ist in einer Hütte bei "..YELLOW.."[8]"..PREV..".";
...
L["Quest_11029_Location"] = "Hazzik (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11029_Note"] = "Sahaak ist bei "..YELLOW.."[3]"..PREV..". Falls irgendein Arakkoa außer Sahaak euch in der Verkleidung sieht, wird er angreifen.";
...
L["Quest_11885_Location"] = "Hazzik (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11885_Note"] = "Der Schädelhaufen ist bei "..GREEN.."[1']"..PREV..". Es droppt nur ein Questgegenstand pro Gruppe für jeden getöteten Nachfahren. Also benötigt jedes Gruppenmitglied, das diese Quest abschließen will, 10 Schriftrollen, um die Nachfahren für den Gegenstad zu beschwören. Die Qualität des Questgegenstands ist grün, also muss darum gewürftelt werden, wenn Plündern als Gruppe aktiviert ist. Diese Quest kann wiederholt werden.";
...
L["Quest_11073_Location"] = "Himmelskommandant Adaris (Wälder von Terokkar - Schattenwindlager; "..YELLOW.."64,66"..PREV..")";
L["Quest_11073_Note"] = "Terokk wird bei "..YELLOW.."[2]"..PREV.." beschworen. Bei 20% wird Terokk immun gegen alle Angriffe. Kurz danach sieht man eine blaues Rauchzeichen wo eine Bombe herabfällt. Zieht Terokk ins Feuer, um sein Schild zu brechen. Er verfällt zwar in Raserei, aber es ist wieder möglich ihn zu töten.";
