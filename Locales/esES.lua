...
L["Quest_4262_Location"] = "Jalinda Spring (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,70"..PREV..")";
L["Quest_4262_Note"] = "Gran Maestro Pyron es un elemental de fuego afuera de la mazmorra. Patrulla cerca del portal en "..YELLOW.."[24]"..PREV.." en el mapa de Las Profundidades Roca Negra en "..YELLOW.."[3]"..PREV.." en el mapa de entrada de la Montaña Roca Negra.";
...
L["Quest_4263_Location"] = "Jalinda Spring (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,69"..PREV..")";
L["Quest_4263_Note"] = "Obtienes la misión requisita de Jalinda Spring también. Encuentras a Lord Incendius en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_4341_Note"] = "La misión requisita empieza con Historiadora Real Archesonus (Forjaz; "..YELLOW.."38,55"..PREV.."). Kharan Martillazo está en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_9015_Note"] = "Misión para el conjunto de equipo de mazmorra. El Círculo de la Ley está en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_4242_Location"] = "Alguacil Windsor (Profundidades de Roca Negra; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_4264_Note"] = "Esta misión es una parte de la cadena de misiones para la armonización de Onyxia. Alguacil Windsor está en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_4282_Location"] = "Alguacil Windsor (Profundidades de Roca Negra; "..YELLOW.."[4]"..PREV..")";
L["Quest_4282_Note"] = "Esta misión es una parte de la cadena para la armonización de Onyxia. Alguacil Windsor está en "..YELLOW.."[4]"..PREV..".\nEncuentras al Señor Gólem Argelmach en "..YELLOW.."[14]"..PREV.." y a General Forjainquina en "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4134_Location"] = "Maga oscura Vivian Latumba (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
...
L["Quest_4132_Note"] = "Encuentras al General Forjira en "..YELLOW.."[13]"..PREV..". Él pedirá ayuda cuando tenga menos del 30% de salud.";
...
L["Quest_3906_Location"] = "Truenozón (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..")";
L["Quest_3906_Note"] = "Maestro supremo Pyron es un elemental de fuego afuera de la mazmorra. Patrulla cerca del portal en "..YELLOW.."[24]"..PREV.." en el mapa de Las Profundidades Roca Negra en "..YELLOW.."[3]"..PREV.." en el mapa de entrada de la Montaña Roca Negra.";
...
L["Quest_3907_Location"] = "Truenozón (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..")";
...
L["Quest_7201_Location"] = "Maga oscura Vivian Latumba (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
L["Quest_7201_Note"] = "Obtienes la misión requisita de Truenozón (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..").\nDespoja a cualquier elemental para obtener la esencia.";
...
L["Quest_3981_Location"] = "Galamav el Preciso (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
...
L["Quest_4724_Location"] = "Galamav el Preciso (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
...
L["Quest_6821_Note"] = "Encuentras al Piroguardián brasadivino en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_4768_Location"] = "Maga oscura Vivian Latumba (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
...
L["Quest_4974_Note"] = "Es la misión para la armonización con Onyxia. Encuentras al Jefe de Guerra Desgarro Puño Negro en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_1160_Note"] = "La cadena de misiones empieza con Dorn Acechaprados (Las Mil Agujas; "..YELLOW.."53,41"..PREV.."). Encuentras el libro en la Biblioteca del Monasterio Escarlata.";
...
L["Quest_5466_Note"] = "Encuentras a Ras Levescarcha en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7629_Location"] = "Gorzeeki Ojosalvajes (Las Estepas Ardientes; "..YELLOW.."12,31"..PREV..")";
...
L["Quest_1098_Note"] = "Encuentras al Mortacechador Adamant en "..YELLOW.."[1]"..PREV..". Mortacechador Vincent está al lado derecho cuando vayas en el patio en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_387_Location"] = "Alcaide Thelagua (Ventormenta - Las Mazmorras; "..YELLOW.."41,58"..PREV..")";
L["Quest_387_Note"] = "";
...
L["Quest_5463_Note"] = "Obtienes la misión requisita de Magistrado Marduke (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV.."). Encuentras el Obsequio de Menethil cerca de "..YELLOW.."[19]"..PREV..". Ver También: "..YELLOW.."[El exánime, Ras Levescarcha]"..PREV.." en Scholomance.";
...
L["Quest_5305_Location"] = "Lilith la Pequeña (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,37"..PREV..")";
...
L["Quest_4143_Location"] = "Gregan Vomitabrebaje (Feralas; "..YELLOW.."45,25"..PREV..")";
...
L["Quest_8413_Location"] = "Bath'rah el Cazavientos (Montañas de Alterac; "..YELLOW.."80,67"..PREV..")";
...
L["Quest_1275_Location"] = "Gershala Noctusurro (Costa Oscura - Auberdine; "..YELLOW.."38,43"..PREV..")";
L["Quest_1275_Note"] = "La misión requisita es opcional. Lo consigues de Argos Noctusurro en (Ventormenta - El Parque; "..YELLOW.."21,55"..PREV.."). \n\nDespoja a cualquier Naga fuera o dentro de la estancia para los bulbos.";
...
L["Quest_1198_Location"] = "Shaedlass Guardalbas (Darnassus - Bancal del Artesano; "..YELLOW.."55,24"..PREV..")";
...
L["Quest_959_Note"] = "Consigues la botella antes de que entras la estancia por matar Magglish el Loco. Cuando entras la cueva, dirígete al derecho para encontrarlo al final del pasaje. Él está en sigilo cerca del muro en "..YELLOW.."[1] en el mapa de la Entrada"..PREV..".";
...
L["Quest_2768_Location"] = "Ingeniero Jefe Silvaina (Tanaris - Gadgetzan; "..YELLOW.."52,28"..PREV..")";
