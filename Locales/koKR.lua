...
local AQ_OR = GREY.." 또는|r ";
local AQ_AND = GREY.." 와|r ";
...
L["Quest_4136_Location"] = "유카 스크류스피곳 (불타는 평원 - 화염 마루; "..YELLOW.."66.0, 22.0"..PREV..")";
L["Quest_4136_Note"] = "선행 퀘스트 요르바 스크류스피곳에게 받았습니다. (타나리스 - 스팀휘들 항구; "..YELLOW.."67.0, 24.0"..PREV..").\n리블리 스크류스피곳은 "..YELLOW.."[15]"..PREV.." 에 있다.";
...
L["Quest_4201_Location"] = "지배인 나그마라 (검은바위 나락; "..YELLOW.."[15]"..PREV..")";
L["Quest_4201_Note"] = "아즈샤라에 있는 거인에게서 거대한 은 광석을 얻을 수 있습니다.  그롬의 피는 약초채집 또는 경매장에서 얻을 수 있습니다.  가득 찬 나그마라의 약병 (운고로 분화구 - 골락카 간헐천; "..YELLOW.."31.0, 50.0"..PREV..").\n퀘스트를 완료한 후, 팔란스를 죽이는 대신 뒷문을 사용할 수 있습니다.";
...
L["Quest_4126_Location"] = "라그나르 썬더브루  (던 모로 - 카라노스; "..YELLOW.."46.8, 52.4"..PREV..")";
L["Quest_4126_Note"] = "이 선행 퀘스트는 에노하르 썬더브루에서 시작 됩니다. (저주받은 땅 - 네더가드 요새; "..YELLOW.."63.6, 20.6"..PREV..").\n당신은 험상궂은 주정뱅이 선술집에서 썬더브루 맥주통은 파괴하면 나타나는 경비원중 한 명으로부터 제조법을 얻을 수 있습니다. "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4262_Location"] = "잘린다 스프리그 (불타는 평원 - 모건의 망루; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4262_Note"] = "멸망의 파이론은 던전 외부의 불 정령입니다.  그는 검은바위 나락 "..YELLOW.."[24]"..PREV.." 지도와 검은바위 산 입구 지도에서 "..YELLOW.."[3]"..PREV.." 포털 근처를 순찰 합니다.";
L["Quest_4262_FollowQuest"] = "인센디우스!";

L["Quest_4263_Name"] = "인센디우스!";
L["Quest_4263_Objective"] = "검은바위 나락에서 불의군주 인센디우스를 찾아 처치해야 합니다.";
L["Quest_4263_Location"] = "잘린다 스프리그 (불타는 평원 - 모건의 망루; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4263_Note"] = "선행 퀘스트는 잘린다 스프리그에서도 나온다.  뷸의군주 인센디우스는 검은 모루 "..YELLOW.."[10]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4123_Location"] = "맥스워트 우버글린트 (불타는 평원 - 화염 마루; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4123_Note"] = "금고에서 산의 정수 "..YELLOW.."[8]"..PREV.." 를 찾을 수 있습니다.  그 금고의 열쇠를 획득하려면 먼저 던전 전체에 떨어지는 유물 금고 열쇠 키를 사용하여 모든 작은 금고를 열어야 합니다.  모든 작은 금고가 열리면, 보초 둠그립과 그의 친구들이 나타납니다. 그들을 처치하여 열쇠를 회수하십시오.";
...
L["Quest_4286_Location"] = "랄리우스 (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.6"..PREV..")";
L["Quest_4286_Note"] = "모든 드워프는 검은무쇠단 벨트주머니 드랍함니다.";
L["Quest_4286_RewardText"] = "1";

L["Quest_4024_Name"] = "화염의 맛";
L["Quest_4024_Objective"] = "검은바위 나락으로 가서 밸가르를 처치하십시오. "..YELLOW.."[...]"..PREV.." 이 거인이 검은바위 나락 내에 살고 있다는 것만 알고 있으며 밸가르의 시체에 변형된 검은용군단 허물을 사용해 불의 정수를 추출해야만 합니다.키루스 테레펜터스에게 담겨진 불의 정수를 가져가야 합니다.";
L["Quest_4024_Location"] = "키루스 테레펜터스 (불타는 평원 - 뱀갈퀴 바위굴; "..YELLOW.."94.8, 31.6"..PREV..")";
L["Quest_4024_Note"] = "퀘스트 라인은 칼라란 윈드블레이드에서 시작됩니다. (이글거리는 협곡; "..YELLOW.."39.0, 38.8"..PREV..").  그가 패배한 후 그에게 '변형된 검은용군단 허물'를 사용하여 퀘스트를 완료하십시오.";
...
L["Quest_4341_Location"] = "국왕 마그니 브론즈비어드 (아이언포지; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4341_Note"] = "이 선행 퀘스트는 왕실사학자 아케소누스에서 시작됩니다. (아이언포지; "..YELLOW.."38.6, 55.4"..PREV..").  \n카란 마이트해머는 "..YELLOW.."[2]"..PREV.." 에 있다.";
...
L["Quest_4362_Location"] = "국왕 마그니 브론즈비어드 (아이언포지; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4362_Note"] = "공주 모이라 브론즈비어드는 "..YELLOW.."[21]"..PREV.." 에 있다.  당신은 다그란 타우릿산 물리 치고 퀘스트를 완료 하기 위해 공주가 살아있어야 합니다.  공주가 죽으면 던전 전체를 초기화하고 다시 시도해야 합니다.  만약 성공한다면, 당신은 공주에게 퀘스트를 완료 할수 있습니다. 그녀는 당신의 보상을 위해 아이언포지에 국왕 마그니 브론즈비어드 보낼 것입니다.";
...
L["Quest_7848_Location"] = "로소스 리프트웨이커 (검은바위 산; "..YELLOW.."[E] 입구 지도에"..PREV..")";
L["Quest_7848_Note"] = "이는 화산 심장부 퀘스트 입니다.  핵 조각은 "..YELLOW.."검은바위 나락"..PREV.." 에 "..YELLOW.."[23]"..PREV..", 화산 심장부 포털과 매우 가깝습니다.  이 퀘스트를 완료한 후, 로소스 리프트웨이커와 이야기하거나 옆에 있는 창문을 통해 점프해 화산 심장부로 들어갈 수 있습니다.";
...
L["Quest_9015_Location"] = "팔린 트리셰이퍼 (혈투의 전장 서쪽; "..YELLOW.."[1] 도서관"..PREV..")";
L["Quest_9015_Note"] = "던전 세트 퀘스트 라인.  법의 심판장은 "..YELLOW.."[6]"..PREV.." 에 있다.";
L["Quest_9015_FollowQuest"] = "안시온의 작별 인사";

L["Quest_4083_Name"] = "유령의 성배";
L["Quest_4083_Objective"] = "그늘의 문지기가 원하는 재료를 유령의 성배에 놓으세요.";
L["Quest_4083_Location"] = "그늘의 문지기 (검은바위 나락; "..YELLOW.."[18]"..PREV..")";
L["Quest_4083_Note"] = "이것은 채광 퀘스트 이며 검은무쇠 주괴 제련 하는 법을 배우기 위해 230 이상의 채광 숙련이 필요합니다. 2개의 별루비, 20개의 금괴 그리고 10개의 진은 주괴가 필요합니다.  그 후에, 검은 무쇠 광석이 있으면 "..YELLOW.."[22]"..PREV.." 검은 가열로에서 제련 할 수 있습니다.  \n이곳은 제련이 가능한 유일한 장소입니다.";
...
L["Quest_4241_Location"] = "치안대장 맥스웰 (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_4241_Note"] = "오닉시아 입장 퀘스트 라인.  \n헬렌디스 리버혼에서 시작됩니다. (불타는 평원 - 모건의 망루; "..YELLOW.."85.6, 68.8"..PREV..").\n치안대장 윈저 "..YELLOW.."[4]"..PREV.." 에 있다.";
...
L["Quest_4242_Location"] = "치안대장 윈저 (검은바위 나락; "..YELLOW.."[4]"..PREV..")";
L["Quest_4242_Note"] = "오닉시아 입장 퀘스트 라인.  치안대장 맥스웰은 (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.8"..PREV..")에 있다.  다음 퀘스트는 검은바위 나락에서 무작위 드랍합니다.";
...
L["Quest_4264_Note"] = "오닉시아 입장 퀘스트 라인.  치안대장 윈저 "..YELLOW.."[4]"..PREV.." 에 있다. 드랍 가능성이 가장 높은 것은 채석장 주변의 검은 무쇠단 폭도 인 것 같습니다.";
...
L["Quest_4282_Location"] = "치안대장 윈저 (검은바위 나락; "..YELLOW.."[4]"..PREV..")";
L["Quest_4282_Note"] = "오닉시아 입장 퀘스트 라인.  잃어버린 단서는 골렘 군주 아젤마크 "..YELLOW.."[14]"..PREV.." 와 그리고 사령관 앵거포지 "..YELLOW.."[13]"..PREV.." 에서 드랍합니다.";
...
L["Quest_4322_Location"] = "치안대장 윈저 (검은바위 나락; "..YELLOW.."[4]"..PREV..")";
L["Quest_4322_Note"] = "오닉시아 입장 퀘스트 라인.  이건 호위 퀘스트.  시작하기 전에 모든 사람이 같은 단계에 있는지 확인하십시오.  이벤트를 시작하기 전에 법의 심판장("..YELLOW.."[6]"..PREV..")과 입구로 가는 길을 정리하면 퀘스트가 더 쉬워집니다. \n불타는 평원 - 모건의 망루에서 치안대장 맥스웰을 찾을 수 있습니다. ("..YELLOW.."84.6, 68.8"..PREV..").";
...
L["Quest_4134_Location"] = "어둠마법사 비비안 라그레이브 (황야의 땅 - 카르가스; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4134_Note"] = "선행 퀘스트는 언더시티 - 연금술 실험실 연금술사 진게에게 시작 됩니다. ("..YELLOW.."49.8 68.2"..PREV..").\n당신은 험상궂은 주정뱅이 선술집에서 썬더브루 맥주통은 파괴하면 나타나는 경비원중 한 명으로부터 제조법을 얻을 수 있습니다. "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4081_Location"] = "현상수배 계시판 (황야의 땅 - 카르가스; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4081_Note"] = "검은바위 나락 첫 번째 부분에서 드워프를 찾을 수 있습니다. \n퀘스트는 장군 고어투스에게 완료 하세요. (황야의 땅 - 카르가스, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4082_Location"] = "현상수배 계시판 (황야의 땅 - 카르가스; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4082_Note"] = "당신이 죽여야 할 드워프는 밸가르 근처에 있습니다. "..YELLOW.."[11]"..PREV..". \n퀘스트는 장군 고어투스에게 완료 하세요. (황야의 땅 - 카르가스, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4132_Location"] = "장군 고어투스 (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4132_Note"] = "이 퀘스트를 받으려면 이전 죽음의 본보기 퀘스트를 모두 완료 한 다음 렉스로트에게 그랄크 로크럽 퀘스트를 시작해야 합니다. (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV.."). \n사령관 앵거포지는 "..YELLOW.."[13]"..PREV.." 에 있다.";
...
L["Quest_4063_Location"] = "로트윌 베리아투스 (황야의 땅; "..YELLOW.."26.0, 45.0"..PREV..")";
L["Quest_4063_Note"] = "선행 퀘스트는 제사장 테오도라 뮬바다니아에게 받습니다. (황야의 땅 - 카르가스; "..YELLOW.."3.0, 47.8"..PREV..").\n골렘군주 아젤마크는 "..YELLOW.."[14]"..PREV.." 에 있다.";
...
L["Quest_3906_Location"] = "썬더하트 (황야의 땅 - 카르가스; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3906_Note"] = "멸망의 파이론은 던전 외부의 불 정령입니다.  그는 검은바위 나락 "..YELLOW.."[24]"..PREV.." 지도와 검은바위 산 입구 지도에서 "..YELLOW.."[3]"..PREV.." 포털 근처를 순찰 합니다.";
...
L["Quest_3907_Location"] = "썬더하트 (황야의 땅 - 카르가스; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3907_Note"] = "선행 퀘스트는 썬더하트에게 받습니다.  뷸의군주 인센디우스는 검은 모루 "..YELLOW.."[10]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_7201_Location"] = "어둠마법사 비비안 라그레이브 (황야의 땅 - 카르가스; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_7201_Note"] = "선행 퀘스트는 썬더하트에게 받습니다. (황야의 땅 - 카르가스; "..YELLOW.."3.4, 48.2"..PREV..").\n 모든 정령은 원소의 정수를 드랍합니다.";
...
L["Quest_3981_Location"] = "명사수 갈라마브 (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV..")";
...
L["Quest_4003_Location"] = "스랄 (오그리마 - 지혜의 골짜기; "..YELLOW.."32.0, 37.8"..PREV..")";
L["Quest_4003_Note"] = "당신은 제왕 다그란 타우릿산 "..YELLOW.."[21]"..PREV.." 찾는다.   당신은 다그란 타우릿산 물리 치고 퀘스트를 완료 하기 위해 공주는 살아있어야 합니다.  공주가 죽으면 던전 전체를 초기화하고 다시 시도해야 합니다.  만약 성공한다면, 당신은 공주에게 퀘스트를 완료 할수 있습니다. 그녀는 당신의 보상을 위해 오그리마에 대족장 스랄에게 보낼 것입니다.";
...
L["Quest_8730_Location"] = "타락한 밸라스트라즈 (검은날개 둥지; "..YELLOW.."[2]"..PREV..")";
L["Quest_8730_Note"] = "오직 한 사람만이 파편을 획득 할 수 있다.  아나크로노스는 (타나리스 - 시간의 동굴; "..YELLOW.."65, 49"..PREV..") 에 있다";
...
L["Quest_7781_Location"] = "네파리안의 머리 (네파리안에서 드랍; "..YELLOW.."[8]"..PREV..")";
L["Quest_7781_Note"] = "대영주 볼바르 폴드라곤은 (스톰윈드 - 스톰윈드 왕궁; "..YELLOW.."78.0, 18.0"..PREV..")에 있다. \n다음 퀘스트는 야전사령관 아프라샤비에게 (스톰윈드 - 영웅의 계곡; "..YELLOW.."66.9, 72.38"..PREV..") 보상을 요청합니다.";
...
L["Quest_8288_Location"] = "용기대장 래쉬레이어의 머리 (용기대장 래쉬레이어에서 드랍; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_7783_Location"] = "네파리안의 머리 (네파리안 드랍; "..YELLOW.."[8]"..PREV..")";
L["Quest_7783_Note"] = "다음 퀘스트는 대군주 사울팽에게 (오그리마 - 힘의 골짜기; "..YELLOW.."51.6, 76.0"..PREV..") 보상을 요청합니다.";
...
L["Quest_4788_Location"] = "발굴조사단장 아이언부트 (타나리스 - 스팀휘들 항구; "..YELLOW.."66.8, 24.0"..PREV..")";
L["Quest_4788_Note"] = "서판은 어둠사냥꾼 보쉬가진 "..YELLOW.."[7]"..PREV.." 그리고 대장군 부네 "..YELLOW.."[9]"..PREV.." 에서 찾을 수 있습니다.\n보상은 다음 퀘스트에서 주어집니다.  퀘스트 라인은 타나리스의 예킨야에서 시작됩니다. ("..YELLOW.."67.0, 22.4"..PREV..").";
...
L["Quest_4729_Location"] = "키블러 (불타는 평원 - 화염마루; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4729_Note"] = "할리콘 근처에서 새끼 검은늑대를 찾을 수 있습니다. "..YELLOW.."[17]"..PREV..".";
...
L["Quest_4862_Location"] = "키블러 (불타는 평원 - 화염마루; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4862_Note"] = "여왕 불그물거미 근처에서 첨탑 거미알을 찾을 수 있습니다. "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4866_Location"] = "털보 존 (불타는 평원 - 화염마루; "..YELLOW.."65.0, 23.6"..PREV..")";
L["Quest_4866_Note"] = "여왕 불그물거미는 "..YELLOW.."[13]"..PREV.." 에 있다. 독 효과는 근처 플레이어에게도 영향을줍니다. 제거되거나 해제되면 퀘스트에 실패합니다.";
...
L["Quest_4701_Location"] = "헬렌디스 리버혼 (불타는 평원 - 모건의 망루; "..YELLOW.."85.6, 68.8"..PREV..")";
L["Quest_4701_Note"] = "할리콘은 "..YELLOW.."[17]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4867_Location"] = "와로쉬 (검은바위 첨탑; "..YELLOW.."[2]"..PREV..")";
L["Quest_4867_Note"] = "와로쉬의 모조를 얻으려면 우로크 둠하울을 불러 처치해야한다. "..YELLOW.."[15]"..PREV..".  그를 소환을 위해 날카로운 장창 "..YELLOW.."[3]"..PREV.." 그리고 오모크의 머리 "..YELLOW.."[5]"..PREV.." 가 필요합니다.  소환하는 동안 우로크 둠하울이 당신을 공격하기 전에 몇차례의 오우거가 나타납니다.  전투중에 창을 사용하여 오우거에게 데미지를 입힐 수 있습니다.";
L["Quest_4867_RewardText"] = "1";

L["Quest_5001_Name"] = "비쥬의 소지품!";
L["Quest_5001_Objective"] = "비쥬의 소지품을 찾아 그녀에게 돌려줘야 합니다!";
L["Quest_5001_Location"] = "비쥬 (검은바위 첨탑; "..YELLOW.."[8]"..PREV..")";
L["Quest_5001_Note"] = "여왕 불그물거미로 "..YELLOW.."[13]"..PREV.." 가는 길에 비쥬의 소지품 찾을 수 있습니다.\n다음은 치안대장 맥스웰에게 이어집니다. (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.8"..PREV..").";
...
L["Quest_5081_Location"] = "치안대장 맥스웰 (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5081_Note"] = "대장군 부네는 "..YELLOW.."[9]"..PREV..", 대군주 오모크는 "..YELLOW.."[5]"..PREV.." 그리고 대군주 웜타라크는 "..YELLOW.."[19]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4742_Location"] = "밸란 (검은바위 첨탑; "..YELLOW.."[1]"..PREV..")";
L["Quest_4742_Note"] = "이것은 검은바위 첨탐 상층 열쇠 퀘스트 입니다.  대군주 오모크에게 뾰족바위일족 보석을 "..YELLOW.."[5]"..PREV..", 대장군 부네에게 가시불꽃부족 보석을 "..YELLOW.."[9]"..PREV.." 그리고 대군주 웜타라크에게 도끼부대 보석을 "..YELLOW.."[19]"..PREV.." 얻습니다.  가공하지 않은 승천의 인장은 검은바위 첨탐 하층 모든 몬스터나 던전 밖에서도 드랍할 수 있습니다.";
...
L["Quest_5089_Location"] = "사령관 드라키사스의 명령서 (대군주 웜타라크에서 드랍; "..YELLOW.."[19]"..PREV..")";
L["Quest_5089_Note"] = "치안대장 맥스웰은 불타는 평원 - 모건의 망루에 있습니다; ("..YELLOW.."84.6, 68.8"..PREV..").";
L["Quest_5089_FollowQuest"] = "사령관 드라키사스 처치 ("..YELLOW.."검은바위 첨탐 상층"..PREV..")";
...
L["Quest_8989_Location"] = "보들리 (검은바위 산; "..YELLOW.."[D] 입구지도"..PREV..")";
...
L["Quest_8989_FollowQuest"] = "마지막 준비 ("..YELLOW.."검은바위 첨탑 상층"..PREV..")";

L["Quest_5306_Name"] = "어둠사냥꾼의 뱀돌";
L["Quest_5306_Objective"] = "검은바위 첨탑으로 가서 어둠사냥꾼 보쉬가진을 처치하고 보쉬가진의 뱀돌을 킬램에게 갖다주어야 합니다.";
L["Quest_5306_Location"] = "킬램 (여명의 설원 - 눈망루 마을; "..YELLOW.."61.2, 37.0"..PREV..")";
L["Quest_5306_Note"] = "대장기술 퀘스트.  어둠사냥꾼 보쉬가진은 "..YELLOW.."[7]"..PREV.." 에 있다.";
...
L["Quest_5103_Location"] = "인간 해골 (검은바위 첨탐 하층; "..YELLOW.."[11]"..PREV..")";
L["Quest_5103_Note"] = "대장기술 퀘스트.  인간의 유해 근처에 불타지 않은 판금 건틀릿을 주워야 합니다. "..YELLOW.."[11]"..PREV..". 말리퍼스 다크해머에게 이어집니다. (여명의 설원 - 눈망루 마을; "..YELLOW.."61.0, 38.6"..PREV..").  다음은 후속 퀘스트에 대한 보상입니다.";
...
L["Quest_4724_Location"] = "명사수 갈라마브 (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4724_Note"] = "당신이 할리콘을 찾는다면 "..YELLOW.."[17]"..PREV..".";
...
L["Quest_4981_Location"] = "렉스로트 (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4981_Note"] = "비쥬는 "..YELLOW.."[8]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4982_Location"] = "비쥬 (검은바위 첨탐; "..YELLOW.."[8]"..PREV..")";
L["Quest_4982_Note"] = "여왕 불그물거미로 "..YELLOW.."[13]"..PREV.." 가는 길에 비쥬의 소지품 찾을 수 있습니다.\n아래 보상은 렉스로트에게 돌아가는 후속 퀘스트에 대한 것입니다. (황야의 땅 - 카르가스; "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4903_Location"] = "장군 고어투스 (황야의 땅 - 카르가스; "..YELLOW.."65,22"..PREV..")";
L["Quest_4903_Note"] = "오닉시아 퀘스트 라인.  대군주 오모크는 "..YELLOW.."[5]"..PREV..", 대장군 부네는 "..YELLOW.."[9]"..PREV.." 그리고 대군주 웜타라크는 "..YELLOW.."[19]"..PREV.." 에서 찾을 수 있습니다.  중요한 검은바위 문서는 이 3명의 보스 중 한명 옆에 나타납니다.";
L["Quest_4903_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_4903_FollowQuest"] = "아이트리그의 지혜 -> 호드를 위하여! ("..YELLOW.."검은바위 첨탑 상층"..PREV..")";

L["Quest_5160_Name"] = "대섭정";
L["Quest_5160_Objective"] = "여명의 설원으로 가서 헬레를 찾아 그녀에게 아우비의 비늘을 전해야 합니다.";
L["Quest_5160_Location"] = "아우비 (검은바위 첨탑; "..YELLOW.."[7]"..PREV..")";
L["Quest_5160_Note"] = "투기장 뒤의 방에서 아우비를 찾을 수 있습니다. "..YELLOW.."[7]"..PREV..".  그녀는 돌출부 위에 쓰러져 있다.\n헬레는 여명의 설원에 있습니다. ("..YELLOW.."54.4, 51.2"..PREV..").  좌표에서 시작하는 동굴이 있습니다. "..YELLOW.."57.0, 50.0"..PREV..".  그 동굴의 끝에는 당신을 헬레로 순간 이동시키는 포털이 있습니다.";
L["Quest_5160_FollowQuest"] = "푸른용군단의 분노";

L["Quest_5047_Name"] = "핀클 에인혼, 명을 받듭니다!";
L["Quest_5047_Objective"] = "눈망루 마을에 있는 말리퍼스 다크해머와 대화해야 합니다.";
L["Quest_5047_Location"] = "핀클 에인혼 (검은바위 첨탑; "..YELLOW.."[8]"..PREV..")";
L["Quest_5047_Note"] = "핀클 에인혼은 괴수를 무두질하게 되면 나타납니다.  말리퍼스 다크해머는 (여명의 설원 - 눈망루 마을; "..YELLOW.."61.0, 38.6"..PREV..") 에서 찾을 수 있습니다.";
...
L["Quest_4734_Location"] = "팅키 스팀보일 (블타는 평원 - 화염마루; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4734_Note"] = "태초의 불꽃 방에서 알을 찾을 수 있습니다. "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6821_Location"] = "군주 히드락시스 (아즈샤라; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6821_Note"] = "불의수호자 엠버시어는 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다.  이 퀘스트는 결국 화산 심장부 공격대에 필요한 물의 정기를 제공합니다.";
...
L["Quest_5102_Location"] = "치안대장 맥스웰 (불타는 평원 - 모건의 망루; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5102_Note"] = "사령관 드라키사스는 "..YELLOW.."[9]"..PREV.." 에서 찾을 수 있습니다.";
L["Quest_5102_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_5102_PreQuest"] = "사령관 드라키사스의 명령서 ("..YELLOW.."검은바위 첨탑 하층"..PREV..")";

L["Quest_4764_Name"] = "파멸의 기념물";
L["Quest_4764_Objective"] = "불타는 평원에 있는 마야라 브라이트윙에게 파멸의 기념물을 가져가야 합니다.";
L["Quest_4764_Location"] = "마야라 브라이트윙 (불타는 평원 - 모건의 망루; "..YELLOW.."84.8, 69.0"..PREV..")";
L["Quest_4764_Note"] = "선행 퀘스트는 백작 레밍턴 리지웰에서 받습니다. (스톰윈드 - 스톰윈드 왕궁; "..YELLOW.."74.0, 30.0"..PREV..").\n\n파멸의 기념물은 "..YELLOW.."[3]"..PREV.." 상자안에 있습니다.  나열된 보상은 후속 퀘스트에 대한 것입니다.";
...
L["Quest_8995_Location"] = "보들리 (검은바위 산; "..YELLOW.."[D] 입구지도"..PREV..")";
L["Quest_8995_Note"] = "던전 방어구 세트 퀘스트 라인.  보들리를 보기 위해서는 4차원 유령 탐색기가 필요합니다. 선행 퀘스트는 '안시온을 찾아서' 에서 얻을 수 있습니다.  군주 발타라크는 "..YELLOW.."[8]"..PREV.." 에서 소환 된다.  나열된 보상은 후속 퀘스트에 대한 것입니다.";
...
L["Quest_5127_Location"] = "로락스 (여명의 설원; "..YELLOW.."63.8, 73.6"..PREV..")";
L["Quest_5127_Note"] = "대장기술 퀘스트.  고랄루크 앤빌크랙은 "..YELLOW.."[5]"..PREV.." 에 있다.";
...
L["Quest_4735_Location"] = "팅키 스팀보일 (불타는 평원 - 화염마루; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4735_Note"] = "태초의 불꽃 방에서 알을 찾을 수 있습니다. "..YELLOW.."[2]"..PREV..".";
L["Quest_4735_PreQuest"] = "알껍질 냉동";
L["Quest_4735_FollowQuest"] = "리어니드 바돌로매 -> 여명의 계략 ("..YELLOW.."스칼로맨스"..PREV..")";
...
L["Quest_6502_Note"] = "이것은 오닉시아 입장에 대한 마지막 퀘스트입니다.  퀘스트 라인을 시작하는 방법에 대한 자세한 정보는 검은바위 나락 퀘스트 '치안대장 윈저'에 있습니다.  사령관 드라키사스는 "..YELLOW.."[9]"..PREV.." 에 있다.";
...
L["Quest_4768_Location"] = "비비안 라그레이브 (황야의 땅 - 카르가스; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4768_Note"] = "선행 퀘스트는 연금술사 진게에게 받습니다. 언더시티 - 연금술 실험실 ("..YELLOW.."50.0, 68.6"..PREV..").\n\n다크 스톤 서판은 "..YELLOW.."[3]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4974_Location"] = "스랄 (오그리마; "..YELLOW.."32, 37.8"..PREV..")";
L["Quest_4974_Note"] = "오닉시아 입장 퀘스트 라인.  대족장 렌드 블랙핸드는 "..YELLOW.."[6]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_6569_Location"] = "노파 미란다 (서부 역병지대 - 슬픔의 언덕; "..YELLOW.."50.8, 77.8"..PREV..")";
...
L["Quest_6602_Note"] = "오닉시아 입장 퀘스트 라인의 마지막 부분.  렉사르는 톨발톱 산맥 사이에 경계에서 리젠되어 잊혀진 땅을 지나 페랄라스로 이동 합니다.  그를 찾는 가장 좋은 방법은 페랄라스에서 시작합니다. "..YELLOW.."48.2, 24.8"..PREV.." 그리고 그를 찾기 위해 북쪽으로 이동합니다.   사령관 드라키사스는 "..YELLOW.."[9]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_214_Location"] = "정찰병 리엘 (서부 몰락지대 - 감시의 언덕; "..YELLOW.."56.6, 47.4"..PREV..")";
...
L["Quest_168_Location"] = "빌더 시슬네틀 (스톰윈드 - 드워프 지구; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_168_Note"] = "카드는 던전 근처 지역의 언데드 몬스터가 드랍합니다. "..YELLOW.."[3]"..PREV.." 입구 지도에 있습니다.";
L["Quest_168_RewardText"] = "1"..AQ_OR.."2";

L["Quest_167_Name"] = "형제여...";
L["Quest_167_Objective"] = "스톰윈드에 있는 빌더 시슬네틀에게 시슬네틀의 배지를 가져가야 합니다.";
L["Quest_167_Location"] = "빌더 시슬네틀 (스톰윈드 - 드워프 지구; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_167_Note"] = "현장 감독 시스네틀은 던전 밖 언데드 지역에서 발견됩니다. "..YELLOW.."[3]"..PREV.." 입구 지도에 있습니다.";
L["Quest_167_RewardText"] = "1";

L["Quest_2040_Name"] = "지하 공격";
L["Quest_2040_Objective"] = "죽음의 폐광에서 노암 톱니구동장치를 찾아 스톰윈드에 있는 쇼니에게 가져가야 합니다.";
L["Quest_2040_Location"] = "소리없는 쇼니 (스톰윈드 - 드워프 지구; "..YELLOW.."62.6, 34.1"..PREV..")";
L["Quest_2040_Note"] = "선택적인 선행 퀘스트는 노아른에게 받을 수 있습니다. (아이언포지 - 땜장이 마을; "..YELLOW.."69.4, 50.6"..PREV..").\n스니드의 벌목기에서 노암 톱니구동장치를 드랍합니다. "..YELLOW.."[3]"..PREV..".";
...
L["Quest_166_Location"] = "그라이언 스타우트맨틀 (서부몰락 지대 - 감시의 언덕; "..YELLOW.."56.2, 47.6"..PREV..")";
L["Quest_166_Note"] = "그라이언 스타우트맨틀에게 이 퀘스트 라인을 시작 합니다.\n에드윈 밴클리프는 죽음의 폐광 마지막 보스입니다. 그는 배 꼭대기에서 그를 찾을 수 있다. "..YELLOW.."[6]"..PREV..".";
...
L["Quest_1654_Location"] = "조던 스틸웰 (던 모로 - 아이언포지 입구; "..YELLOW.."52,36"..PREV..")";
L["Quest_1654_Note"] = "성기사 퀘스트.  조던의 대장장이 망치는 "..YELLOW.."[9]"..PREV.." 에 있다.\n\n나머지 아이템은 "..YELLOW.."[죽음의 폐광]"..PREV..", 모단 호수, 어둠의 해안과 잿빛골짜기.  일부는 사이드 퀘스트를 수행해야합니다.  자세한 내용은 Wowhead에서 찾아 보는 것이 좋습니다.";
...
L["Quest_373_Location"] = "부치지 않은 편지 (에드윈 밴클리프 드랍; "..YELLOW.."[6]"..PREV..")";
L["Quest_373_Note"] = "바로스 알렉스턴은 스톰윈드에 있으면, 빛의 대성당 옆에 있습니다.  "..YELLOW.."49.0, 30.2"..PREV..".";
...
L["Quest_2922_Location"] = "수석땜장이 오버스파크 (아이언포지 - 땜장이 마을; "..YELLOW.."69.8, 50.4"..PREV..")";
L["Quest_2922_Note"] = "수사 세르노에게 선택적인 선행 퀘스트를 받을 수 있습니다. (스톰윈드 - 대성당 광장; "..YELLOW.."40.6, 30.8"..PREV..").\n첨단로봇은 던전의 입구 근처 밖에 있습니다. "..YELLOW.."[4] 입구지도"..PREV..".";
...
L["Quest_2926_Location"] = "오지 토글볼트 (던 모로 - 카라노스; "..YELLOW.."45.8, 49.2"..PREV..")";
L["Quest_2926_Note"] = "선행 퀘스트는 노아른에서 받습니다. (아이언포지 - 땜장이 마을; "..YELLOW.."69.4, 50.6"..PREV..").\n페기물을 채집하려면 "..RED.."살아있는"..PREV.." 오염된 침략꾼이나 오염된 약탈자에게 빈 가연채집병을 사용해야 합니다.  그들은 던전의 시작 부분 근처에서 발견된다";
...
L["Quest_2962_Location"] = "오지 토글볼트 (던 모로 - 카라노스; "..YELLOW.."45.8, 49.2"..PREV..")";
L["Quest_2962_Note"] = "페기물을 채집하려면 "..RED.."살아있는"..PREV.." 오염된 진흙괴물, 오염된 폐기물에게 빈 대형 가연채집병을 사용해야 합니다.  그들은 방사성 폐기물 보스 근처에서 발견됩니다. "..YELLOW.."[4]"..PREV..".";
L["Quest_2962_PreQuest"] = "폐기물 수집";

L["Quest_2928_Name"] = "회전천공식 발굴기";
L["Quest_2928_Objective"] = "스톰윈드에 있는 쇼니에게 기계장치 부속품 24개를 가져가야 합니다.";
L["Quest_2928_Location"] = "소리없는 쇼니 (스톰윈드 - 드워프 지구; "..YELLOW.."55.4, 12.6"..PREV..")";
...
L["Quest_2924_Location"] = "클락몰트 스패너스판 (아이언포지 - 땜장이마을; "..YELLOW.."68.0, 46.8"..PREV..")";
L["Quest_2924_Note"] = "선택적인 선행 퀘스트는 메시엘에게 받을 수 있습니다. (다르나서스 - 전사의 정원; "..YELLOW.."59.2, 45.2"..PREV..").\n필수 인공장치는 던전 주변에 흩어져 있는 기계에서 나옵니다.";
...
L["Quest_2930_Location"] = "수석수리공 캐스트파이프 (아이언포지 - 땜장이마을; "..YELLOW.."70.2, 48.4"..PREV..")";
L["Quest_2930_Note"] = "선택적인 선행 퀘스트는 각심 러스트피즐에게 받을 수 있습니다. (돌발톱 산맥; "..YELLOW.."59.6, 67.0"..PREV..").\n흰색 카드는 무작위 드랍 입니다. 던전에 들어가기 전에 뒷문 옆에 첫 번째 터미널이 있습니다. "..YELLOW.."[C] 입구지도"..PREV..". 행렬천공기록기3005-B는  "..YELLOW.."[3]"..PREV..", 행렬천공기록기3005-C는 "..YELLOW.."[5]"..PREV.." 그리고 행렬천공기록기3005-D는 "..YELLOW.."[6]"..PREV..".";
...
L["Quest_2904_Location"] = "케르노비 (놈리건; "..YELLOW.."[3]"..PREV..")";
L["Quest_2904_Note"] = "호위 퀘스트! 가시덤블 골짜기 - 무법항에서 스쿠티를 찾으십시오. ("..YELLOW.."27.6, 77.4"..PREV..").";
...
L["Quest_2929_Location"] = "땜장이왕 멕카토크 (아이언포지 - 땜장이 마을; "..YELLOW.."69.0, 49.0"..PREV..")";
L["Quest_2929_Note"] = "멕기니어 텔마플러그를 "..YELLOW.."[8]"..PREV.." 찾을 수 있습니다. 그는 놈리건의 마지막 보스입니다.\n전투 중에 측면의 버튼을 눌러 기둥을 무력화 시켜야 한다.";
...
L["Quest_2945_Note"] = "정화 지역에서 빤질빤질세척기 5200에서 반지를 청소할 수 있습니다. "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2947_Note"] = "탈바쉬 델 키젤에게 돌아간다. (아이언포지 - 마법 지구; "..YELLOW.."36.0, 4.0"..PREV.."). 반지를 향상시키기 위한 다음 작업은 선택 사항입니다.";
...
L["Quest_2951_Location"] = "삐까뻔쩍세척기 (놈리건 - 정화 지역; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_2843_Location"] = "스쿠티 (가시덤블 골짜기 - 무법항; "..YELLOW.."27.6, 77.4"..PREV..")";
L["Quest_2843_Note"] = "선행 퀘스트는 소빅에게 받을 수 있습니다. (오그리마 - 명예의 골짜기; "..YELLOW.."75.6, 25.2"..PREV..").\n이 퀘스트를 완료하면 무법항의 응답장치를 사용하여 놈리건으로 순간 이동할 수 있습니다.";
...
L["Quest_2841_Location"] = "노그 (오그리마 - 명예의 골짜기; "..YELLOW.."75.8, 25.2"..PREV..")";
L["Quest_2841_Note"] = "멕기니어 텔마플러그를 "..YELLOW.."[8]"..PREV.." 찾을 수 있습니다. 그는 놈리건의 마지막 보스입니다.\n전투 중에 측면의 버튼을 눌러 기둥을 무력화 시켜야 한다.";
...
L["Quest_2949_Note"] = "노그에게 돌아간다. (오그리마 - 명예의 골짜기; "..YELLOW.."75.8, 25.2"..PREV.."). 반지를 향상시키기 위한 다음 작업은 선택 사항입니다.";
...
L["Quest_1050_Location"] = "사서 메이 페일더스트 (아이언포지 - 탐험가의 전당; "..YELLOW.."74.6, 12.6"..PREV..")";
L["Quest_1050_Note"] = "이 책은 신비술사 도안으로 이어지는 복도 중 하나의 왼쪽 바닥에 있습니다. ("..YELLOW.."[2]"..PREV..").  플레이어가 그것을 집고 나면 사라집니다.  1~2분 후에 다시 젠 됩니다.";
L["Quest_1050_RewardText"] = "1";

L["Quest_1951_Name"] = "아나스타샤에게 보고";
L["Quest_1951_Objective"] = "먼지진흙 습지대에 있는 타베사에게 마력의 의식을 가져가야 합니다.";
L["Quest_1951_Location"] = "학자 틸스 (버섯구름 봉우리 - 소금 평원; "..YELLOW.."78.2, 75.8"..PREV..")";
L["Quest_1951_Note"] = "마법사 퀘스트.  선행 퀘스트는 대도시 상급 마법사에게 제공됩니다.  신비술사 도안으로 이어지는 마지막 복도에서 책을 찾을 수 있습니다. ("..YELLOW.."[2]"..PREV..").  그것은 선반에 꽂혀 있습니다.\n\n퀘스트는 타베사에게 이어 집니다. (먼지진흙 습지대; "..YELLOW.."46.0, 57.0"..PREV..").  \n다음은 그것에 대한 보상입니다.";
...
L["Quest_1053_Location"] = "경건한 신자 랄레이 (힐스브레드 구릉지 - 사우스쇼어; "..YELLOW.."51.4, 58.4"..PREV..")";
L["Quest_1053_Note"] = "이 퀘스트 라인은 스톰윈드 - 빛의 대성당 수사 크롤리에서 시작됩니다. ("..YELLOW.."42.4, 24.4"..PREV..").\n종교재판관 화이트메인과 붉은십자군 사령관 모그레인은 "..YELLOW.."붉은십자군 수도원: 대성당 [2]"..PREV..", \n헤로드는 "..YELLOW.."붉은십자군 수도원: 무기고 [1]"..PREV.." 그리고 사냥개조련사 록시는 "..YELLOW.."붉은십자군 수도원: 도서관 [1]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_1113_Location"] = "수석 연금술사 파라넬 (언더시티 - 연금술 실험실; "..YELLOW.."48.6, 69.4"..PREV..")";
L["Quest_1113_Note"] = "붉은십자군 수도원 안에 있는 모든 몬스터는 열정의 증거를 드랍 할 수 있습니다.  여기는 포털 근처 던전 외부의 몬스터들도 포함됩니다.";
L["Quest_1113_PreQuest"] = "조분석을 나에게! ("..YELLOW.."[가시덩굴 우리]"..PREV..")";

L["Quest_1160_Name"] = "지혜의 시험!!";
L["Quest_1160_Objective"] = "언데드 위협의 기원을 찾아 언더시티에 있는 파쿠알 핀탈라스에게 가져가야 합니다.";
L["Quest_1160_Location"] = "파쿠알 핀탈라스 (언더시티 - 연금술 실험실; "..YELLOW.."57.8, 65.0"..PREV..")";
L["Quest_1160_Note"] = "퀘스트 라인은 도른 플레인스토커에서 시작됩니다. (버섯구름 봉우리; "..YELLOW.."53.8, 41.6"..PREV..").  그 책은 '보물 갤러리'라고 불리는 도서관의 한 부분에 있는 탁자 위에 있다.  그것은 던전의 중간쯤에 있습니다.\n\n다음은 그것에 대한 보상입니다.";
...
L["Quest_1049_Location"] = "현자 트루스시커 (썬더 블러프; "..YELLOW.."34.6, 47.2"..PREV..")";
...
L["Quest_1048_Location"] = "바리마트라스 (언더시티 - 왕실; "..YELLOW.."56.2, 92.6"..PREV..")";
L["Quest_1048_Note"] = "종교재판관 화이트메인과 붉은십자군 사령관 모그레인은 "..YELLOW.."붉은십자군 수도원: 대성당 [2]"..PREV..", 헤로드는 "..YELLOW.."붉은십자군 수도원: 무기고 [1]"..PREV.." 그리고 사냥개조련사 록시는 "..YELLOW.."붉은십자군 수도원: 도서관 [1]"..PREV..".";
...
L["Quest_1051_Location"] = "보렐 센구츠 (붉은십자군 수도원 - 무덤; "..YELLOW.."[1]"..PREV..")";
L["Quest_1051_Note"] = "붉은십자군 수도원 무덤 시작 부분에 보렐 센구츠 찾을 수 있습니다.  이 퀘스트에 필요한 반지 드랍은 낸시 비샤스가 하는데 알터랙 산맥 근처 집에서 찾을 수 있습니다. (힐스브래드 구릉지 - 타렌 밀농장; "..YELLOW.."62.6, 19.0"..PREV..").";
...
L["Quest_5529_Location"] = "베티나 비글징크 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.6"..PREV..")";
...
L["Quest_5582_Note"] = "역병 걸린 작은 새끼용은 생기 있는 용비늘을 드랍합니다.  베티나 비글징크은 동부 역병지대 - 희망의 빛 예배당 ("..YELLOW.."81.4, 59.6"..PREV..") 에 있다.";
...
L["Quest_5382_Location"] = "에바 사크호프 (서부 역병지대 - 카엘 다로우; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5382_Note"] = "학자 테올렌 크라스티노브, 에바 사크호프의 유해 그리고 루시엔 사크호프의 유해는 "..YELLOW.."[9]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5515_Location"] = "에바 사크호프 (서부 역병지대 - 카엘 다로우; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5515_Note"] = "잔다이스 바로브는 "..YELLOW.."[3]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5384_Location"] = "에바 사크호프 (서부 역병지대 - 카엘 다로우; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5384_Note"] = "베란다는 "..YELLOW.."[2]"..PREV.." 에 있다.";
...
L["Quest_5466_Location"] = "집정관 마르듀크 (서부 역병지대 - 카엘 다로우; "..YELLOW.."70.4, 74.0"..PREV..")";
L["Quest_5466_Note"] = "라스 프로스트위스퍼는  "..YELLOW.."[7]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5343_Location"] = "웰던 바로브 (서부 역병지대 - 서리바람 야영지; "..YELLOW.."43.4, 83.8"..PREV..")";
L["Quest_5343_Note"] = "카엘 다로우 증서는 "..YELLOW.."[12]"..PREV..", 브릴 증서는 "..YELLOW.."[7]"..PREV..", 타렌 밀농장 증서는 "..YELLOW.."[4]"..PREV.." 그리고 사우스쇼어 증서는 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다.\n다음은 그거에 대한 보상입니다.";
...
L["Quest_4771_Location"] = "베티나 비글징크 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.6"..PREV..")";
L["Quest_4771_Note"] = "새끼용의 정수의 시작은 팅키 스팀보일에서 (불타는 평원 - 화염 마루; "..YELLOW.."65.2, 23.8"..PREV.."). 강당은 "..YELLOW.."[6]"..PREV.." 에 있다.";
...
L["Quest_7629_Location"] = "고르지키 와일드아이즈 (불타는 평원; "..YELLOW.."12.6, 31.6"..PREV..")";
L["Quest_7629_Note"] = "흑마법사 영웅 탈것 퀘스트 라인.  연금술 실험실은 "..YELLOW.."[7]"..PREV.." 에서 찾을 수 있습니다.";
L["Quest_7629_PreQuest"] = "모르줄 블러드브링어 -> 소로시안 별가루";
L["Quest_7629_FollowQuest"] = "소로스의 공포마 ("..YELLOW.."혈투의 전장 서쪽"..PREV..")";
...
L["Quest_7647_Location"] = "그레이슨 섀도브레이커 경 (스톰윈드 - 대성당; "..YELLOW.."37.6, 32.6"..PREV..")";
L["Quest_7647_Note"] = "성기사 영웅 탈것 퀘스트 라인.  이 퀘스트 라인은 길고 많은 단계가 있습니다.  WoWhead.com 에는 이를 완료하는 방법에 대해 자세히 설명한 훌륭한 안내서가 있습니다.  대형 납골당 지하실은 "..YELLOW.."[5]"..PREV.." 에 있다.";
...
L["Quest_5341_Location"] = "알렉시 바로브 (티리스팔 숲 - 보루; "..YELLOW.."83.0, 71.4"..PREV..")";
L["Quest_5341_Note"] = "카엘 다로우 증서는 "..YELLOW.."[12]"..PREV..", 브릴 증서는 "..YELLOW.."[7]"..PREV..", 타렌 밀농장 증서는 "..YELLOW.."[4]"..PREV.." 그리고 사우스쇼어 증서는 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다..\n다음은 그것에 대한 보상입니다.";
...
L["Quest_8258_Location"] = "사고른 크레스트스트라이더 (오그리마 - 지혜의 골짜기; "..YELLOW.."38.6, 36.2"..PREV..")";
L["Quest_8258_Note"] = "주술사 퀘스트.  선행 퀘스트는 동일한 NPC에서 받습니다.\n\n죽음의 기사 다크리버는 "..YELLOW.."[5]"..PREV.." 소환됩니다.";
...
L["Quest_1740_Location"] = "도안 카르한 (불모의 땅; "..YELLOW.."49.2, 57.2"..PREV..")";
L["Quest_1740_Note"] = "흑마법사 퀘스트.  \n황혼의 망치단 수행사제에게 소랜루크 조각 3개  "..YELLOW.."[검은심연 나락]"..PREV..". \n그림자송곳니일족 검은영혼에게 큰 소랜루크 조각은 1개  "..YELLOW.."[그림자송곳니 성채]"..PREV.." 를 얻을 수 있다.";
...
L["Quest_1098_Location"] = "고위집행관 하드렉 (은빛소나무 숲 - 공동묘지; "..YELLOW.."43.4, 40.8"..PREV..")";
L["Quest_1098_Note"] = "죽음의추적자 아다만트는 "..YELLOW.."[1]"..PREV.." 에 있다. 당신이 안뜰에 갈 때 죽음의추적자 빈센트는 오른쪽에 있습니다.";
L["Quest_1098_RewardText"] = "1";

L["Quest_1013_Name"] = "우르의 책";
L["Quest_1013_Objective"] = "언더시티의 연금술 실험실에 있는 관리인 벨두거에게 우르의 책을 가져가야 합니다.";
L["Quest_1013_Location"] = "관리인 벨두거 (언더시티 - 연금술 실험실; "..YELLOW.."53.6, 54.0"..PREV..")";
L["Quest_1013_Note"] = "방에 들어가면 왼쪽에 책이 "..YELLOW.."[6]"..PREV.." 있습니다.";
...
L["Quest_1014_Location"] = "달라 던위버 (은빛소나무 숲 - 공동묘지; "..YELLOW.."44.2, 39.8"..PREV..")";
L["Quest_1014_Note"] = "대마법사 아루갈은 "..YELLOW.."[8]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_386_Location"] = "경비병 베르턴 (붉은마루 산맥 - 레이크샤이어; "..YELLOW.."26.4, 46.6"..PREV..")";
L["Quest_386_Note"] = "타고르를 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_377_Location"] = "Millstipe (그늘숲 - 다크샤이어; "..YELLOW.."72.0, 47.8"..PREV..")";
L["Quest_377_Note"] = "덱스트렌은 "..YELLOW.."[5]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_387_Location"] = "교도소장 델워터 (스톰윈드 - 지하감옥; "..YELLOW.."41.2, 58.0"..PREV..")";
...
L["Quest_388_Location"] = "니코바 라스콜 (스톰윈드 - 구 시가지; "..YELLOW.."66.8, 46.4"..PREV..")";
...
L["Quest_378_Location"] = "모틀리 가마슨 (저습지 - 던 모드르; "..YELLOW.."49.6, 18.2"..PREV..")";
L["Quest_378_Note"] = "이전 퀘스트도 모틀리 가마슨에서 받을 수 있습니다. 캄 딥퓨리는 "..YELLOW.."[2]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_391_Location"] = "교도소장 델워터 (스톰윈드 - 지하감옥; "..YELLOW.."41.2, 58.0"..PREV..")";
L["Quest_391_Note"] = "바질 스레드는 "..YELLOW.."[4]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5212_Location"] = "베티나 비글징크 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.6"..PREV..")";
...
L["Quest_5213_Location"] = "베티나 비글징크 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.6"..PREV..")";
L["Quest_5213_Note"] = "스컬지 자료는 3개의 타워 "..YELLOW.."[15]"..PREV..", "..YELLOW.."[16]"..PREV.." 과 "..YELLOW.."[17]"..PREV.." 중 하나에 있습니다..";
...
L["Quest_5243_Location"] = "존경받는 리어니드 바돌로매 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.6, 57.8"..PREV..")";
...
L["Quest_5214_Location"] = "스모키 라루 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."80.6, 58.0"..PREV..")";
L["Quest_5214_Note"] = "최고급 담배는 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다.  상자를 열면 프라스 샤비가 나타납니다.";
...
L["Quest_5282_Location"] = "에간 (동부 역병지대 - 테러데일; "..YELLOW.."14.4, 33.6"..PREV..")";
L["Quest_5282_Note"] = "선행 퀘스트는 관리인 알렌에서 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."79.4, 63.8"..PREV..") 받습니다.  시민의 유령은 스트라솔름 거리를 걸어 다닙니다.";
...
L["Quest_5848_Location"] = "화가 렌프레이 (서부 역병지대 - 카엘 다로우; "..YELLOW.."65.6, 75.4"..PREV..")";
L["Quest_5848_Note"] = "사전 퀘스트는 티리온 폴드링에서 (서부 역병지대; "..YELLOW.."7.4, 43.6"..PREV..") 받습니다.  근처에서 사진을 "..YELLOW.."[10]"..PREV.." 찾을 수 있습니다.";
...
L["Quest_5463_Location"] = "존경받는 리어니드 바돌로 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.6, 57.8"..PREV..")";
L["Quest_5463_Note"] = "선행 퀘스트는 집정관 마르듀크에서 (서부 역병지대 - 카엘 다로우; "..YELLOW.."70.4, 74.0"..PREV..") 받습니다.  부정한 땅은 "..YELLOW.."[19]"..PREV.." 에 있다.";
...
L["Quest_5125_Location"] = "아우리우스 (스트라솔름; "..YELLOW.."[13]"..PREV..")";
L["Quest_5125_Note"] = "요새의 첫 방에 있는 상자에서 (말로의 금고 "..YELLOW.."[7]"..PREV..") 메달을 얻습니다. (길이 갈라지기 전에). 귀속되지 않으므로 다른 플레이어와 교환하거나 별도로 실행할 수 있습니다.\n\n아우리우스에게 메달을 준 후 남작 리븐데어와 싸울 때 그는 당신을 도울 것입니다. "..YELLOW.."[19]"..PREV..". 남작이 죽은 후 아우리우스도 죽습니다. 그의 시체와 대화하여 보상을 받으세요.";
...
L["Quest_5251_Location"] = "공작 니콜라스 즈바른호프 (서부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.8"..PREV..")";
L["Quest_5251_Note"] = "기록관과 기록은 "..YELLOW.."[10]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5262_Location"] = "발나자르 (스트라솔름; "..YELLOW.."[11]"..PREV..")";
L["Quest_5262_Note"] = "동부 역병지대 - 희망의 빛 예배당에서 공작 니콜라스 즈바른호프 ("..YELLOW.."81.4, 59.8"..PREV..") 찾을 수 있습니다.";
...
L["Quest_5263_Location"] = "공작 니콜라스 즈바른호프 (동부 역병지대 - 희망의 빛 예배당; "..YELLOW.."81.4, 59.8"..PREV..")";
L["Quest_5263_Note"] = "남작 리븐데어는 "..YELLOW.."[19]"..PREV.." 에 있다.\n\n다음은 그것에 대한 보상입니다.";
...
L["Quest_8945_Note"] = "안시온 하몬은 스트라솔름 정문 포털 바로 밖에 서 있습니다. 그를 보려면 4차원 유령탐색기가 필요합니다. 유령탐색기는 선행 퀘스트에서 나옵니다. 퀘스트라인은 단지 보상으로 시작합니다. 얼라이언스는 아이언포지의 델리아나 ("..YELLOW.."43, 52"..PREV.."), 호드는 오그리마의 모크바르 ("..YELLOW.."38, 37"..PREV..").\n이것은 악명 높은 '45분' 남작 최단시간 클리어 입니다.";
...
L["Quest_8968_Location"] = "보들리 (검은바위 산; "..YELLOW.."[D] 입구지도"..PREV..")";
L["Quest_8968_Note"] = "보들리를 보기 위해서는 4차원 유령 탐색기가 필요합니다. 선행 퀘스트는 '안시온을 찾아서' 에서 얻을 수 있습니다.\n\n자리엔과 소도스는 "..YELLOW.."[11]"..PREV.." 에서 소환 된다.";
...
L["Quest_5307_Location"] = "세릴 스컬지베인 (여명의 설원 - 눈망루 마을; "..YELLOW.."61.2, 37.2"..PREV..")";
L["Quest_5307_Note"] = "대장기술 퀘스트.  검은호위대 검제작자는 "..YELLOW.."[15]"..PREV.." 근처에서 소환됩니다.";
...
L["Quest_5305_Location"] = "호리호리한 릴리스 (여명의 설원 - 눈망루 마을; "..YELLOW.."61.2, 37.2"..PREV..")";
L["Quest_5305_Note"] = "대장기술 퀘스트.  진홍십자군 대장장이는 "..YELLOW.."[8]"..PREV.." 에서 소환됩니다.";
...
L["Quest_7622_Location"] = "에리스 헤븐파이어 (동부 역병지대; "..YELLOW.."20.8, 18.2"..PREV..")";
L["Quest_7622_Note"] = "사제 퀘스트.  에리스 헤븐파이어에게 이 퀘스트와 사전 퀘스트를 받으려면 신앙의 눈이 필요합니다. (불의 군주의 보물에서 나옴 "..YELLOW.."[화산 심장부]"..PREV..").\n\n이 퀘스트 보상은, 신앙의 눈과 어둠의 눈을 결합했을 때 (여명의 설원 또는 저주받은 땅 악마에게서 드랍합니다.) 축복의 지팡이가 생성됩니다.";
...
L["Quest_6163_Location"] = "나타노스 블라이트콜러 (동부 역병지대; "..YELLOW.."26.6, 74.8"..PREV..")";
L["Quest_6163_Note"] = "선행 퀘스트는 나타노스 블라이트콜러에게 받습니다.  먹보 람스타인은 "..YELLOW.."[18]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_1475_Location"] = "브로한 캐스크벨리 (스톰윈드- 드워프 지구; "..YELLOW.."64.2, 20.8"..PREV..")";
...
L["Quest_3445_Location"] = "안젤라스 문브리즈 (페랄라스 - 페더문 요새; "..YELLOW.."31.8, 45.6"..PREV..")";
L["Quest_3445_Note"] = "마본 리벳시커는 "..YELLOW.."52.6, 45.8"..PREV..".에서 찾을 수 있습니다.";
L["Quest_3445_FollowQuest"] = "돌무리";

L["Quest_3446_Name"] = "심연의 늪";
L["Quest_3446_Objective"] = "슬픔의 늪에 있는 가라앉은 사원에서 학카르 제단을 찾아야 합니다.";
L["Quest_3446_Location"] = "마본 리벳시커 (타나리스; "..YELLOW.."52.6, 45.8"..PREV..")";
L["Quest_3446_Note"] = "제단은 "..YELLOW.."[1]"..PREV.." 에 있다.";
...
L["Quest_3447_Location"] = "마본 리벳시커 (타나리스; "..YELLOW.."52.6, 45.8"..PREV..")";
L["Quest_3447_Note"] = "석상은 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다. 활성화 순서는 지도를 참조하십시오.";
...
L["Quest_4143_Location"] = "그레간 브루스퓨 (페랄라스; "..YELLOW.."45.0, 25.4"..PREV..")";
L["Quest_4143_Note"] = "선행 퀘스트는 '무이긴과 라라온' 무이긴에서 시작 됩니다. (운고로 분화구 - 마샬의 야영지; "..YELLOW.."43.0, 9.6"..PREV.."). 사원의 지하껍질괴물, 진흙미늘벌레 또는 괴물에서 아지랑이를 얻을 수 있습니다.";
L["Quest_4143_PreQuest"] = "무이긴과 라리온 -> 그레간 방문 ";

L["Quest_3528_Name"] = "학카르의 화신";
L["Quest_3528_Objective"] = "타나리스에 있는 예킨야에게 충만한 학카르의 알을 가져가야 합니다.";
L["Quest_3528_Location"] = "예킨야 (타나리스 - 스팀휘들 항구; "..YELLOW.."67.0, 22.4"..PREV..")";
L["Quest_3528_Note"] = "퀘스트 라인은 같은 NPC에 '계곡천둥매의 영혼' 으로 시작됩니다. ("..YELLOW.."[줄파락]"..PREV.." 참조).\n이벤트를 시작하려면 알을 "..YELLOW.."[3]"..PREV.." 사용해야 합니다.  그것이 시작되면 적들이 소환 되어 공격합니다.  그들 중 일부는 학카르의 피를 떨어뜨린다.  이 피를 사용하면 원 주위에 횃불을 끌수 있습니다.  이 후 학카르의 화신이 소환 됩니다.  그를 죽이고 알을 채울수 있는 '학카르의 정수'를 획득합니다.";
...
L["Quest_1446_Location"] = "추방된 아탈라이트롤 (동부 내륙지; "..YELLOW.."33.6, 75.2"..PREV..")";
L["Quest_1446_Note"] = "잠말란은 "..YELLOW.."[4]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_3373_Location"] = "에라니쿠스의 정수 (에라니쿠스의 사령; "..YELLOW.."[6]"..PREV..")";
L["Quest_3373_Note"] = "에라니쿠스의 사령 옆에 정수의 샘을 찾을 수 있습니다. "..YELLOW.."[6]"..PREV..".";
...
L["Quest_8422_Location"] = "임프시 (악령의 숲; "..YELLOW.."41.6, 45.0"..PREV..")";
...
L["Quest_8425_Location"] = "호드 영웅의 넋 (슬픔의 늪; "..YELLOW.."34.2, 66.0"..PREV..")";
...
L["Quest_9053_Location"] = "토르와 패스파인더 (운고로 분화구; "..YELLOW.."71.6, 76.0"..PREV..")";
L["Quest_9053_Note"] = "드루이드 퀘스트.  썩은 덩굴은 지도에 "..YELLOW.."[1]"..PREV.." 나열된 순서대로 석상을 활성화하여 소환 된 아탈알라리온에서 드랍합니다.";
...
L["Quest_8232_Location"] = "Ogtinc (아즈샤라; "..YELLOW.."42.2, 42.6"..PREV..")";
L["Quest_8232_Note"] = "사냥꾼 퀘스트.  몰파즈는 "..YELLOW.."[5]"..PREV.." 에 있다.";
...
L["Quest_8253_Location"] = "대마법사 실렘 (아즈샤라; "..YELLOW.."29.6, 40.6"..PREV..")";
L["Quest_8253_Note"] = "마법사 퀘스트.  몰파즈는 "..YELLOW.."[5]"..PREV.." 에 있다.";
...
L["Quest_8257_Location"] = "오그틴크 (아즈샤라; "..YELLOW.."42.2, 42.6"..PREV..")";
L["Quest_8257_Note"] = "사제 퀘스트.  몰파즈는 "..YELLOW.."[5]"..PREV.." 에 있다.  그레타 모스후프에 있다. (악령의 숲 - 에메랄드 성소; "..YELLOW.."51.2, 82.2"..PREV..").";
...
L["Quest_8236_Location"] = "대마법사 실렘 (아즈샤라; "..YELLOW.."29.6, 40.6"..PREV..")";
L["Quest_8236_Note"] = "도적 퀘스트.  몰파즈에서 "..YELLOW.."[5]"..PREV.." 하늘색 열쇠가 드랍합니다.  조라크 라벤홀트 경은 알터랙 산맥 - 라벤홀트 장원에 있다. ("..YELLOW.."86.0, 79.0"..PREV..").";
...
L["Quest_8418_Location"] = "사령관 아쉬람 발러피스트 (서부 역병지대 - 서리바람 야영지; "..YELLOW.."42.8, 84.0"..PREV..")";
...
L["Quest_1445_Location"] = "펠제룰 (슬픔의 늪 - 스토나드; "..YELLOW.."48.0, 55.0"..PREV..")";
...
L["Quest_3380_Location"] = "의술사 우제리 (페랄라스; "..YELLOW.."74.4, 43.4"..PREV..")";
L["Quest_3380_Note"] = "마본 리벳시커는 "..YELLOW.."52.6, 45.8"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_4146_Location"] = "리브 리즐픽스 (불모의 땅; "..YELLOW.."62.4, 38.6"..PREV..")";
L["Quest_4146_Note"] = "선행 퀘스트는 '무이긴과 라라온' 라리온에서 시작 됩니다. (운고로 분화구; "..YELLOW.."45.6, 8.6"..PREV..").  사원의 지하껍질괴물, 진흙미늘벌레 또는 괴물에서 아지랑이를 얻을 수 있습니다.";
...
L["Quest_8413_Location"] = "바람의감시자 바스라 (알터랙 산맥; "..YELLOW.."80.4, 66.8"..PREV..")";
...
L["Quest_721_Location"] = "발굴조사단장 라이돌 (황야의 땅; "..YELLOW.."53.4, 43.2"..PREV..")";
L["Quest_721_Note"] = "선행 퀘스트는 구겨진 지도에서 시작됩니다. (황야의 땅; "..YELLOW.."53.0, 34.1"..PREV..").\n던전의 정문에 들어가기 전에 입구 지도 지역에서 해머토 그레즈를 "..YELLOW.."[1]"..PREV.." 찾을 수 있습니다.";
...
L["Quest_722_Location"] = "해머토 그레즈 (울다만; "..YELLOW.."입구 공간[1]"..PREV..").";
L["Quest_722_Note"] = "던전의 정문에 들어가기 전에 해당 지역에 있는 마그레간 딥섀도가 "..YELLOW.."[2 이동함]"..PREV.." 아뮬렛을 드랍합니다.";
...
L["Quest_1139_Location"] = "조언자 벨그룸 (아이언포지 - 탐험가의 전당; "..YELLOW.."77.2, 10.0"..PREV..")";
L["Quest_1139_Note"] = "서판은 "..YELLOW.."[8]"..PREV.." 에 있다.";
...
L["Quest_2418_Location"] = "리글퍼즈 (황야의 땅; "..YELLOW.."42.4, 52.8"..PREV..")";
...
L["Quest_704_Location"] = "발굴조사단장 아이언밴드 (모단 호수 - 아이언밴드의 발굴현장; "..YELLOW.."65.8, 65.6"..PREV..")";
L["Quest_704_Note"] = "선행 퀘스트는 발굴조사단장 스톰파이크에서 시작됩니다. (아이언포지 - 탐험가의 전당; "..YELLOW.."74.4, 12.0"..PREV..").\n돌조각 단지는 던전내, 외부 동굴 전체에 흩어져 있습니다.";
...
L["Quest_709_Location"] = "실성한 텔두린 (황야의 땅; "..YELLOW.."51.4, 76.8"..PREV..")";
L["Quest_709_Note"] = "서판은 동굴 북쪽에, 터널의 동쪽 끝에, 던전 앞에 있다."..YELLOW.."[3]"..PREV.."";
...
L["Quest_2398_Location"] = "발굴조사단장 스톰파이크 (아이언포지 - 탐험가의 전당; "..YELLOW.."74.4, 12.0"..PREV..")";
L["Quest_2398_Note"] = "밸로그는 "..YELLOW.."[1]"..PREV.." 에 있다.";
...
L["Quest_2240_Location"] = "밸로그 (울다만; "..YELLOW.."[1]"..PREV..")";
L["Quest_2240_Note"] = "비밀 석실은 "..YELLOW.."[4]"..PREV.." 에 있다.  비밀 석실을 열려면 레벨로쉬 티솔의 자루와 "..YELLOW.."[3]"..PREV.." 그리고 밸로그의 궤짝에서 그니키브의 메달 "..YELLOW.."[1]"..PREV.." 이 필요합니다.  이 두 아이템을 합치면 잃어버린 역사의 지팡이 만들수 있습니다.  지팡이는 지도방 "..YELLOW.."[3] 그리고 [4]"..PREV.." 에서 아이로나야를 소환하는 데 사용 됩니다.  그녀를 죽인 후, 그녀가 나온 방 안으로 들어가면 퀘스트가 완료됩니다.";
...
L["Quest_2198_Note"] = "목걸이를 탈바쉬 델 키젤에게 가져 가십시오. (아이언포지 - 마법 지구; "..YELLOW.."36.0, 4.0"..PREV..").";
...
L["Quest_2200_Location"] = "탈바쉬 델 키젤 (아이언포지 - 마법 지구; "..YELLOW.."36.0, 4.0"..PREV..")";
L["Quest_2200_Note"] = "성기사는 "..YELLOW.."[2]"..PREV.." 에 있다.";
...
L["Quest_2201_Location"] = "성기사의 유해 (울다만; "..YELLOW.."[2]"..PREV..")";
L["Quest_2201_Note"] = "보석은 "..YELLOW.."[1]"..PREV.." 눈에 띄는 항아리에, "..YELLOW.."[8]"..PREV.." 어둠괴철로단 금고에서, 그리고 "..YELLOW.."[9]"..PREV.." 그림로크 \n참고: 어둠괴철로단 금고를 열 때 몇명의 몬스터가 소환 됩니다.  탈바쉬의 수정점 유리병을 사용하여 퀘스트를 시작하고 다음 임무를 수행합니다.";
...
L["Quest_2204_Note"] = "부서진 목걸이의 마력원천은 아카에다스에서 드랍합니다. "..YELLOW.."[10]"..PREV..".  탈바쉬 델 키젤는 (아이언포지 - 마법 지구; "..YELLOW.."36.0, 4.0"..PREV..") 에 있다.";
...
L["Quest_17_Location"] = "가크 힐터치 (모단 호수 - 텔사마; "..YELLOW.."37.0, 49.2"..PREV..")";
...
L["Quest_1360_Location"] = "크롬 스타우트암 (아이언포지 - 탐험가의 전당; "..YELLOW.."74.2, 9.8"..PREV..")";
L["Quest_1360_Note"] = "던전에 들어가기 전에 보물을 찾을 수 있습니다.  그것은 동굴의 북쪽, 첫 번째 터널의 남동쪽 끝에 있습니다. "..YELLOW.."[4]"..PREV..".";
...
L["Quest_2278_Location"] = "노르간논의 원반 (울다만; "..YELLOW.."[11]"..PREV..")";
L["Quest_2278_Note"] = "퀘스트를 받은 후, 디스크 왼쪽에 있는 돌 감시자에게 말하십시오.  그런 다음 백금 원반을 다시 사용하여 소형 원반을 받으십시오. 소형 원반을 썬더 블러프 현자 트루스시커에게 가져가야 합니다. ("..YELLOW.."34.8, 47.8"..PREV..").  다음은 근처에 있는 다른 NPC에게 시작합니다.";
...
L["Quest_1956_Location"] = "타베사 (먼지진흙 습지대; "..YELLOW.."46.0, 57.0"..PREV..")";
L["Quest_1956_Note"] = "마법사 퀘스트.  흑요석 마력원천은 흑요석 파수꾼 "..YELLOW.."[5]"..PREV.." 에서 드랍합니다.";
...
L["Quest_1192_Location"] = "포직 (버섯구름 봉우리 - 신기루 경주장; "..YELLOW.."80.0, 75.8"..PREV..")";
...
L["Quest_2283_Location"] = "드란 드로퍼스 (오그리마 - 골목길; "..YELLOW.."59.4, 36.8"..PREV..")";
...
L["Quest_2284_Location"] = "드란 드로퍼스 (오그리마 - 골목길; "..YELLOW.."59.4, 36.8"..PREV..")";
L["Quest_2284_Note"] = "성기사는 "..YELLOW.."[2]"..PREV.." 에 있다.";
...
L["Quest_2318_Location"] = "성기사의 유해 (울다만; "..YELLOW.."[2]"..PREV..")";
L["Quest_2318_Note"] = "자칼 모스멜드는  (황야의 땅 - 카르가스; "..YELLOW.."2.6, 46.0"..PREV..") 에 있다.";
...
L["Quest_2339_Location"] = "자칼 모스멜드 (황야의 땅 - 카르가스; "..YELLOW.."2.6, 46.0"..PREV..")";
L["Quest_2339_Note"] = "보석은 "..YELLOW.."[1]"..PREV.." 눈에 띄는 항아리에, "..YELLOW.."[8]"..PREV.." 어둠괴철로단 금고에서, 그리고 "..YELLOW.."[9]"..PREV.." 그림로크.  \n참고: 어둠괴철로단 금고를 열 때 몇명의 몬스터가 소환 됩니다.  부서진 목걸이의 마력원천은 아카에다스에서 드랍합니다. "..YELLOW.."[10]"..PREV..".";
...
L["Quest_2202_Location"] = "자칼 모스멜드 (황야의 땅 - 카르가스; "..YELLOW.."2.6, 46.0"..PREV..")";
...
L["Quest_2342_Location"] = "패트릭 가레트 (언더시티; "..YELLOW.."62.6, 48.4"..PREV..")";
L["Quest_2342_Note"] = "던전에 들어가기 전에 보물을 찾을 수 있습니다. 남쪽 터널 끝에 있습니다. 입구지도에 "..YELLOW.."[5]"..PREV..".";

L["Quest_971_Name"] = "심연의 지식";
L["Quest_971_Objective"] = "아이언포지, 쓸쓸한 뒷골목에 있는 게릭 본그립에게 로르갈리스 초본을 가져가야 합니다.";
L["Quest_971_Location"] = "게릭 본그립 (아이언포지 - 쓸쓸한 뒷골목; "..YELLOW.."50.4, 6.0"..PREV..")";
L["Quest_971_Note"] = "물 속에서 초본을 "..YELLOW.."[2]"..PREV.." 찾을 수 있습니다.";
...
L["Quest_1275_Location"] = "게르샬라 나이트위스퍼 (어둠의 해안 - 아우버다인; "..YELLOW.."38.4, 43.0"..PREV..")";
L["Quest_1275_Note"] = "선행 퀘스트는 선택 사항입니다.  아르고스 나이트위스퍼에서 받을 수 있습니다. (스톰윈드 - 공원; "..YELLOW.."21.4, 55.6"..PREV..").  던전 포털 입구 외부에서 나가의 변이된 뇌간을 드랍합니다.";
...
L["Quest_1198_Location"] = "새벽감시자 섀드라스 (다르나서스 - 장인의 정원; "..YELLOW.."55.4, 24.6"..PREV..")";
L["Quest_1198_Note"] = "당신은 은빛경비병 타엘리드를 "..YELLOW.."[4]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_1200_Location"] = "은빛경비병 타엘리드 (검은심연 나락; "..YELLOW.."[4]"..PREV..")";
L["Quest_1200_Note"] = "황혼의 군주 켈리스는 "..YELLOW.."[8]"..PREV.." 에 있다.  새벽감시자 셀고름은 (다르나서스 - 장인의 정원; "..YELLOW.."55.8, 24.2"..PREV..") 에서 찾을 수 있습니다.";
...
L["Quest_1199_Location"] = "은빛경비병 마나도스 (다르나서스 - 장인의 정원; "..YELLOW.."55.2, 23.6"..PREV..")";
...
L["Quest_6563_Location"] = "제네우 생크리 (잿빛 골짜기 - 조람가르 전초기지; "..YELLOW.."11.6, 34.2"..PREV..")";
L["Quest_6563_Note"] = "선행 퀘스트인 검은심연의 나락으로는 츄나만에게 받을 수 있습니다. (돌발톱 산맥 - 해바위 야영지; "..YELLOW.."47.2, 64.2"..PREV..").  사파이어는 던전 입구 이전의 터널에서 찾을 수 있습니다.";
...
L["Quest_6564_Note"] = "검은심연의 바다여사제에게 축축한 쪽지를 얻을 수 있습니다.  그다음 제네우 생크리에게 가져 가십시오. (잿빛 골짜기 - 조람가르 전초기지; "..YELLOW.."11.6, 34.2"..PREV..").  로구스 제트는 "..YELLOW.."[6]"..PREV.."에 있다.  나열된 보상은 후속 퀘스트를 위한 것입니다.";
...
L["Quest_6921_Location"] = "제네우 생크리 (잿빛 골짜기 - 조람가르 전초기지; "..YELLOW.."11.6, 34.2"..PREV..")";
L["Quest_6921_Note"] = "물 속에서 심연의 핵 "..YELLOW.."[7]"..PREV.." 을 찾을 수 있습니다.  당신이 심연의 핵을 얻으면 군주 아쿠아니스가 당신을 공격합니다.  그는 퀘스트 아이템을 드랍 합니다. 당신은 그걸 가지고 제네우 생크리에게 돌아가야 합니다.";
...
L["Quest_6561_Location"] = "은빛경비병 타엘리드 (검은심연 나락; "..YELLOW.."[4]"..PREV..")";
L["Quest_6561_Note"] = "황혼의 군주 켈리스가 "..YELLOW.."[8]"..PREV.." 에 있습니다. 바샤나 룬토템을 (썬더 블러프 - 장로의 봉우리; "..YELLOW.."70.8, 33.8"..PREV..") 찾을 수 있습니다.";
...
L["Quest_7441_Location"] = "아즈토르딘 (페랄라스 - 라리스의 정자; "..YELLOW.."76.8, 37.4"..PREV..")";
L["Quest_7441_Note"] = "푸실린은 "..YELLOW.."[1]"..PREV.." 에 있다.  네가 말을 걸면 도망가지만, 더이상 움직이지 않게 되면 전투가 시작됩니다. "..YELLOW.."[2]"..PREV..".  그는 혈투의 전장 북쪽과 서쪽에서 사용되는 초승달 열쇠를 드랍합니다.";
...
L["Quest_7488_Location"] = "라트로니쿠스 문스피어 (페랄라스 - 페더문 요새; "..YELLOW.."30.4, 46.0"..PREV..")";
L["Quest_7488_Note"] = "레스텐드리스는 "..YELLOW.."[3]"..PREV.." 에 있다.  선행 퀘스트는 아이언포지의 급사 해머풀에서 나옵니다.  그는 도시 전체를 돌아 다닙니다.";
...
L["Quest_5526_Location"] = "라빈 사투르나 (달의 숲 - 나이트 헤이븐; "..YELLOW.."51.6, 44.8"..PREV..")";
L["Quest_5526_Note"] = "칼날바람 알진은 "..YELLOW.."[5]"..PREV.." 에서 찾을 수 있습니다.  선행 퀘스트는 라빈 사투르나에서 그리고 당신을 정화의 성물함을 (실리더스; "..YELLOW.."63.2, 55.2"..PREV..") 회수하도록 보냅니다.";
...
L["Quest_8990_Location"] = "보들리 (검은바위 산; "..YELLOW.."[D] 입구지도"..PREV..")";
...
L["Quest_8990_FollowQuest"] = "마지막 준비 ("..YELLOW.."검은바위 첨탑 상층"..PREV..")";
...
L["Quest_7581_Location"] = "노쇠한 다이오 (저주받은 땅 - 타락의 흉터; "..YELLOW.."34.2, 50.0"..PREV..")";
L["Quest_7581_Note"] = "이것은 노쇠한 다이오가 준 또 다른 퀘스트와 함께 파멸의 의식 주문에 대한 흑마법사 전용 퀘스트 입니다.  '푸실린과 노쇠한 아즈토르딘' 퀘스트에서 제공하는 초승달 열쇠가 있다면, 라리스 정자 뒷문을 통해 혈투의 전장 동쪽으로 들어갈 수 있습니다. (페랄라스; "..YELLOW.."77, 37"..PREV..").";

L["Quest_7489_Name"] = "레스텐드리스의 그물!";
L["Quest_7489_Objective"] = "페랄라스의 모자케 야영지에 있는 탈로 쏜후프에게 레스텐드리스의 그물을 가져가야 합니다.";
L["Quest_7489_Location"] = "탈로 쏜후프 (페랄라스 - 모자케 야영지; "..YELLOW.."76.0, 43.8"..PREV..")";
L["Quest_7489_Note"] = "레스텐드리스는 혈투의 전장 "..YELLOW.."동쪽"..PREV.." 에 "..YELLOW.."[3]"..PREV.." 있습니다.  선행 퀘스트는 오그리마의 징집관 고를라취에서 나온다.  그는 도시 전체를 돌아 다닙니다.";
L["Quest_7489_RewardText"] = "1";
L["Quest_7489_PreQuest"] = "모자케 야영지";

L["Quest_1193_Name"] = "부서진 함정";
L["Quest_1193_Objective"] = "함정을 수리합니다.";
L["Quest_1193_Location"] = "부서진 함정 (혈투의 전장; "..YELLOW.."북쪽"..PREV..")";
...
L["Quest_5518_Location"] = "노트 팀블잭 (혈투의 전장; "..YELLOW.."북쪽, [4]"..PREV..")";
L["Quest_5518_Note"] = "반복 가능한 퀘스트.  오우거 타닌은 "..YELLOW.."[4] (위에)"..PREV.." 근처에서 볼 수 있습니다.  룬무늬 두루마리는 재봉술, 튼튼한 가죽은 무두질, 룬문자 실타래는 재봉용품 상인에서 나옵니다.";
L["Quest_5518_RewardText"] = "1";

L["Quest_5525_Name"] = "노트 구출 대작전!";
L["Quest_5525_Objective"] = "노트 팀블잭을 위해 고르독 족쇄 열쇠를 수집합니다.";
L["Quest_5525_Location"] = "노트 팀블잭 (혈투의 전장; "..YELLOW.."북쪽, [4]"..PREV..")";
...
L["Quest_7703_Location"] = "대장 크롬크러쉬 (혈투의 전장; "..YELLOW.."북쪽, [5]"..PREV..")";
L["Quest_7703_Note"] = "왕자 토르텔드린은 "..YELLOW.."서쪽"..PREV.." 과 "..YELLOW.."[7]"..PREV.." 에 있습니다.  건틀릿은 근처 상자안에 있습니다.  공물 실행 후 이 퀘스트를 얻을 수 있으며 '왕이 되는 것이 좋다!' 버프를 가질 수 있습니다.";
L["Quest_7703_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_5528_Name"] = "고르독 술 맛보기";
L["Quest_5528_Objective"] = "무료 술.";
L["Quest_5528_Location"] = "천둥발 크리그 (혈투의 전장; "..YELLOW.."북쪽, [2]"..PREV..")";
...
L["Quest_7482_Location"] = "학자 룬쏜 (페랄라스 - 페더문 요새; "..YELLOW.."31.2, 43.4"..PREV..")";
L["Quest_7482_Note"] = "카리엘 윈탈루스의 유해는 "..GREEN.."[1'] 도서관"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_7461_Location"] = "셴드랄라 고대인 (혈투의 전장; "..YELLOW.."서쪽, [1] (위에)"..PREV..")";
L["Quest_7461_Note"] = "수정탑은 "..BLUE.."[B]"..PREV.." 에 있다. 이몰타르는 "..YELLOW.."[6]"..PREV..", 왕자 토르텔드린는 "..YELLOW.."[7]"..PREV.." 에 있다.";
...
L["Quest_7877_Location"] = "셴드랄라 고대인 (혈투의 전장; "..YELLOW.."서쪽, [1]"..PREV..")";
L["Quest_7877_Note"] = "근처 계단 아래에 보물을 찾을 수 있습니다. "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7631_Location"] = "모르줄 블러드브링어 (불타는 평원; "..YELLOW.."12,31"..PREV..")";
L["Quest_7631_Note"] = "흑마법사 퀘스트.  흑마법사 영웅 탈것 퀘스트 라인의 최종 퀘스트.  먼저 표시된 모든 수정탑을 멈추게 해야 합니다. "..BLUE.."[B]"..PREV.." 그리고 이몰타르를 처지 "..YELLOW.."[6]"..PREV..".  그 후, 소환 의식을 시작할 수 있습니다.  약 20개의 영혼의 조각을 준비하고 데스무라의 종, 심판의 양초, 어둠의 물레를 유지하기 위해 특별히 지정된 흑마법사가 있어야 합니다.  공포의 수호병은 지배를 할수 있습니다.  완료 후, 공포마 영홍과 대화하여 퀘스트를 완료하십시오.";
L["Quest_7631_PreQuest"] = "임프 배달 ("..YELLOW.."스칼로맨스"..PREV..")";

L["Quest_7506_Name"] = "에메랄드의 꿈...";
L["Quest_7506_Objective"] = "주인에게 책을 되돌려주십시오.";
L["Quest_7506_Location"] = "에메랄드의 꿈 (모든 혈투의 전장에서 무작위로 보스에서 드랍합니다.)";
L["Quest_7506_Note"] = "드루이드 퀘스트.  책을 현자 야본에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7503_Note"] = "사냥꾼 퀘스트.  책을 현자 마이코스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7500_Note"] = "마법사 퀘스트.  책을 현자 킬드라스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7501_Note"] = "성기사 퀘스트.  책을 현자 마이코스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7504_Note"] = "사제 퀘스트.  책을 현자 야본에게 넘겨주십시오 "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7498_Note"] = "도적 퀘스트.  책을 현자 킬드라스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7502_Note"] = "흑마법사 퀘스트.  책을 현자 마이코스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7499_Note"] = "전사 퀘스트.  책을 현자 킬드라스에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7484_Location"] = "현자 리드로스 (혈투의 전장 서쪽; "..GREEN.."[1'] 도서관"..PREV..")";
L["Quest_7484_Note"] = "선행 퀘스트는 아니지만, 이 퀘스트를 시작하기 전에 엘프의 전설을 완료해야 합니다.\n\n성서는 혈투의 전장에서 무작위로 드랍하며 거래가 가능하므로 경매장에서 찾을 수 있습니다.  어둠의 허물은 획득 시 귀속이며, 일부 보스에서 드랍할 수 있습니다. 되살아난 피조물과 되살아난 해골문지기는 "..YELLOW.."스칼로맨스"..PREV.." 에 있다.";
...
L["Quest_7485_Location"] = "현자 리드로스 (혈투의 전장 서쪽; "..GREEN.."[1'] 도서관"..PREV..")";
L["Quest_7485_Note"] = "선행 퀘스트는 아니지만, 이 퀘스트를 시작하기 전에 엘프의 전설을 완료해야 합니다.\n\n성서는 혈투의 전장에서 무작위로 드랍하며 거래가 가능하므로 경매장에서 찾을 수 있습니다.  닳아해진 누더기골렘 조각은 획득 시 귀속이며 먹보 람스타인, 독고름 누더기골렘, 썩은담즙 누더기골렘과 기워붙인 누더기골렘에서 드랍합니다. "..YELLOW.."스트라솔름"..PREV..".";
...
L["Quest_7483_Location"] = "현자 리드로스 (혈투의 전장 서쪽; "..GREEN.."[1'] 도서관"..PREV..")";
...
L["Quest_7507_Location"] = "폴로르의 용사냥 개론 (무작위 보스 드랍 "..YELLOW.."혈투의 전장"..PREV..")";
L["Quest_7507_Note"] = "전사 또는 성기사 퀘스트.  현자 리드로스에게 갑니다. (혈투의 전장 서쪽; "..GREEN.."[1'] 도서관"..PREV..").  이것을 바꾸면 쿠엘 세라에 대한 퀘스트를 시작할 수 있습니다.";
...
L["Quest_7481_Location"] = "현자 코로루스크 (페랄라스 - 모자케 야영지; "..YELLOW.."75.0, 43.8"..PREV..")";
L["Quest_7481_Note"] = "카리엘 윈탈루스의 유해는 "..GREEN.."[1'] 도서관"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_7505_Note"] = "주술사 퀘스트. 책을 현자 야본에게 넘겨주십시오. "..GREEN.."[1'] 도서관"..PREV..".";
...
L["Quest_7070_Location"] = "대마법사 테르보쉬 (먼지진흙 습지대 - 테라모어 섬; "..YELLOW.."66.4, 49.2"..PREV..")";
...
L["Quest_7041_Location"] = "탈렌드리아 (잊혀진 땅 - 나이젤의 야영지; "..YELLOW.."68.4, 8.8"..PREV..")";
...
L["Quest_7028_Location"] = "윌로우 (잊혀진 땅; "..YELLOW.."62.2, 39.6"..PREV..")";
...
L["Quest_7067_Location"] = "켄타우로스 추방자 (잊혀진 땅;  주변을 돌아다님 "..YELLOW.."50.4, 86.6"..PREV..")";
L["Quest_7067_Note"] = "이름 없는 예언자를 쳐치 하고 ("..YELLOW.."[A] 입구지도"..PREV..") 칸5명을 처치하세요.  첫 번째는 근처의 중간 경로에 있습니다. ("..YELLOW.."[1] 입구지도"..PREV..").  두 번째는 마라우돈의 보라색 부분이지만 던전에 들어가기 전에 ("..YELLOW.."[2] 입구지도"..PREV..").  세 번째는 던전에 들어가기 전에 주황색 부분에 있습니다. ("..YELLOW.."[3] 입구지도"..PREV..").  네 번째는 가깝고 "..YELLOW.."[4]"..PREV.." 그리고 다섯 번째도 가깝습니다.  "..YELLOW.."[1]"..PREV..".";
...
L["Quest_7044_Location"] = "카빈드라 (잊혀진 땅 - 마라우돈; "..YELLOW.."[4] 입구지도"..PREV..")";
L["Quest_7044_Note"] = "던전에 들어가기 전에 주황색 시작 부분에 카빈드라를 찾을 수 있습니다.\n녹시온에서 셀레브리안 마법봉을 "..YELLOW.."[2]"..PREV..", 군주 바일텅에서 셀레브리안 다이아몬드를 "..YELLOW.."[5]"..PREV.." 얻습니다. 셀레브라스는 "..YELLOW.."[7]"..PREV.." 에 있다. 그와 대화 하려면 그를 처치해야 합니다.";
L["Quest_7044_FollowQuest"] = "셀레브라스의 홀";

L["Quest_7046_Name"] = "셀레브라스의 홀";
L["Quest_7046_Objective"] = "회복된 셀레브라스가 셀레브라스의 홀을 만드는 동안 그를 도와야 합니다.\n의식을 마친 후 그와 대화하십시오.";
L["Quest_7046_Location"] = "회복된 셀레브라스 (마라우돈; "..YELLOW.."[7]"..PREV..")";
...
L["Quest_7065_Location"] = "수호자 마란디스 (잊혀진 땅 - 나이젤의 야영지; "..YELLOW.."63.8, 10.6"..PREV..")";
L["Quest_7065_Note"] = "공주 테라드라스는 "..YELLOW.."[11]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_7066_Location"] = "재타르의 영혼 (마라우돈; "..YELLOW.."[11]"..PREV..")";
L["Quest_7066_Note"] = "공주 테라드라스를 처치하고 재타르의 영혼이 나타납니다. "..YELLOW.."[11]"..PREV..". 수호자 레물로스는 (달의 숲 - 레물로스의 제단; "..YELLOW.."36.2, 41.8"..PREV..") 에서 찾을 수 있습니다.";
...
L["Quest_7068_Location"] = "우텔나이 (오그리마 - 정기의 골짜기; "..YELLOW.."39.0, 86.0"..PREV..")";
...
L["Quest_7029_Location"] = "바르크 배틀스카 (잊혀진 땅 - 그늘수렵 마을; "..YELLOW.."23.2, 70.2"..PREV..")";
...
L["Quest_7064_Location"] = "셀렌드라 (잊혀진 땅; "..YELLOW.."26.8, 77.6"..PREV..")";
L["Quest_7064_Note"] = "공주 테라드라스는 "..YELLOW.."[11]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_5723_Location"] = "라하우로 (썬더 블러프 - 장로의 봉우리; "..YELLOW.."70.4, 32.2"..PREV..")";
...
L["Quest_5725_Location"] = "바리마트라스 (언더시티 - 왕실; "..YELLOW.."56.2, 92.6"..PREV..")";
...
L["Quest_5722_Location"] = "라하우로 (썬더 블러프 - 장로의 봉우리; "..YELLOW.."70.4, 32.2"..PREV..")";
L["Quest_5722_Note"] = "마우르 그림토템은 "..YELLOW.."[1]"..PREV.." 에서 찾을 수 있습니다.  가방을 얻은 후 당신은 썬더 블러프에 라하우로에게 가져가야 합니다.  보상은 후속 퀘스트를 위한 것입니다.";
...
L["Quest_5728_Location"] = "스랄 (오그리마 - 지혜의 골짜기; "..YELLOW.."32.0, 37.8"..PREV..")";
L["Quest_5728_Note"] = "당신은 바잘란 "..YELLOW.."[4]"..PREV.." 과 기원사 제로쉬 "..YELLOW.."[3]"..PREV.." 를 찾을 수 있습니다.  선행 퀘스트는 오그리마 스랄에서 시작됩니다.";
...
L["Quest_5761_Location"] = "네루 파이어블레이드 (오그리마 - 어둠의 틈; "..YELLOW.."49.6, 50.4"..PREV..")";
L["Quest_5761_Note"] = "당신은 욕망의 타라가만를 "..YELLOW.."[2]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_6626_Location"] = "미리암 문싱어 (불모의 땅; "..YELLOW.."49.0, 94.8"..PREV..")";
...
L["Quest_3525_Location"] = "벨리스트라즈 (가시덩굴 구릉; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_3636_Location"] = "대주교 베네딕투스 (스톰윈드 - 빛의 대성당; "..YELLOW.."39.6, 27.4"..PREV..")";
L["Quest_3636_Note"] = "혹한의 암네나르는 가시덩굴 구릉의 마지막 보스입니다. 당신은 "..YELLOW.."[6]"..PREV.." 에서 찾을 수 있다.";
...
L["Quest_6521_Location"] = "바리마트라스 (언더시티 - 왕실; "..YELLOW.."56.2, 92.6"..PREV..")";
L["Quest_6521_Note"] = "이전 퀘스트는 가시덩굴 우리의 마지막 보스에서 얻을 수 있습니다.  던전 밖에서 사절 말킨을 발견할 수 있습니다. (불모의 땅; "..YELLOW.."48.0, 92.4"..PREV..").";
...
L["Quest_3341_Location"] = "앤드류 브로넬 (언더시티 - 마법 지구; "..YELLOW.."74.0, 32.8"..PREV..")";
L["Quest_3341_Note"] = "혹한의 암네나르는 가시덩굴 구릉의 마지막 보스입니다.  당신은 "..YELLOW.."[6]"..PREV.." 에서 찾을 수 있다.";
...
L["Quest_1221_Location"] = "메보크 미지릭스 (불모의 땅 - 톱니항; "..YELLOW.."62.4, 37.6"..PREV..")";
...
L["Quest_1142_Location"] = "헤랄라스 팰로우브룩 (가시덩굴 우리; "..YELLOW.."[8]"..PREV..")";
L["Quest_1142_Note"] = "펜던트는 무작위 드랍 입니다.  트레샬라 팰로우브룩에게 펜던트를 가져가야 합니다. (다르나서스 - 상인의 정원; "..YELLOW.."69.4, 67.4"..PREV..").";
L["Quest_1142_RewardText"] = "1"..AQ_OR.."2";

L["Quest_1144_Name"] = "수입업자 윌릭스";
L["Quest_1144_Objective"] = "수입업자 윌릭스를 호위해 가시덩굴 우리에서 나가야 합니다.";
L["Quest_1144_Location"] = "수입업자 윌릭스 (가시덩굴 우리; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_1101_Location"] = "팔핀델 웨이워더 (페랄라스 - 탈라나르; "..YELLOW.."89.6, 46.4"..PREV..")";
L["Quest_1101_Note"] = "서슬깃 차를가 "..YELLOW.."[7]"..PREV.." 이 퀘스트에 필요한 메달을 드랍합니다.";
...
L["Quest_1701_Location"] = "푸렌 롱비어드 (스톰윈드 - 드워프 지구; "..YELLOW.."58.0, 16.8"..PREV..")";
L["Quest_1701_Note"] = "전사 퀘스트.  루구르에게 "..YELLOW.."[1]"..PREV.." 연소 약병을 얻을 수 있습니다.\n\n 다음 연퉤는 각 종족마다 다릅니다. 인간을 위한 불타는 혈액, 드워프와 노움은 위한 철산호 그리고 나이트 엘프를 위한 바짝 마른 알껍질로 이어 집니다.";
...
L["Quest_1109_Location"] = "수석 연금술사 파라넬 (언더시티 - 연금술 실험실; "..YELLOW.."48.4, 69.4 "..PREV..")";
L["Quest_1109_Note"] = "가시덩굴 조분석 던전에서 발견되는 박쥐에 의해 드랍됩니다.";
L["Quest_1109_FollowQuest"] = "열정의 증거 ("..YELLOW.."[붉은십자군 수도원]"..PREV..")";

L["Quest_1102_Name"] = "운명의 복수";
L["Quest_1102_Objective"] = "썬더 블러프에 있는 아울드 스톤스파이어에게 차를가의 심장을 가져가야 합니다.";
L["Quest_1102_Location"] = "아울드 스톤스파이어 (썬더 블러프; "..YELLOW.."36.2, 59.8"..PREV..")";
L["Quest_1102_Note"] = "서슬깃 차를가는 "..YELLOW.."[7]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_1838_Location"] = "툰그림 파이어게이즈 (불모의 땅; "..YELLOW.."57.2, 30.2"..PREV..")";
L["Quest_1838_Note"] = "전사 퀘스트.  루구르에게 "..YELLOW.."[1]"..PREV.." 연소 약병을 얻을 수 있습니다..\n\n이 퀘스트를 완료하면 동일한 NPC에서 4개의 새로운 퀘스트를 시작할 수 있습니다.";
...
L["Quest_1486_Location"] = "날팍 (불모의 땅 - 통곡의 동굴; "..YELLOW.."47, 36"..PREV..")";
...
L["Quest_959_Location"] = "기중기 기사 비글퍼즈 (불모의 땅 - 톱니항; "..YELLOW.."63.0, 37.6"..PREV..")";
...
L["Quest_1491_Location"] = "메보크 미지릭스 (불모의 땅 - 톱니항; "..YELLOW.."62.4, 37.6"..PREV..")";
...
L["Quest_1487_Location"] = "에브루 (불모의 땅 - 통곡의 동굴; "..YELLOW.."47, 36"..PREV..")";
...
L["Quest_6981_Location"] = "빛나는 조각 (걸신들린 무타누스로 부터 드랍; "..YELLOW.."[9]"..PREV..")";
L["Quest_6981_Note"] = "4명의 지도자 드루이드를 죽이고 입구에 있는 타우렌 드루이드를 호위해야 걸신들린 무타누스가 나타납니다. \n조각을 가지게 되면, 당신은 그것을 톱니항에 은행으로 가져오고, 그런 다음 통곡의 동굴 언덕 위에 팔라 세이지윈드에게 가져가야 합니다. (불모의 땅; "..YELLOW.."48.2, 32.8"..PREV..").";
...
L["Quest_962_Location"] = "연금술사 자마 (썬더 블러프 - 정기의 봉우리; "..YELLOW.."23.0, 21.0"..PREV..")";
L["Quest_962_Note"] = "연금술사 자마는 정기의 봉우리 아래 동굴에 있습니다.  선행 퀘스트는 연금술사 헬브림에게 받을 수 있습니다. (불모의 땅 - 크로스로드; "..YELLOW.."51.4, 30.2"..PREV..").\n던전 입구와 던전 내부의 동굴에서 불뱀꽃이 있습니다.  약초채집을 가진 플레이어는 미니맵에서 식물을 볼 수 있습니다.";
...
L["Quest_914_Location"] = "나라 와일드메인 (썬더 블러프 - 장로의 봉우리; "..YELLOW.."75.6, 31.2"..PREV..")";
L["Quest_914_Note"] = "퀘스트 라인은 대드루이드 하뮬 룬토템에서 시작 됩니다. (썬더 블러프 - 장로의 봉우리; "..YELLOW.."78.4, 28.4"..PREV..")\n4명의 드루이드 보스가 보석을 드랍 - 군주 코브란 "..YELLOW.."[2]"..PREV..", 여군주 아나콘드라 "..YELLOW.."[3]"..PREV..", 군주 피타스 "..YELLOW.."[5]"..PREV.." 와 군주 서펜티스 "..YELLOW.."[7]"..PREV..".";
...
L["Quest_3042_Location"] = "트렌튼 라이트해머 (타나리스 - 가젯잔; "..YELLOW.."51.4, 28.6"..PREV..")";
...
L["Quest_2865_Location"] = "트란렉 (타나리스 - 가젯잔; "..YELLOW.."51.6, 26.8"..PREV..")";
L["Quest_2865_Note"] = "선행 퀘스트는 크라젝에서 시작됩니다. (가시덤불 골짜기 - 무법항; "..YELLOW.."27.0, 77.2"..PREV..").\n모든 쇠똥구리는 껍질을 드랍 할 수 있습니다.  당신은 많은 쇠똥구리를 "..YELLOW.."[2]"..PREV.." 찾을 수 있습니다.";
L["Quest_2865_PreQuest"] = "트란렉";

L["Quest_2846_Name"] = "심연의 티아라";
L["Quest_2846_Objective"] = "먼지진흙 습지대에 있는 타베사에게 심연의 티아라를 가져가야 합니다.";
L["Quest_2846_Location"] = "타베사 (먼지진흙 습지대; "..YELLOW.."46.0, 57.0"..PREV..")";
L["Quest_2846_Note"] = "유체술사 벨라타는 "..YELLOW.."[6]"..PREV.." 심연의 티아라를 드랍합니다.";
...
L["Quest_2991_Location"] = "샤디우스 그림섀이드 (저주받은 땅 - 너더가드 요새; "..YELLOW.."67.0, 19.4"..PREV..")";
L["Quest_2991_Note"] = "퀘스트 라인은 그리핀 조련사 탈론액스에서 시작 됩니다. (동부 내륙지 - 와일드해머 요새; "..YELLOW.."9.8, 44.4"..PREV..").\n네크룸 거트츄어는 "..YELLOW.."[4]"..PREV.." 사원 행사 마지막에 싸우는 군중과 함께 나타납니다.";
...
L["Quest_3527_Location"] = "예킨야 (타나리스 - 스팀휘들 항구; "..YELLOW.."67.0, 22.4"..PREV..")";
L["Quest_3527_Note"] = "동일한 NPC에서 선행 퀘스트를 받습니다.\n서판은 순교자 데카 "..YELLOW.."[2]"..PREV.." 그리고 유체술사 벨라타 "..YELLOW.."[6]"..PREV.." 에서 드랍합니다.";
...
L["Quest_2768_Location"] = "선임기술자 빌지위즐 (타나리스 - 가젯잔; "..YELLOW.."52.4, 28.4"..PREV..")";
L["Quest_2768_Note"] = "하사관 블라이에게서 막대를 얻습니다.  사원 행사 후에 "..YELLOW.."[4]"..PREV.." 그것을 찾을 수 있습니다.";
L["Quest_2768_RewardText"] = "1"..AQ_OR.."2";

L["Quest_2770_Name"] = "가즈릴라";
L["Quest_2770_Objective"] = "소금 평원에 있는 위즐 브라스볼츠에게 가즈릴라의 전기 비늘을 가져가야 합니다.";
L["Quest_2770_Location"] = "위즐 브라스볼츠 (버섯구름 봉우리 - 신기루 경주장; "..YELLOW.."78.0, 77.0"..PREV..")";
L["Quest_2770_Note"] = "가즈릴라는 "..YELLOW.."[6]"..PREV.." 징을 두드리면 소환됩니다.  파티원에게 줄파락의 나무망치가 있어야 합니다.";
...
L["Quest_2936_Location"] = "장로 가드린 (듀로타 - 센진 마을; "..YELLOW.."56.0, 74.6"..PREV..")";
L["Quest_2936_Note"] = "퀘스트 라인은 독병에서 시작 됩니다. 동부 내륙지의 트롤 마을 테이블에서 발견됩니다.\n서판은 "..YELLOW.."[2]"..PREV.." 에서 찾을 수 있습니다.";
...
L["Quest_6822_Location"] = "군주 히드락시스 (아즈샤라; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6822_Note"] = "이들은 화산 심장부 내부에서 발견되는 정예 몬스터 입니다.";
L["Quest_6822_PreQuest"] = "엠버시어의 눈 ("..YELLOW.."검은바위 첨탑 상층"..PREV..")";
...
L["Quest_6824_Location"] = "군주 히드락시스 (아즈샤라; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6824_Note"] = "루시프론은 "..YELLOW.."[1]"..PREV..", 설퍼론은 "..YELLOW.."[8]"..PREV..", 게헨나스는 "..YELLOW.."[3]"..PREV.." 그리고 샤즈라는 "..YELLOW.."[5]"..PREV..".  다음의 퀘스트에 대한 보상이 제공됩니다.";
...
L["Quest_7786_Location"] = "대영주 데미트리안 (실리더스; "..YELLOW.."21.8, 8.6"..PREV..")";
L["Quest_7786_Note"] = "우레폭풍 - 바람추적자의 성검 퀘스트라인.  가르 또는 남작 게돈에서 바람추적자의 족쇄 왼쪽 또는 오른쪽을 조각을 얻은 후 시작됩니다. 가르 "..YELLOW.."[4]"..PREV.." 남작 게돈 "..YELLOW.."[6]"..PREV..".  그런 다음 대영주 데이트리안에게 이야기하여 퀘스트를 시작하십시오.  라그라노스에서 불의 군주의 정수가 드랍합니다. "..YELLOW.."[10]"..PREV..".  이후 재료를 합치면, 왕자 썬더란이 소환되며 그를 처치해야 합니다. 그는 40인 공격대 보스입니다.";
...
L["Quest_7604_Location"] = "로크토스 다크바게이너 (검은바위 나락; "..YELLOW.."[15]"..PREV..")";
L["Quest_7604_Note"] = "로크토스로 부터 계약을 받으려면 설퍼론 주괴가 필요합니다. 화산 심장부의 초열의 골레마그에서 드랍합니다. "..YELLOW.."[7]"..PREV..".";
L["Quest_7604_RewardText"] = "1";

L["Quest_7632_Name"] = "고대의 잎사귀";
L["Quest_7632_Objective"] = "단단한 고대의 잎사귀의 주인을 찾아야 합니다. 행운을 빕니다. 세상은 아주 넓으니까요.";
L["Quest_7632_Location"] = "단단한 고대의 잎사귀 (불의 군주의 보물에서 드랍합니다.; "..YELLOW.."[9]"..PREV..")";
L["Quest_7632_Note"] = "고대정령 바르투스로 바뀝니다. (악령의 숲 - 강철나무 숲; "..YELLOW.."48.8, 24.2"..PREV..").";
L["Quest_7632_FollowQuest"] = "힘줄 감긴 고대의 잎주머니 ("..YELLOW.."아주어고스"..PREV..")";

L["Quest_8578_Name"] = "수정점 고글? 문제 없어요!";
L["Quest_8578_Objective"] = "나라인의 수정점 고글을 찾은 후, 타나리스에 있는 나라인 수스팬시에게 돌아가야 한다.";
L["Quest_8578_Location"] = "눈에 잘 띄지 않는 상자 (은빛소나무 숲 - 그레이메인 성벽; "..YELLOW.."46.2, 86.6"..PREV..")";
L["Quest_8578_Note"] = "퀘스트는 나라인 수스팬시로 변경되며 (타나리스; "..YELLOW.."65.2, 18.6"..PREV.."), 선행 퀘스트를 획득할 수 있습니다.";
...
L["Quest_7509_Location"] = "현자 리드로스 (혈투의 전장 서쪽; "..YELLOW.."[1] 도서관"..PREV..")";
...
L["Quest_7509_PreQuest"] = "폴로르의 용사냥 개론 ("..YELLOW.."혈투의 전장 서쪽"..PREV..") -> 쿠엘세라 검 만들기";

L["Quest_7495_Name"] = "얼라이언스의 승리";
L["Quest_7495_Objective"] = "오닉시아의 머리를 스톰윈드로 갖고 가서 국왕 바리안 린에게 보여주어야 합니다.";
L["Quest_7495_Location"] = "오닉시아의 머리 (오닉시아에서 드랍; "..YELLOW.."[3]"..PREV..")";
L["Quest_7495_Note"] = "대영주 볼바르 폴드라곤 (스톰윈드 - 스톰윈드 왕궁; "..YELLOW.."78.0, 18.0"..PREV..") 에 있다. 공격대 한 명만이 아이템을 루팅 할 수 있으며 퀘스트는 캐릭터 당 한 번만 수행 할 수 있습니다.\n\n다음은 그것에 대한 보상입니다.";
...
L["Quest_7490_Location"] = "오닉시아의 머리 (오닉시아에서 드랍; "..YELLOW.."[3]"..PREV..")";
L["Quest_7490_Note"] = "스랄은 (오그리마 - 지혜의 골짜기; "..YELLOW.."32.0, 37.8"..PREV..") 에 있다. 공격대 한 명만이 아이템을 루팅 할 수 있으며 퀘스트는 캐릭터 당 한 번만 수행 할 수 있습니다.\n\n다음은 그것에 대한 보상입니다.";
...
L["Quest_8201_Location"] = "엑잘 (가시덤블 골짜기 - 요잠바 섬; "..YELLOW.."15.2, 15.4"..PREV..")";
...
L["Quest_8183_Location"] = "학카르의 심장 (학카르에서 드랍; "..YELLOW.."[11]"..PREV..")";
L["Quest_8183_Note"] = "몰소르 (가시덤불 골짜기 - 요잠바 섬; "..YELLOW.."15.0, 15.2"..PREV..")";
...
L["Quest_8227_Note"] = "내트 페이글은 먼지진흙 습지대 ("..YELLOW.."59, 60"..PREV..") 에 있다. 퀘스트를 진행하면 내트페이글에게 진흙노린재 미끼를 구매하여 줄구룹에서 가즈란카를 소환할 수 있습니다.";

L["Quest_9023_Name"] = "완벽한 독";
L["Quest_9023_Objective"] = "세나리온 요새에 있는 더크 썬더우드가 베녹시스의 독주머니와 쿠린낙스의 독주머니를 가져다 달라고 했습니다.";
L["Quest_9023_Location"] = "더크 썬더우드 (실리더스 - 세나리온 요새; "..YELLOW.."52, 39"..PREV..")";
L["Quest_9023_Note"] = "대사제 베녹시스에서 베녹시스의 독주머니 드랍 "..YELLOW.."줄구룹"..PREV.." at "..YELLOW.."[2]"..PREV..". 쿠린낙스에서 쿠린낙스의 독주머니 드랍 "..YELLOW.."안퀴라즈 폐허"..PREV.." 에 "..YELLOW.."[1]"..PREV..".";
...
L["Quest_8791_Location"] = "무적의 오시리안의 머리 (무적의 오시리안에서 드랍; "..YELLOW.."[6]"..PREV..")";
L["Quest_8791_Note"] = "지휘관 마랄리스 (실리더스 - 세나리온 요새; "..YELLOW.."49, 34"..PREV..")";
...
L["Quest_8801_Location"] = "쑨의 눈 (쑨에서 드랍; "..YELLOW.."[9]"..PREV..")";
L["Quest_8801_Note"] = "캘레스트라즈 (안퀴라즈 사원; "..YELLOW.."2'"..PREV..")";
L["Quest_8801_FollowQuest"] = "칼림도어의 구세주";

L["Quest_8802_Name"] = "칼림도어의 구세주";
L["Quest_8802_Objective"] = "시간의 동굴에 있는 아나크로노스에게 쑨의 눈을 가져가야 합니다.";
L["Quest_8802_Location"] = "쑨의 눈 (쑨에서 드랍; "..YELLOW.."[9]"..PREV..")";
L["Quest_8802_Note"] = "아나크로노스 (타나리스 - 시간의 동굴; "..YELLOW.."65, 49"..PREV..")";
...
L["Quest_8784_Note"] = "안도르고스로 변신 (안퀴라즈 사원; "..YELLOW.."1'"..PREV..").";

L["Quest_8579_Name"] = "필멸의 영웅";
L["Quest_8579_Objective"] = "안퀴라즈 사원에 있는 칸드로스트라즈에게 퀴라지 군주의 휘장을 가져 가십시오.";
L["Quest_8579_Location"] = "칸드로스트라즈 (안퀴라즈 사원; "..YELLOW.."[1']"..PREV..")";
...
L["Quest_7261_Location"] = "부관 로티메르 (아이언포지 - 광장; "..YELLOW.."30,62"..PREV..")";
L["Quest_7261_Note"] = "부관 해거딘은 (알터랙 산맥; "..YELLOW.."39,81"..PREV..") 에 있다.";
...
L["Quest_7162_Location"] = "부관 해거딘 (알터랙 산맥; "..YELLOW.."39,81"..PREV..")";
L["Quest_7162_Note"] = "스톰파이크 깃발은 얼음날개 동굴 "..YELLOW.."[11]"..PREV.." 에 알터랙 계곡 - 북쪽지도. 계급장은 평판이 상승됨에 따라 NPC와 대화하여 상위 계급장으로 교체할 수 있습니다.\n\n이 퀘스트를 받기 위해 선행 퀘스트는 필요하지 않습니다.";
...
L["Quest_7141_Location"] = "발굴조사단장 스톤휴어 (알터랙 산맥; "..YELLOW.."41,80"..PREV..") and\n(알터랙 계곡 - 북쪽; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "드렉타르는 (알터랙 계곡 - 남쪽; "..YELLOW.."[B]"..PREV..") 에 있다. 퀘스트를 완료하기 위해 실제로 처치 할 필요는 없습니다. 전장은 어떤 식으로든 우리편이 승리해야합니다.\n이 퀘스트를 시작한 후, 보상을 위해 다시 NPC에 이야기하십시오.";
...
L["Quest_7121_Location"] = "산악경비대 붐벨로 (알터랙 계곡 - 북쪽; "..YELLOW.."Near [3] Before Bridge"..PREV..")";
L["Quest_7121_Note"] = "스톰파이크 병참장교는 (알터랙 계곡 - 북쪽; "..YELLOW.."[7]"..PREV..") 더 많은 퀘스트를 제공합니다.";

L["Quest_6982_Name"] = "얼음이빨 광산 보급품";
L["Quest_6982_Objective"] = "던 발다르에 있는 얼라이언스 병참장교에게 얼음이빨 광산 보급품 10개를 가져가야 합니다.";
L["Quest_6982_Location"] = "스톰파이크 병참장교 (알터랙 계곡 - 북쪽; "..YELLOW.."[7]"..PREV..")";
L["Quest_6982_Note"] = "보급품은 얼음이빨 광산 (알터랙 계곡 - 남쪽; "..YELLOW.."[6]"..PREV..") 에서 찾을 수 있습니다.";

L["Quest_5892_Name"] = "깊은무쇠 광산 보급품";
L["Quest_5892_Objective"] = "던 발다르에 있는 얼라이언스 병참장교에게 깊은무쇠 광산 보급품 10개를 가져가야 합니다.";
L["Quest_5892_Location"] = "스톰파이크 병참장교 (알터랙 계곡 - 북쪽; "..YELLOW.."[7]"..PREV..")";
L["Quest_5892_Note"] = "보급품은 검은무쇠 광산 (알터랙 계곡 - 북쪽; "..YELLOW.."[1]"..PREV..") 에서 찾을 수 있습니다.";

L["Quest_7223_Name"] = "방어구 조각";
L["Quest_7223_Objective"] = "던 발다르에 있는 멀고트 딥포지에게 방어구 조각 20개를 가져가야 합니다.";
L["Quest_7223_Location"] = "멀고트 딥포지 (알터랙 계곡 - 북쪽; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_7122_Location"] = "하사관 두르겐 스톰파이크 (알터랙 산맥; "..YELLOW.."37,77"..PREV..")";
L["Quest_7122_Note"] = "퀘스트를 완료하려면, 호드가 점령하는 동안 둘중 하나 깊은무쇠 광산에 모를로취나 (알터랙 계곡 - 북쪽; "..YELLOW.."[1]"..PREV..") 얼음이빨 광산에 작업반장 스니블을 (알터랙 계곡 - 남쪽; "..YELLOW.."[6]"..PREV..") 처치해야 합니다.";

L["Quest_7102_Name"] = "보초탑과 참호";
L["Quest_7102_Objective"] = "적군의 보초탑이나 참호에 있는 깃발을 파괴한 후 알터랙 산맥에 있는 하사관 두르겐 스톰파이크에게 돌아가야 합니다.";
L["Quest_7102_Location"] = "하사관 두르겐 스톰파이크 (알터랙 산맥; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7081_Location"] = "하사관 두르겐 스톰파이크 (알터랙 산맥; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7027_Location"] = "스톰파이크 야수관리인 (알터랙 계곡 - 북쪽; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7026_Location"] = "스톰파이크 산양기병대 지휘관 (알터랙 계곡 - 북쪽; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7386_Location"] = "대드루이드 렌퍼럴 (알터랙 계곡 - 북쪽; "..YELLOW.."[2]"..PREV..")";
L["Quest_7386_Note"] = "200개 정도의 수정을 반납하면, 대드루이드 렌퍼럴 걷기 시작합니다. (알터랙 계곡 - 북쪽; "..YELLOW.."[19]"..PREV.."). 그곳에 도착하면 그녀는 소환 의식을 시작하며 10명이 도와야합니다. 성공하면, 숲군주 이부스가 소환되어 전투를 돕습니다.";
...
L["Quest_6881_Location"] = "대드루이드 렌퍼럴 (알터랙 계곡 - 북쪽; "..YELLOW.."[2]"..PREV..")";
L["Quest_6881_Note"] = "200개 정도의 수정을 반납하면, 대드루이드 렌퍼럴 걷기 시작합니다. (알터랙 계곡 - 북쪽; "..YELLOW.."[19]"..PREV.."). 그곳에 도착하면 그녀는 소환 의식을 시작하며 10명이 도와야합니다. 성공하면, 숲군주 이부스가 소환되어 전투를 돕습니다.";
...
L["Quest_6942_Location"] = "편대사령관 실도르 (알터랙 계곡 - 북쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6941_Location"] = "편대사령관 비포르 (알터랙 계곡 - 북쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6943_Location"] = "편대사령관 이크만 (알터랙 계곡 - 북쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7241_Location"] = "서리늑대 사절 로크스트롬 (오그리마 - 힘의 골짜기 "..YELLOW.."50,71"..PREV..")";
L["Quest_7241_Note"] = "Warmaster Laggrond is at (알터랙 산맥; "..YELLOW.."62,59"..PREV..").";
...
L["Quest_7161_Location"] = "전투대장 락그론드 (알터랙 산맥; "..YELLOW.."62,59"..PREV..")";
L["Quest_7161_Note"] = "The Frostwolf Banner is in the Wildpaw Cavern at (알터랙 계곡 - 남쪽; "..YELLOW.."[15]"..PREV.."). Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe prequest is not necessary to obtain this quest.";
...
L["Quest_7142_Location"] = "보그가 데스그립 (알터랙 산맥; "..YELLOW.."64,60"..PREV..")";
L["Quest_7142_Note"] = "Vanndar Stormpike is at (알터랙 계곡 - 남쪽; "..YELLOW.."[B]"..PREV.."). He does not actually need to be killed to complete the quest. The battleground just has to be won by your side in any manner.\nAfter turning this quest in, talk to the NPC again for the reward.";
...
L["Quest_7123_Location"] = "조테크 (알터랙 계곡 - 남쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_5893_Location"] = "서리늑대 병참장교 (알터랙 계곡 - 남쪽; "..YELLOW.."[10]"..PREV..")";
L["Quest_5893_Note"] = "The supplies can be found in the Coldtooth Mine at (알터랙 계곡 - 남쪽; "..YELLOW.."[6]"..PREV..").";

L["Quest_6985_Name"] = "깊은무쇠 광산 보급품";
L["Quest_6985_Objective"] = "서리늑대 요새에 있는 서리늑대 병참장교에게 깊은무쇠 광산 보급품 10개를 가져가야 합니다.";
L["Quest_6985_Location"] = "서리늑대 병참장교 (알터랙 계곡 - 남쪽; "..YELLOW.."[10]"..PREV..")";
L["Quest_6985_Note"] = "The supplies can be found in the Irondeep Mine at (알터랙 계곡 - 남쪽; "..YELLOW.."[1]"..PREV..").";

L["Quest_7224_Name"] = "전리품";
L["Quest_7224_Objective"] = "서리늑대 마을에 있는 대장장이 렉자르에게 방어구 조각 20개를 가져가야 합니다.";
L["Quest_7224_Location"] = "대장장이 렉자르 (알터랙 계곡 - 남쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7124_Location"] = "하사관 티카 블러드스날 (알터랙 산맥; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7101_Location"] = "하사관 티카 블러드스날 (알터랙 산맥; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7082_Location"] = "하사관 티카 블러드스날 (알터랙 산맥; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7001_Location"] = "서리늑대부족 야수관리인 (알터랙 계곡 - 남쪽; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7002_Location"] = "서리늑대 늑대기병대 지휘관 (알터랙 계곡 - 남쪽; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7385_Location"] = "원시술사 투를로가 (알터랙 계곡 - 남쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6801_Location"] = "원시술사 투를로가 (알터랙 계곡 - 남쪽; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6825_Location"] = "편대사령관 구스 (알터랙 계곡 - 남쪽; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6826_Location"] = "편대사령관 제즈톨 (알터랙 산맥 - 남쪽; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6827_Location"] = "편대사령관 멀베릭 (알터랙 계곡 - 남쪽; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_8105_Location"] = "야전사령관 오슬라이트 (아라시 고원 - 임시 주둔지; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8120_Location"] = "죽음의경비대장 드와이어 (아라시 고원 - 해머폴; "..YELLOW.."74,35"..PREV..")";
