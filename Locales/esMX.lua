...
local AQ_OR = GREY.." o|r ";
local AQ_AND = GREY.." y|r ";
...
L["Quest_3802_Location"] = "Franclorn Forjador (Montaña Roca Negra; "..GREEN.."[1'] en el mapa de la Entrada"..PREV..")";
L["Quest_3802_Note"] = "Franclorn está al centro de la Montaña Roca Negra encima de su tumba. Tienes que estar muerto para hablar consigo para empezar la misión.\nFinoso Virunegro está en "..YELLOW.."[9]"..PREV..". Encuentras el Santuario cerca de la arena en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_4136_Location"] = "Yuka Llavenrosca (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,22"..PREV..")";
L["Quest_4136_Note"] = "Obtienes la misión requisita de Yorba Llavenrosca (Tanaris - Puerto Bonvapor; "..YELLOW.."67,23"..PREV..").\nRibbly está en "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4201_Location"] = "Coima Nagmara (Profundidades de Roca Negra; "..YELLOW.."[15]"..PREV..")";
L["Quest_4201_Note"] = "Despoja a los gigantes en Azshara para obtener las Vetas gigantes de plata. Puedes coger Gromsanguina si tienes herboristería o comprarla en la subasta. Llenas el vial en los Baños de Golakka (Cráter de Un'Goro; "..YELLOW.."31,50"..PREV..").\nDespués de completar la misión, puedes usar la puerta trasera en lugar de matar a Falange.";
...
L["Quest_4126_Location"] = "Ragnar Cebatruenos  (Dun Morogh - Kharanos; "..YELLOW.."46,52"..PREV..")";
L["Quest_4126_Note"] = "Obtienes la misión requisita de Enohar Cebatruenos (Las Tierras Devastadas - Castillo de Nethergarde; "..YELLOW.."61,18"..PREV..").\nConsigues la receta de los guardias que aparezcan si destruyes la cerveza así en "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4262_Location"] = "Jalinda Espiga (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,70"..PREV..")";
L["Quest_4262_Note"] = "Maestro supremo Pyron es un elemental de fuego afuera del calabozo. Patrulla cerca del portal en "..YELLOW.."[24]"..PREV.." en el mapa de Las Profundidades Roca Negra en "..YELLOW.."[3]"..PREV.." en el mapa de entrada de la Montaña Roca Negra.";
...
L["Quest_4263_Location"] = "Jalinda Espiga (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,69"..PREV..")";
L["Quest_4263_Note"] = "Obtienes la misión requisita de Jalinda Espiga también. Encuentras a Lord Incendius en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_4123_Location"] = "Maxwort Suprandor (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,23"..PREV..")";
L["Quest_4123_Note"] = "Encuentras el corazón de la montaña en "..YELLOW.."[8]"..PREV.." dentro de una caja fuerte. Consigues la llave para la caja fuerte de Depositario Stilgiss. Él se aparecerá después de abrir todas las cajitas fuertes.";
...
L["Quest_4286_Location"] = "Oralius (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."84,68"..PREV..")";
...
L["Quest_4024_Location"] = "Cyrus Therepentio (Las Estepas Ardientes; "..YELLOW.."94,31"..PREV..")";
L["Quest_4024_Note"] = "La cadena de misiones empieza con Kalaran Espada del Viento (La Garganta de Fuego; "..YELLOW.."39,38"..PREV..").\nBael'Gar está en "..YELLOW.."[11]"..PREV..".";
...
L["Quest_4341_Location"] = "Rey Magni Barbabronce (Forjaz; "..YELLOW.."39,55"..PREV..")";
L["Quest_4341_Note"] = "La misión requisita empieza con Historiadora Real Archesonus (Forjaz; "..YELLOW.."38,55"..PREV.."). Kharan Martillo Poderoso está en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_4362_Location"] = "Rey Magni Barbabronce (Forjaz; "..YELLOW.."39,55"..PREV..")";
L["Quest_4362_Note"] = "Princesa Moira Barbabronce está en "..YELLOW.."[21]"..PREV..". Es posible que sanará a Dagran. Interrúmpela pero no puedes matarla para completar la misión. Después de hablar consigo tienes que devolver a Rey Magni Barbabronce.";
...
L["Quest_7848_Location"] = "Lothos Levantagrietas (Montaña Roca Negra; "..YELLOW.."[E] en el mapa de la Entrada"..PREV..")";
L["Quest_7848_Note"] = "Después de completar la misión, puedes usar el portal justo al lado de Lothos Levantagrietas para entrar el Núcleo de Magma.\nEncuentras el Trozo del Núcleo cerca de "..YELLOW.."[23]"..PREV..".";
...
L["Quest_9015_Location"] = "Falrin Tallarbol (La Masacre Oeste; "..YELLOW.."[1] Librería"..PREV..")";
L["Quest_9015_Note"] = "Misión para el conjunto de equipo de calabozo. El Círculo de la Ley está en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_4083_Location"] = "Penumbra'rel (Profundidades de Roca Negra; "..YELLOW.."[18]"..PREV..")";
L["Quest_4083_Note"] = "Solamente los mineros con habilidad de 230 o más alto pueden conseguir esta misión para aprender Fundir hierro negro. Los materiales para el cáliz: 2 [Rubí estrella], 20 [Barra de oro], 10 [Barra de veraplata]. Si tienes [Mena de hierro negro], puedes fundirla a La Forja Negra en "..YELLOW.."[22]"..PREV..".";
...
L["Quest_4241_Location"] = "Mariscal Maxwell (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."84,68"..PREV..")";
L["Quest_4241_Note"] = "Esta misión es una parte de la cadena para la armonización con Onyxia. La misión para la cadena empieza con Helendis Rivacuerno (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,68"..PREV..").\nMariscal Windsor está en "..YELLOW.."[4]"..PREV..". Tienes que regresar a Mariscal Maxwell después de completar la misión.";
...
L["Quest_4242_Location"] = "Mariscal Windsor (Profundidades de Roca Negra; "..YELLOW.."[4]"..PREV..")";
L["Quest_4242_Note"] = "Esta misión es una parte de la cadena para la armonización de Onyxia. Mariscal Maxwell está en (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."85,69"..PREV.."). La siguiente misión en la cadena se despoja en las Profundidades de Roca Negra.";
...
L["Quest_4264_Note"] = "Esta misión es una parte de la cadena de misiones para la armonización de Onyxia. Mariscal Windsor está en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_4282_Location"] = "Mariscal Windsor (Profundidades de Roca Negra; "..YELLOW.."[4]"..PREV..")";
L["Quest_4282_Note"] = "Esta misión es una parte de la cadena para la armonización de Onyxia. Mariscal Windsor está en "..YELLOW.."[4]"..PREV..".\nEncuentras al Señor Gólem Argelmach en "..YELLOW.."[14]"..PREV.." y a General Forjainquina en "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4322_Location"] = "Mariscal Windsor (Profundidades de Roca Negra; "..YELLOW.."[4]"..PREV..")";
L["Quest_4322_Note"] = "Esta misión es una parte de la cadena para la armonización con Onyxia. Mariscal Windsor está en "..YELLOW.."[4]"..PREV..".\nEs más fácil realizar la misión si haces el Círculo de la Ley ("..YELLOW.."[6]"..PREV..") y el camino a la entrada antes de empezar el evento. Encuentras a Mariscal Maxwell en Las Estepas Ardientes - Vigilia de Morgan ("..YELLOW.."84,68"..PREV..")";
...
L["Quest_4134_Location"] = "Maga oscura Vivian Lagrave (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
L["Quest_4134_Note"] = "Obtienes la misión requisita de la Boticaria Zinge en Entrañas - El Apothecarium ("..YELLOW.."50,68"..PREV..").\nConsigues la receta de unos de los guardias que aparezcan si destruyes la cerveza en "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4081_Location"] = "SE BUSCA (Tierras Inhóspitas - Kargath; "..YELLOW.."3,47"..PREV..")";
L["Quest_4081_Note"] = "Encuentras a los enanos a la primera parte de las Profundidades de Roca Negra.\nEncuentras al Señor de la guerra Dientegore en Kargath en la parte superior de la torre (Tierras Inhóspitas, "..YELLOW.."5,47"..PREV..").";
...
L["Quest_4082_Location"] = "SE BUSCA (Tierras Inhóspitas - Kargath; "..YELLOW.."3,47"..PREV..")";
L["Quest_4082_Note"] = "Encuentras a los enanos cerca de Bael'Gar "..YELLOW.."[11]"..PREV..". Encuentras al Señor de la guerra Dientegore en Kargath en la parte superior de la torre (Tierras Inhóspitas, "..YELLOW.."5,47"..PREV..").\nLa misión siguiente empieza con Lexlort (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV.."). Encuentras a Grark Lorkrub en Las Estepas Ardientes ("..YELLOW.."38,35"..PREV.."). Tienes que reducir su salud a menos de 50% para atarlo y empezar la misión de escolta.";
...
L["Quest_4132_Location"] = "Señor de la guerra Dientegore (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
L["Quest_4132_Note"] = "Encuentras al General Forjainquina en "..YELLOW.."[13]"..PREV..". Él pedirá ayuda cuando tenga menos del 30% de salud.";
...
L["Quest_4063_Location"] = "Lotwil Veriatus (Tierras Inhóspitas; "..YELLOW.."25,44"..PREV..")";
L["Quest_4063_Note"] = "Obtienes la misión requisita de Hierofante Theodora Mulvadania (Tierras Inhóspitas - Kargath; "..YELLOW.."3,47"..PREV..").\nEncuentras al Señor Gólem Argelmach en "..YELLOW.."[14]"..PREV..".";
...
L["Quest_3906_Location"] = "Corazón Atronador (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..")";
L["Quest_3906_Note"] = "Maestro supremo Pyron es un elemental de fuego afuera del calabozo. Patrulla cerca del portal en "..YELLOW.."[24]"..PREV.." en el mapa de Las Profundidades Roca Negra en "..YELLOW.."[3]"..PREV.." en el mapa de entrada de la Montaña Roca Negra.";
...
L["Quest_3907_Location"] = "Corazón Atronador (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..")";
L["Quest_3907_Note"] = "Obtienes la misión requisita de Corazón Atronador también.\nEncuentras a Lord Incendius en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_7201_Location"] = "Maga oscura Vivian Lagrave (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
L["Quest_7201_Note"] = "Obtienes la misión requisita de Corazón Atronador (Tierras Inhóspitas - Kargath; "..YELLOW.."3,48"..PREV..").\nDespoja a cualquier elemental para obtener la esencia.";
...
L["Quest_3981_Location"] = "Galamav el Tirador (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
...
L["Quest_4003_Location"] = "Thrall (Orgrimmar; "..YELLOW.."31,37"..PREV..")";
L["Quest_4003_Note"] = "Después de hablar con Kharan Martillo Poderoso y Thrall, consigues esta misión.\nEncuentras al Emperador Dagran Thaurissan en "..YELLOW.."[21]"..PREV..". Es posible que Princesa Moira Barbabronce sanará a Dagran. Interrúmpela pero no puedes matarla para completar la misión. (Las recompensas son para la misión ¿Princesa salvada?)";
...
L["Quest_8730_Location"] = "Vaelastrasz el Corrupto (Guarida Alanegra; "..YELLOW.."[2]"..PREV..")";
L["Quest_8730_Note"] = "Puede conseguir sola una persona el fragmento. Anacronos (Tanaris - Cavernas del Tiempo; "..YELLOW.."65,49"..PREV..")";
...
L["Quest_7781_Location"] = "Cabeza de Nefarian; "..YELLOW.."[8]"..PREV.."";
L["Quest_7781_Note"] = "Alto señor Bolvar Fordragón está en Ventormenta - Castillo de Ventormenta; "..YELLOW.."78,20"..PREV..". La misión siguiente te envia al Mariscal de campo Afrasiabi (Ventormenta - Valle de los Héroes; "..YELLOW.."67,72"..PREV..") para obtener la recompensa.";
...
L["Quest_8288_Location"] = "Cabeza del Señor de linaje Capazote; "..YELLOW.."[3]"..PREV.."";
...
L["Quest_7783_Location"] = "Cabeza de Nefarian; "..YELLOW.."[8]"..PREV.."";
L["Quest_7783_Note"] = "La misión siguiente te envia al Alto señor supremo Colmillosauro (Orgrimmar - Valle de la Fuerza; "..YELLOW.."51,76"..PREV..") para la recompensa.";
...
L["Quest_4788_Location"] = "Prospector Ferrobota (Tanaris - Puerto Bonvapor; "..YELLOW.."66,23"..PREV..")";
L["Quest_4788_Note"] = "Encuentras las tablillas cerca de "..YELLOW.."[7]"..PREV.." y "..YELLOW.."[9]"..PREV..".\nLas recompensas son para la misión 'La confrontación con Yeh'kinya'. Encuentras a Yeh'kinya cerca del Prospector Ferrobota.";
...
L["Quest_4729_Location"] = "Kibler (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,22"..PREV..")";
L["Quest_4729_Note"] = "Encuentras el cachorro de huargo en "..YELLOW.."[17]"..PREV..".";
...
L["Quest_4862_Location"] = "Kibler (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,22"..PREV..")";
L["Quest_4862_Note"] = "Encuentras los huevos de araña cerca de "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4866_Location"] = "John Andrajoso (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,23"..PREV..")";
L["Quest_4866_Note"] = "Madre Telebrasada está en "..YELLOW.."[13]"..PREV..". El efecto de veneno atrapa los jugadores cercanos también. Si está quitado o disipado, fallarás la misión.";
...
L["Quest_4701_Location"] = "Helendis Rivacuerno (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."5,47"..PREV..")";
L["Quest_4701_Note"] = "Halycon está en "..YELLOW.."[17]"..PREV..".";
...
L["Quest_4867_Location"] = "Warosh (Cumbre de Roca Negra Inferior; "..YELLOW.."[2]"..PREV..")";
L["Quest_4867_Note"] = "Invoca y mata a Urok Aullasino en "..YELLOW.."[15]"..PREV.." para obtener el Mojo de Warosh. Para invocarlo, necesitas la Pica férrea y la Cabeza de Omokk en "..YELLOW.."[5]"..PREV..". La Pica férrea está en "..YELLOW.."[3]"..PREV..". Durante la invocación, aparecerán oleadas de ogros antes de que aparezca Urok Aullasino. Usa la Pica férrea para dañar a los ogros.";
...
L["Quest_5001_Location"] = "Bijou (Cumbre de Roca Negra Inferior; "..YELLOW.."[8]"..PREV..")";
L["Quest_5001_Note"] = "Encuentras las pertenencias de Bijou a la ruta a Madre Telebrasadas en "..YELLOW.."[10]"..PREV..".\nMariscal Maxwell está en (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."84,58"..PREV..").";
...
L["Quest_5081_Location"] = "Mariscal Maxwell (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."84,58"..PREV..")";
L["Quest_5081_Note"] = "Encuentras al Maestro de guerra Voone en "..YELLOW.."[9]"..PREV..", Alto señor Omokk en "..YELLOW.."[5]"..PREV.." y Señor supremo Vermiothalak en "..YELLOW.."[19]"..PREV..".";
...
L["Quest_4742_Location"] = "Vaelan (Cumbre de Roca Negra Inferior; "..YELLOW.."[1]"..PREV..")";
L["Quest_4742_Note"] = "Consigues la Gema de Cumbrerroca del Alto señor Omokk en "..YELLOW.."[5]"..PREV..", la Gema de Espina Ahumada del Maestro de guerra Voone en "..YELLOW.."[9]"..PREV.." y la Gema de Hacha de Sangre del Señor supremo Vermiothalak en "..YELLOW.."[19]"..PREV..". Despoja a cualquier enemigo en la Cumbre de Roca Negra Inferior para obtener el Sello de ascención sin adornar. Obtienes la llave para entrar la Cumbre de Roca Negra Superior si completas la cadena de misiones.";
...
L["Quest_5089_Location"] = "Orden del general Drakkisath (botín del Señor supremo Vermiothalak; "..YELLOW.."[19]"..PREV..")";
L["Quest_5089_Note"] = "Mariscal Maxwell está en Las Estepas Ardientes - Vigilia de Morgan; ("..YELLOW.."84,58"..PREV..").";
L["Quest_5089_FollowQuest"] = "Muerte al general Drakkisath ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_8989_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
...
L["Quest_8989_FollowQuest"] = "Últimos preparativos ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_5306_Location"] = "Kilram (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,37"..PREV..")";
L["Quest_5306_Note"] = "Misión para Herreros. Cazadora de las Sombras Vosh'gajin está en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_5103_Location"] = "Restos humanos (Cumbre de Roca Negra Inferior; "..YELLOW.."[11]"..PREV..")";
L["Quest_5103_Note"] = "Misión para Herreros. Coge los Guanteletes de placas sin templar cerca de los restos humanos en "..YELLOW.."[11]"..PREV..". Devuélveselos a Malyfous Martilloscuro (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,39"..PREV.."). Las recompensas son para la misión siguiente.";
...
L["Quest_4724_Location"] = "Galamav el Tirador (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
L["Quest_4724_Note"] = "Halycon está en "..YELLOW.."[15]"..PREV..".";
...
L["Quest_4981_Location"] = "Lexlort (Tierras Inhóspitas - Kargath; "..YELLOW.."5,47"..PREV..")";
L["Quest_4981_Note"] = "Encuentras a Bijou en "..YELLOW.."[8]"..PREV..".";
...
L["Quest_4982_Location"] = "Bijou (Cumbre de Roca Negra Inferior; "..YELLOW.."[8]"..PREV..")";
L["Quest_4982_Note"] = "Encuentras las pertenencias de Bijou a la ruta a Madre Telebrasadas en "..YELLOW.."[10]"..PREV..".\nLas recompensas son para la misión 'El informe de reconocimiento de Bijou'.";
...
L["Quest_4903_Location"] = "Señor de la guerra Dientegore (Tierras Inhóspitas - Kargath; "..YELLOW.."65,22"..PREV..")";
L["Quest_4903_Note"] = "Es la misión requisita para la cadena de misiones para la armonización con Onyxia.\nEncuentras al Maestro de guerra Voone en "..YELLOW.."[9]"..PREV..", Alto señor Omokk en "..YELLOW.."[5]"..PREV.." y Señor supremo Vermiothalak en "..YELLOW.."[19]"..PREV..". Los Importantes documentos de Roca Negra aparece cerca de uno de los jefes.";
L["Quest_4903_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_4903_FollowQuest"] = "La sabiduría de Eitrigg -> ¡Por la Horda! ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_5160_Location"] = "Awbee (Cumbre de Roca Negra Superior; "..YELLOW.."[7]"..PREV..")";
L["Quest_5160_Note"] = "Encuentras a Awbee en la habitación después de la Arena en "..YELLOW.."[7]"..PREV..".\nHaleh está en la Cuna del Invierno ("..YELLOW.."54,51"..PREV.."). Usa el portal al fin de la cueva para irte a ella.";
...
L["Quest_5047_Location"] = "Finkle Einhorn (Cumbre de Roca Negra Superior; "..YELLOW.."[8]"..PREV..")";
L["Quest_5047_Note"] = "Finkle Einhorn aparece después de desollar a La Bestia. Encuentras a Malyfous Martilloscuro en (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,38"..PREV..").";
...
L["Quest_4734_Location"] = "Tinkee Vaporio (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,24"..PREV..")";
L["Quest_4734_Note"] = "Encuentras los huevos en "..YELLOW.."[2]"..PREV..".";
L["Quest_4734_RewardText"] = "1";
L["Quest_4734_PreQuest"] = "Esencia de cría -> Tinkee Vaporio";
L["Quest_4734_FollowQuest"] = "La colecta de huevos y Leonid Barthalomew -> Gambito del Alba ("..YELLOW.."Scholomance"..PREV..")";

L["Quest_6821_Name"] = "Ojo del Brasadivino";
L["Quest_6821_Objective"] = "Lleva el ojo del Brasadivino al duque Hydraxis a Azshara.";
L["Quest_6821_Location"] = "Duque Hydraxis (Azshara; "..YELLOW.."79,73"..PREV..")";
L["Quest_6821_Note"] = "Encuentras al Piroguardia Brasadivino en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_5102_Location"] = "Mariscal Maxwell (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."82,68"..PREV..")";
L["Quest_5102_Note"] = "Encuentras al General Drakkisath en "..YELLOW.."[9]"..PREV..".";
L["Quest_5102_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_5102_PreQuest"] = "Orden del general Drakkisath ("..YELLOW.."Cumbre de Roca Negra Inferior"..PREV..")";
...
L["Quest_4764_Location"] = "Mayara Alasol (Las Estepas Ardientes - Vigilia de Morgan; "..YELLOW.."84,69"..PREV..")";
L["Quest_4764_Note"] = "Obtienes la misión requisita de Conde Remington Bonacresta (Ventormenta - Castillo de Ventormenta; "..YELLOW.."74,30"..PREV..").\n\nEl broche de Equipasino está en "..YELLOW.."[3]"..PREV.." dentro de un cofre.";
...
L["Quest_7761_Location"] = "Orden de Puño Negro (botín del Intendente del Escudo del Estigma; "..YELLOW.."[7] en el mapa de la Entrada"..PREV..")";
L["Quest_7761_Note"] = "Es la misión para la armonización con Guarida Alanegra. El Intendente del Escudo del Estigma está a la derecha justo antes del portal a la Cumbre de Roca Negra.\n\nGeneral Drakkisath está en "..YELLOW.."[9]"..PREV..". El orbe está detrás de él.";
...
L["Quest_8994_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
...
L["Quest_8994_PreQuest"] = "La parte derecha del amuleto de Lord Valthalak ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_8995_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
L["Quest_8995_Note"] = "Necesitas el Detector de fantasmas extradimensional para ver a Bodley. Lo consigues de la misión 'Buscando a Anthion'. Invoca a Lord Valthalak en "..YELLOW.."[7]"..PREV..". Las recompensas son para la misión 'Regresa junto a Bodley'.";
...
L["Quest_5127_Location"] = "Lorax (Cuna del Invierno; "..YELLOW.."64,74"..PREV..")";
L["Quest_5127_Note"] = "Misión para Herreros. Goraluk Yunquegrieta está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_4735_Location"] = "Tinkee Vaporio (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,24"..PREV..")";
L["Quest_4735_Note"] = "Encuentras los huevos en "..YELLOW.."[2]"..PREV..".";
L["Quest_4735_PreQuest"] = "Un huevo congelado";
L["Quest_4735_FollowQuest"] = "Leonid Barthalomew -> Gambito del Alba ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_6502_Location"] = "Haleh (Cuna del Invierno; "..YELLOW.."54,51"..PREV..")";
L["Quest_6502_Note"] = "Es la parte final para la cadena de misiones para la armonización con Onyxia por la Alianza. Encuentras al General Drakkisath en "..YELLOW.."[9]"..PREV..".";
...
L["Quest_4768_Location"] = "Maga oscura Vivian Lagrave (Tierras Inhóspitas - Kargath; "..YELLOW.."2,47"..PREV..")";
L["Quest_4768_Note"] = "Obtienes la misión requisita de la Boticaria Zinge en Entrañas - El Apothecarium ("..YELLOW.."50,68"..PREV..").\n\nLa tablilla de Rocanegra está en "..YELLOW.."[3]"..PREV.." dentro de un cofre.";
...
L["Quest_4974_Location"] = "Thrall (Orgrimmar; "..YELLOW.."31,38"..PREV..")";
L["Quest_4974_Note"] = "Es la misión para la armonización con Onyxia. Encuentras al Jefe de Guerra Rend Puño Negro en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_6569_Location"] = "Myranda la Fada (Tierras de la Peste del Oeste; "..YELLOW.."50,77"..PREV..")";
...
L["Quest_6602_Location"] = "Rexxar (Desolace - Aldea Cazasombras; "..YELLOW.."25,71"..PREV..")";
L["Quest_6602_Note"] = "Es la parte final para la misión para la armonización con Onyxia. Encuentras al General Drakkisath en "..YELLOW.."[9]"..PREV..".";
...
L["Quest_214_Location"] = "Exploradora Riell (Páramos de Poniente - Colina del Centinela; "..YELLOW.."56,47"..PREV..")";
...
L["Quest_168_Location"] = "Wilder Cardortiga (Ventormenta - Distrito de los Enanos; "..YELLOW.."65,21"..PREV..")";
L["Quest_168_Note"] = "Despoja a los No-muertos afuera de la estancia en la localización cerca de "..YELLOW.."[3]"..PREV.." en el mapa de la Entrada para obtener las tarjetas.";
...
L["Quest_167_Location"] = "Wilder Cardortiga (Ventormenta - Distrito de los Enanos; "..YELLOW.."65,21"..PREV..")";
L["Quest_167_Note"] = "Supervisor Cardotiga está afuera de la estancia en la localización de los No-muertos en "..YELLOW.."[3]"..PREV.." en el mapa de la Entrada.";
...
L["Quest_2040_Location"] = "Shoni la Shilenshiosha (Ventormenta - Distrito de los Enanos; "..YELLOW.."55,12"..PREV..")";
L["Quest_2040_Note"] = "Se puede obtener la misión requisita de Gnoarn (Forjaz - Ciudad Manitas; "..YELLOW.."69,50"..PREV..").\nDespoja a Trituradora de Sneed en "..YELLOW.."[3]"..PREV.." para obtener la Dentrituradora goblin.";
...
L["Quest_166_Location"] = "Gryan Mantorrecio (Páramos de Poniente - Colina del Centinela; "..YELLOW.."56,47"..PREV..")";
L["Quest_166_Note"] = "Empieza la cadena de misiones a Gryan Mantorrecio (Páramos de Poniente - Colina del Centinela; "..YELLOW.."56,47"..PREV..").\nEdwin VanCleef es el último jefe de Las Minas de la Muerte. Se puede encontrar a la cubierta del barco en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_1654_Location"] = "Jordan Fontana (Dun Morogh - Entrada de Forjaz; "..YELLOW.."52,36"..PREV..")";
L["Quest_1654_Note"] = "Solamente para Paladines: Para ver la nota haz clic en "..YELLOW.."[Información de La prueba de rectitud]"..PREV..".";
...
L["Quest_373_Location"] = "Una carta sin enviar (Despoja a Edwin VanCleef para obtenerla; "..YELLOW.."[6]"..PREV..")";
L["Quest_373_Note"] = "Baros Alexston está en la Ciudad de Ventormenta, al lado de la Catedral de la Luz en "..YELLOW.."49,30"..PREV..".";
...
L["Quest_2922_Location"] = "Maestro manitas Sobrechispa (Forjaz - Ciudad Manitas; "..YELLOW.."69,50"..PREV..")";
L["Quest_2922_Note"] = "Obtienes la misión requisita de Hermano Sarno (Ventormenta - Plaza de la Catedral; "..YELLOW.."40,30"..PREV..").\nEncuentras a Tecnobot antes de entrar la estancia cerca de la entrada trasera en "..YELLOW.."[4] en el mapa de la Entrada"..PREV..".";
...
L["Quest_2926_Location"] = "Ozzie Voltiflop (Dun Morogh - Kharanos; "..YELLOW.."45,49"..PREV..")";
L["Quest_2926_Note"] = "Obtienes la misión requisita de Gnoarn (Forjaz - Ciudad Manitas; "..YELLOW.."69,50"..PREV..").\nPara obtener los restos radiactivos, tienes que usar la ampolla con los invasores o saqueadores "..RED.."vivos"..PREV..".";
...
L["Quest_2962_Location"] = "Ozzie Voltiflop (Dun Morogh - Kharanos; "..YELLOW.."45,49"..PREV..")";
L["Quest_2962_Note"] = "Usa la ampolla con los rondadores y horrores irradiados "..RED.."vivos"..PREV..".";
...
L["Quest_2928_Location"] = "Shoni la Shilenshiosha (Ventormenta - Distrito de los Enanos; "..YELLOW.."55,12"..PREV..")";
...
L["Quest_2924_Location"] = "Klockmort Palmalicate (Forjaz - Ciudad Manitas; "..YELLOW.."68,46"..PREV..")";
L["Quest_2924_Note"] = "Obtienes la misión requisita de Mathiel (Darnassus - Bancal del Guerrero; "..YELLOW.."59,45"..PREV.."). No es necesario obtener la misión requisita para empezar esta misión.\nConsigues las Esencias artificiales de los Extrapoladores artificiales que están desperdigados por todas las partes de la estancia.";
...
L["Quest_2930_Location"] = "Maestro mecánico Funditubo (Forjaz - Ciudad Manitas; "..YELLOW.."69,48"..PREV..")";
L["Quest_2930_Note"] = "Obtienes la misión requisita de Gaxim Silvóxido (Sierra Espolón; "..YELLOW.."59,67"..PREV.."). No es necesario obtener la misión requisita para empezar esta misión.\nLa Tarjeta perforada blanca es botín aleatorio de los troggs fuera de la estancia. Encuentras el Perforágrafo Matriz 3005-A cerca de la entrada trasera antes de entrar la estancia en "..YELLOW.."[3] en el mapa de la Entrada"..PREV..". Perforágrafo Matriz 3005-B está en "..YELLOW.."[3]"..PREV..", 3005-C está en "..YELLOW.."[5]"..PREV.." y 3005-D está en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_2904_Note"] = "Es una misión de escolta. Encuentras a Scooty en Vega de Tuercespina - Bahía del Botín ("..YELLOW.."27,77"..PREV..").";
...
L["Quest_2929_Location"] = "Manitas Mayor Mekkatorque (Forjaz - Ciudad Manitas; "..YELLOW.."68,48"..PREV..")";
L["Quest_2929_Note"] = "Encuentras a Termochufe en "..YELLOW.."[8]"..PREV..". Él es el último jefe de Gnomeregan.\nDesactiva las columnas por oprimir los botónes rojos durante la pelea.";
...
L["Quest_2945_Note"] = "Limpia el anillo con El Destellamatic 5200 en el Punto de Limpieza en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2947_Note"] = "Entrega la misión a Talvash del Kissel (Forjaz - La Sala Mística; "..YELLOW.."36,3"..PREV.."). La misión siguiente para mejorar el anillo es opcional.";
...
L["Quest_2951_Location"] = "El Destellamatic 5200 (Gnomeregan - Punto de Limpieza; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_2843_Location"] = "Scooty (Vega de Tuercespina - Bahía del Botín; "..YELLOW.."27,77"..PREV..")";
L["Quest_2843_Note"] = "Obtienes la misión requisita de Sovik (Orgrimmar - El Valle del Honor; "..YELLOW.."75,25"..PREV..").\nDespués de terminar la misión, puedes usar el transpondedor en Bahía del Botín.";
...
L["Quest_2841_Location"] = "Nogg (Orgrimmar - El Valle del Honor; "..YELLOW.."75,25"..PREV..")";
L["Quest_2841_Note"] = "Encuentras a Termochufe en "..YELLOW.."[8]"..PREV..". Él es el último jefe de Gnomeregan.\nDesactiva las columnas por oprimir los botónes rojos durante la pelea.";
...
L["Quest_2949_Note"] = "Entrega la misión a Nogg (Orgrimmar - El Valle del Honor; "..YELLOW.."75,25"..PREV.."). La misión siguiente para mejorar el anillo es opcional.";
...
L["Quest_1050_Location"] = "Bibliotecaria Mae Palipolvo (Forjaz - Sala de los Exploradores; "..YELLOW.."74,12"..PREV..")";
L["Quest_1050_Note"] = "El libro está en el piso en el lado izquierdo de uno de los corredores que conducen a Arcanista Doan ("..YELLOW.."[2]"..PREV..").";
...
L["Quest_1951_Location"] = "Tabetha (Marjal Revolcafango; "..YELLOW.."43,57"..PREV..")";
L["Quest_1951_Note"] = "Solamente para Magos: Encuentras el libro en el último corredor que conduce a Arcanista Doan ("..YELLOW.."[2]"..PREV..").";
...
L["Quest_1053_Location"] = "Raleigh el Devoto (Laderas de Trabalomas - Costasur; "..YELLOW.."51,58"..PREV..")";
L["Quest_1053_Note"] = "Esta cadena de misiones empieza con Hermano Cuerviz en Ventormenta - Catedral de Luz ("..YELLOW.."42,24"..PREV..").\nEncuentras a la Alta inquisidora Melenablanca y al Comandante Escarlata Mograine en la "..YELLOW.."Catedral [2]"..PREV..", a Herod en el "..YELLOW.."Arsenal [1]"..PREV.." y al Maestro de Canes Loksey en la "..YELLOW.."Biblioteca [1]"..PREV..".";
...
L["Quest_1113_Location"] = "Maestro boticario Faranell (Entrañas - El Apothecarium; "..YELLOW.."48,69"..PREV..")";
L["Quest_1113_Note"] = "Despoja a cualquier persona en el Monasterio Escarlata para obtener los Corazones de fanatismo.";
L["Quest_1113_PreQuest"] = "Guano del Horado ("..YELLOW.."[Horado Rajacieno]"..PREV..")";
...
L["Quest_1160_Location"] = "Parqual Fintallas (Entrañas - El Apothecarium; "..YELLOW.."57,65"..PREV..")";
L["Quest_1160_Note"] = "La cadena de misiones empieza con Dorn Acechallanos (Las Mil Agujas; "..YELLOW.."53,41"..PREV.."). Encuentras el libro en la Biblioteca del Monasterio Escarlata.";
...
L["Quest_1049_Location"] = "Sabio Buscador de la Verdad (Cima del Trueno; "..YELLOW.."34,47"..PREV..")";
...
L["Quest_1048_Location"] = "Varimathras (Entrañas - Barrio Real; "..YELLOW.."56,92"..PREV..")";
L["Quest_1048_Note"] = "Encuentras a la Alta inquisidora Melenablanca y al Comandante Escarlata Mograine en la "..YELLOW.."Catedral [2]"..PREV..", Herod en el "..YELLOW.."Arsenal [1]"..PREV.." y al Maestro de Canes Loksey en la "..YELLOW.."Biblioteca [1]"..PREV..".";
...
L["Quest_1051_Location"] = "Vorrel Sengutz (Monasterio Escarlata - Cementerio; "..YELLOW.."[1]"..PREV..")";
L["Quest_1051_Note"] = "Encuentras a Vorrel Sengutz al comienzo del cementerio del Monasterio Escarlata. Nancy Vishas, quien tiene el anillo para esta misión, está en una casa en las Montañas de Alterac ("..YELLOW.."31,32"..PREV..").";
...
L["Quest_5529_Location"] = "Betina Bigglezink (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
...
L["Quest_5582_Note"] = "Despoja a las crías de dragón apestadas para obtener las Escamas de dragón sana. Encuentras a Betina Bigglezink en las Tierras de la Peste del Este - Capilla de la Esperanza de la Luz ("..YELLOW.."81,59"..PREV..").";
...
L["Quest_5382_Location"] = "Eva Sarkhoff (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5382_Note"] = "Encuentras al Doctor Theolen Krastinov, los restos de Eva Sarkhoff, y los restos de Lucien Sarkhoff en "..YELLOW.."[9]"..PREV..".";
...
L["Quest_5515_Location"] = "Eva Sarkhoff (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5515_Note"] = "Encuentras a Jandice Barov en "..YELLOW.."[3]"..PREV..".";
...
L["Quest_5384_Location"] = "Eva Sarkhoff (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5384_Note"] = "El Porche está en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_5466_Location"] = "Magistrado Marduke (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV..")";
L["Quest_5466_Note"] = "Encuentras a Ras Murmuhielo en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_5343_Location"] = "Weldon Barov (Tierras de la Peste del Oeste - Campamento del Orvallo; "..YELLOW.."43,83"..PREV..")";
L["Quest_5343_Note"] = "Encuentras las escrituras de Castel Darrow en "..YELLOW.."[12]"..PREV..", las escrituras de Rémol en "..YELLOW.."[7]"..PREV..", las escrituras de Molino Tarren en "..YELLOW.."[4]"..PREV..", y las escrituras de Costasur en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_4771_Location"] = "Betina Bigglezink (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
L["Quest_4771_Note"] = "La misión \'Esencia de cría\' empieza con Tinkee Vaporio (Las Estepas Ardientes - Peñasco Llamarada; "..YELLOW.."65,23"..PREV.."). La Sala de visión está en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_7629_Location"] = "Gorzeeki Ojovago (Las Estepas Ardientes; "..YELLOW.."12,31"..PREV..")";
L["Quest_7629_Note"] = "Solamente para Brujos: Encuentras el Laboratorio de alquimia en "..YELLOW.."[7]"..PREV..".";
L["Quest_7629_PreQuest"] = "Mor'zul Sangredoble -> Polvo estelar xorothiano";
L["Quest_7629_FollowQuest"] = "Corcel nefasto xorothiano ("..YELLOW.."La Masacre Oeste"..PREV..")";
...
L["Quest_8992_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
...
L["Quest_8992_FollowQuest"] = "Últimos preparativos ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_7647_Location"] = "Lord Grisillo Quiebrasombras (Ciudad de Ventormenta - Catedral; "..YELLOW.."38,33"..PREV..")";
L["Quest_7647_Note"] = "Cadena de misiones para la montura épica de paladín. El sótano de El Gran Osario está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_5341_Location"] = "Alexi Barov (Claros de Tirisfal - El Baluarte; "..YELLOW.."80,73"..PREV..")";
L["Quest_5341_Note"] = "Encuentras las escrituras de Castel Darrow en "..YELLOW.."[12]"..PREV..", las escrituras de Rémol en "..YELLOW.."[7]"..PREV..", las escrituras de Molino Tarren en "..YELLOW.."[4]"..PREV..", y las escrituras de Costasur en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_8258_Location"] = "Sagorne Zancresta (Orgrimmar - Valle de la Sabiduría; "..YELLOW.."39,36"..PREV..")";
L["Quest_8258_Note"] = "Solamente para chamanes.\n\nInvoca al Caballero de la Muerte Atracoscuro en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_1740_Location"] = "Doan Karhan (Los Baldíos; "..YELLOW.."49,57"..PREV..")";
L["Quest_1740_Note"] = "Solamente para Brujos: Consigues los 3 Trozos de Soran'ruk de los Acólitos Crepusculares en "..YELLOW.."[Cavernas de Brazanegra]"..PREV..". Consigues el Trozo de Soran'ruk grande en "..YELLOW.."[Castillo de Colmillo Oscuro]"..PREV.." de los Almanegras Colmillo Oscuro.";
...
L["Quest_1098_Location"] = "Sumo ejecutor Hadrec (Bosque de Argénteos - El Sepulcro; "..YELLOW.."43,40"..PREV..")";
L["Quest_1098_Note"] = "Encuentras al Mortacechador Adamant en "..YELLOW.."[1]"..PREV..". Mortacechador Vincent está en el lado derecho cuando vayas en el patio en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_1013_Location"] = "Vigilante Bel'dugur (Entrañas - El Apothecarium; "..YELLOW.."53,54"..PREV..")";
L["Quest_1013_Note"] = "Encuentras el libro en "..YELLOW.."[11]"..PREV.." en el lado izquierdo cuando entres la sala.";
...
L["Quest_1014_Location"] = "Dalar Tejealba (Bosque de Argénteos - El Sepulcro; "..YELLOW.."44,39"..PREV..")";
L["Quest_1014_Note"] = "Encuentras al Archimago Arugal en "..YELLOW.."[13]"..PREV..".";
...
L["Quest_386_Location"] = "Guardia Berton (Montañas Crestagrana - Villa del Lago; "..YELLOW.."26,46"..PREV..")";
L["Quest_386_Note"] = "Encuentras a Targorr en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_377_Location"] = "Consejero Tallolino (Bosque del Ocaso - Villa Oscura; "..YELLOW.."72,47"..PREV..")";
L["Quest_377_Note"] = "Encuentras a Dextren Ward en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_387_Location"] = "Celador Thelagua (Ventormenta - Las Mazmorras; "..YELLOW.."41,58"..PREV..")";
L["Quest_387_Note"] = "";
...
L["Quest_388_Location"] = "Nikova Raskol (Ventormenta - Casco Antiguo; "..YELLOW.."73,46"..PREV..")";
...
L["Quest_378_Location"] = "Motley Garmason (Los Humedales - Dun Modr; "..YELLOW.."49,18"..PREV..")";
L["Quest_378_Note"] = "Obtienes la misión requisita de Motley también. Encuentras a Kam Furiahonda en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_391_Location"] = "Celador Thelagua (Ventormenta - Las Mazmorras; "..YELLOW.."41,58"..PREV..")";
L["Quest_391_Note"] = "Para obtener más información sobre la misión requisita, ve "..YELLOW.."[Las Minas de la Muerte, La hermandad de los Defias]"..PREV..".\nEncuentras a Bazil Thredd en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_5212_Location"] = "Betina Bigglezink (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
...
L["Quest_5213_Location"] = "Betina Bigglezink (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
L["Quest_5213_Note"] = "La información sobre la Plaga está en los 3 zigurats que se encuentran cerca de "..YELLOW.."[15]"..PREV..", "..YELLOW.."[16]"..PREV.." y "..YELLOW.."[17]"..PREV..".";
...
L["Quest_5243_Location"] = "Leonid Barthalomew el Venerado (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."80,58"..PREV..")";
...
L["Quest_5214_Location"] = "Smokey LaRue (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."80,58"..PREV..")";
L["Quest_5214_Note"] = "Encuentras la Tienda de humo cerca de "..YELLOW.."[1]"..PREV..". Fras Siabi aparece después de abrir la caja.";
...
L["Quest_5282_Location"] = "Egan (Tierras de la Peste del Este; "..YELLOW.."14,33"..PREV..")";
L["Quest_5282_Note"] = "Obtienes la misión requisita de Custodio Alen (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."79,63"..PREV.."). Los ciudadanos espectrales caminan sobre todas las partes de Stratholme.";
...
L["Quest_5848_Location"] = "Artista Renfray (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."65,75"..PREV..")";
L["Quest_5848_Note"] = "Obtienes la misión requisita de Tirion Vadín (Tierras de la Peste del Oeste; "..YELLOW.."7,43"..PREV.."). Encuentras la pintura cerca de "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5463_Location"] = "Leonid Barthalomew el Venerado (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."80,58"..PREV..")";
L["Quest_5463_Note"] = "Obtienes la misión requisita de Magistrado Marduke (Tierras de la Peste del Oeste - Castel Darrow; "..YELLOW.."70,73"..PREV.."). Encuentras el Obsequio de Menethil cerca de "..YELLOW.."[19]"..PREV..". Ver También: "..YELLOW.."[El exánime, Ras Murmuhielo]"..PREV.." en Scholomance.";
...
L["Quest_5125_Note"] = "Para empezar la misión tienes que darle a Aurius [El medallón de Fe]. Encuentras el medallón en una caja (Caja fuerte de Malor "..YELLOW.."[7]"..PREV..") en la primera sala del bastión. Después de entregarle a Aurius el medallón, te ayuda cuando tu grupo luche contra Barón Osahendido "..YELLOW.."[19]"..PREV..". Después de matar al Barón Osahendido, habla con Aurius para obtener las recompensas.";
...
L["Quest_5251_Location"] = "Duque Nicholas Zverenhoff (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
L["Quest_5251_Note"] = "Encuentras el Archivo y al Archivista en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5262_Note"] = "Encuentras al Duque Nicholas Zverenhoff en las Tierras de la Peste del Este - Capilla de la Esperanza de la Luz ("..YELLOW.."81,59"..PREV..").";
...
L["Quest_5263_Location"] = "Duque Nicholas Zverenhoff (Tierras de la Peste del Este - Capilla de la Esperanza de la Luz; "..YELLOW.."81,59"..PREV..")";
L["Quest_5263_Note"] = "Encuentras al Barón Osahendido en "..YELLOW.."[19]"..PREV..".";
...
L["Quest_8945_Note"] = "Anthion está fuera del portal a Stratholme. Tienes que llevar el Detector de fantasmas extradimensional para verlo. Lo obtienes de la misión requisita. La cadena de misiones empieza con Una compensación justa. Deliana en Forjaz ("..YELLOW.."43,52"..PREV..") para la Alianza, Mokvar en Orgrimmar ("..YELLOW.."38,37"..PREV..") para la Horda.\nTienes que matar al Barón Osahendido en 45 minutos o menos.";
...
L["Quest_8991_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
...
L["Quest_8991_FollowQuest"] = "Últimos preparativos ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_9257_Location"] = "Anacronos (Tanaris - Cavernas del Tiempo; "..YELLOW.."65,49"..PREV..")";
L["Quest_9257_Note"] = "Invoca a Atiesh en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_5307_Location"] = "Seril Finiquiplaga (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,37"..PREV..")";
L["Quest_5307_Note"] = "Solamente para Herreros: Invoca al Armero Guardia Negra cerca de "..YELLOW.."[15]"..PREV..".";
...
L["Quest_5305_Location"] = "Lilith la Ágil (Cuna del Invierno - Vista Eterna; "..YELLOW.."61,37"..PREV..")";
L["Quest_5305_Note"] = "Solamente para Herreros: Invoca al Forjamartillos Carmesí en "..YELLOW.."[8]"..PREV..".";
...
L["Quest_7622_Location"] = "Eris Feleste (Tierras de la Peste del Este; "..YELLOW.."18,14"..PREV..")";
L["Quest_7622_Note"] = "Necesitas El Ojo de divinidad para ver Eris Feleste (despoja al Alijo del Señor del Fuego en "..YELLOW.."[Núcleo de Magma]"..PREV..").\n\nMezclando la recompensa de esta misión con El Ojo de divinidad y El Ojo de la Sombra forma Oración, el bastón épico para sacerdotes";
...
L["Quest_6163_Location"] = "Nathanos Clamañublo (Tierras de la Peste del Este; "..YELLOW.."26,74"..PREV..")";
L["Quest_6163_Note"] = "Obtienes la misión requisita de Nathanos Clamañublo también. Encuentras a Ramstein en "..YELLOW.."[18]"..PREV..".";
...
L["Quest_1475_Location"] = "Brohann Barriliga (Ventormenta - Distrito de los Enanos; "..YELLOW.."64,20"..PREV..")";
...
L["Quest_3445_Location"] = "Angelas Brisaluna (Feralas - Bastión Plumaluna; "..YELLOW.."31,45"..PREV..")";
L["Quest_3445_Note"] = "Encuentras a Marvon Buscarroblones en "..YELLOW.."52,45"..PREV..".";
...
L["Quest_3446_Location"] = "Marvon Buscarroblones (Tanaris; "..YELLOW.."52,45"..PREV..")";
L["Quest_3446_Note"] = "El Altar está en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_3447_Location"] = "Marvon Buscarroblones (Tanaris; "..YELLOW.."52,45"..PREV..")";
L["Quest_3447_Note"] = "Encuentras las estatuas en "..YELLOW.."[1]"..PREV..". Ve en el mapa para ver la orden de activarlas.";
...
L["Quest_4143_Location"] = "Gregan Tirabirras (Feralas; "..YELLOW.."45,25"..PREV..")";
L["Quest_4143_Note"] = "La misión requisita 'Muigin y Larion' empieza con Muigin (Cráter de Un'Goro - Refugio de Marshal; "..YELLOW.."42,9"..PREV.."). Despoja a los Rondadores de lo profundo, Gusanos de la oscuridad, y Mocos saturados para obtener las calimas.";
...
L["Quest_1446_Location"] = "El Exiliado Atal'ai (Tierras del Interior; "..YELLOW.."33,75"..PREV..")";
L["Quest_1446_Note"] = "Encuentras a Jammal'an en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_3373_Location"] = "Esencia de Eranikus (botín de la Sombra de Eranikus; "..YELLOW.."[6]"..PREV..")";
L["Quest_3373_Note"] = "Encuentras la Fuente de esencia justo al lado de la Sombra de Eranikus en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_8422_Location"] = "Diblis (Frondavil; "..YELLOW.."42,45"..PREV..")";
...
L["Quest_8425_Location"] = "Héroe caído de la Horda (Pantano de las Penas; "..YELLOW.."34,66"..PREV..")";
...
L["Quest_9053_Location"] = "Torwa Abrecaminos (Cráter de Un'Goro; "..YELLOW.."72,76"..PREV..")";
L["Quest_9053_Note"] = "Solamente para Druidas: Despoja a Atal'alarion que está invocado en "..YELLOW.."[1]"..PREV.." por activar las estatuas en la orden especificada en el mapa para obtener la vid pútrida.";
...
L["Quest_8232_Note"] = "Solamente para Cazadores: Morphaz está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_8253_Location"] = "Archimago Xylem (Azshara; "..YELLOW.."29,40"..PREV..")";
L["Quest_8253_Note"] = "Solamente para Magos: Morphaz está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_8257_Note"] = "Solamente para Sacerdotes: Morphaz está en "..YELLOW.."[5]"..PREV..". Greta Pezuñamusgo está en Frondavil - Santuario Esmeralda ("..YELLOW.."51,82"..PREV..").";
...
L["Quest_8236_Location"] = "Archimago Xylem (Azshara; "..YELLOW.."29,40"..PREV..")";
L["Quest_8236_Note"] = "Solamente para Pícaros: Despoja a Morphaz en "..YELLOW.."[5]"..PREV.." para obtener la llave azur. Lord Jorach Ravenholdt está en Montañas de Alterac - Ravenholdt ("..YELLOW.."86,79"..PREV..").";
...
L["Quest_8418_Location"] = "Comandante Ashlam Puñovalor (Tierras de la Peste del Oeste - Campamento del Orvallo; "..YELLOW.."43,85"..PREV..")";
...
L["Quest_1445_Location"] = "Fel'Zerul (Pantano de las Penas - Rocal; "..YELLOW.."47,54"..PREV..")";
...
L["Quest_3380_Location"] = "Médico brujo Uzer'i (Feralas; "..YELLOW.."74,43"..PREV..")";
L["Quest_3380_Note"] = "Encuentras a Marvon Marvon Buscarroblones en "..YELLOW.."52,45"..PREV..".";
...
L["Quest_4146_Location"] = "Liv Rizzlefix (Los Baldíos; "..YELLOW.."62,38"..PREV..")";
L["Quest_4146_Note"] = "La misión requisita 'Larion y Muigin' empieza con Larion (Cráter de Un'Goro; "..YELLOW.."45,8"..PREV.."). Despoja a los Rondadores de lo profundo, Gusanos de la oscuridad, y Mocos saturados para obtener las calimas.";
...
L["Quest_8413_Location"] = "Bath'rah el Vigía del viento (Montañas de Alterac; "..YELLOW.."80,67"..PREV..")";
...
L["Quest_721_Location"] = "Prospector Ryedol (Tierras Inhóspitas; "..YELLOW.."53,43"..PREV..")";
L["Quest_721_Note"] = "La misión requisita empieza al Mapa arrugado (Tierras Inhóspitas; "..YELLOW.."53,33"..PREV..").\nEncuentras a Grez Piemartillo antes de entrar la estancia en "..YELLOW.."[1]"..PREV.." en el mapa de la Entrada.";
...
L["Quest_722_Location"] = "Grez Piemartillo (Uldaman; "..YELLOW.."[1] en el mapa de la Entrada"..PREV..").";
L["Quest_722_Note"] = "Despoja a Magregan Sombraprofunda en "..YELLOW.."[2] en el mapa de la Entrada para obtener el amuleto"..PREV..".";
...
L["Quest_1139_Location"] = "Consejero Belgrum (Forjaz - Sala de los Exploradores; "..YELLOW.."77,10"..PREV..")";
L["Quest_1139_Note"] = "La tablilla está en "..YELLOW.."[8]"..PREV..".";
...
L["Quest_2418_Location"] = "Aparejez (Tierras Inhóspitas; "..YELLOW.."42,52"..PREV..")";
...
L["Quest_704_Location"] = "Prospector Vetaferro (Loch Modan - Excavación de Vetaferro; "..YELLOW.."65,65"..PREV..")";
L["Quest_704_Note"] = "La misión requisita empieza al Prospector Pico Tormenta (Forjaz - Sala de los Exploradores; "..YELLOW.."74,12"..PREV..").\nLas urnas están desperdigadas en la cueva afuera de la estancia.";
...
L["Quest_709_Location"] = "Theldurin el Perdido (Tierras Inhóspitas; "..YELLOW.."51,76"..PREV..")";
L["Quest_709_Note"] = "La tablilla está al norte de las cuevas, al fin este del túnel, antes de la estancia en el mapa de la Entrada en "..YELLOW.."[3]"..PREV..".";
...
L["Quest_2398_Location"] = "Prospector Pico Tormenta (Forjaz - Sala de los Exploradores; "..YELLOW.."75,12"..PREV..")";
L["Quest_2398_Note"] = "Baelog está en "..YELLOW.."[1]"..PREV..".";
...
L["Quest_2240_Note"] = "La cámara oculta está en "..YELLOW.."[4]"..PREV..". Para abrir la cámara oculta, necesitas El bastón de Tsol de Revelosh en "..YELLOW.."[3]"..PREV.." y el Medallón de Gni'kiv en el Cofre de Baelog en "..YELLOW.."[1]"..PREV..". Mezcla los objetos para hacer el Bastón de Prehistoria. Usa el bastón en la habitación entre "..YELLOW.."[3] y [4]"..PREV.." para invocar a Hierraya. Después de matarla, corre dentro de la habitación de donde vino para obtener crédito para la misión.";
...
L["Quest_2198_Note"] = "Lleva el collar a Talvash del Kissel (Forjaz - La Sala Mística; "..YELLOW.."36,3"..PREV..").";
...
L["Quest_2200_Location"] = "Talvash del Kissel (Forjaz - La Sala Mística; "..YELLOW.."36,3"..PREV..")";
L["Quest_2200_Note"] = "El paladín está en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2201_Location"] = "Restos de un paladín (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2201_Note"] = "Las gemas están en "..YELLOW.."[1]"..PREV.." dentro de la Urna llamativa, "..YELLOW.."[8]"..PREV.." del Alijo de Forjatiniebla, y "..YELLOW.."[9]"..PREV.." de Grimlok. Por favor nota que aparecerán enanos forjatiniebla después de abrir el Alijo de Forjatiniebla.\nUsa el Cuenco de visión de Talvash para entregar la misión y obtener la misión siguiente.";
...
L["Quest_2204_Note"] = "Despoja a Archaedas para obtener el Fuente de alimentación del collar destrozado en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_17_Location"] = "Ghak Sanadón (Loch Modan - Thelsamar; "..YELLOW.."37,49"..PREV..")";
...
L["Quest_1360_Location"] = "Krom Brazorrecio (Forjaz - Sala de los Exploradores; "..YELLOW.."74,9"..PREV..")";
L["Quest_1360_Note"] = "Encuentras el tesoro antes de entrar la estancia. Está a la parte al norte de las cuevas, al fin sureste del primer túnel. En el mapa de la Entrada está en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_1956_Location"] = "Tabetha (Marjal Revolcafango; "..YELLOW.."46,57"..PREV..")";
L["Quest_1956_Note"] = "Solamente para Magos: \nDespoja a una Centinela obsidiana para obtener el Fuente de poder obsidiano en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_1192_Location"] = "Pozík (Las Mil Agujas - Circuito del Espejismo; "..YELLOW.."80.1, 75.9"..PREV..")";
...
L["Quest_2283_Location"] = "Dran Droffers (Orgrimmar - La Calle Mayor; "..YELLOW.."59,36"..PREV..")";
...
L["Quest_2284_Location"] = "Dran Droffers (Orgrimmar - La Calle Mayor; "..YELLOW.."59,36"..PREV..")";
L["Quest_2284_Note"] = "El paladín está en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2318_Location"] = "Restos de un paladín (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2318_Note"] = "El traductor Jarkal Musgofusión está en Kargath (Tierras Inhóspitas; "..YELLOW.."2,46"..PREV..").";
...
L["Quest_2339_Location"] = "Jarkal Musgofusión (Tierras Inhóspitas - Kargath; "..YELLOW.."2,46"..PREV..")";
L["Quest_2339_Note"] = "Las gemas están en "..YELLOW.."[1]"..PREV.." dentro de la Urna llamativa, "..YELLOW.."[8]"..PREV.." del Alijo de Forjatiniebla, y "..YELLOW.."[9]"..PREV.." de Grimlok. Por favor nota que aparecerán enanos forjatiniebla después de abrir el Alijo de Forjatiniebla. Despoja a Archaedas para obtener el Fuente de alimentación del collar destrozado en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_2202_Location"] = "Jarkal Musgofusión (Tierras Inhóspitas - Kargath; "..YELLOW.."2,69"..PREV..")";
...
L["Quest_2342_Location"] = "Patrick Garrett (Entrañas; "..YELLOW.."72,48"..PREV..")";
L["Quest_2342_Note"] = "Encuentras el tesoro antes de entrar la estancia. Está al fin del túnel sur. En el mapa de la Entrada está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_971_Location"] = "Gerrig Agarrahueso (Forjaz - La Caverna Abandonada; "..YELLOW.."50,5"..PREV..")";
L["Quest_971_Note"] = "Encuentras el manuscrito en "..YELLOW.."[2]"..PREV.." en el agua.";
...
L["Quest_1275_Location"] = "Gershala Susurro Nocturno (Costa Oscura - Auberdine; "..YELLOW.."38,43"..PREV..")";
L["Quest_1275_Note"] = "La misión requisita es opcional. Lo consigues de Argos Susurro Nocturno en (Ventormenta - El Parque; "..YELLOW.."21,55"..PREV.."). \n\nDespoja a cualquier Naga fuera o dentro de la estancia para los bulbos.";
...
L["Quest_1198_Location"] = "Vigía del Alba Shaedlass (Darnassus - Bancal del Artesano; "..YELLOW.."55,24"..PREV..")";
L["Quest_1198_Note"] = "Encuentras al Guardia Argenta Thaelrid en "..YELLOW.."[4]"..PREV..".";
...
L["Quest_1200_Location"] = "Guardia Argenta Thaelrid (Cavernas de Brazanegra; "..YELLOW.."[4]"..PREV..")";
L["Quest_1200_Note"] = "Señor Crepuscular Kelris está en "..YELLOW.."[8]"..PREV..". Encuentras al Vigía del Alba Selgorm en Darnassus - Bancal del Artesano ("..YELLOW.."55,24"..PREV.."). \n\n¡ATENCIÓN! Si enciendes las flamas junto al Señor Crepuscular Kelris, aparezcan los enemigos hóstiles.";
...
L["Quest_1199_Location"] = "Guardia Argenta Manados (Darnassus - Bancal del Artesano; "..YELLOW.."55,23"..PREV..")";
...
L["Quest_6563_Location"] = "Je'neu Sancrea (Vallefresno - Avanzada de Zoram'gar; "..YELLOW.."11,33"..PREV..")";
L["Quest_6563_Note"] = "Obtienes la misión requisita Problemas en las profundidades de Tsunaman (Sierra Espolón - Refugio Roca del Sol; "..YELLOW.."47,64"..PREV.."). Se encuentra los cristales en los tuneles antes de entrar la estancia.";
...
L["Quest_6564_Note"] = "Despoja a las Sacerdotisas de las mareas Brazanegra para obtener la nota mojada. Entrégasela a Je'neu Sancrea (Vallefresno - Avanzada de Zoram'gar; "..YELLOW.."11,33"..PREV.."). Lorgus Jett está en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_6921_Location"] = "Je'neu Sancrea (Vallefresno - Avanzada de Zoram'gar; "..YELLOW.."11,33"..PREV..")";
L["Quest_6921_Note"] = "Encuentras el núcleo de las profundidades en "..YELLOW.."[7]"..PREV.." en el agua. Cuando consigas el núcleo, aparezca Barón Aquanis y te ataca. Despoja a él para obtener un objeto de misión para llevar a Je'neu Sancrea.";
...
L["Quest_6561_Location"] = "Guardia Argenta Thaelrid (Cavernas de Brazanegra; "..YELLOW.."[4]"..PREV..")";
L["Quest_6561_Note"] = "Señor Crepuscular Kelris está en "..YELLOW.."[8]"..PREV..". Encuentras a Bashana Tótem de Runa en Cima del Trueno - Alto de los Ancestros ("..YELLOW.."70,33"..PREV.."). \n\n¡ATENCIÓN! Si enciendes las flamas junto al Señor Crepuscular Kelris, aparezcan los enemigos hóstiles.";
...
L["Quest_7441_Location"] = "Azj'Tordin (Feralas - Pabellón de Lariss; "..YELLOW.."76,37"..PREV..")";
L["Quest_7441_Note"] = "Pusillín está en La Masacre "..YELLOW.."Este"..PREV.." en "..YELLOW.."[1]"..PREV..". Él corre cuando hables consigo y se lucha en "..YELLOW.."[2]"..PREV..". Despoja a él para obtener Llave creciente para entrar a La Masacre Norte y Oeste.";
...
L["Quest_7488_Location"] = "Latronicus Lanzaluna (Feralas - Bastión Plumaluna; "..YELLOW.."30,46"..PREV..")";
L["Quest_7488_Note"] = "Lethtendris está en La Masacre "..YELLOW.."Este"..PREV.." en "..YELLOW.."[3]"..PREV..". Obtienes la misión requisita del Mensajero Sentencia en Forjaz. Deambula por toda la ciudad.";
...
L["Quest_5526_Location"] = "Rabine Saturna (Claro de la Luna - Amparo de la Noche; "..YELLOW.."51,44"..PREV..")";
L["Quest_5526_Note"] = "Encuentras a Alzzin el Formaferal en la parte "..YELLOW.."Este"..PREV.." de La Masacre en "..YELLOW.."[5]"..PREV..". El relicario está en Silithius en "..YELLOW.."62,54"..PREV..". Obtienes la misión requisita de Rabine Saturna también.";
...
L["Quest_8990_Location"] = "Bodley (Montaña Roca Negra; "..YELLOW.."[D] en el mapa de la Entrada"..PREV..")";
...
L["Quest_8990_FollowQuest"] = "Últimos preparativos ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_7581_Location"] = "Daio el Decrépito (Las Tierras Devastadas - La Escara Impía; "..YELLOW.."34,50"..PREV..")";
L["Quest_7581_Note"] = "Solamente para Brujos: Esta misión es una parte de la cadena de misiones para su hechizo Ritual del apocalipsis. La ruta más fácil para buscar a los Sátiros Mala Hierbas es que entrar por La Masacre Este al puerto trasera en el Pabellón de Lariss (Feralas; "..YELLOW.."77,37"..PREV.."). Necesitas la Llave creciente.";
...
L["Quest_7489_Location"] = "Talo Pezuñahendida (Feralas - Campamento Mojache; "..YELLOW.."76,43"..PREV..")";
L["Quest_7489_Note"] = "Lethtendris está en La Masacre "..YELLOW.."Este"..PREV.." en "..YELLOW.."[3]"..PREV..". Obtienes la misión requisita de Clamaguerras Gorlach en Orgrimmar. Deambula por toda la ciudad.";
...
L["Quest_1193_Location"] = "Trampa rota (La Masacre; "..YELLOW.."Norte"..PREV..")";
...
L["Quest_5518_Location"] = "Knot Llavededo (La Masacre; "..YELLOW.."Norte, [4]"..PREV..")";
L["Quest_5518_Note"] = "Misión repetible. Consigues el Tanino de ogro cerca de "..YELLOW.."[4] (encima)"..PREV..".";
...
L["Quest_5525_Location"] = "Knot Llavededo (La Masacre; "..YELLOW.."Norte, [4]"..PREV..")";
...
L["Quest_7703_Location"] = "Capitán Kromcrush (La Masacre; "..YELLOW.."Norte, [5]"..PREV..")";
L["Quest_7703_Note"] = "El Príncipe Tortheldrin está en La Masacre "..YELLOW.."Oeste"..PREV.." en "..YELLOW.."[7]"..PREV..". El guante está cerca de él dentro un cofre. Solamente puedes conseguir la misión después de realizar el tributo y si tienes el buff 'Rey del Gordok'.";
...
L["Quest_5528_Location"] = "Vapuleador Kreeg (La Masacre; "..YELLOW.."Norte, [2]"..PREV..")";
...
L["Quest_7482_Location"] = "Erudita Runaespina (Feralas - Bastión Plumaluna; "..YELLOW.."31,43"..PREV..")";
L["Quest_7482_Note"] = "Encuentras a Kariel Winthalus en la "..YELLOW.."Librería (Oeste)"..PREV..".";
...
L["Quest_7461_Location"] = "Ancestro Shen'dralar (La Masacre; "..YELLOW.."Oeste, [1] (encima)"..PREV..")";
L["Quest_7461_Note"] = "Las torres están marcadas así como "..BLUE.."[B]"..PREV..". Immol'thar está en "..YELLOW.."[6]"..PREV..", Príncipe Tortheldrin está en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7877_Location"] = "Ancestro Shen'dralar (La Masacre; "..YELLOW.."Oeste, [1]"..PREV..")";
L["Quest_7877_Note"] = "Encuentras el tesoro debajo de las escaleras en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7631_Location"] = "Mor'zul Sangredoble (Las Estepas Ardientes; "..YELLOW.."12,31"..PREV..")";
L["Quest_7631_Note"] = "Solamente para Brujos: La misión última de la cadena de misiones para la montura de los brujos. Al primer tienes que desactivar las torres marcadas así como "..BLUE.."[B]"..PREV.." y mata a Immol'thar en "..YELLOW.."[6]"..PREV..". Después, empieza la invocación. Necesitas al menos 20 Fragmentos de alma y un brujo asignado a mantener la campanilla, la vela, y la rueda activas. Se Puede esclavizar los Guardias apocalípticos. Después de terminarla, habla con el Espíritu de corcel nefasto para completar la misión.";
L["Quest_7631_PreQuest"] = "Entrega de diablillo ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_7506_Note"] = "Solamente para Druidas: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7503_Note"] = "Solamente para Cazadores: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7500_Note"] = "Solamente para Magos: Devuelves el libro al Tradicionalista Kildrath a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7501_Note"] = "Solamente para Paladines: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7504_Note"] = "Solamente para Sacerdotes: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7498_Note"] = "Solamente para Pícaros: Devuelves el libro al Tradicionalista Kildrath a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7502_Note"] = "Solamente para Brujos: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7499_Note"] = "Solamente para Guerreros: Devuelves el libro al Tradicionalista Kildrath a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7484_Location"] = "Tradicionalista Lydros (La Masacre Oeste; "..YELLOW.."[1'] Librería"..PREV..")";
L["Quest_7484_Note"] = "Tienes que completar la misión \"Leyendas élficas\" antes de empezar esta misión.\n\nEl tratado es botín aleatorio de La Masacre y puedes comerciarlo y comprarlo en la subasta. El Piel de Sombra es ligado y puedes conseguirlo de algunos jefes, Ensamblajes resucitados, y Guardahuesos resucitados en "..YELLOW.."Scholomance"..PREV..".";
...
L["Quest_7485_Location"] = "Tradicionalista Lydros (La Masacre Oeste; "..YELLOW.."[1'] Librería"..PREV..")";
L["Quest_7485_Note"] = "Tienes que completar la misión \"Leyendas élficas\" antes de empezar esta misión.\n\nEl tratado es botín aleatorio de La Masacre y puedes comerciarlo y comprarlo en la subasta. Las Costuras desgarradas de abominación son ligadas y puedes conseguirlas de Ramstein el Empachador, Eructaveneno, Vomitón bílico, y Horror de retazos en "..YELLOW.."Stratholme"..PREV..".";
...
L["Quest_7483_Location"] = "Tradicionalista Lydros (La Masacre Oeste; "..YELLOW.."[1'] Librería"..PREV..")";
...
L["Quest_7507_Location"] = "Compendio de matar dragones de Foror (botín aleatorio de los jefes en "..YELLOW.."La Masacre"..PREV..")";
L["Quest_7507_Note"] = "Solamente para Guerreros y Paladines. Devuélvelo al Tradicionalista Lydros en (La Masacre Oeste; "..YELLOW.."[1'] Librería"..PREV.."). Te permite empezar la misión para forjar Quel'Serrar después de terminar la misión.";
...
L["Quest_7481_Location"] = "Sabio Korolusk (Feralas - Campamento Mojache; "..YELLOW.."74,43"..PREV..")";
L["Quest_7481_Note"] = "Encuentras a Kariel Winthalus en la "..YELLOW.."Librería (Oeste)"..PREV..".";
...
L["Quest_7505_Note"] = "Solamente para Chamanes: Devuelves el libro al Tradicionalista Javon a la "..YELLOW.."1' Librería"..PREV..".";
...
L["Quest_7070_Location"] = "Archimago Tervosh (Marjal Revolcafango - Isla Theramore; "..YELLOW.."66,49"..PREV..")";
...
L["Quest_7041_Location"] = "Talendria (Desolace - Punta de Nijel; "..YELLOW.."68,8"..PREV..")";
...
L["Quest_7067_Location"] = "Paria Centauro (Desolace; "..YELLOW.."45,86"..PREV..")";
...
L["Quest_7044_Location"] = "Cavindra (Desolace - Maraudon; "..YELLOW.."[4] en el mapa de la Entrada"..PREV..")";
L["Quest_7044_Note"] = "Encuentras a Cavindra al comienzo de la parte naranja antes de entrar la estancia.\nConsigues el Vara de Celebras de Noxxion en "..YELLOW.."[2]"..PREV.." y el Diamante de Celebras de Lord Lenguavil en "..YELLOW.."[5]"..PREV..". Celebras está en "..YELLOW.."[7]"..PREV..". Tienes que derrotarlo para hablar consigo.";
...
L["Quest_7046_Location"] = "Celebras el Redimido (Maraudon; "..YELLOW.."[7]"..PREV..")";
...
L["Quest_7065_Location"] = "Vigilante Marandis (Desolace - Punta de Nijel; "..YELLOW.."63,10"..PREV..")";
L["Quest_7065_Note"] = "Encuentras a la Princesa Theradras en "..YELLOW.."[11]"..PREV..".";
...
L["Quest_7066_Location"] = "Espíritu de Zaetar (Maraudon; "..YELLOW.."[11]"..PREV..")";
L["Quest_7066_Note"] = "El Espíritu de Zaetar aparece después de matar a la Princesa Theradras en "..YELLOW.."[11]"..PREV..". Encuentras al Guardián Remulos en (Claro de la Luna - Santuario de Remulos; "..YELLOW.."36,41"..PREV..").";
...
L["Quest_7068_Location"] = "Uthel'nay (Orgrimmar - Valle de los Espíritus; "..YELLOW.."39,86"..PREV..")";
...
L["Quest_7029_Location"] = "Vark Marca de Guerra (Desolace - Aldea Cazasombras; "..YELLOW.."23,70"..PREV..")";
...
L["Quest_7064_Note"] = "Encuentras a la Princesa Theradras en "..YELLOW.."[11]"..PREV..".";
...
L["Quest_5723_Location"] = "Rahauro (Cima del Trueno - Alto de los Ancestros; "..YELLOW.."70,29"..PREV..")";
...
L["Quest_5725_Location"] = "Varimathras (Entrañas - Barrio Real; "..YELLOW.."56,92"..PREV..")";
...
L["Quest_5722_Location"] = "Rahauro (Cima del Trueno - Alto de los Ancestros; "..YELLOW.."70,29"..PREV..")";
L["Quest_5722_Note"] = "Encuentras a Maur Tótem Siniestro en "..YELLOW.."[1]"..PREV..". Después de recoger la cartera tienes que devolverla a Rahauro en Cima del Trueno.";
...
L["Quest_5728_Location"] = "Thrall (Orgrimmar - Valle de la Sabiduría; "..YELLOW.."31,37"..PREV..")";
L["Quest_5728_Note"] = "Encuentras a Bazzalan en "..YELLOW.."[4]"..PREV.." y Jergosh en "..YELLOW.."[3]"..PREV..". La cadena de misiones empieza con Thrall en Orgrimmar.";
...
L["Quest_5761_Location"] = "Neeru Hojafuego (Orgrimmar - Circo de las Sombras; "..YELLOW.."49,50"..PREV..")";
L["Quest_5761_Note"] = "Encuentras a Taragaman en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6626_Location"] = "Myriam Lunacanta (Los Baldíos; "..YELLOW.."49,94"..PREV..")";
...
L["Quest_3525_Location"] = "Belnistrasz (Zahúrda Rajacieno; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_3636_Location"] = "Arzobispo Benedictus (Ventormenta - Catedral de la Luz; "..YELLOW.."39,27"..PREV..")";
L["Quest_3636_Note"] = "Amnennar el Gélido es el último jefe en la Zahúrda Rajacieno. Lo encuentras en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_6521_Location"] = "Varimathras (Entrañas - Barrio Real; "..YELLOW.."56,92"..PREV..")";
L["Quest_6521_Note"] = "Obtienes la misión requisita del último jefe en el Horado Rajacieno. Encuentras a Malcin fuera de la estancia (Los Baldíos; "..YELLOW.."48,92"..PREV..").";
...
L["Quest_3341_Location"] = "Andrew Brownell (Entrañas - Barrio de la Magia; "..YELLOW.."72,32"..PREV..")";
L["Quest_3341_Note"] = "Amnennar el Gélido es el último jefe en la Zahúrda Rajacieno. Lo encuentras en "..YELLOW.."[6]"..PREV..".";
...
L["Quest_1221_Location"] = "Mebok Mizzyrix (Los Baldíos - Trinquete; "..YELLOW.."62,37"..PREV..")";
...
L["Quest_1142_Location"] = "Heralath Arroyobarbecho (Horado Rajacieno; "..YELLOW.."[8]"..PREV..")";
L["Quest_1142_Note"] = "El colgante es botín aleatorio. Llévalo a Trashala Arroyobarbecho en Darnassus - Bancal del Artesano ("..YELLOW.."69,67"..PREV..").";
...
L["Quest_1144_Location"] = "Willix el Importador (Horado Rajacieno; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_1101_Location"] = "Díscolo Falfindel (Feralas - Thalanaar; "..YELLOW.."89,46"..PREV..")";
L["Quest_1101_Note"] = "Despoja a Charlga Filonavaja "..YELLOW.."[7]"..PREV.." para obtener el medallón.";
...
L["Quest_1701_Location"] = "Furen Barbalarga (Ventormenta - Distrito de los Enanos; "..YELLOW.."57,16"..PREV..")";
L["Quest_1701_Note"] = "Solamente para Guerreros: Consigues el Vial de flogisto de Roogug en "..YELLOW.."[1]"..PREV..".\n\nDespués de completar la misión, se abrirá 3 nuevas misiones: Sangre ardiente en Ventormenta, Coral férreo en Forjaz, y Cáscaras asoladas en Darnassus.";
...
L["Quest_1109_Location"] = "Maestro boticario Faranell (Entrañas - El Apothecarium; "..YELLOW.."48,69 "..PREV..")";
L["Quest_1109_Note"] = "Despoja a cualquier murciélago en la estancia para obtener el Guano del Horado";
L["Quest_1109_FollowQuest"] = "Corazones de fanatismo ("..YELLOW.."[Monasterio Escarlata]"..PREV..")";
...
L["Quest_1102_Location"] = "Auld Picopiedra (Cima del Trueno; "..YELLOW.."36,59"..PREV..")";
L["Quest_1102_Note"] = "Encuentras a Charlga Filonavaja en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_1838_Location"] = "Thun'grim Vistafuego (Los Baldíos; "..YELLOW.."57,30"..PREV..")";
L["Quest_1838_Note"] = "Solamente para Guerreros: Consigues el Vial de flogisto de Roogug en "..YELLOW.."[1]"..PREV..".\n\nDespués de completar la misión, abrirá 4 nuevas misiones";
...
L["Quest_1486_Location"] = "Nalpak (Los Baldíos - Cuevas de los Lamentos; "..YELLOW.."47,36"..PREV..")";
...
L["Quest_959_Location"] = "Operador de grúa Pelardo (Los Baldíos - Trinquete; "..YELLOW.."63,37"..PREV..")";
L["Quest_959_Note"] = "Consigues la botella antes de que entras la estancia por matar Loco Magglish. Cuando entras la cueva, dirígete al derecho para encontrarlo al final del pasaje. Él está en sigilo cerca del muro en "..YELLOW.."[1] en el mapa de la Entrada"..PREV..".";
...
L["Quest_1491_Location"] = "Mebok Mizzyrix (Los Baldíos - Trinquete; "..YELLOW.."62,37"..PREV..")";
...
L["Quest_1487_Location"] = "Ebru (Los Baldíos - Cuevas de los Lamentos; "..YELLOW.."47,36"..PREV..")";
...
L["Quest_6981_Location"] = "Fragmento resplandeciente (Despoja a Mutanus el Devorador); "..YELLOW.."[9]"..PREV..")";
...
L["Quest_962_Location"] = "Boticaria Zamah (Cima del Trueno - Alto de los Espíritus; "..YELLOW.."22,20"..PREV..")";
L["Quest_962_Note"] = "Boticaria Zamah está en una cueva debajo del Alto de los Espíritus. Obtienes la misión requisita del Boticario Helbrim (Los Baldíos - El Cruce; "..YELLOW.."51,30"..PREV..").\nRecojas la Reptilia dentro de la cueva enfrente de la estancia y dentro de la estancia. Los jugadores que tienen Botánica pueden ver las hierbas por sus minimapa.";
...
L["Quest_914_Location"] = "Nara Ferocrín (Cima del Trueno - Alto de los Ancestros; "..YELLOW.."75,31"..PREV..")";
L["Quest_914_Note"] = "La cadena de misiones empieza con Hamuul Tótem de Runa (Cima del Trueno - Alto de los Ancestros; "..YELLOW.."78,28"..PREV..")\nDespoja a los 4 druidas para obtener las gemas en "..YELLOW.."[2]"..PREV..", "..YELLOW.."[3]"..PREV..", "..YELLOW.."[5]"..PREV..", "..YELLOW.."[7]"..PREV..".";
...
L["Quest_3042_Location"] = "Trenton Mazaligera (Tanaris - Gadgetzan; "..YELLOW.."51,28"..PREV..")";
...
L["Quest_2865_Note"] = "La misión requisita empieza con Krazek (Vega de Tuercespina - Bahía del Botín; "..YELLOW.."25,77"..PREV..").\nDespoja a cualquier escarabajo para obtener los caparazones. Hay muchos escarabajos que están en "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2846_Location"] = "Tabetha (Marjal Revolcafango; "..YELLOW.."46,57"..PREV..")";
L["Quest_2846_Note"] = "Despoja a Hidromántica Velratha en "..YELLOW.."[6]"..PREV.." para obtener la tiara de las profundidades.";
...
L["Quest_2991_Location"] = "Thadius Sombramacabra (Las Tierras Devastadas - Castillo de Nethergarde; "..YELLOW.."66,19"..PREV..")";
L["Quest_2991_Note"] = "La cadena de misiones empieza con Maestro de grifos Garracha (Tierras del Interior - Pico Nidal; "..YELLOW.."9,44"..PREV..").\nNekrum aparece en "..YELLOW.."[4]"..PREV.." durante el evento de las escaleras.";
...
L["Quest_3527_Location"] = "Yeh'kinya (Tanaris - Puerto Bonvapor; "..YELLOW.."66,22"..PREV..")";
L["Quest_3527_Note"] = "Obtienes la misión requisita de Yeh'kinya también.\nDespoja a Theka el Martír en "..YELLOW.."[2]"..PREV.." y Hidromántica Velratha en "..YELLOW.."[6]"..PREV.." para obtener la primera y segunda tablillas Mosh'aru.";
...
L["Quest_2768_Location"] = "Ingeniero Jefe Pasaquillas (Tanaris - Gadgetzan; "..YELLOW.."52,28"..PREV..")";
L["Quest_2768_Note"] = "Obtienes la vara del Sargento Bly. Lo encuentras en "..YELLOW.."[4]"..PREV.." después del evento en las escaleras.";
...
L["Quest_2770_Location"] = "Wizzle Pernolatón (Las Mil Agujas - Circuito del Espejismo; "..YELLOW.."78,77"..PREV..")";
L["Quest_2770_Note"] = "Obtienes la misión requisita de Klockmort Palmalicate (Forjaz - Ciudad Manitas; "..YELLOW.."68,46"..PREV.."). No es necesario tener la misión requisita para obtener la misión de Gahz'rilla.\nInvoca a Gahz'rilla en "..YELLOW.."[6]"..PREV.." con la Marra de Zul'Farrak.\nObtienes la marra sacra de Qiaga la Vigilante (Tierras del Interior - El Altar de Zul; "..YELLOW.."49,70"..PREV.."). Úsala al Altar de Jintha'Alor en "..YELLOW.."59,77"..PREV.." para crear la Marra de Zul'Farrak.";
...
L["Quest_6822_Location"] = "Duque Hydraxis (Azshara; "..YELLOW.."79,73"..PREV..")";
L["Quest_6822_Note"] = "Están por dentro del Núcleo de Magma.";
L["Quest_6822_PreQuest"] = "Ojo del Brasadivino ("..YELLOW.."Cumbre de Roca Negra Superior"..PREV..")";
...
L["Quest_6824_Location"] = "Duque Hydraxis (Azshara; "..YELLOW.."79,73"..PREV..")";
L["Quest_6824_Note"] = "Lucifron está en "..YELLOW.."[1]"..PREV..", Sulfuron está en "..YELLOW.."[8]"..PREV..", Gehennas está en "..YELLOW.."[3]"..PREV.." y Shazzrah está en "..YELLOW.."[5]"..PREV..".";
...
L["Quest_7786_Location"] = "Alto señor Demitrian (Silithus; "..YELLOW.."22,9"..PREV..")";
L["Quest_7786_Note"] = "Una parte de la cadena de misiones para Trueno Furioso, Espada Bendita del Hijo del Viento. Empieza después de obtener la mitad izquierda o la derecha de Garr en "..YELLOW.."[4]"..PREV.." o Barón Geddon en "..YELLOW.."[6]"..PREV..". Habla con Alto señor Demitrian para empezar la cadena de misiones. Despoja a Ragnaros para obtener la Esencia del Señor del Fuego en "..YELLOW.."[10]"..PREV..". Después de entregar la misión, se invoca el Príncipe Thunderaan y debes matarlo. Se requiere una banda de 40 jugadores.";
...
L["Quest_7604_Location"] = "Lokhtos Tratoscuro (Profundidades de Roca Negra; "..YELLOW.."[15]"..PREV..")";
L["Quest_7604_Note"] = "Necesitas un Lingote de sulfuron para obtener el contrato de Lokhtos. Despoja a Golemagg el Incinerador en el Núcleo de Magma en "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7632_Location"] = "Hoja petrificada vieja (botín del Alijo del Señor del Fuego; "..YELLOW.."[9]"..PREV..")";
L["Quest_7632_Note"] = "Entrégala a Vartrus el Ancestro en (Frondavil - Bosque de Troncoferro; "..YELLOW.."49,24"..PREV..").";
L["Quest_7632_FollowQuest"] = "Carcaj antiguo cosido con tendón ("..YELLOW.."Azuregos"..PREV..")";
...
L["Quest_8578_Location"] = "Narain Sabelotodo (Tanaris; "..YELLOW.."65,18"..PREV..")";
...
L["Quest_7509_Location"] = "Tradicionalista Lydros (La Masacre Oeste; "..YELLOW.."[1] Librería"..PREV..")";
...
L["Quest_7509_PreQuest"] = "Compendio de Foror ("..YELLOW.."La Masacre Oeste"..PREV..") -> Forjar Quel'Serrar";
...
L["Quest_7495_Location"] = "Cabeza de Onyxia (botín de Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7495_Note"] = "Alto señor Bolvar Fordragón está en (Ventormenta - Castillo de Ventormenta; "..YELLOW.."78,20"..PREV.."). Sólo un jugador en la banda puede conseguir la cabeza.\n\nLas recompensas son para la misión siguiente.";
...
L["Quest_7490_Location"] = "Cabeza de Onyxia (botín de Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7490_Note"] = "Thrall está en (Orgrimmar - Valle de la Sabiduría; "..YELLOW.."31,37"..PREV.."). Sólo un jugador en la banda puede conseguir la cabeza.\n\nLas recompensas son para la misión siguiente.";
...
L["Quest_8201_Location"] = "Exzhal (Vega de Tuercespina - Isla Yojamba; "..YELLOW.."15,15"..PREV..")";
...
L["Quest_8183_Location"] = "Corazón de Hakkar (botín de Hakkar; "..YELLOW.."[11]"..PREV..")";
L["Quest_8183_Note"] = "Molthor (Vega de Tuercespina - Isla Yojamba; "..YELLOW.."15,15"..PREV..")";
...
L["Quest_8227_Note"] = "Nat Pagle está en el Marjal Revolcafango ("..YELLOW.."59,60"..PREV.."). Después de entregar la misión, puedes comprar el Cebo de Fangoapestoso de Nat Pagle para invocar a Gahz'ranka en Zul'Gurub.";
...
L["Quest_9023_Location"] = "Dirk Truenedera (Silithus - Fuerte Cenarion; "..YELLOW.."52,39"..PREV..")";
L["Quest_9023_Note"] = "Despoja al Sumo sacerdote Venoxis en "..YELLOW.."Zul'Gurub"..PREV.." para obtener la glándula de veneno de Venoxis. Despoja a Kurinnaxx en las "..YELLOW.."Ruinas de Ahn'Qiraj"..PREV.." en "..YELLOW.."[1]"..PREV.." para obtener la glándula de veneno de Kurinnaxx.";
...
L["Quest_8791_Location"] = "Cabeza de Osirio el Sinmarcas (botín de Osirio el Sinmarcas; "..YELLOW.."[6]"..PREV..")";
L["Quest_8791_Note"] = "Comandante Mar'alith (Silithus - Fuerte Cenarion; "..YELLOW.."49,34"..PREV..")";
...
L["Quest_8801_Location"] = "Ojo de C'Thun (botín de C'Thun; "..YELLOW.."[9]"..PREV..")";
L["Quest_8801_Note"] = "Caelestrasz (Templo de Ahn'Qiraj; "..YELLOW.."2'"..PREV..")\nLas recompensas son para la misión siguiente.";
...
L["Quest_8802_Location"] = "Ojo de C'Thun (despoja a C'Thun; "..YELLOW.."[9]"..PREV..")";
L["Quest_8802_Note"] = "Anacronos (Tanaris - Cavernas del Tiempo; "..YELLOW.."65,49"..PREV..")";
...
L["Quest_8784_Note"] = "Llévalo a Andorgos (Templo de Ahn'Qiraj; "..YELLOW.."1'"..PREV..").";
...
L["Quest_8579_Location"] = "Kandrostrasz (Templo de Ahn'Qiraj; "..YELLOW.."[1']"..PREV..")";
...
L["Quest_7261_Location"] = "Teniente Rotimer (Forjaz - La Plaza; "..YELLOW.."30,62"..PREV..")";
L["Quest_7261_Note"] = "Teniente Haggerdin está en (Montañas de Alterac; "..YELLOW.."39,81"..PREV..").";
...
L["Quest_7162_Location"] = "Teniente Haggerdin (Montañas de Alterac; "..YELLOW.."39,81"..PREV..")";
L["Quest_7162_Note"] = "El estandarte Pico Tormenta está en la cueva Ala Gélida en "..YELLOW.."[11]"..PREV.." en el mapa Valle de Alterac - Norte. Habla con el mismo PNJ cada vez que subes tu reputación para obtener una insignia mejorada.\n\nLa misión requisita no es necesaria para obtener esta misión.";
...
L["Quest_7141_Location"] = "Prospectora Tallapiedra (Montañas de Alterac; "..YELLOW.."41,80"..PREV..") y\n(Valle de Alterac - Norte; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "Drek'thar está en (Valle de Alterac - Sur; "..YELLOW.."[B]"..PREV..").";
...
L["Quest_7121_Location"] = "Montaraz Bramibum (Valle de Alterac- Norte; "..YELLOW.."Cerca de [3] delante de la puente"..PREV..")";
L["Quest_7121_Note"] = "El Intendente Pico Tormenta está en (Valle de Alterac - Norte; "..YELLOW.."[7]"..PREV..").";
...
L["Quest_6982_Location"] = "Intendente Pico Tormenta (Valle de Alterac - Norte; "..YELLOW.."[7]"..PREV..")";
L["Quest_6982_Note"] = "Encuentras los suministros en la Mina Dentefrío (Valle de Alterac - Sur; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_5892_Location"] = "Intendente Pico Tormenta (Valle de Alterac - Norte; "..YELLOW.."[7]"..PREV..")";
L["Quest_5892_Note"] = "Encuentras los suministros en la Mina Ferrohondo (Valle de Alterac - Norte; "..YELLOW.."[1]"..PREV..").";
...
L["Quest_7223_Location"] = "Murgot Forjahonda (Valle de Alterac - Norte; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_7122_Location"] = "Sargento Durgen Pico Tormenta (Montañas de Alterac; "..YELLOW.."37,77"..PREV..")";
L["Quest_7122_Note"] = "Mata a Morloch en la Mina Ferrohondo (Valle de Alterac - Norte; "..YELLOW.."[1]"..PREV..") o Capataz Snivvle en la Mina Dentefrío (Valle de Alterac - Sur; "..YELLOW.."[6]"..PREV..") mientras está bajo control de la Horda.";
...
L["Quest_7102_Location"] = "Sargento Durgen Pico Tormenta (Montañas de Alterac; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7081_Location"] = "Sargento Durgen Pico Tormenta (Montañas de Alterac; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7027_Location"] = "Maestra de establos Pico Tormenta (Valle de Alterac - Norte; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7026_Location"] = "Comandante de jinetes de carneros Pico Tormenta (Valle de Alterac - Norte; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7386_Location"] = "Archidruida Renferal (Valle de Alterac - Norte; "..YELLOW.."[2]"..PREV..")";
L["Quest_7386_Note"] = "Despúes de entregar alrededor 200 cristales, Archidruida Renferal caminará hacia (Valle de Alterac - Norte; "..YELLOW.."[19]"..PREV.."). Empezará el ritual de invocación que requiere 10 jugadores para asistirle. Si lo completa, invocará Ivus, el Señor del Bosque para ayudarles en la batalla.";
...
L["Quest_6881_Location"] = "Archidruida Renferal (Valle de Alterac - Norte; "..YELLOW.."[2]"..PREV..")";
L["Quest_6881_Note"] = "Despúes de entregar alrededor 200 cristales, Archidruida Renferal caminará hacia (Valle de Alterac - Norte; "..YELLOW.."[19]"..PREV.."). Empezará el ritual de invocación que requiere 10 jugadores para asistirle. Si lo completa, invocará Ivus, el Señor del Bosque para ayudarles en la batalla.";
...
L["Quest_6942_Location"] = "Comandante del aire Slidore (Valle de Alterac - Norte; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6941_Location"] = "Comandante del aire Vipore (Valle de Alterac - Norte; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6943_Location"] = "Comandante del aire Ichman (Valle de Alterac - Norte; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7241_Location"] = "Embajadora Rokhstrom Lobo Gélido (Orgrimmar - Valle de Fuerza; "..YELLOW.."50,71"..PREV..")";
L["Quest_7241_Note"] = "Maestro de guerra Laggrond está en (Montañas de Alterac; "..YELLOW.."62,59"..PREV..").";
...
L["Quest_7161_Location"] = "Maestro de guerra Laggrond (Montañas de Alterac; "..YELLOW.."62,59"..PREV..")";
L["Quest_7161_Note"] = "El estandarte Lobo Gélido está en la caverna Zarpa Salvaje en "..YELLOW.."[15]"..PREV.." en el mapa Valle de Alterac - Sur. Habla con el mismo PNJ cada vez que subes tu reputación para obtener una insignia mejorada.\n\nLa misión requisita no es necesaria para obtener esta misión.";
...
L["Quest_7142_Location"] = "Voggah Agarre Letal (Montañas de Alterac; "..YELLOW.."64,60"..PREV..")";
L["Quest_7142_Note"] = "Vanndar Pico Tormenta está en (Valle de Alterac - Norte; "..YELLOW.."[B]"..PREV..").";
...
L["Quest_7123_Location"] = "Jotek (Valle de Alterac - Sur; "..YELLOW.."[8]"..PREV..")";
L["Quest_7123_Note"] = "El Intendente Lobo Gélido está en "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5893_Location"] = "Intendente Lobo Gélido (Valle de Alterac - Sur; "..YELLOW.."[10]"..PREV..")";
L["Quest_5893_Note"] = "Encuentras los suministros en la Mina Dentefrío en (Valle de Alterac - Sur; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_6985_Location"] = "Intendente Lobo Gélido (Valle de Alterac - Sur; "..YELLOW.."[10]"..PREV..")";
L["Quest_6985_Note"] = "Encuentras los suministros en la Mina Ferrohondo (Valle de Alterac - Norte; "..YELLOW.."[1]"..PREV..").";
...
L["Quest_7224_Location"] = "Herrero Regzar (Valle de Alterac - Sur; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7124_Location"] = "Cabo Teeka Gruñido Sangriento (Montañas de Alterac; "..YELLOW.."66,55"..PREV..")";
L["Quest_7124_Note"] = "Mata a Morloch en la Mina Ferrohondo (Valle de Alterac - Norte; "..YELLOW.."[1]"..PREV..") o Capataz Snivvle en la Mina Dentefrío (Valle de Alterac - Sur; "..YELLOW.."[6]"..PREV..") mientras está bajo control de la Alianza.";
...
L["Quest_7101_Location"] = "Cabo Teeka Gruñido Sangriento (Montañas de Alterac; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7082_Location"] = "Cabo Teeka Gruñido Sangriento (Montañas de Alterac; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7001_Location"] = "Maestra de establos Lobo Gélido (Valle de Alterac - Sur; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7002_Location"] = "Comandante jinete de lobos Lobo Gélido (Valle de Alterac - Sur; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7385_Location"] = "Primalista Thurloga (Valle de Alterac - Sur; "..YELLOW.."[8]"..PREV..")";
L["Quest_7385_Note"] = "Despúes de entregar alrededor 150 galones de sangre, Primalista Thurloga caminará hacia (Valle de Alterac - Sur; "..YELLOW.."[14]"..PREV.."). Empezará el ritual de invocación que requiere 10 jugadores para asistirle. Si lo completa, invocará Lokholar, el Señor del Hielo para ayudarles en la batalla.";
...
L["Quest_6801_Location"] = "Primalista Thurloga (Valle de Alterac - Sur; "..YELLOW.."[8]"..PREV..")";
L["Quest_6801_Note"] = "Despúes de entregar alrededor 150 galones de sangre, Primalista Thurloga caminará hacia (Valle de Alterac - Sur; "..YELLOW.."[14]"..PREV.."). Empezará el ritual de invocación que requiere 10 jugadores para asistirle. Si lo completa, invocará Lokholar, el Señor del Hielo para ayudarles en la batalla.";
...
L["Quest_6825_Location"] = "Comandante del aire Guse (Valle de Alterac - Sur; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6826_Location"] = "Comandante del aire Jeztor (Valle de Alterac - Sur; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6827_Location"] = "Comandante del aire Mulverick (Valle de Alterac - Sur; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_8105_Location"] = "Mariscal de campo Uluz (Tierras Altas de Arathi - Refugio de la Zaga; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8114_Location"] = "Mariscal de campo Uluz (Tierras Altas de Arathi - Refugio de la Zaga; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8115_Location"] = "Mariscal de campo Uluz (Tierras Altas de Arathi - Refugio de la Zaga; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8120_Location"] = "Maestra de la Muerte Duire (Tierras Altas de Arathi - Sentencia; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8121_Location"] = "Maestra de la Muerte Duire (Tierras Altas de Arathi - Sentencia; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8122_Location"] = "Maestra de la Muerte Duire (Tierras Altas de Arathi - Sentencia; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8446_Note"] = "Entrega el objeto a Guardián Remulos (Claro de la Luna - Santuario de Remulos; "..YELLOW.."36,41"..PREV.."). La recompensa es para la misión siguiente.";
...
L["Quest_7634_Location"] = "Hastat el Anciano (Frondavil - Bosque de Troncoferro; "..YELLOW.."48,24"..PREV..")";
L["Quest_7634_Note"] = "Solamente para Cazadores: Mata a Azuregos para obtener el Tendón de dragón Azul maduro. Azuregos rodea en el centro de la península sureña cerca de "..YELLOW.."[1]"..PREV..".";
L["Quest_7634_RewardText"] = "1";
L["Quest_7634_PreQuest"] = "La hoja antigua ("..YELLOW.."Núcleo de Magma"..PREV..")";
