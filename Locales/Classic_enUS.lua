...
L["Quest_4136_Location"] = "Yuka Screwspigot (Burning Steppes - Flame Crest; "..YELLOW.."66.0, 22.0"..PREV..")";
L["Quest_4136_Note"] = "You get the prequest from Yorba Screwspigot (Tanaris - Steamwheedle Port; "..YELLOW.."67.0, 24.0"..PREV..").\nRibbly Screwspigot is at "..YELLOW.."[15]"..PREV..".";
L["Quest_4136_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4201_Location"] = "Mistress Nagmara (Blackrock Depths; "..YELLOW.."[15]"..PREV..")";
L["Quest_4201_Note"] = "You get the Giant Silver Veins from Giants in Azshara.  Gromsblood can be acquired from either a herbalist or at the Auction House.  The vial is filled at (Un'Goro Crater - Golakka Hot Springs; "..YELLOW.."31.0, 50.0"..PREV..").\nAfter completing the quest, you can use the backdoor instead of killing Phalanx.";
L["Quest_4201_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_4126_Location"] = "Ragnar Thunderbrew  (Dun Morogh - Kharanos; "..YELLOW.."46.8, 52.4"..PREV..")";
L["Quest_4126_Note"] = "The prequest starts at Enohar Thunderbrew (Blasted Lands - Nethergarde Keep; "..YELLOW.."63.6, 20.6"..PREV..").\nYou get the recipe from one of the guards who appear if you destroy the ale barrel in the Grim Guzzler at "..YELLOW.."[15]"..PREV..".";
L["Quest_4126_RewardText"] = "1(x10)"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_4262_Location"] = "Jalinda Sprig (Burning Steppes - Morgan's Vigil; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4262_Note"] = "Overmaster Pyron is a fire elemental outside the dungeon.  He patrols near the portal at "..YELLOW.."[24]"..PREV.." on the Blackrock Depths map and at "..YELLOW.."[3]"..PREV.." on the Blackrock Mountain entrance map.";
...
L["Quest_4263_Location"] = "Jalinda Sprig (Burning Steppes - Morgan's Vigil; "..YELLOW.."85.4, 70.0"..PREV..")";
L["Quest_4263_Note"] = "The prequest comes from Jalinda Sprig too.  Lord Incendius can be found around The Black Anvil at "..YELLOW.."[10]"..PREV..".";
L["Quest_4263_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_4123_Location"] = "Maxwort Uberglint (Burning Steppes - Flame Crest; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4123_Note"] = "You can find the Heart of the Mountain at "..YELLOW.."[8]"..PREV.." in a safe.  To acquire the key to that safe you must first open up all the smaller safes using Relic Coffer Keys that drop throughout the dungeon.  Once all small safes are open, Watchman Doomgrip and his friends will appear.  Defeat them to retrieve the key.";
...
L["Quest_4286_Location"] = "Oralius (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.6"..PREV..")";
L["Quest_4286_Note"] = "All dwarves can drop the packs.";
L["Quest_4286_RewardText"] = "1";
...
L["Quest_4024_Location"] = "Cyrus Therepentous (Burning Steppes - Slither Rock; "..YELLOW.."94.8, 31.6"..PREV..")";
L["Quest_4024_Note"] = "The questline starts at Kalaran Windblade (Searing Gorge; "..YELLOW.."39.0, 38.8"..PREV..").  I am not certain that it is required.\nBael'Gar is at "..YELLOW.."[11]"..PREV..".  Use the 'Altered Black Dragonflight Molt' on him after he is defeated to complete the quest.";
L["Quest_4024_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4341_Location"] = "King Magni Bronzebeard (Ironforge; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4341_Note"] = "The prequest starts at Royal Historian Archesonus (Ironforge; "..YELLOW.."38.6, 55.4"..PREV..").  Kharan Mighthammer is at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_4362_Location"] = "King Magni Bronzebeard (Ironforge; "..YELLOW.."39.4, 55.8"..PREV..")";
L["Quest_4362_Note"] = "Princess Moira Bronzebeard is at "..YELLOW.."[21]"..PREV..".  You must defeat Emperor Dagran Thaurissan and leave the Princess alive to complete the quest.  If the Princess dies you will have to reset the entire dungeon and try again.  If successful, you can turn the quest into the Princess and she will send you back to King Magni Bronzebeard in Ironforge for your reward.";
L["Quest_4362_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_9015_Location"] = "Falrin Treeshaper (Dire Maul West; "..YELLOW.."[1] Library"..PREV..")";
L["Quest_9015_Note"] = "Dungeon Set questline.  The Ring of Law is at "..YELLOW.."[6]"..PREV..".";
...
L["Quest_4241_Location"] = "Marshal Maxwell (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_4241_Note"] = "Onyxia attunement questline.  It starts at Helendis Riverhorn (Burning Steppes - Morgan's Vigil; "..YELLOW.."85.6, 68.8"..PREV..").\nMarshal Windsor is at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_4242_Location"] = "Marshal Windsor (Blackrock Depths; "..YELLOW.."[4]"..PREV..")";
L["Quest_4242_Note"] = "Onyxia attunement questline.  Marshal Maxwell is at (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..").  The next quest in the chain comes from a randomly dropped item in Blackrock Depths.";
L["Quest_4242_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_4264_Note"] = "Onyxia attunement questline.  Marshal Windsor is at "..YELLOW.."[4]"..PREV..". Best chance for drops seems to be the Dark Iron mobs around the Quarry.";
...
L["Quest_4282_Location"] = "Marshal Windsor (Blackrock Depths; "..YELLOW.."[4]"..PREV..")";
L["Quest_4282_Note"] = "Onyxia attunement questline.  The Lost Information drops from Golem Lord Argelmach at "..YELLOW.."[14]"..PREV.." and General Angerforge at "..YELLOW.."[13]"..PREV..".";
...
L["Quest_4322_Location"] = "Marshal Windsor (Blackrock Depths; "..YELLOW.."[4]"..PREV..")";
L["Quest_4322_Note"] = "Onyxia attunement questline.  This is an escort quest.  Be sure everyone is on the same stage before you start it.  The quest is easier if you clean the Ring of Law ("..YELLOW.."[6]"..PREV..") and the path to the entrance before you start the event. You find Marshal Maxwell at Burning Steppes - Morgan's Vigil ("..YELLOW.."84.6, 68.8"..PREV..").";
L["Quest_4322_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_4134_Location"] = "Shadowmage Vivian Lagrave (Badlands - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4134_Note"] = "The prequest starts from from Apothecary Zinge in Undercity - The Apothecarium ("..YELLOW.."49.8 68.2"..PREV..").\nYou get the recipe from one of the guards who appear if you destroy the ale barrel in the Grim Guzzler at "..YELLOW.."[15]"..PREV..".";
L["Quest_4134_RewardText"] = "1(x5)"..AQ_AND.."2(x5)"..AQ_AND.."3"..AQ_OR.."4";
...
L["Quest_4081_Location"] = "Sign Post (Badlands - Kargath; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4081_Note"] = "You can find the dwarves in the first part of Blackrock Depths. \nTurn the quest in to Warlord Goretooth at (Badlands - Kargath, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4082_Location"] = "Sign Post (Badlands - Kargath; "..YELLOW.."3.8, 47.5"..PREV..")";
L["Quest_4082_Note"] = "The dwarves you need to kill are near Bael'Gar at "..YELLOW.."[11]"..PREV..". \nTurn the quest in to Warlord Goretooth at (Badlands - Kargath, "..YELLOW.."5.8, 47.6"..PREV..").";
...
L["Quest_4132_Location"] = "Warlord Goretooth (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4132_Note"] = "To obtain this quest you must complete both the previous KILL ON SIGHT quests and then start a quest called Grark Lorkrub from Lexlort (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV.."). \nGeneral Angerforge is at "..YELLOW.."[13]"..PREV..".";
L["Quest_4132_RewardText"] = "1";
...
L["Quest_4063_Location"] = "Lotwil Veriatus (Badlands; "..YELLOW.."26.0, 45.0"..PREV..")";
L["Quest_4063_Note"] = "You get the prequest from Hierophant Theodora Mulvadania (Badlands - Kargath; "..YELLOW.."3.0, 47.8"..PREV..").\nGolem Lord Argelmach is at "..YELLOW.."[14]"..PREV..".";
L["Quest_4063_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_3906_Location"] = "Thunderheart (Badlands - Kargath; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3906_Note"] = "Overmaster Pyron is a fire elemental outside the dungeon.  He patrols near the portal at "..YELLOW.."[24]"..PREV.." on the Blackrock Depths map and at "..YELLOW.."[3]"..PREV.." on the Blackrock Mountain entrance map.";
...
L["Quest_3907_Location"] = "Thunderheart (Badlands - Kargath; "..YELLOW.."3.4, 48.2"..PREV..")";
L["Quest_3907_Note"] = "You get the prequest from Thunderheart too.  Lord Incendius can be found around The Black Anvil at "..YELLOW.."[10]"..PREV..".";
L["Quest_3907_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_7201_Location"] = "Shadowmage Vivian Lagrave (Badlands - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_7201_Note"] = "You get the prequest from Thunderheart (Badlands - Kargath; "..YELLOW.."3.4, 48.2"..PREV..").\n Every elemental can drop Essence of the Elements.";
L["Quest_7201_RewardText"] = "1";
...
L["Quest_3981_Location"] = "Galamav the Marksman (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
...
L["Quest_4003_Location"] = "Thrall (Orgrimmar - Valley of Wisdom; "..YELLOW.."32.0, 37.8"..PREV..")";
...
L["Quest_4003_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_8730_Location"] = "Vaelastrasz the Corrupt (Blackwing Lair; "..YELLOW.."[2]"..PREV..")";
L["Quest_8730_Note"] = "Only one person can loot the Shard.  Anachronos is at (Tanaris - Caverns of Time; "..YELLOW.."65, 49"..PREV..")";
L["Quest_8730_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7781_Location"] = "Head of Nefarian (drops from Nefarian; "..YELLOW.."[8]"..PREV..")";
L["Quest_7781_Note"] = "Highlord Bolvar Fordragon is at (Stormwind City - Stormwind Keep; "..YELLOW.."78.0, 18.0"..PREV.."). The follow up sends you to Field Marshal Stonebridge (Stormwind - Valley of Heroes; "..YELLOW.."66.9, 72.38"..PREV..") for the reward.";
...
L["Quest_8288_Location"] = "Head of the Broodlord Lashlayer (drops from Broodlord Lashlayer; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_7783_Location"] = "Head of Nefarian (drops from Nefarian; "..YELLOW.."[8]"..PREV..")";
L["Quest_7783_Note"] = "The follow up sends you to High Overlord Saurfang (Orgrimmar - Valley of Strength; "..YELLOW.."51.6, 76.0"..PREV..") for the reward.";
...
L["Quest_4788_Location"] = "Prospector Ironboot (Tanaris - Steamwheedle Port; "..YELLOW.."66.8, 24.0"..PREV..")";
L["Quest_4788_Note"] = "You find the tablets near Shadow Hunter Vosh'gajin at "..YELLOW.."[7]"..PREV.." and War Master Voone at "..YELLOW.."[9]"..PREV..".\nThe rewards come from the follow up quest.  The quest line starts with Yeh'kinya at Tanaris ("..YELLOW.."67.0, 22.4"..PREV..").";
L["Quest_4788_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_4729_Location"] = "Kibler (Burning Steppes - Flame Crest; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4729_Note"] = "You find the Worg Pup near Halcyon at "..YELLOW.."[17]"..PREV..".";
L["Quest_4729_RewardText"] = "1";
...
L["Quest_4862_Location"] = "Kibler (Burning Steppes - Flame Crest; "..YELLOW.."65.8, 22.0"..PREV..")";
L["Quest_4862_Note"] = "You find the spider eggs near Mother Smolderweb at "..YELLOW.."[13]"..PREV..".";
L["Quest_4862_RewardText"] = "1";
...
L["Quest_4866_Location"] = "Ragged John (Burning Steppes - Flame Crest; "..YELLOW.."65.0, 23.6"..PREV..")";
L["Quest_4866_Note"] = "Mother Smolderweb is at "..YELLOW.."[13]"..PREV..". The poison effect snares nearby players as well. If it is removed or dispelled, you fail the quest.";
L["Quest_4866_RewardText"] = "1";
...
L["Quest_4701_Location"] = "Helendis Riverhorn (Burning Steppes - Morgan's Vigil; "..YELLOW.."85.6, 68.8"..PREV..")";
L["Quest_4701_Note"] = "You find Halycon at "..YELLOW.."[17]"..PREV..".";
L["Quest_4701_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_4867_Name"] = "Urok Doomhowl";
L["Quest_4867_Objective"] = "Read Warosh's Scroll. Bring Warosh's Mojo to Warosh.";
L["Quest_4867_Location"] = "Warosh (Blackrock Spire; "..YELLOW.."[2]"..PREV..")";
L["Quest_4867_Note"] = "To get Warosh's Mojo you have to evoke and kill Urok Doomhowl at "..YELLOW.."[15]"..PREV..".  For his Evocation you need the Spear at "..YELLOW.."[3]"..PREV.." and Highlord Omokk's Head from "..YELLOW.."[5]"..PREV..".  During the Evocation a few waves of ogres appear before Urok Doomhowl attacks you.  You can use the Spear during the fight to damage the ogres.";
L["Quest_4867_RewardText"] = "1";

L["Quest_5001_Name"] = "Bijou's Belongings";
L["Quest_5001_Objective"] = "Find Bijou's Belongings and return them to her. Good luck!";
L["Quest_5001_Location"] = "Bijou (Blackrock Spire; "..YELLOW.."[8]"..PREV..")";
L["Quest_5001_Note"] = "You find Bijou's Belongings on the way to Mother Smolderweb at "..YELLOW.."[13]"..PREV..".\nThe followup goes to Marshal Maxwell at (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..").";
...
L["Quest_5081_Location"] = "Marshal Maxwell (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5081_Note"] = "You find War Master Voone at "..YELLOW.."[9]"..PREV..", Highlord Omokk at "..YELLOW.."[5]"..PREV.." and Overlord Wyrmthalak at "..YELLOW.."[19]"..PREV..".";
L["Quest_5081_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_4742_Location"] = "Vaelan (Blackrock Spire; "..YELLOW.."[1]"..PREV..")";
L["Quest_4742_Note"] = "This is the quest for the key for Upper Blackrock Spire.  You get the Gemstone of Spirestone from Highlord Omokk at "..YELLOW.."[5]"..PREV..", the Gemstone of Smolderthorn from War Master Voone at "..YELLOW.."[9]"..PREV.." and the Gemstone of Bloodaxe from Overlord Wyrmthalak at "..YELLOW.."[19]"..PREV..".  The Unadorned Seal of Ascension can drop from near all mobs in Lower Blackrock Spire or outside the dungeon.";
...
L["Quest_5089_Location"] = "General Drakkisath's Command (drops from Overlord Wyrmthalak; "..YELLOW.."[19]"..PREV..")";
L["Quest_5089_Note"] = "Marshal Maxwell is in the Burning Steppes - Morgan's Vigil; ("..YELLOW.."84.6, 68.8"..PREV..").";
L["Quest_5089_FollowQuest"] = "General Drakkisath's Demise ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_8989_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
...
L["Quest_8989_FollowQuest"] = "Final Preparations ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_5306_Note"] = "Blacksmith quest.  Shadow Hunter Vosh'gajin is at "..YELLOW.."[7]"..PREV..".";
L["Quest_5306_RewardText"] = "1";
...
L["Quest_5103_Location"] = "Human Remains (Lower Blackrock Spire; "..YELLOW.."[11]"..PREV..")";
L["Quest_5103_Note"] = "Blacksmith quest.  Be sure to pick up the Unfired Plate Gauntlets near the Human Remains at "..YELLOW.."[11]"..PREV..". Turns in to Malyfous Darkhammer (Winterspring - Everlook; "..YELLOW.."61.0, 38.6"..PREV..").  The rewards listed are for the followup quest.";
L["Quest_5103_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_4724_Location"] = "Galamav the Marksman (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4724_Note"] = "You find Halycon at "..YELLOW.."[17]"..PREV..".";
L["Quest_4724_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_4981_Name"] = "Operative Bijou";
L["Quest_4981_Objective"] = "Travel to Blackrock Spire and find out what happened to Bijou.";
L["Quest_4981_Location"] = "Lexlort (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV..")";
L["Quest_4981_Note"] = "You find Bijou at "..YELLOW.."[8]"..PREV..".";
...
L["Quest_4982_Location"] = "Bijou (Blackrock Spire; "..YELLOW.."[8]"..PREV..")";
L["Quest_4982_Note"] = "You find Bijou's Belongings on the way to Mother Smolderweb at "..YELLOW.."[13]"..PREV..".\nThe rewards below are for the followup quest, which turns in back at Lexlort (Badlands - Kargath; "..YELLOW.."5.8, 47.6"..PREV..").";
L["Quest_4982_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_4903_Location"] = "Warlord Goretooth (Badlands - Kargath; "..YELLOW.."65,22"..PREV..")";
L["Quest_4903_Note"] = "Onyxia attunement questline.  You find Highlord Omokk at "..YELLOW.."[5]"..PREV..", War Master Voone at "..YELLOW.."[9]"..PREV.." and Overlord Wyrmthalak at "..YELLOW.."[19]"..PREV..".  The Blackrock Documents appear next to one of these 3 bosses.";
L["Quest_4903_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_4903_FollowQuest"] = "Eitrigg's Wisdom -> For the Horde! ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_5160_Location"] = "Awbee (Blackrock Spire; "..YELLOW.."[7]"..PREV..")";
L["Quest_5160_Note"] = "You find Awbee in the room after the Arena at "..YELLOW.."[7]"..PREV..".  She stands on a jutty.\nHaleh is in Winterspring ("..YELLOW.."54.4, 51.2"..PREV..").  There's a cave that starts at coordinates "..YELLOW.."57.0, 50.0"..PREV..".  At the end of that cave is a portal that teleports you to Haleh.";
...
L["Quest_5047_Location"] = "Pip Quickwit (Blackrock Spire; "..YELLOW.."[8]"..PREV..")";
L["Quest_5047_Note"] = "Pip Quickwit spawns after skinning The Beast.  You find Malyfous Darkhammer at (Winterspring - Everlook; "..YELLOW.."61.0, 38.6"..PREV..").";
...
L["Quest_4734_Location"] = "Tinkee Steamboil (Burning Steppes - Flame Crest; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4734_Note"] = "You can find the eggs in the room of Father Flame at "..YELLOW.."[2]"..PREV..".";
L["Quest_4734_RewardText"] = "1";
...
L["Quest_6821_Location"] = "Duke Hydraxis (Azshara; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6821_Note"] = "You can find Pyroguard Emberseer at "..YELLOW.."[1]"..PREV..".  This quest will eventually give you the Eternal Quintessence, which is needed for the Molten Core raid.";
...
L["Quest_5102_Location"] = "Marshal Maxwell (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.6, 68.8"..PREV..")";
L["Quest_5102_Note"] = "You find General Drakkisath at "..YELLOW.."[9]"..PREV..".";
L["Quest_5102_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_5102_PreQuest"] = "General Drakkisath's Command ("..YELLOW.."Lower Blackrock Spire"..PREV..")";
...
L["Quest_4764_Location"] = "Mayara Brightwing (Burning Steppes - Morgan's Vigil; "..YELLOW.."84.8, 69.0"..PREV..")";
L["Quest_4764_Note"] = "You get the prequest from Count Remington Ridgewell (Stormwind - Stormwind Keep; "..YELLOW.."74.0, 30.0"..PREV..").\n\nDoomrigger's Clasp is at "..YELLOW.."[3]"..PREV.." in a chest.  The rewards listed are for the followup quest.";
L["Quest_4764_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7761_Location"] = "Blackhand's Command (drops from Scarshield Quartermaster; "..YELLOW.."[1] on Entrance Map"..PREV..")";
L["Quest_7761_Note"] = "Blackwing Lair attunement quest. Scarshield Quartermaster is found if you turn right before the LBRS/UBRS portal.\n\nGeneral Drakkisath is at "..YELLOW.."[9]"..PREV..". The brand is behind him.";
...
L["Quest_8994_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
...
L["Quest_8995_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
L["Quest_8995_Note"] = "Dungeon Armor set questline.  Extra-Dimensional Ghost Revealer is needed to see Bodley.  You get it from the 'In Search of Anthion' quest.  Lord Valthalak is summoned at "..YELLOW.."[8]"..PREV..".  The rewards listed are for the follow up quest.";
L["Quest_8995_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_5127_Location"] = "Lorax (Winterspring; "..YELLOW.."63.8, 73.6"..PREV..")";
L["Quest_5127_Note"] = "Blacksmith quest.  Goraluk Anvilcrack is at "..YELLOW.."[5]"..PREV..".";
L["Quest_5127_RewardText"] = "1"..AQ_AND.."2 "..AQ_AND.."3 (x5)";
...
L["Quest_4735_Location"] = "Tinkee Steamboil (Burning Steppes - Flame Crest; "..YELLOW.."65.2, 23.8"..PREV..")";
L["Quest_4735_Note"] = "You find the eggs in the room of Father Flame at "..YELLOW.."[2]"..PREV..".";
L["Quest_4735_PreQuest"] = "Egg Freezing";
L["Quest_4735_FollowQuest"] = "Leonid Barthalomew -> Dawn's Gambit ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_6502_Note"] = "This the last quest for Onyxia attunement.  More information about how to start the quest line is in the Blackrock Depths quest 'Marshal Windsor'.  You find General Drakkisath at "..YELLOW.."[9]"..PREV..".";
L["Quest_6502_RewardText"] = "1";
...
L["Quest_4768_Location"] = "Vivian Lagrave (Badlands - Kargath; "..YELLOW.."3.0, 47.6"..PREV..")";
L["Quest_4768_Note"] = "You get the prequest from Apothecary Zinge in Undercity - The Apothecarium ("..YELLOW.."50.0, 68.6"..PREV..").\n\nThe Darkstone Tablet is at "..YELLOW.."[3]"..PREV.." in a chest.";
L["Quest_4768_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_4974_Note"] = "Onyxia attunement questline.  You find Warchief Rend Blackhand at "..YELLOW.."[6]"..PREV..".";
L["Quest_4974_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_6569_Location"] = "Myranda the Hag (Western Plaguelands - Sorrow Hill; "..YELLOW.."50.8, 77.8"..PREV..")";
...
L["Quest_6602_Note"] = "Last part of the Onyxia attunement questline.  Rexxar spawns at the border between Stonetalon Mountains and walks down through Desolace to Feralas.  The best way of finding him is starting in Feralas at around "..YELLOW.."48.2, 24.8"..PREV.." and moving North to intercept him.   You find General Drakkisath at "..YELLOW.."[9]"..PREV..".";
L["Quest_6602_RewardText"] = "1";
...
L["Quest_214_Location"] = "Scout Riell (Westfall - Sentinel Hill; "..YELLOW.."56.6, 47.4"..PREV..")";
...
L["Quest_214_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_168_Location"] = "Wilder Thistlenettle (Stormwind - Dwarven District; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_168_Note"] = "The cards drop off undead mobs outside the dungeon in the area near "..YELLOW.."[3]"..PREV.." on the Entrance map.";
L["Quest_168_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_167_Location"] = "Wilder Thistlenettle (Stormwind - Dwarven District; "..YELLOW.."65.2, 21.2"..PREV..")";
L["Quest_167_Note"] = "Foreman Thistlenettle is found outside the dungeon in the undead area at "..YELLOW.."[3]"..PREV.." on the Entrance map.";
L["Quest_167_RewardText"] = "1";
...
L["Quest_2040_Location"] = "Shoni the Silent (Stormwind - Dwarven District; "..YELLOW.."62.6, 34.1"..PREV..")";
L["Quest_2040_Note"] = "The optional prequest can be obtained from Gnoarn (Ironforge - Tinkertown; "..YELLOW.."69.4, 50.6"..PREV..").\nSneed's Shredder drops the Gnoam Sprecklesprocket "..YELLOW.."[3]"..PREV..".";
L["Quest_2040_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_166_Location"] = "Gryan Stoutmantle (Westfall - Sentinel Hill; "..YELLOW.."56.2, 47.6"..PREV..")";
L["Quest_166_Note"] = "You start this questline at Gryan Stoutmantle.\nEdwin VanCleef is the last boss of The Deadmines. You can find him at the top of his ship "..YELLOW.."[6]"..PREV..".";
L["Quest_166_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1654_Location"] = "Jordan Stilwell (Dun Morogh - Ironforge Entrance; "..YELLOW.."52,36"..PREV..")";
L["Quest_1654_Note"] = "Paladin quest.  Jordan's Smithing Hammer is at  "..YELLOW.."[9]"..PREV..".\n\nThe remaining items come from "..YELLOW.."[Deadmines]"..PREV..", Loch Modan, Darkshore and Ashenvale.  Some require doing side quests.  I recommend looking it up on Wowhead for all the details.";
L["Quest_1654_RewardText"] = "1";
...
L["Quest_373_Location"] = "An Unsent Letter (drops from Edwin VanCleef; "..YELLOW.."[6]"..PREV..")";
L["Quest_373_Note"] = "Baros Alexston is in Stormwind City, next to the Cathedral of Light at "..YELLOW.."49.0, 30.2"..PREV..".";
...
L["Quest_2922_Location"] = "Tinkmaster Overspark (Ironforge - Tinkertown; "..YELLOW.."69.8, 50.4"..PREV..")";
L["Quest_2922_Note"] = "You get the optional prequest from Brother Sarno (Stormwind - Cathedral Square; "..YELLOW.."40.6, 30.8"..PREV..").\nTechbot is outside the dungeon near the alternate entrance for the dungeon, at "..YELLOW.."[C] on Entrance Map"..PREV..".";
...
L["Quest_2926_Location"] = "Ozzie Togglevolt (Dun Morogh - Kharanos; "..YELLOW.."45.8, 49.2"..PREV..")";
L["Quest_2926_Note"] = "The prequest comes from Gnoarn (Ironforge - Tinkertown; "..YELLOW.."69.4, 50.6"..PREV..").\nTo get fallout you must use the Phial on "..RED.."alive"..PREV.." Irradiated Invaders or Irradiated Pillagers.  They are found near the beginning of the dungeon";
...
L["Quest_2962_Location"] = "Ozzie Togglevolt (Dun Morogh - Kharanos; "..YELLOW.."45.8, 49.2"..PREV..")";
L["Quest_2962_Note"] = "To get fallout you must use the Phial on "..RED.."alive"..PREV.." Irradiated Slimes or Horrors.  They are found near the Viscous Fallout boss at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_2928_Location"] = "Shoni the Silent (Stormwind - Dwarven District; "..YELLOW.."55.4, 12.6"..PREV..")";
L["Quest_2928_Note"] = "All robots can drop the Robo-mechanical Guts.";
L["Quest_2928_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_2924_Location"] = "Klockmort Spannerspan (Ironforge - Tinkertown; "..YELLOW.."68.0, 46.8"..PREV..")";
L["Quest_2924_Note"] = "The optional prequest comes from Mathiel (Darnassus - Warrior's Terrace; "..YELLOW.."59.2, 45.2"..PREV..").\nThe Essential Artificials come from machines scattered around the dungeon.";
...
L["Quest_2930_Location"] = "Master Mechanic Castpipe (Ironforge - Tinkertown; "..YELLOW.."70.2, 48.4"..PREV..")";
L["Quest_2930_Note"] = "The optional prequest comes from Gaxim Rustfizzle (Stonetalon Mountains; "..YELLOW.."59.6, 67.0"..PREV..").\nThe white card is a random drop. You find the first terminal next to the back entrance before you enter the dungeon at "..YELLOW.."[C] on Entrance Map"..PREV..". The 3005-B is at "..YELLOW.."[3]"..PREV..", the 3005-C at "..YELLOW.."[5]"..PREV.." and the 3005-D is at "..YELLOW.."[6]"..PREV..".";
L["Quest_2930_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_2904_Note"] = "Escort quest! You find Scooty in Stranglethorn Vale - Booty Bay ("..YELLOW.."27.6, 77.4"..PREV..").";
L["Quest_2904_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_2929_Location"] = "High Tinker Mekkatorque (Ironforge - Tinkertown; "..YELLOW.."69.0, 49.0"..PREV..")";
L["Quest_2929_Note"] = "You find Mekgineer Thermaplugg at "..YELLOW.."[8]"..PREV..". He is the last boss in Gnomeregan.\nDuring the fight you have to disable the columns through pushing the button on the side.";
L["Quest_2929_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_2945_Note"] = "The Ring can be cleaned off at the Sparklematic 5200 in the Clean Room at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2947_Note"] = "Turns in to Talvash del Kissel (Ironforge - Mystic Ward; "..YELLOW.."36.0, 4.0"..PREV.."). The followup to enhance the ring is optional.";
...
L["Quest_2951_Location"] = "Sparklematic 5200 (Gnomeregan - The Clean Room; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_2843_Location"] = "Scooty (Stranglethorn Vale - Booty Bay; "..YELLOW.."27.6, 77.4"..PREV..")";
L["Quest_2843_Note"] = "You get the prequest from Sovik (Orgrimmar - Valley of Honor; "..YELLOW.."75.6, 25.2"..PREV..").\nWhen you complete this quest you can use the transporter in Booty Bay to teleport to Gnomeregan.";
L["Quest_2843_RewardText"] = "1";
...
L["Quest_2841_Location"] = "Nogg (Orgrimmar - Valley of Honor; "..YELLOW.."75.8, 25.2"..PREV..")";
L["Quest_2841_Note"] = "You find Thermaplugg at "..YELLOW.."[8]"..PREV..". He is the last boss in Gnomeregan.\nDuring the fight you have to disable the columns through pushing the button on the side.";
L["Quest_2841_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_2949_Note"] = "Turns in to Nogg (Orgrimmar - The Valley of Honor; "..YELLOW.."75.8, 25.2"..PREV.."). The followup to enhance the ring is optional.";
L["Quest_2949_RewardText"] = "1";
...
L["Quest_1050_Location"] = "Librarian Mae Paledust (Ironforge - Hall of Explorers; "..YELLOW.."74.6, 12.6"..PREV..")";
L["Quest_1050_Note"] = "The book is on the floor on the left side of one of the corridors leading to Arcanist Doan ("..YELLOW.."[2]"..PREV..").  After a player picks it up it will vanish.  It will respawn in a moment or two.";
L["Quest_1050_RewardText"] = "1";

L["Quest_1951_Name"] = "Rituals of Power";
L["Quest_1951_Objective"] = "Bring the book Rituals of Power to Tabetha in Dustwallow Marsh.";
L["Quest_1951_Location"] = "Magus Tirth (Thousand Needles - Shimmering Flats; "..YELLOW.."78.2, 75.8"..PREV..")";
L["Quest_1951_Note"] = "Mage quest.  The prequest is given at the Mage trainers in major cities.  You can find the book in the last corridor leading to Arcanist Doan ("..YELLOW.."[2]"..PREV..").  It is hanging off a shelf.\n\nTurn the quest into Tabetha (Dustwallow Marsh; "..YELLOW.."46.0, 57.0"..PREV..").  The rewards listed are for the followup.";
L["Quest_1951_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1053_Location"] = "Raleigh the Devout (Hillsbrad Foothills - Southshore; "..YELLOW.."51.4, 58.4"..PREV..")";
L["Quest_1053_Note"] = "This quest line starts at Brother Crowley in Stormwind - Cathedral of Light ("..YELLOW.."42.4, 24.4"..PREV..").\nYou can find High Inquisitor Whitemane and Scarlet Commander Mograine at "..YELLOW.."SM: Cathedral [2]"..PREV..", Herod at "..YELLOW.."SM: Armory [1]"..PREV.." and Houndmaster Loksey at "..YELLOW.."SM: Library [1]"..PREV..".";
L["Quest_1053_RewardText"] = "1";
...
L["Quest_1113_Location"] = "Master Apothecary Faranell (Undercity - The Apothecarium; "..YELLOW.."48.6, 69.4"..PREV..")";
...
L["Quest_1113_PreQuest"] = "Going, Going, Guano! ("..YELLOW.."[Razorfen Kraul]"..PREV..")";
...
L["Quest_1160_Location"] = "Parqual Fintallas (Undercity - The Apothecarium; "..YELLOW.."57.8, 65.0"..PREV..")";
L["Quest_1160_Note"] = "The questline starts at Dorn Plainstalker (Thousand Needles; "..YELLOW.."53.8, 41.6"..PREV..").  The book is on a table in a section of the library called the 'Gallery of Treasures'.  It is about halfway through the dungeon.\n\nThe rewards listed are for the followup.";
L["Quest_1160_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1049_Location"] = "Sage Truthseeker (Thunderbluff; "..YELLOW.."34.6, 47.2"..PREV..")";
...
L["Quest_1049_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1048_Location"] = "Varimathras (Undercity - Royal Quarter; "..YELLOW.."56.2, 92.6"..PREV..")";
L["Quest_1048_Note"] = "You can find High Inquisitor Whitemane and Scarlet Commander Mograine at "..YELLOW.."SM: Cathedral [2]"..PREV..", Herod at "..YELLOW.."SM: Armory [1]"..PREV.." and Houndmaster Loksey at "..YELLOW.."SM: Library [1]"..PREV..".";
L["Quest_1048_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1051_Location"] = "Vorrel Sengutz (Scarlet Monastery - Graveyard; "..YELLOW.."[1]"..PREV..")";
L["Quest_1051_Note"] = "You can find Vorrel Sengutz at the beginning of the Graveyard section of the Scarlet Monastery.  Nancy Vishas, who drops the ring needed for this quest, can be found in a house in the Alterac Mountains near ("..YELLOW.."31, 32"..PREV..").  The house she's in can vary each time.  The quest turns in to Monika Sengutz (Hillsbrad Foothills - Tarren Mill; "..YELLOW.."62.6, 19.0"..PREV..").";
L["Quest_1051_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_5529_Location"] = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.6"..PREV..")";
...
L["Quest_5582_Note"] = "Plagued Hatchlings can drop the Healthy Dragon Scales.  You can find Betina Bigglezink at Eastern Plaguelands - Light's Hope Chapel ("..YELLOW.."81.4, 59.6"..PREV..").";
...
L["Quest_5382_Location"] = "Eva Sarkhoff (Western Plaguelands - Caer Darrow; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5382_Note"] = "You find Doctor Theolen Krastinov, the remains of Eva Sarkhoff and the remains of Lucien Sarkhoff at "..YELLOW.."[9]"..PREV..".";
...
L["Quest_5515_Location"] = "Eva Sarkhoff (Western Plaguelands - Caer Darrow; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5515_Note"] = "You can find Jandice Barov at "..YELLOW.."[3]"..PREV..".";
...
L["Quest_5384_Location"] = "Eva Sarkhoff (Western Plaguelands - Caer Darrow; "..YELLOW.."70.2, 73.8"..PREV..")";
L["Quest_5384_Note"] = "The porch is at "..YELLOW.."[2]"..PREV..".";
L["Quest_5384_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3";
...
L["Quest_5466_Location"] = "Magistrate Marduke (Western Plaguelands - Caer Darrow; "..YELLOW.."70.4, 74.0"..PREV..")";
L["Quest_5466_Note"] = "You can find Ras Frostwhisper at "..YELLOW.."[7]"..PREV..".";
L["Quest_5466_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5343_Location"] = "Weldon Barov (Western Plaguelands - Chillwind Camp; "..YELLOW.."43.4, 83.8"..PREV..")";
L["Quest_5343_Note"] = "You can find The Deed to Caer Darrow at "..YELLOW.."[12]"..PREV..", The Deed to Brill at "..YELLOW.."[7]"..PREV..", The Deed to Tarren Mill at "..YELLOW.."[4]"..PREV.." and The Deed to Southshore at "..YELLOW.."[1]"..PREV..".\nThe reward listed is for the followup.";
L["Quest_5343_RewardText"] = "1";
...
L["Quest_4771_Location"] = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.6"..PREV..")";
L["Quest_4771_Note"] = "Broodling Essence begins at Tinkee Steamboil (Burning Steppes - Flame Crest; "..YELLOW.."65.2, 23.8"..PREV.."). The Viewing Room is at "..YELLOW.."[6]"..PREV..".";
L["Quest_4771_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7629_Location"] = "Gorzeeki Wildeyes (Burning Steppes; "..YELLOW.."12.6, 31.6"..PREV..")";
L["Quest_7629_Note"] = "Warlock Epic Mount questline.  You find the alchemy lab at "..YELLOW.."[7]"..PREV..".";
L["Quest_7629_PreQuest"] = "Mor'zul Bloodbringer -> Xorothian Stardust";
L["Quest_7629_FollowQuest"] = "Dreadsteed of Xoroth ("..YELLOW.."Dire Maul West"..PREV..")";
...
L["Quest_8992_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
...
L["Quest_8992_FollowQuest"] = "Final Preparations ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_7647_Location"] = "Lord Grayson Shadowbreaker (Stormwind City - Cathedral; "..YELLOW.."37.6, 32.6"..PREV..")";
L["Quest_7647_Note"] = "Paladin Epic Mount questline.  This questline is lengthy and has many steps.  There is an excellent guide on WoWhead.com that goes into great detail on how to complete it.  The Great Ossuary's basement is at "..YELLOW.."[5]"..PREV..".";
...
L["Quest_5341_Location"] = "Alexi Barov (Tirisfal Glades - The Bulwark; "..YELLOW.."83.0, 71.4"..PREV..")";
L["Quest_5341_Note"] = "You can find The Deed to Caer Darrow at "..YELLOW.."[12]"..PREV..", The Deed to Brill at "..YELLOW.."[7]"..PREV..", The Deed to Tarren Mill at "..YELLOW.."[4]"..PREV.." and The Deed to Southshore at "..YELLOW.."[1]"..PREV..".\nThe reward listed is for the followup.";
L["Quest_5341_RewardText"] = "1";
...
L["Quest_8258_Location"] = "Sagorne Creststrider (Orgrimmar - Valley of Wisdom; "..YELLOW.."38.6, 36.2"..PREV..")";
L["Quest_8258_Note"] = "Shaman quest.  The prequest is obtained from the same NPC.\n\nDeath Knight Darkreaver is summoned at "..YELLOW.."[5]"..PREV..".";
L["Quest_8258_RewardText"] = "1";
...
L["Quest_1740_Location"] = "Doan Karhan (The Barrens; "..YELLOW.."49.2, 57.2"..PREV..")";
L["Quest_1740_Note"] = "Warlock quest.  You get the 3 Soran'ruk Fragments from Twilight Accolytes in "..YELLOW.."[Blackfathom Deeps]"..PREV..". You get the Large Soran'ruk Fragment in "..YELLOW.."[Shadowfang Keep]"..PREV.." from Shadowfang Darksouls.";
L["Quest_1740_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1098_Location"] = "High Executor Hadrec (Silverpine Forest - The Sepulcher; "..YELLOW.."43.4, 40.8"..PREV..")";
L["Quest_1098_Note"] = "You find Deathstalker Adamant at "..YELLOW.."[1]"..PREV..". Deathstalker Vincent is on the right side when you go into the courtyard.";
L["Quest_1098_RewardText"] = "1";
...
L["Quest_1013_Location"] = "Keeper Bel'dugur (Undercity - The Apothecarium; "..YELLOW.."53.6, 54.0"..PREV..")";
L["Quest_1013_Note"] = "You find the book at "..YELLOW.."[6]"..PREV.." on the left side when you enter the room.";
L["Quest_1013_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1014_Location"] = "Dalar Dawnweaver (Silverpine Forest - The Sepulcher; "..YELLOW.."44.2, 39.8"..PREV..")";
L["Quest_1014_Note"] = "You find Archmage Arugal at "..YELLOW.."[8]"..PREV..".";
L["Quest_1014_RewardText"] = "1";

L["Quest_386_Name"] = "What Comes Around...";
L["Quest_386_Objective"] = "Bring the head of Targorr the Dread to Guard Berton in Lakeshire.";
L["Quest_386_Location"] = "Guard Berton (Redridge Mountains - Lakeshire; "..YELLOW.."26.4, 46.6"..PREV..")";
L["Quest_386_Note"] = "You can find Targorr at "..YELLOW.."[1]"..PREV..".";
L["Quest_386_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_377_Location"] = "Millstipe (Duskwood - Darkshire; "..YELLOW.."72.0, 47.8"..PREV..")";
L["Quest_377_Note"] = "You can find Dextren at "..YELLOW.."[5]"..PREV..".";
L["Quest_377_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_387_Location"] = "Warden Thelwater (Stormwind - The Stockade; "..YELLOW.."41.2, 58.0"..PREV..")";
...
L["Quest_388_Location"] = "Nikova Raskol (Stormwind - Old Town; "..YELLOW.."66.8, 46.4"..PREV..")";
...
L["Quest_378_Location"] = "Motley Garmason (Wetlands - Dun Modr; "..YELLOW.."49.6, 18.2"..PREV..")";
L["Quest_378_Note"] = "The preceding quest can be obtained from Motley Garmason too. You can find Kam Deepfury at "..YELLOW.."[2]"..PREV..".";
L["Quest_378_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_391_Location"] = "Warden Thelwater (Stormwind - The Stockade; "..YELLOW.."41.2, 58.0"..PREV..")";
L["Quest_391_Note"] = "You can find Bazil Thredd at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_5212_Location"] = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.6"..PREV..")";
...
L["Quest_5213_Location"] = "Betina Bigglezink (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.6"..PREV..")";
L["Quest_5213_Note"] = "The Scourge Data is in one of the 3 Towers, you find near "..YELLOW.."[15]"..PREV..", "..YELLOW.."[16]"..PREV.." and "..YELLOW.."[17]"..PREV..".";
L["Quest_5213_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_5243_Location"] = "Leonid Barthalomew the Revered (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.6, 57.8"..PREV..")";
...
L["Quest_5243_RewardText"] = "1 (x5)"..AQ_AND.."2 (x5)"..AQ_AND.."3"..AQ_OR.."4";
...
L["Quest_5214_Location"] = "Smokey LaRue (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."80.6, 58.0"..PREV..")";
L["Quest_5214_Note"] = "You find the smoke shop near "..YELLOW.."[1]"..PREV..".  Ezra Grimm spawns when you open box.";
L["Quest_5214_RewardText"] = "1";
...
L["Quest_5282_Location"] = "Egan (Eastern Plaguelands - Terrordale; "..YELLOW.."14.4, 33.6"..PREV..")";
L["Quest_5282_Note"] = "You get the prequest from Caretaker Alen (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."79.4, 63.8"..PREV..").  The Spectral Citizens walk through the streets of Stratholme.";
L["Quest_5282_RewardText"] = "1";
...
L["Quest_5848_Location"] = "Artist Renfray (Western Plaguelands - Caer Darrow; "..YELLOW.."65.6, 75.4"..PREV..")";
L["Quest_5848_Note"] = "You get the prequest from Tirion Fordring (Western Plaguelands; "..YELLOW.."7.4, 43.6"..PREV..").  You can find the picture near "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5463_Location"] = "Leonid Barthalomew the Revered (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.6, 57.8"..PREV..")";
L["Quest_5463_Note"] = "You get the prequest from Magistrate Marduke (Western Plaguelands - Caer Darrow; "..YELLOW.."70.4, 74.0"..PREV..").  The unholy ground is at "..YELLOW.."[19]"..PREV..".";
...
L["Quest_5125_Note"] = "You get the Medallion from a chest (Malor's Strongbox "..YELLOW.."[7]"..PREV..") in the first chamber of the bastion (before the ways split). It is not bound so you can trade it from another player or get it in a separate run.\n\nAfter giving Aurius the Medallion he'll help you when you fight Baron Rivendare "..YELLOW.."[19]"..PREV..". After the Baron dies, Aurius will also die. Talk to his corpse to receive the reward.";
L["Quest_5125_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_5251_Location"] = "Duke Nicholas Zverenhoff (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.8"..PREV..")";
L["Quest_5251_Note"] = "You can find the Archive and the Achivist at "..YELLOW.."[10]"..PREV..".";
...
L["Quest_5262_Note"] = "You find Duke Nicholas Zverenhoff in the Eastern Plaguelands - Light's Hope Chapel ("..YELLOW.."81.4, 59.8"..PREV..").";
...
L["Quest_5263_Location"] = "Duke Nicholas Zverenhoff (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."81.4, 59.8"..PREV..")";
L["Quest_5263_Note"] = "Baron Rivendare is at "..YELLOW.."[19]"..PREV..".\n\nThe rewards listed are for the followup.";
L["Quest_5263_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8968_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
L["Quest_8968_Note"] = "Extra-Dimensional Ghost Revealer is needed to see Bodley. You get it from the 'In Search of Anthion' quest.\n\nJarien and Sothos are summoned at "..YELLOW.."[11]"..PREV..".";
...
L["Quest_8991_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
...
L["Quest_8991_FollowQuest"] = "Final Preparations ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_9257_Location"] = "Anachronos (Tanaris - Caverns of Time; "..YELLOW.."65, 49"..PREV..")";
L["Quest_9257_Note"] = "Atiesh is summoned at "..YELLOW.."[2]"..PREV..".\n\nAs of October 2019 this quest is not available in WoW Classic yet.  I'll update this when it is added.";
L["Quest_9257_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5307_Location"] = "Seril Scourgebane (Winterspring - Everlook; "..YELLOW.."61.2, 37.2"..PREV..")";
L["Quest_5307_Note"] = "Blacksmith quest.  The Black Guard Swordsmith is summoned near "..YELLOW.."[15]"..PREV..".";
L["Quest_5307_RewardText"] = "1";
...
L["Quest_5305_Location"] = "Lilith the Lithe (Winterspring - Everlook; "..YELLOW.."61.2, 37.2"..PREV..")";
L["Quest_5305_Note"] = "Blacksmith quest.  The Crimson Hammersmith is summoned at "..YELLOW.."[8]"..PREV..".";
L["Quest_5305_RewardText"] = "1";
...
L["Quest_7622_Location"] = "Eris Havenfire (Eastern Plaguelands; "..YELLOW.."20.8, 18.2"..PREV..")";
L["Quest_7622_Note"] = "Priest quest.  In order to see Eris Havenfire and get this quest and the prequest, you need the Eye of Divinity (comes from Cache of the Firelord in "..YELLOW.."[Molten Core]"..PREV..").\n\nThis quest's reward, when combined with Eye of Divinity and The Eye of Shadow (drops from demons in Winterspring or Blasted Lands) form Benediction, an epic priest's staff.";
L["Quest_7622_RewardText"] = "1";
...
L["Quest_6163_Location"] = "Nathanos Blightcaller (Eastern Plaguelands; "..YELLOW.."26.6, 74.8"..PREV..")";
L["Quest_6163_Note"] = "You get the prequest from Nathanos Blightcaller, too.  You can find Ramstein the Gorger at "..YELLOW.."[18]"..PREV..".";
L["Quest_6163_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1475_Location"] = "Brohann Caskbelly (Stormwind - Dwarven District; "..YELLOW.."64.2, 20.8"..PREV..")";
...
L["Quest_3445_Location"] = "Angelas Moonbreeze (Feralas - Feathermoon Stronghold; "..YELLOW.."31.8, 45.6"..PREV..")";
L["Quest_3445_Note"] = "You find Marvon Rivetseeker at "..YELLOW.."52.6, 45.8"..PREV..".";
...
L["Quest_3446_Location"] = "Marvon Rivetseeker (Tanaris; "..YELLOW.."52.6, 45.8"..PREV..")";
L["Quest_3446_Note"] = "The Altar is at "..YELLOW.."[1]"..PREV..".";
...
L["Quest_3447_Location"] = "Marvon Rivetseeker (Tanaris; "..YELLOW.."52.6, 45.8"..PREV..")";
L["Quest_3447_Note"] = "You find the statues at "..YELLOW.."[1]"..PREV..". See map for order to activate them.";
L["Quest_3447_RewardText"] = "1";
...
L["Quest_4143_Location"] = "Gregan Brewspewer (Feralas; "..YELLOW.."45.0, 25.4"..PREV..")";
L["Quest_4143_Note"] = "The Prequest 'Muigin and Larion' starts at Muigin (Un'Goro Crater - Marshal's Refuge; "..YELLOW.."43.0, 9.6"..PREV.."). You get the Haze from Deep Lurkers, Murk Worms or Oozes in the Temple.";
...
L["Quest_1446_Location"] = "The Atal'ai Exile (The Hinterlands; "..YELLOW.."33.6, 75.2"..PREV..")";
L["Quest_1446_Note"] = "You find Jammal'an at "..YELLOW.."[4]"..PREV..".";
L["Quest_1446_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_3373_Location"] = "The Essence of Eranikus (drops from Shade of Eranikus; "..YELLOW.."[6]"..PREV..")";
L["Quest_3373_Note"] = "You find the Essence Font next to where Shade of Eranikus is at "..YELLOW.."[6]"..PREV..".";
L["Quest_3373_RewardText"] = "1";
...
L["Quest_8422_Location"] = "Impsy (Felwood; "..YELLOW.."41.6, 45.0"..PREV..")";
...
L["Quest_8422_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8425_Location"] = "Fallen Hero of the Horde (Swamp of Sorrows; "..YELLOW.."34.2, 66.0"..PREV..")";
...
L["Quest_8425_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_9053_Location"] = "Torwa Pathfinder (Un'Goro Crater; "..YELLOW.."71.6, 76.0"..PREV..")";
L["Quest_9053_Note"] = "Druid quest.  The Putrid Vine drops from Atal'alarion who is summoned at "..YELLOW.."[1]"..PREV.." by activating the statues in the order listed on the map.";
L["Quest_9053_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8232_Location"] = "Ogtinc (Azshara; "..YELLOW.."42.2, 42.6"..PREV..")";
L["Quest_8232_Note"] = "Hunter quest.  Morphaz is at "..YELLOW.."[5]"..PREV..".";
L["Quest_8232_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8253_Location"] = "Archmage Xylem (Azshara; "..YELLOW.."29.6, 40.6"..PREV..")";
L["Quest_8253_Note"] = "Mage quest.  Morphaz is at "..YELLOW.."[5]"..PREV..".";
L["Quest_8253_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8257_Location"] = "Ogtinc (Azshara; "..YELLOW.."42.2, 42.6"..PREV..")";
L["Quest_8257_Note"] = "Priest quest.  Morphaz is at "..YELLOW.."[5]"..PREV..".  Greta Mosshoof is at (Felwood - Emerald Sanctuary; "..YELLOW.."51.2, 82.2"..PREV..").";
L["Quest_8257_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8236_Location"] = "Archmage Xylem (Azshara; "..YELLOW.."29.6, 40.6"..PREV..")";
L["Quest_8236_Note"] = "Rogue quest.  The Azure Key drops from Morphaz at "..YELLOW.."[5]"..PREV..".  Lord Jorach Ravenholdt is at Alterac Mountains - Ravenholdt ("..YELLOW.."86.0, 79.0"..PREV..").";
L["Quest_8236_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8418_Location"] = "Commander Ashlam Valorfist (Western Plaguelands - Chillwind Camp; "..YELLOW.."42.8, 84.0"..PREV..")";
...
L["Quest_8418_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_1445_Location"] = "Fel'Zerul (Swamp of Sorrows - Stonard; "..YELLOW.."48.0, 55.0"..PREV..")";
L["Quest_1445_Note"] = "All mobs in the Temple can drop the Fetishes.";
L["Quest_1445_RewardText"] = "1";
...
L["Quest_3380_Location"] = "Witch Doctor Uzer'i (Feralas; "..YELLOW.."74.4, 43.4"..PREV..")";
L["Quest_3380_Note"] = "You find Marvon Rivetseeker at "..YELLOW.."52.6, 45.8"..PREV..".";
...
L["Quest_4146_Location"] = "Liv Rizzlefix (Barrens; "..YELLOW.."62.4, 38.6"..PREV..")";
L["Quest_4146_Note"] = "The prequest 'Larion and Muigin' starts at Larion (Un'Goro Crater; "..YELLOW.."45.6, 8.6"..PREV..").  You get the Haze from Deep Lurkers, Murk Worms or Oozes in the Temple.";
...
L["Quest_8413_Location"] = "Bath'rah the Windwatcher (Alterac Mountains; "..YELLOW.."80.4, 66.8"..PREV..")";
...
L["Quest_8413_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_721_Location"] = "Prospector Ryedol (Badlands; "..YELLOW.."53.4, 43.2"..PREV..")";
L["Quest_721_Note"] = "The Prequest starts at the Crumpled Map (Badlands; "..YELLOW.."53.0, 34.1"..PREV..").\nYou find Hammertoe Grez in the area before you enter the dungeon's main portal.";
...
L["Quest_722_Location"] = "Hammertoe Grez (Uldaman; "..YELLOW.."Entrance Area before Dungeon"..PREV..").";
...
L["Quest_1139_Location"] = "Advisor Belgrum (Ironforge - Hall of Explorers; "..YELLOW.."77.2, 10.0"..PREV..")";
L["Quest_1139_Note"] = "The tablet is at "..YELLOW.."[8]"..PREV..".";
L["Quest_1139_RewardText"] = "1";
...
L["Quest_2418_Location"] = "Rigglefuzz (Badlands; "..YELLOW.."42.4, 52.8"..PREV..")";
L["Quest_2418_Note"] = "The stones can be found on any Shadowforge enemies before and in the dungeon.";
L["Quest_2418_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_704_Name"] = "Agmond's Fate";
L["Quest_704_Objective"] = "Bring 4 Carved Stone Urns to Prospector Ironband in Loch Modan.";
L["Quest_704_Location"] = "Prospector Ironband (Loch Modan - Ironband's Excavation Site; "..YELLOW.."65.8, 65.6"..PREV..")";
L["Quest_704_Note"] = "The Prequest starts at Prospector Stormpike (Ironforge - Hall of Explorers; "..YELLOW.."74.4, 12.0"..PREV..").\nThe Urns are scattered throughout the caves before the dungeon.";
L["Quest_704_RewardText"] = "1";
...
L["Quest_2398_Location"] = "Prospector Stormpike (Ironforge - Hall of Explorers; "..YELLOW.."74.4, 12.0"..PREV..")";
L["Quest_2398_Note"] = "Baelog is at "..YELLOW.."[1]"..PREV..".";
...
L["Quest_2240_Note"] = "The Hidden Chamber is at "..YELLOW.."[4]"..PREV..".  To open the Hidden Chamber you need The Shaft of Tsol from Revelosh "..YELLOW.."[3]"..PREV.." and the Gni'kiv Medallion from Baelog's Chest "..YELLOW.."[1]"..PREV..".  Combine these two items to form Staff of Prehistoria.  The Staff is used in the Map Room between "..YELLOW.."[3] and [4]"..PREV.." to summon Ironaya.  After killing her, run inside the room she came from to get quest credit.";
L["Quest_2240_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_2198_Note"] = "Bring the necklace to Talvash del Kissel (Ironforge - The Mystic Ward; "..YELLOW.."36.0, 4.0"..PREV..").";
...
L["Quest_2200_Location"] = "Talvash del Kissel (Ironforge - The Mystic Ward; "..YELLOW.."36.0, 4.0"..PREV..")";
L["Quest_2200_Note"] = "The Paladin is at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2201_Location"] = "Remains of a Paladin (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2201_Note"] = "The gems are at "..YELLOW.."[1]"..PREV.." in a Conspicous Urn, "..YELLOW.."[8]"..PREV.." from the Shadowforge Cache, and "..YELLOW.."[9]"..PREV.." off Grimlok.  Note that when openning the Shadowforge Cache, a few mobs will spawn an aggro you.  Use Talvash's Scrying Bowl to turn the quest in and get the followup.";
...
L["Quest_2204_Note"] = "The Shattered Necklace Power Source drops from Archaedas "..YELLOW.."[10]"..PREV..".  Talvash del Kissel is at (Ironforge - The Mystic Ward; "..YELLOW.."36.0, 4.0"..PREV..").";
L["Quest_2204_RewardText"] = "1";
...
L["Quest_17_Location"] = "Ghak Healtouch (Loch Modan - Thelsamar; "..YELLOW.."37.0, 49.2"..PREV..")";
...
L["Quest_1360_Location"] = "Krom Stoutarm (Ironforge - Hall of Explorers; "..YELLOW.."74.2, 9.8"..PREV..")";
...
L["Quest_2278_Location"] = "The Discs of Norgannon (Uldaman; "..YELLOW.."[11]"..PREV..")";
L["Quest_2278_Note"] = "After you receive the quest, speak to the stone watcher to the left of the discs.  Then use the platinum discs again to recieve miniature discs, which you'll have to take to Sage Truthseeker in Thunder Bluff ("..YELLOW.."34.8, 47.8"..PREV..").  The followup starts another NPC who is nearby.";
L["Quest_2278_RewardText"] = "1"..AQ_AND.."2(x5)"..AQ_OR.."3(x5)";
...
L["Quest_1956_Location"] = "Tabetha (Dustwallow Marsh; "..YELLOW.."46.0, 57.0"..PREV..")";
L["Quest_1956_Note"] = "Mage quest.  The Obsidian Power Source drops from the Obsidian Sentinel at "..YELLOW.."[5]"..PREV..".";
...
L["Quest_1192_Location"] = "Pozzik (Thousand Needles - Mirage Raceway; "..YELLOW.."80.0, 75.8"..PREV..")";
...
L["Quest_2283_Location"] = "Dran Droffers (Orgrimmar - The Drag; "..YELLOW.."59.4, 36.8"..PREV..")";
...
L["Quest_2284_Location"] = "Dran Droffers (Orgrimmar - The Drag; "..YELLOW.."59.4, 36.8"..PREV..")";
L["Quest_2284_Note"] = "The Paladin is at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2318_Location"] = "Remains of a Paladin (Uldaman; "..YELLOW.."[2]"..PREV..")";
L["Quest_2318_Note"] = "The translator Jarkal Mossmeld is at (Badlands - Kargath; "..YELLOW.."2.6, 46.0"..PREV..").";
...
L["Quest_2339_Location"] = "Jarkal Mossmeld (Badlands - Kargath; "..YELLOW.."2.6, 46.0"..PREV..")";
L["Quest_2339_Note"] = "The gems are at "..YELLOW.."[1]"..PREV.." in a Conspicous Urn, "..YELLOW.."[8]"..PREV.." from the Shadowforge Cache, and "..YELLOW.."[9]"..PREV.." off Grimlok.  Note that when openning the Shadowforge Cache, a few mobs will spawn an aggro you.  The Shattered Necklace Power Source drops from Archaedas "..YELLOW.."[10]"..PREV..".";
L["Quest_2339_RewardText"] = "1";
...
L["Quest_2202_Location"] = "Jarkal Mossmeld (Badlands - Kargath; "..YELLOW.."2.6, 46.0"..PREV..")";
...
L["Quest_2342_Location"] = "Patrick Garrett (Undercity; "..YELLOW.."62.6, 48.4"..PREV..")";
L["Quest_2342_Note"] = "You find the treasure before you enter the dungeon. It is at the end of the south tunnel. On the entrance map, it's at "..YELLOW.."[5]"..PREV..".";
...
L["Quest_971_Location"] = "Gerrig Bonegrip (Ironforge - The Forlorn Cavern; "..YELLOW.."50.4, 6.0"..PREV..")";
L["Quest_971_Note"] = "You find the Manuscript at "..YELLOW.."[2]"..PREV.." in the water.";
L["Quest_971_RewardText"] = "1";
...
L["Quest_1275_Location"] = "Gershala Nightwhisper (Darkshore - Auberdine; "..YELLOW.."38.4, 43.0"..PREV..")";
L["Quest_1275_Note"] = "The prequest is optional.  You get it from Argos Nightwhisper at (Stormwind City - The Park; "..YELLOW.."21.4, 55.6"..PREV..").  Nagas inside the dungeon and just outside the portal can drop the Corrupt Brain stems.";
L["Quest_1275_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1198_Location"] = "Dawnwatcher Shaedlass (Darnassus - Craftsmen's Terrace; "..YELLOW.."55.4, 24.6"..PREV..")";
L["Quest_1198_Note"] = "You find Argent Guard Thaelrid at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_1200_Location"] = "Argent Guard Thaelrid (Blackfathom Deeps; "..YELLOW.."[4]"..PREV..")";
L["Quest_1200_Note"] = "Twilight Lord Kelris is at "..YELLOW.."[8]"..PREV..".  You find Dawnwatcher Selgorm in (Darnassus - Craftsmen's Terrace; "..YELLOW.."55.8, 24.2"..PREV..").";
L["Quest_1200_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_1199_Location"] = "Argent Guard Manados (Darnassus - Craftsmen's Terrace; "..YELLOW.."55.2, 23.6"..PREV..")";
L["Quest_1199_Note"] = "All Twilight mobs throughout the dungeon can drop the Twilight Pendants.";
L["Quest_1199_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_6563_Location"] = "Je'neu Sancrea (Ashenvale - Zoram'gar Outpost; "..YELLOW.."11.6, 34.2"..PREV..")";
L["Quest_6563_Note"] = "You get the prequest Trouble in the Deeps from Tsunaman (Stonetalon Mountains - Sun Rock Retreat; "..YELLOW.."47.2, 64.2"..PREV..").  The crystals can be found in the tunnels before the dungeon.";
...
L["Quest_6564_Note"] = "You get the Damp Note from Blackfathom Tide Priestesses.  Then take it to Je'neu Sancrea (Ashenvale - Zoram'gar Outpost; "..YELLOW.."11.6, 34.2"..PREV..").  Lorgus Jett is at "..YELLOW.."[6]"..PREV..".  The rewards listed are for the followup quest.";
L["Quest_6564_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_6921_Location"] = "Je'neu Sancrea (Ashenvale - Zoram'gar Outpost; "..YELLOW.."11.6, 34.2"..PREV..")";
L["Quest_6921_Note"] = "You find the Fathom Core at "..YELLOW.."[7]"..PREV.." in the water.  When you get the core Baron Aquanis appears and attacks you.  He drops a quest item which you have to take back to Je'neu Sancrea.";
...
L["Quest_6561_Location"] = "Argent Guard Thaelrid (Blackfathom Deeps; "..YELLOW.."[4]"..PREV..")";
L["Quest_6561_Note"] = "Twilight Lord Kelris is at "..YELLOW.."[8]"..PREV..". You find Bashana Runetotem at (Thunderbluff - The Elder Rise; "..YELLOW.."70.8, 33.8"..PREV..").";
L["Quest_6561_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7441_Location"] = "Azj'Tordin (Feralas - Lariss Pavillion; "..YELLOW.."76.8, 37.4"..PREV..")";
L["Quest_7441_Note"] = "Pusillin is at "..YELLOW.."[1]"..PREV..".  He runs when you talk to him, but stops and fights at "..YELLOW.."[2]"..PREV..".  He'll drop the Crescent Key which is used for Dire Maul North and West.";
L["Quest_7441_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7488_Location"] = "Latronicus Moonspear (Feralas - Feathermoon Stronghold; "..YELLOW.."30.4, 46.0"..PREV..")";
L["Quest_7488_Note"] = "Lethtendris is at "..YELLOW.."[3]"..PREV..".  The prequest comes from Courier Hammerfall in Ironforge.  He roams the entire city.";
L["Quest_7488_RewardText"] = "1";
...
L["Quest_5526_Location"] = "Rabine Saturna (Moonglade - Nighthaven; "..YELLOW.."51.6, 44.8"..PREV..")";
L["Quest_5526_Note"] = "You find Alliz the Wildshaper at "..YELLOW.."[5]"..PREV..".  The prequest comes from Rabine Saturna as well and sends you to recover the Reliquary of Purity from (Silithus; "..YELLOW.."63.2, 55.2"..PREV..").";
L["Quest_5526_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_8990_Location"] = "Bodley (Blackrock Mountain; "..YELLOW.."[D] on Entrance Map"..PREV..")";
...
L["Quest_8990_FollowQuest"] = "Final Preparations ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_7581_Location"] = "Daio the Decrepit (Blasted Lands - The Tainted Scar; "..YELLOW.."34.2, 50.0"..PREV..")";
L["Quest_7581_Note"] = "This along with another quest given by Daio the Decrepit are Warlock only quests for the Ritual of Doom spell.  If you have the Crescent Key, provided by the quest 'Pusillin and the Elder Azj'Tordin', then you can enter Dire Maul East through  back door at the Lariss Pavilion (Feralas; "..YELLOW.."77, 37"..PREV..").";
...
L["Quest_7489_Location"] = "Talo Thornhoof (Feralas - Camp Mojache; "..YELLOW.."76.0, 43.8"..PREV..")";
L["Quest_7489_Note"] = "Lethtendris is in Dire Maul "..YELLOW.."East"..PREV.." at "..YELLOW.."[3]"..PREV..".  The prequest comes from Warcaller Gorlach in Orgrimmar.  He roams the entire city.";
L["Quest_7489_RewardText"] = "1";
L["Quest_7489_PreQuest"] = "Camp Mojache";

L["Quest_1193_Name"] = "A Broken Trap";
L["Quest_1193_Objective"] = "Repair the trap.";
L["Quest_1193_Location"] = "A Broken Trap (Dire Maul; "..YELLOW.."North"..PREV..")";
...
L["Quest_5518_Location"] = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..PREV..")";
L["Quest_5518_Note"] = "Repeatable quest.  You get the Ogre Tannin near "..YELLOW.."[4] (above)"..PREV..".  The Bolts of Runecloth come from a Tailor, the Rugged Leather from a Leatherworker and the Rune Threads from a Tailoring Vendor.";
L["Quest_5518_RewardText"] = "1";

L["Quest_5525_Name"] = "Free Knot!";
L["Quest_5525_Objective"] = "Collect a Gordok Shackle Key for Knot Thimblejack.";
L["Quest_5525_Location"] = "Knot Thimblejack (Dire Maul; "..YELLOW.."North, [4]"..PREV..")";
...
L["Quest_7703_Location"] = "Captain Kromcrush (Dire Maul; "..YELLOW.."North, [5]"..PREV..")";
L["Quest_7703_Note"] = "Tortheldrin is in Dire Maul "..YELLOW.."West"..PREV.." at "..YELLOW.."[7]"..PREV..".  The Gauntlet is near him in a chest.  You can only get this quest after a Tribute run and have the 'It's Good to be King!' buff.";
L["Quest_7703_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_5528_Name"] = "The Gordok Taste Test";
L["Quest_5528_Objective"] = "Free Booze.";
L["Quest_5528_Location"] = "Stomper Kreeg (Dire Maul; "..YELLOW.."North, [2]"..PREV..")";
L["Quest_5528_Note"] = "Just talk to the NPC to accept and complete the quest at the same time.";
L["Quest_5528_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_7482_Location"] = "Scholar Runethorn (Feralas - Feathermoon Stronghold; "..YELLOW.."31.2, 43.4"..PREV..")";
L["Quest_7482_Note"] = "You find Kariel Winthalus in the "..GREEN.."[1'] Library"..PREV..".";
...
L["Quest_7461_Location"] = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1] (above)"..PREV..")";
L["Quest_7461_Note"] = "The Pylons are marked as "..BLUE.."[B]"..PREV..". Immol'thar is at "..YELLOW.."[6]"..PREV..", Prince Tortheldrin at "..YELLOW.."[7]"..PREV..".";
...
L["Quest_7877_Location"] = "Shen'dralar Ancient (Dire Maul; "..YELLOW.."West, [1]"..PREV..")";
L["Quest_7877_Note"] = "You can find the Treasure under the stairs near "..YELLOW.."[7]"..PREV..".";
L["Quest_7877_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7631_Location"] = "Mor'zul Bloodbringer (Burning Steppes; "..YELLOW.."12,31"..PREV..")";
L["Quest_7631_Note"] = "Warlock quest.  Final Quest in the Warlock Epic mount questline.  First you must shut down all Pylons marked with "..BLUE.."[B]"..PREV.." and then kill Immol'thar at "..YELLOW.."[6]"..PREV..".  After that, you can begin the Summoning Ritual.  Be sure to have around 20 Soul Shards ready and have one Warlock specifically assigned to keeping the Bell, Candle and Wheel up.  The Doomguards that come can be enslaved.  After completion, talk to the Dreadsteed ghost to complete the quest.";
L["Quest_7631_PreQuest"] = "Imp Delivery ("..YELLOW.."Scholomance"..PREV..")";
...
L["Quest_7506_Note"] = "Druid quest.  You turn the book in to Lorekeeper Javon at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7506_RewardText"] = "1";
...
L["Quest_7503_Note"] = "Hunter quest.  You turn the book in to Lorekeeper Mykos at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7503_RewardText"] = "1";
...
L["Quest_7500_Note"] = "Mage quest.  You turn the book in to Lorekeeper Kildrath at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7500_RewardText"] = "1";
...
L["Quest_7501_Note"] = "Paladin quest.  You turn the book in to Lorekeeper Mykos at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7501_RewardText"] = "1";
...
L["Quest_7504_Note"] = "Priest quest.  You turn the book in to Lorekeeper Javon at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7504_RewardText"] = "1";
...
L["Quest_7498_Note"] = "Rogue quest.  You turn the book in to Lorekeeper Kildrath at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7498_RewardText"] = "1";
...
L["Quest_7502_Note"] = "Warlock quest.  You turn the book in to Lorekeeper Mykos at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7502_RewardText"] = "1";
...
L["Quest_7499_Note"] = "Warrior quest.  You turn the book in to Lorekeeper Kildrath at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7499_RewardText"] = "1";
...
L["Quest_7484_Location"] = "Lorekeeper Lydros (Dire Maul West; "..GREEN.."[1'] Library"..PREV..")";
L["Quest_7484_Note"] = "It's not a prequest, but Elven Legends must be completed before this quest can be started.\n\nThe Libram is a random drop in Dire Maul and is tradeable, so it may be found on the Auction House.  Skin of Shadow is Soulbound and can drop off some bosses, Risen Constructs and Risen Bonewarder in "..YELLOW.."Scholomance"..PREV..".";
L["Quest_7484_RewardText"] = "1";
...
L["Quest_7485_Location"] = "Lorekeeper Lydros (Dire Maul West; "..GREEN.."[1'] Library"..PREV..")";
L["Quest_7485_Note"] = "It's not a prequest, but Elven Legends must be completed before this quest can be started.\n\nThe Libram is a random drop in Dire Maul and is tradeable, so it may be found on the Auction House.  Frayed Abomination Stitching is Soulbound and can drop off Ramstein the Gorger, Venom Belchers, Bile Spewer and Patchwork Horror in "..YELLOW.."Stratholme"..PREV..".";
L["Quest_7485_RewardText"] = "1";
...
L["Quest_7483_Location"] = "Lorekeeper Lydros (Dire Maul West; "..GREEN.."[1'] Library"..PREV..")";
...
L["Quest_7507_Location"] = "Nostro's Compendium of Dragon Slaying (random boss drop in "..YELLOW.."Dire Maul"..PREV..")";
L["Quest_7507_Note"] = "Warrior or Paladin quest.  It turns in to Lorekeeper Lydros at (Dire Maul West; "..GREEN.."[1'] Library"..PREV..").  Turning this in allows you to start the quest for Quel'Serrar.";
...
L["Quest_7481_Location"] = "Sage Korolusk (Feralas - Camp Mojache; "..YELLOW.."75.0, 43.8"..PREV..")";
L["Quest_7481_Note"] = "You find Kariel Winthalus in the "..GREEN.."[1'] Library"..PREV..".";
...
L["Quest_7505_Note"] = "Shaman quest. You turn the book in to Lorekeeper Javon at the "..GREEN.."[1'] Library"..PREV..".";
L["Quest_7505_RewardText"] = "1";
...
L["Quest_7070_Location"] = "Archmage Tervosh (Dustwallow Marsh - Theramore Isle; "..YELLOW.."66.4, 49.2"..PREV..")";
...
L["Quest_7070_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7041_Location"] = "Talendria (Desolace - Nijel's Point; "..YELLOW.."68.4, 8.8"..PREV..")";
...
L["Quest_7067_Location"] = "Centaur Pariah (Desolace;  Roams around "..YELLOW.."50.4, 86.6"..PREV..")";
L["Quest_7067_Note"] = "Kill the The Nameless Prophet at ("..YELLOW.."[A] on Entrance Map"..PREV..") and then kill the 5 Kahns.  The first is in the middle path near ("..YELLOW.."[D] on Entrance Map"..PREV..").  The second is in the purple part of Maraudon but before you enter the dungeon ("..YELLOW.."[B] on Entrance Map"..PREV..").  The third is in the orange part before you enter the dungeon ("..YELLOW.."[C] on Entrance Map"..PREV..").  The fourth is near "..YELLOW.."[4]"..PREV.." and the fifth is near  "..YELLOW.."[1]"..PREV..".";
L["Quest_7067_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_7044_Location"] = "Cavindra (Desolace - Maraudon; "..YELLOW.."[4] on Entrance Map"..PREV..")";
L["Quest_7044_Note"] = "You find Cavindra at the beginning  of the orange part before you enter the dungeon.\nYou get the Celebrian Rod from Noxxion at "..YELLOW.."[2]"..PREV..", the Celebrian Diamond from Lord Vyletongue at  "..YELLOW.."[5]"..PREV..". Celebras is at "..YELLOW.."[7]"..PREV..". You have to defeat him to be able to talk to him.";
...
L["Quest_7046_Location"] = "Celebras the Redeemed (Maraudon; "..YELLOW.."[7]"..PREV..")";
L["Quest_7046_Note"] = "Celebras creates the Scepter. Speak with him after he is finished.";
L["Quest_7046_RewardText"] = "1";
...
L["Quest_7065_Location"] = "Keeper Marandis (Desolace - Nijel's Point; "..YELLOW.."63.8, 10.6"..PREV..")";
L["Quest_7065_Note"] = "You find Princess Theradras at "..YELLOW.."[11]"..PREV..".";
L["Quest_7065_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7066_Location"] = "Zaetar's Spirit (Maraudon; "..YELLOW.."[11]"..PREV..")";
L["Quest_7066_Note"] = "Zaetars Ghost appears after killing Princess Theradras "..YELLOW.."[11]"..PREV..". You find Keeper Remulos at (Moonglade - Shrine of Remulos; "..YELLOW.."36.2, 41.8"..PREV..").";
...
L["Quest_7068_Location"] = "Uthel'nay (Orgrimmar - Valley of Spirits; "..YELLOW.."39.0, 86.0"..PREV..")";
...
L["Quest_7068_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7029_Location"] = "Vark Battlescar (Desolace - Shadowprey Village; "..YELLOW.."23.2, 70.2"..PREV..")";
...
L["Quest_7029_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7064_Location"] = "Selendra (Desolace; "..YELLOW.."26.8, 77.6"..PREV..")";
L["Quest_7064_Note"] = "You find Princess Theradras at "..YELLOW.."[11]"..PREV..".";
L["Quest_7064_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_5723_Location"] = "Rahauro (Thunder Bluff - Elder Rise; "..YELLOW.."70.4, 32.2"..PREV..")";
...
L["Quest_5725_Location"] = "Varimathras (Undercity - Royal Quarter; "..YELLOW.."56.2, 92.6"..PREV..")";
L["Quest_5725_Note"] = "The books can be dropped by Searing Blade Cultists and Searing Blade Warlocks.";
L["Quest_5725_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_5722_Location"] = "Rahauro (Thunder Bluff - Elder Rise; "..YELLOW.."70.4, 32.2"..PREV..")";
L["Quest_5722_Note"] = "You find Maur Grimtotem at "..YELLOW.."[1]"..PREV..".  After getting the satchel you must bring it back to Rahauro in Thunder Bluff.  The rewards are for the followup quest.";
L["Quest_5722_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_5728_Location"] = "Thrall (Orgrimmar - Valley of Wisdom; "..YELLOW.."32.0, 37.8"..PREV..")";
L["Quest_5728_Note"] = "You find Bazzalan at  "..YELLOW.."[4]"..PREV.." and Jergosh the Invoker at "..YELLOW.."[3]"..PREV..".  The prequest starts at Thrall in Orgrimmar.";
L["Quest_5728_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_5761_Location"] = "Neeru Fireblade (Orgrimmar - Cleft of Shadow; "..YELLOW.."49.6, 50.4"..PREV..")";
L["Quest_5761_Note"] = "You find Taragaman the Hungerer at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6626_Location"] = "Myriam Moonsinger (The Barrens; "..YELLOW.."49.0, 94.8"..PREV..")";
...
L["Quest_3525_Location"] = "Belnistrasz (Razorfen Downs; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_3636_Location"] = "Archbishop Benedictus (Stormwind - Cathedral of Light; "..YELLOW.."39.6, 27.4"..PREV..")";
L["Quest_3636_Note"] = "Amnennar the Coldbringer is the last boss in Razorfen Downs. You can find him at "..YELLOW.."[6]"..PREV..".";
L["Quest_3636_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_6521_Location"] = "Varimathras (Undercity - Royal Quarter; "..YELLOW.."56.2, 92.6"..PREV..")";
L["Quest_6521_Note"] = "The preceding quest can be obtained from the last Boss in Razorfen Kraul.  You find Malcin outside the dungeon (The Barrens; "..YELLOW.."48.0, 92.4"..PREV..").";
L["Quest_6521_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_3341_Location"] = "Andrew Brownell (Undercity - The Magic Quarter; "..YELLOW.."74.0, 32.8"..PREV..")";
L["Quest_3341_Note"] = "Amnennar the Coldbringer is the last Boss at Razorfen Downs.  You can find him at "..YELLOW.."[6]"..PREV..".";
L["Quest_3341_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_1221_Location"] = "Mebok Mizzyrix (The Barrens - Ratchet; "..YELLOW.."62.4, 37.6"..PREV..")";
L["Quest_1221_Note"] = "The Crate, the Stick and the Manual can all be found near Mebok Mizzyrix.";
L["Quest_1221_RewardText"] = "1";
...
L["Quest_1142_Location"] = "Heraltha Fallowbrook (Razorfen Kraul; "..YELLOW.."[8]"..PREV..")";
L["Quest_1142_Note"] = "The pendant is a random drop.  You must bring back the pendant to Treshala Fallowbrook (Darnassus - Tradesmen Terrace; "..YELLOW.."69.4, 67.4"..PREV..").";
L["Quest_1142_RewardText"] = "1"..AQ_OR.."2";

L["Quest_1144_Name"] = "Willix the Importer";
L["Quest_1144_Objective"] = "Escort Willix the Importer out of Razorfen Kraul.";
L["Quest_1144_Location"] = "Willix the Importer (Razorfen Kraul; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_1144_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1101_Location"] = "Falfindel Waywarder (Feralas - Thalanaar; "..YELLOW.."89.6, 46.4"..PREV..")";
L["Quest_1101_Note"] = "Charlga Razorflank "..YELLOW.."[7]"..PREV.." drops the Medallion required for this quest.";
L["Quest_1101_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_1701_Location"] = "Furen Longbeard (Stormwind - Dwarven District; "..YELLOW.."58.0, 16.8"..PREV..")";
L["Quest_1701_Note"] = "Warrior quest.  You get the Vial of Phlogiston from Roogug at "..YELLOW.."[1]"..PREV..".\n\nThe followup quest is different for each race. Burning Blood for Humans, Iron Coral for Dwarves and Gnomes and Sunscorched Shells for Night Elves.";
...
L["Quest_1109_Location"] = "Master Apothecary Faranell (Undercity - The Apothecarium; "..YELLOW.."48.4, 69.4 "..PREV..")";
L["Quest_1109_Note"] = "Kraul Guano is dropped by any of the bats found within the dungeon.";
L["Quest_1109_FollowQuest"] = "Hearts of Zeal ("..YELLOW.."[Scarlet Monastery]"..PREV..")";

L["Quest_1102_Name"] = "A Vengeful Fate";
L["Quest_1102_Objective"] = "Bring Razorflank's Heart to Auld Stonespire in Thunder Bluff.";
L["Quest_1102_Location"] = "Auld Stonespire (Thunderbluff; "..YELLOW.."36.2, 59.8"..PREV..")";
L["Quest_1102_Note"] = "You can find Charlga Razorflank at "..YELLOW.."[7]"..PREV..".";
L["Quest_1102_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_1838_Location"] = "Thun'grim Firegaze (The Barrens; "..YELLOW.."57.2, 30.2"..PREV..")";
L["Quest_1838_Note"] = "Warrior quest.  You get the Vial of Phlogiston from Roogug at "..YELLOW.."[1]"..PREV..".\n\nCompleting this quest allows you to start four new quests from the same NPC.";
...
L["Quest_1486_Location"] = "Nalpak (Barrens - Wailing Caverns; "..YELLOW.."47, 36"..PREV..")";
...
L["Quest_1486_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_959_Location"] = "Crane Operator Bigglefuzz (Barrens - Ratchet; "..YELLOW.."63.0, 37.6"..PREV..")";
...
L["Quest_1491_Location"] = "Mebok Mizzyrix (Barrens - Ratchet; "..YELLOW.."62.4, 37.6"..PREV..")";
...
L["Quest_1487_Location"] = "Ebru (Barrens - Wailing Caverns; "..YELLOW.."47, 36"..PREV..")";
...
L["Quest_1487_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_6981_Location"] = "The Glowing Shard (drops from Mutanus the Devourer; "..YELLOW.."[9]"..PREV..")";
L["Quest_6981_Note"] = "Mutanus the Devourer will only appear if you kill the four leader druids of the fang and escort the tauren druid at the entrance.\nWhen you have the Shard, you must bring it to the Bank at Ratchet, and then back to the top of the hill over Wailing Caverns to Falla Sagewind (The Barrens; "..YELLOW.."48.2, 32.8"..PREV..").";
L["Quest_6981_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_962_Location"] = "Apothecary Zamah (Thunder Bluff - Spirit Rise; "..YELLOW.."23.0, 21.0"..PREV..")";
L["Quest_962_Note"] = "Apothecary Zamah is in a cave under the Spirit Rise.  You get the prequest from Apothecary Helbrim (Barrens - Crossroads; "..YELLOW.."51.4, 30.2"..PREV..").\nYou get the Serpentbloom inside the cave in front of the dungeon and inside the dungeon.  Players with Herbalism can see the plants on their minimap.";
L["Quest_962_RewardText"] = "1";
...
L["Quest_914_Location"] = "Nara Wildmane (Thunder Bluff - Elder Rise; "..YELLOW.."75.6, 31.2"..PREV..")";
L["Quest_914_Note"] = "The questline starts at Arch Druid Hamuul Runetotem (Thunderbluff - Elder Rise; "..YELLOW.."78.4, 28.4"..PREV..")\nThe 4 druids bosses drop the gems - Lord Cobrahn "..YELLOW.."[2]"..PREV..", Lady Anacondra "..YELLOW.."[3]"..PREV..", Lord Pythas "..YELLOW.."[5]"..PREV.." and Lord Serpentis "..YELLOW.."[7]"..PREV..".";
L["Quest_914_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_3042_Location"] = "Trenton Lighthammer (Tanaris - Gadgetzan; "..YELLOW.."51.4, 28.6"..PREV..")";
...
L["Quest_2865_Location"] = "Tran'rek (Tanaris - Gadgetzan; "..YELLOW.."51.6, 26.8"..PREV..")";
L["Quest_2865_Note"] = "The prequest starts at Krazek (Stranglethorn Vale - Booty Bay; "..YELLOW.."27.0, 77.2"..PREV..").\nAll scarabs can drop the shells.  You can find many scarabs at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_2846_Location"] = "Tabetha (Dustwallow Marsh; "..YELLOW.."46.0, 57.0"..PREV..")";
L["Quest_2846_Note"] = "Hydromancer Velratha drops the Tiara of the Deep at "..YELLOW.."[6]"..PREV..".";
L["Quest_2846_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_2991_Location"] = "Thadius Grimshade (The Blasted Lands - Nethergarde Keep; "..YELLOW.."67.0, 19.4"..PREV..")";
L["Quest_2991_Note"] = "The questline starts at Gryphon Master Talonaxe (The Hinterlands - Wildhammer Stronghold; "..YELLOW.."9.8, 44.4"..PREV..").\nNekrum spawns at "..YELLOW.."[4]"..PREV.." with the final crowd you fight for the Temple event.";
...
L["Quest_3527_Location"] = "Yeh'kinya (Tanaris - Steamwheedle Port; "..YELLOW.."67.0, 22.4"..PREV..")";
L["Quest_3527_Note"] = "You get the prequest from the same NPC.\nThe Tablets drop from Theka the Martyr at "..YELLOW.."[2]"..PREV.." and Hydromancer Velratha at "..YELLOW.."[6]"..PREV..".";
...
L["Quest_2768_Location"] = "Chief Engineer Bilgewhizzle (Tanaris - Gadgetzan; "..YELLOW.."52.4, 28.4"..PREV..")";
L["Quest_2768_Note"] = "You get the Rod from Sergeant Bly.  You can find him at "..YELLOW.."[4]"..PREV.." after the Temple event.";
L["Quest_2768_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_2770_Location"] = "Wizzle Brassbolts (Thousands Needles - Mirage Raceway; "..YELLOW.."78.0, 77.0"..PREV..")";
L["Quest_2770_Note"] = "Gahz'rilla is summoned at at "..YELLOW.."[6]"..PREV.." by banging the gong.  A party member must have the Mallet of Zul'Farrak.";
L["Quest_2770_RewardText"] = "1";
...
L["Quest_2936_Location"] = "Meister Gadrin (Durotar - Sen'jin Village; "..YELLOW.."56.0, 74.6"..PREV..")";
L["Quest_2936_Note"] = "The Questline starts at a Venom Bottle, which is found on tables in Troll Villages in The Hinterlands.\nYou find the Tablet at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_6822_Location"] = "Duke Hydraxis (Azshara; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6822_Note"] = "These are non-bosses found inside Molten Core.";
L["Quest_6822_PreQuest"] = "Eye of the Emberseer ("..YELLOW.."Upper Blackrock Spire"..PREV..")";
...
L["Quest_6824_Location"] = "Duke Hydraxis (Azshara; "..YELLOW.."79.2, 73.6"..PREV..")";
L["Quest_6824_Note"] = "Lucifron is at "..YELLOW.."[1]"..PREV..", Sulfuron is at "..YELLOW.."[8]"..PREV..", Gehennas is at "..YELLOW.."[3]"..PREV.." and Shazzrah is at "..YELLOW.."[5]"..PREV..".  The rewards listed are given for the followup quest.";
L["Quest_6824_RewardText"] = "1"..AQ_OR.."2";
...
L["Quest_7786_Location"] = "Highlord Demitrian (Silithus; "..YELLOW.."21.8, 8.6"..PREV..")";
...
L["Quest_7604_Location"] = "Lokhtos Darkbargainer (Blackrock Depths; "..YELLOW.."[15]"..PREV..")";
...
L["Quest_7632_Location"] = "Ancient Petrified Leaf (drops from Cache of the Firelord; "..YELLOW.."[9]"..PREV..")";
L["Quest_7632_Note"] = "Turns in to Vartrus the Ancient at (Felwood - Irontree Woods; "..YELLOW.."48.8, 24.2"..PREV..").";
L["Quest_7632_FollowQuest"] = "An Introduction -> Ancient Sinew Wrapped Lamina ("..YELLOW.."Azuregos"..PREV..")";
...
L["Quest_8578_Location"] = "Inconspicuous Crate (Silverpine Forest - Greymane Wall; "..YELLOW.."46.2, 86.6"..PREV..")";
L["Quest_8578_Note"] = "The quest turns in to Narain Soothfancy (Tanaris; "..YELLOW.."65.2, 18.6"..PREV.."), which is also where the pre-quest is obtained.";
L["Quest_8578_RewardText"] = "1(x3)";
...
L["Quest_7509_Location"] = "Lorekeeper Lydros (Dire Maul West; "..YELLOW.."[1] Library"..PREV..")";
...
L["Quest_7509_RewardText"] = "1";
L["Quest_7509_PreQuest"] = "Nostro's Compendium ("..YELLOW.."Dire Maul West"..PREV..") -> The Forging of Quel'Serrar";
...
L["Quest_7495_Location"] = "Head of Onyxia (drops from Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7495_Note"] = "Highlord Bolvar Fordragon is at (Stormwind City - Stormwind Keep; "..YELLOW.."78.0, 18.0"..PREV.."). Only one person in the raid can loot this item and the quest can be done once per character.\n\nRewards listed are for the followup.";
L["Quest_7495_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_7490_Location"] = "Head of Onyxia (drops from Onyxia; "..YELLOW.."[3]"..PREV..")";
L["Quest_7490_Note"] = "Thrall is at (Orgrimmar - Valley of Wisdom; "..YELLOW.."32.0, 37.8"..PREV.."). Only one person in the raid can loot this item and the quest can be done once per character.\n\nRewards listed are for the followup.";
L["Quest_7490_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8201_Location"] = "Exzhal (Stranglethorn Vale - Yojamba Isle; "..YELLOW.."15.2, 15.4"..PREV..")";
L["Quest_8201_Note"] = "Make sure you loot all the priests.";
L["Quest_8201_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_8183_Name"] = "The Heart of Hakkar";
L["Quest_8183_Objective"] = "Bring the Heart of Hakkar to Molthor on Yojamba Isle.";
L["Quest_8183_Location"] = "Heart of Hakkar (drops from Hakkar; "..YELLOW.."[11]"..PREV..")";
L["Quest_8183_Note"] = "Molthor (Stranglethorn Vale - Yojamba Isle; "..YELLOW.."15.0, 15.2"..PREV..")";
L["Quest_8183_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_8227_Note"] = "Nat Pagle is at Dustwallow Marsh ("..YELLOW.."59, 60"..PREV.."). Turning the quest in allows you to buy Mudskunk Lures from Nat Pagle to summon Gahz'ranka in Zul'Gurub.";
...
L["Quest_9023_Location"] = "Dirk Thunderwood (Silithus - Cenarion Hold; "..YELLOW.."52, 39"..PREV..")";
L["Quest_9023_Note"] = "Venoxis's Venom Sac drops from High priest Venoxis in "..YELLOW.."Zul'Gurub"..PREV..". Kurinnaxx's Venom Sac drops in the "..YELLOW.."Ruins of Ahn'Qiraj"..PREV.." at "..YELLOW.."[1]"..PREV..".";
L["Quest_9023_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_OR.."6";
...
L["Quest_8801_Note"] = "Caelestrasz (Temple of Ahn'Qiraj; "..YELLOW.."2'"..PREV..")";
...
L["Quest_8802_Note"] = "Anachronos (Tanaris - Caverns of Time; "..YELLOW.."65, 49"..PREV..")";
...
L["Quest_8784_Note"] = "Turns in to Andorgos (Temple of Ahn'Qiraj; "..YELLOW.."1'"..PREV..").";
...
L["Quest_8579_Location"] = "Kandrostrasz (Temple of Ahn'Qiraj; "..YELLOW.."[1']"..PREV..")";
...
L["Quest_7261_Location"] = "Lieutenant Rotimer (Ironforge - The Commons; "..YELLOW.."30,62"..PREV..")";
L["Quest_7261_Note"] = "Lieutenant Haggerdin is at (Alterac Mountains; "..YELLOW.."39,81"..PREV..").";
...
L["Quest_7162_Location"] = "Lieutenant Haggerdin (Alterac Mountains; "..YELLOW.."39,81"..PREV..")";
L["Quest_7162_Note"] = "The Stormpike Banner is in the Icewing Cavern at "..YELLOW.."[11]"..PREV.." on the Alterac Valley - North map. Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe prequest is not necessary to obtain this quest.";
...
L["Quest_7141_Location"] = "Prospector Stonehewer (Alterac Mountains; "..YELLOW.."41,80"..PREV..") and\n(Alterac Valley - North; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "Drek'thar is at (Alterac Valley - South; "..YELLOW.."[B]"..PREV.."). He does not actually need to be killed to complete the quest. The battleground just has to be won by your side in any manner.\nAfter turning this quest in, talk to the NPC again for the reward.";
...
L["Quest_7121_Location"] = "Mountaineer Boombellow (Alterac Valley - North; "..YELLOW.."Near [3] Before Bridge"..PREV..")";
L["Quest_7121_Note"] = "The Stormpike Quartermaster is at (Alterac Valley - North; "..YELLOW.."[7]"..PREV..") and provides more quests.";
...
L["Quest_6982_Location"] = "Stormpike Quartermaster (Alterac Valley - North; "..YELLOW.."[7]"..PREV..")";
L["Quest_6982_Note"] = "The supplies can be found in the Coldtooth Mine at (Alterac Valley - South; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_5892_Location"] = "Stormpike Quartermaster (Alterac Valley - North; "..YELLOW.."[7]"..PREV..")";
L["Quest_5892_Note"] = "The supplies can be found in the Irondeep Mine at (Alterac Valley - North; "..YELLOW.."[1]"..PREV..").";

L["Quest_7223_Name"] = "Armor Scraps";
L["Quest_7223_Objective"] = "Bring 20 Armor Scraps to Murgot Deepforge in Dun Baldar.";
L["Quest_7223_Location"] = "Murgot Deepforge (Alterac Valley - North; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_7122_Location"] = "Sergeant Durgen Stormpike (Alterac Mountains; "..YELLOW.."37,77"..PREV..")";
L["Quest_7122_Note"] = "To complete the quest, you must kill either Morloch in the Irondeep Mine at (Alterac Valley - North; "..YELLOW.."[1]"..PREV..") or Taskmaster Snivvle in the Coldtooth Mine at (Alterac Valley - South; "..YELLOW.."[6]"..PREV..") while the Horde control it.";
...
L["Quest_7102_Location"] = "Sergeant Durgen Stormpike (Alterac Mountains; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7081_Location"] = "Sergeant Durgen Stormpike (Alterac Mountains; "..YELLOW.."37,77"..PREV..")";
...
L["Quest_7027_Location"] = "Stormpike Stable Master (Alterac Valley - North; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7026_Location"] = "Stormpike Ram Rider Commander (Alterac Valley - North; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7386_Location"] = "Arch Druid Renferal (Alterac Valley - North; "..YELLOW.."[2]"..PREV..")";
L["Quest_7386_Note"] = "After turning in 200 or so crystals, Arch Druid Renferal will begin walking towards (Alterac Valley - North; "..YELLOW.."[19]"..PREV.."). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Ivus the Forest Lord will be summoned to help the battle.";
...
L["Quest_6881_Location"] = "Arch Druid Renferal (Alterac Valley - North; "..YELLOW.."[2]"..PREV..")";
L["Quest_6881_Note"] = "After turning in 200 or so crystals, Arch Druid Renferal will begin walking towards (Alterac Valley - North; "..YELLOW.."[19]"..PREV.."). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Ivus the Forest Lord will be summoned to help the battle.";
...
L["Quest_6942_Location"] = "Wing Commander Slidore (Alterac Valley - North; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6941_Location"] = "Wing Commander Vipore (Alterac Valley - North; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6943_Location"] = "Wing Commander Ichman (Alterac Valley - North; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7241_Location"] = "Frostwolf Ambassador Rokhstrom (Orgrimmar - Valley of Strength "..YELLOW.."50,71"..PREV..")";
L["Quest_7241_Note"] = "Warmaster Laggrond is at (Alterac Mountains; "..YELLOW.."62,59"..PREV..").";
...
L["Quest_7161_Location"] = "Warmaster Laggrond (Alterac Mountains; "..YELLOW.."62,59"..PREV..")";
L["Quest_7161_Note"] = "The Frostwolf Banner is in the Wildpaw Cavern at (Alterac Valley - South; "..YELLOW.."[15]"..PREV.."). Talk to the same NPC each time you gain a new Reputation level for an upgraded Insignia.\n\nThe prequest is not necessary to obtain this quest.";
...
L["Quest_7142_Location"] = "Voggah Deathgrip (Alterac Mountains; "..YELLOW.."64,60"..PREV..")";
L["Quest_7142_Note"] = "Vanndar Stormpike is at (Alterac Valley - North; "..YELLOW.."[B]"..PREV.."). He does not actually need to be killed to complete the quest. The battleground just has to be won by your side in any manner.\nAfter turning this quest in, talk to the NPC again for the reward.";
...
L["Quest_7123_Location"] = "Jotek (Alterac Valley - South; "..YELLOW.."[8]"..PREV..")";
L["Quest_7123_Note"] = "The Frostwolf Quartermaster is at "..YELLOW.."[10]"..PREV.." and provides more quests.";
...
L["Quest_5893_Location"] = "Frostwolf Quartermaster (Alterac Valley - South; "..YELLOW.."[10]"..PREV..")";
L["Quest_5893_Note"] = "The supplies can be found in the Coldtooth Mine at (Alterac Valley - South; "..YELLOW.."[6]"..PREV..").";
...
L["Quest_6985_Location"] = "Frostwolf Quartermaster (Alterac Valley - South; "..YELLOW.."[10]"..PREV..")";
L["Quest_6985_Note"] = "The supplies can be found in the Irondeep Mine at (Alterac Valley - North; "..YELLOW.."[1]"..PREV..").";

L["Quest_7224_Name"] = "Enemy Booty";
L["Quest_7224_Objective"] = "Bring 20 Armor Scraps to Smith Regzar in Frostwolf Village.";
L["Quest_7224_Location"] = "Smith Regzar (Alterac Valley - South; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7124_Location"] = "Corporal Teeka Bloodsnarl (Alterac Mountains; "..YELLOW.."66,55"..PREV..")";
L["Quest_7124_Note"] = "To complete the quest, you must kill either Morloch in the Irondeep Mine at (Alterac Valley - North; "..YELLOW.."[1]"..PREV..") or Taskmaster Snivvle in the Coldtooth Mine at (Alterac Valley - South; "..YELLOW.."[6]"..PREV..") while the Alliance control it.";
...
L["Quest_7101_Location"] = "Corporal Teeka Bloodsnarl (Alterac Mountains; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7082_Location"] = "Corporal Teeka Bloodsnarl (Alterac Mountains; "..YELLOW.."66,55"..PREV..")";
...
L["Quest_7001_Location"] = "Frostwolf Stable Master (Alterac Valley - South; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7002_Location"] = "Frostwolf Wolf Rider Commander (Alterac Valley - South; "..YELLOW.."[9]"..PREV..")";
...
L["Quest_7385_Location"] = "Primalist Thurloga (Alterac Valley - South; "..YELLOW.."[8]"..PREV..")";
L["Quest_7385_Note"] = "After turning in 150 or so Blood, Primalist Thurloga will begin walking towards (Alterac Valley - South; "..YELLOW.."[1]"..PREV.."). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Lokholar the Ice Lord will be summoned to kill Alliance players.";
...
L["Quest_6801_Location"] = "Primalist Thurloga (Alterac Valley - South; "..YELLOW.."[8]"..PREV..")";
L["Quest_6801_Note"] = "After turning in 150 or so Blood, Primalist Thurloga will begin walking towards (Alterac Valley - South; "..YELLOW.."[1]"..PREV.."). Once there, she will begin a summoning ritual which will require 10 people to assist. If successful, Lokholar the Ice Lord will be summoned to kill Alliance players.";
...
L["Quest_6825_Location"] = "Wing Commander Guse (Alterac Valley - South; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6826_Location"] = "Wing Commander Jeztor (Alterac Valley - South; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_6827_Location"] = "Wing Commander Mulverick (Alterac Valley - South; "..YELLOW.."[13]"..PREV..")";
...
L["Quest_8105_Location"] = "Field Marshal Oslight (Arathi Highlands - Refuge Pointe; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8114_Location"] = "Field Marshal Oslight (Arathi Highlands - Refuge Pointe; "..YELLOW.."46,45"..PREV..")";
...
L["Quest_8115_Location"] = "Field Marshal Oslight (Arathi Highlands - Refuge Pointe; "..YELLOW.."46,45"..PREV..")";
L["Quest_8115_Note"] = "You need to be Exalted with the League of Arathor to get this quest.";
L["Quest_8115_RewardText"] = "1";
...
L["Quest_8120_Location"] = "Deathmaster Dwire (Arathi Highlands - Hammerfall; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8121_Location"] = "Deathmaster Dwire (Arathi Highlands - Hammerfall; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_8122_Location"] = "Deathmaster Dwire (Arathi Highlands - Hammerfall; "..YELLOW.."74,35"..PREV..")";
L["Quest_8122_Note"] = "You need to be Exalted with The Defilers to get this quest.";
L["Quest_8122_RewardText"] = "1";
...
L["Quest_8446_Note"] = "Quest turns in to Keeper Remulos at (Moonglade - Shrine of Remulos; "..YELLOW.."36,41"..PREV.."). Reward listed is for the followup.";
L["Quest_8446_RewardText"] = "1";
...
L["Quest_7634_Location"] = "Hastat the Ancient (Felwood - Irontree Woods; "..YELLOW.."48,24"..PREV..")";
L["Quest_7634_Note"] = "Kill Azuregos to get the Mature Blue Dragon Sinew. He walks around the middle of the southern peninsula in Azshara near "..YELLOW.."[1]"..PREV..".";
L["Quest_7634_RewardText"] = "1";
L["Quest_7634_PreQuest"] = "The Ancient Leaf ("..YELLOW.."Molten Core"..PREV..")";
...
L["Quest_9575_Location"] = "Lieutenant Chadwick (Hellfire Peninsula - Honor Hold; "..YELLOW.."56.6, 66.4"..PREV..")";
L["Quest_9575_Note"] = "Gargolmar is at "..YELLOW.."[1]"..PREV..", Omor is at "..YELLOW.."[2]"..PREV.." and Nazan is at "..YELLOW.."[3]"..PREV..".  Gunny is at (Hellfire Peninsula - Honor Hold; "..YELLOW.."56.4, 66.6"..PREV.."). \n\nTo get this quest, you must complete 'Ill Omens', which starts with 'Know your Enemy' from Force Commander Dannath Trollbane (Hellfire Peninsula - Honor Hold; "..YELLOW.."56.6, 66.6"..PREV..").";
L["Quest_9575_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_9575_PreQuest"] = "Know your Enemy -> Ill Omens";
L["Quest_9575_FollowQuest"] = "Heart of Rage ("..YELLOW.."HFC: Blood Furnace"..PREV..")";
...
L["Quest_9587_Location"] = "Ominous Letter (drops from Vazruden the Herald; "..YELLOW.."[3]"..PREV..")";
L["Quest_9587_Note"] = "Force Commander Danath Trollbane is at "..YELLOW.."56.6, 66.6"..PREV.." in Honor Hold.";
L["Quest_9587_FollowQuest"] = "The Blood is Life ("..YELLOW.."HFC: Blood Furnace"..PREV..")";
...
L["Quest_11354_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_9572_Location"] = "Stone Guard Stok'ton (Hellfire Peninsula - Thrallmar; "..YELLOW.."55.2, 36.0"..PREV..")";
L["Quest_9572_Note"] = "Gargolmar is at "..YELLOW.."[1]"..PREV..", Omor is at "..YELLOW.."[2]"..PREV.." and Nazan is at "..YELLOW.."[3]"..PREV..". Caza'rez is at (Hellfire Peninsula - Thrallmar; "..YELLOW.."54.8, 36.0"..PREV.."). \n\nTo get this quest, you must complete 'Forward Base: Reaver's Fall', which starts with the 'Through the Dark Portal' quest you receive at the Dark Portal in Blasted Lands.";
...
L["Quest_9572_FollowQuest"] = "Heart of Rage ("..YELLOW.."HFC: Blood Furnace"..PREV..")";
...
L["Quest_9588_Location"] = "Ominous Letter (drops from Vazruden the Herald; "..YELLOW.."[3]"..PREV..")";
L["Quest_9588_Note"] = "Nazgrel is at "..YELLOW.."55.0, 36.0"..PREV.." in Thrallmar.";
L["Quest_9588_FollowQuest"] = "The Blood is Life ("..YELLOW.."HFC: Blood Furnace"..PREV..")";
...
L["Quest_9589_Location"] = "Gunny (Hellfire Peninsula - Honor Hold; "..YELLOW.."56,67"..PREV..")";
L["Quest_9589_Note"] = "All Orcs in Blood Furnace can drop the Blood Vials.";
L["Quest_9589_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_9589_PreQuest"] = "Dark Tidings ("..YELLOW.."Hellfire Ramparts"..PREV..")";
...
L["Quest_9607_Location"] = "Gunny (Hellfire Peninsula - Honor Hold; "..YELLOW.."56,67"..PREV..").";
L["Quest_9607_Note"] = "Quest completes in room with final boss.  Force Commander Danath Trollbane is at "..YELLOW.."57,67"..PREV.." in Honor Hold.";
L["Quest_9607_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_9607_PreQuest"] = "Weaken the Ramparts ("..YELLOW.."Hellfire Ramparts"..PREV..")";
...
L["Quest_11362_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_9590_Location"] = "Caza'rez (Hellfire Peninsula - Thrallmar; "..YELLOW.."55,36"..PREV..")";
L["Quest_9590_Note"] = "All Orcs in Blood Furnace can drop the Blood Vials.";
L["Quest_9590_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
L["Quest_9590_PreQuest"] = "Dark Tidings ("..YELLOW.."Hellfire Ramparts"..PREV..")";
...
L["Quest_9608_Location"] = "Caza'rez (Hellfire Peninsula - Thrallmar; "..YELLOW.."55,36"..PREV..")";
L["Quest_9608_Note"] = "Quest completes in room with final boss. Nazgrel is at Hellfire Peninsula - Thrallmar ("..YELLOW.."55,36"..PREV..").";
L["Quest_9608_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
L["Quest_9608_PreQuest"] = "Weaken the Ramparts ("..YELLOW.."Hellfire Ramparts"..PREV..")";

L["Quest_9494_Name"] = "Fel Embers";
L["Quest_9494_Objective"] = "Magus Zabraxis at Honor Hold wants you to bring her a Fel Ember";
L["Quest_9494_Location"] = "Magus Zabraxis (Hellfire Peninsula - Honor Hold; "..YELLOW.."54,66"..PREV..")";
L["Quest_9494_Note"] = "After killing Grand Warlock Netherkurse at "..YELLOW.."[2]"..PREV..", he'll drop an Amulet. Use the amulet at one of the braziers near his throne to get the Fel Ember.";
L["Quest_9494_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_9493_Location"] = "Field Commander Romus (Hellfire Peninsula - Honor Hold; "..YELLOW.."57,63"..PREV..")";
...
L["Quest_9492_Location"] = "Force Commander Danath Trollbane (Hellfire Peninsula - Honor Hold; "..YELLOW.."57,67"..PREV..")";
L["Quest_9492_Note"] = "Warchief Kargath Bladefist is at "..YELLOW.."[5]"..PREV..".";
L["Quest_9492_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9524_Location"] = "Randy Whizzlesprocket (Shattered Halls; "..YELLOW.."Heroic [1]"..PREV..")";
L["Quest_9524_Note"] = "Requires Heroic Dungeon Difficulty.\n\nCaptain Alina is at "..YELLOW.."[5]"..PREV..". Timer with 55 minutes starts at the beginning of the Archer event.";
...
L["Quest_10884_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
...
L["Quest_10670_Location"] = "David Wayne (Terokkar Forest - Wayne's Refuge; "..YELLOW.."78,39"..PREV..").";
L["Quest_10670_Note"] = "Warbringer O'mrogg is at "..YELLOW.."[4]"..PREV..".\n\nThe item will drop in both Normal and Heroic modes.";
L["Quest_10670_PreQuest"] = "Fresh From the Mechanar ("..YELLOW.."The Mechanar"..PREV..") & The Lexicon Demonica ("..YELLOW.."Shadow Labyrinth"..PREV..")";
...
L["Quest_11363_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11363_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nWarchief Kargath Bladefist is at "..YELLOW.."[5]"..PREV..".";
L["Quest_11363_RewardText"] = "1(x2)";
...
L["Quest_10754_Location"] = "Primed Key Mold  (drops from Smith Gorlunk in Shadowmoon Valley - Ata'mal Terrace; "..YELLOW.."68,36"..PREV..")";
L["Quest_10754_Note"] = "The Smith that drops the Primed Key Mold is easily soloable and very easily reachable with a flying mount.\n\nForce Commander Danath is at (Hellfire Peninsula - Honor Hold; "..YELLOW.."57,67"..PREV.."). He sends you to Grand Master Dumphry for the next part of the quest at (Hellfire Peninsula - Honor Hold; "..YELLOW.."51,60"..PREV..")...";
L["Quest_10754_RewardText"] = "1";
...
L["Quest_9496_Location"] = "Shadow Hunter Ty'jin (Hellfire Peninsula - Thrallmar; "..YELLOW.."55,36"..PREV..")";
...
L["Quest_9495_Location"] = "Nazgrel (Hellfire Peninsula - Thrallmar; "..YELLOW.."55,36"..PREV..")";
L["Quest_9495_Note"] = "Warchief Kargath Bladefist is Located at "..YELLOW.."[5]"..PREV..".";
L["Quest_9495_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9525_Location"] = "Drisella (Shattered Halls; "..YELLOW.."Heroic [1]"..PREV..")";
...
L["Quest_10755_Location"] = "Primed Key Mold  (drops from Smith Gorlunk in Shadowmoon Valley - Ata'mal Terrace; "..YELLOW.."68,36"..PREV..")";
L["Quest_10755_Note"] = "The Smith that drops the Primed Key Mold is easily soloable and very easily reachable with a flying mount.\n\nNazgrel is at (Hellfire Peninsula - Thrallmar; "..YELLOW.."55,36"..PREV.."). He sends you to Grand Master Rohok for the next part of the quest at (Hellfire Peninsula - Thrallmar; "..YELLOW.."53,38"..PREV..")...";
L["Quest_10755_RewardText"] = "1";
...
L["Quest_10888_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
...
L["Quest_11002_Note"] = "Only one person in the raid can win the head to start this quest. Force Commander Danath Trollbane is at "..YELLOW.."57,67"..PREV..".";
...
L["Quest_11003_Note"] = "Only one person in the raid can win the head to start this quest. Nazgrel is at "..YELLOW.."55,36"..PREV..".";
...
L["Quest_9738_Location"] = "Watcher Jhang (Coilfang Reservoir; "..YELLOW.."52,36"..PREV..")";
L["Quest_9738_Note"] = "Watcher Jhang is in the underwater cavern at the summoning stone. Earthbinder Rayge is at "..YELLOW.."[3]"..PREV..", Windcaller Claw is at "..YELLOW.."[4]"..PREV..". The prequests do not appear to be necessary to obtain this quest.";
L["Quest_9738_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_11368_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11368_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nQuagmirran is at "..YELLOW.."[7]"..PREV..".";
L["Quest_11368_RewardText"] = "1(x2)";
...
L["Quest_10901_Location"] = "Skar'this the Heretic  (Slave Pens; "..YELLOW.."Heroic [3]"..PREV..")";
L["Quest_10901_Note"] = "The Earthen Signet drops off Gruul in "..YELLOW.."Gruul's Lair"..PREV.." and the Blazing Signet drops off Nightbane at "..YELLOW.."[15]"..PREV..".\n\nThis quest used to be required to enter Serpentshrine Cavern, but is no longer necessary.";
...
L["Quest_11696_Location"] = "Numa Cloudsister (Slave Pens; "..YELLOW.."Just inside the portal"..PREV..")";
L["Quest_11696_Note"] = "Luma Skymother is near "..YELLOW.."[1]"..PREV..". You don't have to do any of the other seasonal quests to obtain this quest. The prequest is optional.";
...
L["Quest_11691_Location"] = "Luma Skymother (Slave Pens; "..YELLOW.."Near [1]"..PREV..")";
L["Quest_11691_Note"] = "The Ice Stone is a short distance from Luma Skymother. Completing this quest summons Ahune at "..YELLOW.."[1]"..PREV..". It can be done once a day per character.";
...
L["Quest_11972_Note"] = "Luma Skymother is at (Slave Pens; "..YELLOW.."Near [1]"..PREV.."). This item will only drop once a year per character.";
...
L["Quest_9763_Location"] = "Watcher Jhang (Coilfang Reservoir; "..YELLOW.."52,36"..PREV..")";
L["Quest_9763_Note"] = "Watcher Jhang is in the underwater cavern at the summoning stone. Warlord Kalithresh is at "..YELLOW.."[4]"..PREV..". Make sure to destroy the Tanks when Kalithresh uses them.";
L["Quest_9763_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10885_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
L["Quest_10885_Note"] = "Requires Heroic Dungeon Difficulty. Murmur is at "..YELLOW.."[5]"..PREV..". Kalithresh's Trident comes from The Steamvault.\n\nThis quest used to be required to enter Tempest Keep: The Eye, but is no longer necessary.";
...
L["Quest_9832_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
L["Quest_9832_Note"] = "Part of the Karazhan attunement line. The Arcane Container is at "..YELLOW.."[2]"..PREV..". Opening it will spawn an elemental that must be killed to get the fragment. The Second Key Fragment is in The Steamvault.";
L["Quest_9832_PreQuest"] = "Entry Into Karazhan ("..YELLOW.."Auch: Shadow Labyrinth"..PREV..")";
...
L["Quest_11370_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11370_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nWarlord Kalithresh is at "..YELLOW.."[4]"..PREV..".";
L["Quest_11370_RewardText"] = "1(x2)";
...
L["Quest_9717_Location"] = "T'shu (Zangarmarsh - Sporeggar; "..YELLOW.."19,49"..PREV..")";
L["Quest_9717_Note"] = "You must be Neutral with Sporeggar to pick up this quest. The Underspore Frond is just behind Hungarfen, located at "..YELLOW.."[1]"..PREV..".";
L["Quest_9717_RewardText"] = "1";
...
L["Quest_11369_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_9715_Location"] = "Gzhun'tt (Zangarmarsh - Sporeggar; "..YELLOW.."19,50"..PREV..")";
...
L["Quest_10164_Location"] = "Greatfather Aldrimus (Terokkar Forest; "..YELLOW.."35,65"..PREV..")";
L["Quest_10164_Note"] = "Exarch Maladarr is Located at "..YELLOW.."[2]"..PREV..". The prequest line starts from Ha'lei (Terokkar Forest - Auchindoun; "..YELLOW.."35,65"..PREV..").";
L["Quest_10164_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11374_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_10167_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
...
L["Quest_10168_Note"] = "D'ore appears after Exarch Maladarr has been killed. Mother Kashur is at (Nagrand; "..YELLOW.."26,61"..PREV.."). Get a group of 3 or more people before taking on the Ancient Orc Spirits.";
...
L["Quest_10216_Location"] = "Artificer Morphalius (Terokkar Forest - Auchindoun; "..YELLOW.."39,58"..PREV..")";
L["Quest_10216_Note"] = "Ethereal Transporter Control Panel is at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10218_Location"] = "Cryo-Engineer Sha'heen (Mana Tombs; "..YELLOW.."[4]"..PREV..")";
L["Quest_10218_Note"] = "To summon Cryo-Engineer Sha'heen, click on the Ethereal Transporter Control Panel at "..YELLOW.."[4]"..PREV..". He'll spawn along with several other friendly Consortium NPCs.  The entire instance should be cleared before hand. Leave nothing alive. The escort can only be attempted once per instance.";
L["Quest_10218_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10165_Location"] = "Nexus-Prince Haramand (Terrokar Forest - Auchindoun; "..YELLOW.."39,58"..PREV..").";
L["Quest_10165_Note"] = "Nexus-Prince Shaffar is at "..YELLOW.."[5]"..PREV..".";
L["Quest_10165_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10977_Note"] = "Requires Heroic Dungeon Difficulty. There are two Stasis Chambers. The first is just beyond Pandemonius "..YELLOW.."[1]"..PREV..". The second is in Nexus-Prince Shaffar's room "..YELLOW.."[5]"..PREV..". You'll need a Mark of the Nexus-King for each.";
L["Quest_10977_RewardText"] = "1(x5)";
...
L["Quest_11373_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11373_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nNexus-Prince Shaffar is at "..YELLOW.."[5]"..PREV..".";
L["Quest_11373_RewardText"] = "1(x2)";
...
L["Quest_10097_Location"] = "Isfar (Terokkar Forest - Auchindoun; "..YELLOW.."44,65"..PREV..")";
L["Quest_10097_Note"] = "Darkweaver Syth is at "..YELLOW.."[1]"..PREV..". Lakka is in a cage in the same room. Openning her cage does not spawn enemies.";
L["Quest_10097_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10098_Location"] = "Isfar (Terokkar Forest - Auchindoun; "..YELLOW.."44,65"..PREV..")";
L["Quest_10098_Note"] = "Terokk's Mask drops off Darkweaver Syth at "..YELLOW.."[1]"..PREV..", the Saga of Terokk is found at "..YELLOW.."[2]"..PREV.." and Terokk's Quill drops from Talon King Ikiss at "..YELLOW.."[3]"..PREV..".";
L["Quest_10098_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_11001_Location"] = "Morthis Whisperwing (Zangarmarsh - Cenarion Refuge; "..YELLOW.."80,65"..PREV..")";
L["Quest_11001_Note"] = "Requires Heroic Dungeon Difficulty. This is the last quest in the Druid Swift Flight Form questline. The Raven God Anzu is summoned at "..YELLOW.."[2]"..PREV.." with materials provided by the quest giver.";
L["Quest_11001_RewardText"] = "1";
...
L["Quest_11372_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_11372_RewardText"] = "1(x2)";

L["Quest_10178_Name"] = "Find Spy To'gun";
L["Quest_10178_Objective"] = "Locate Spy To'gun in the Shadow Labyrinth of Auchindoun.";
L["Quest_10178_Location"] = "Spy Grik'tha (Terokkar Forest - Auchindoun; "..YELLOW.."40,72"..PREV..")";
L["Quest_10178_Note"] = "To'gun is at "..YELLOW.."[1]"..PREV..", and also shows on minimap";
...
L["Quest_10091_Location"] = "Spy To'gun (Shadow Labyrinth; "..YELLOW.."[1]"..PREV..")";
L["Quest_10091_Note"] = "Soul Devices are the dark purple orbs that can be found scattered around the instance. Spymistress Mehlisah Highcrown is at (Shattrath City - Terrace of Light; "..YELLOW.."51,45"..PREV..")";
L["Quest_10091_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_10649_Location"] = "Altruis the Sufferer (Nagrand; "..YELLOW.."27,43"..PREV..")";
L["Quest_10649_Note"] = "Blackheart the Inciter is at "..YELLOW.."[3]"..PREV..". This is the last part of a chain quest that starts in Shadowmoon Valley at "..YELLOW.."61,28"..PREV.." for Aldor and "..YELLOW.."55,58"..PREV.." for Scryer";
...
L["Quest_10177_Location"] = "Spymistress Mehlisah Highcrown (Shattrath City - Terrace of Light; "..YELLOW.."51,45"..PREV..")";
L["Quest_10177_Note"] = "Field Commander Mahfuun is at (Terrokar Forest - Auchindoun; "..YELLOW.."40,72"..PREV.."), just out the Shadow Labyrinth entrance.";
...
L["Quest_10094_Location"] = "Field Commander Mahfuun (Terrokar Forest - Auchindoun; "..YELLOW.."40,72"..PREV..")";
L["Quest_10094_Note"] = "The Codex of Blood is just in front of Grandmaster Vorpil at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10095_Location"] = "The Codex of Blood (Shadow Labyrinth; "..YELLOW.."[4]"..PREV..")";
L["Quest_10095_Note"] = "Murmur is at "..YELLOW.."[5]"..PREV..". Spymistress Mehlisah Highcrown is at (Shattrath City - Terrace of Light; "..YELLOW.."51,45"..PREV..")";
L["Quest_10095_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_9831_Note"] = "Part of the Karazhan attunement line. The Arcane Container is next to Murmur at "..YELLOW.."[5]"..PREV..". Opening it will spawn an elemental that must be killed to get the fragment.";
...
L["Quest_10666_Location"] = "David Wayne (Terokkar Forest - Wayne's Refuge; "..YELLOW.."78,39"..PREV..").";
L["Quest_10666_Note"] = "Grandmaster Vorpil is at "..YELLOW.."[4]"..PREV..". Completing this quest along with Fresh from the Mechanar ("..YELLOW.."TK: The Mechanar"..PREV..") will open up two new quests from David Wayne.\n\nThe item will not drop in Heroic mode.";
...
L["Quest_11375_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_10445_Location"] = "Soridormi (Tanaris - Caverns of Time; "..YELLOW.."58,57"..PREV.."). NPC walks around the area.";
L["Quest_10445_Note"] = "This quest is needed for attunement for Battle of Mount Hyjal. Kael'thas Sunstrider is at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10944_Note"] = "Akama is at (Shadowmoon Valley - Warden's Cage; "..YELLOW.."58,48"..PREV..").\n\nThis is part of the Black Temple attunement questline that starts from Anchorite Ceyla (Shadowmoon Valley - Altar of Sha'tar; "..YELLOW.."62,38"..PREV..") for Aldor and Arcanist Thelis (Shadowmoon Valley - Sanctum of the Stars; "..YELLOW.."56,59"..PREV..") for Scryers.";
L["Quest_10944_PreQuest"] = "Tablets of Baa'ri -> Akama's Promise";
L["Quest_10944_FollowQuest"] = "Ruse of the Ashtongue ("..YELLOW.."The Eye"..PREV..")";
...
L["Quest_10296_Location"] = "Andormu (Tanaris - Caverns of Time; "..YELLOW.."58,54"..PREV..")";
...
L["Quest_10297_Location"] = "Sa'at (Black Morass; "..YELLOW.."Entrance"..PREV..")";
...
L["Quest_10298_Location"] = "Andormu (Tanaris - Caverns of Time; "..YELLOW.."58,54"..PREV..")";
L["Quest_10298_Note"] = "";
...
L["Quest_9836_Location"] = "Khadgar (Shatrath City - Terrace of Light; "..YELLOW.."54,44"..PREV..")";
...
L["Quest_10902_Location"] = "Lorokeem (Shattrath City - Lower City; "..YELLOW.."46,23"..PREV..")";
...
L["Quest_11382_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_10947_Location"] = "Akama (Shadowmoon Valley - Warden's Cage; "..YELLOW.."58,48"..PREV..")";
L["Quest_10947_Note"] = "Part of the Black Temple attunement line. Rage Winterchill is at "..YELLOW.."[1]"..PREV..".";
L["Quest_10947_PreQuest"] = "Ruse of the Ashtongue ("..YELLOW.."The Eye"..PREV..")";
...
L["Quest_10282_Location"] = "Andormu (Tanaris - Caverns of Time; "..YELLOW.."58,54"..PREV..")";
...
L["Quest_10283_Location"] = "Erozion (Old Hillsbrad; "..YELLOW.."Entrance"..PREV..")";
L["Quest_10283_Note"] = "Thrall is at "..YELLOW.."[2]"..PREV..". Go to Southshore to hear the story of Ashbringer and see some people with familiar names like Kel'Thuzad and Herod the Bully.";
...
L["Quest_10284_Location"] = "Thrall (Old Hillsbrad; "..YELLOW.."[2]"..PREV..")";
...
L["Quest_10285_Note"] = "Andormu is at (Tanaris - Caverns of Time; "..YELLOW.."58,54"..PREV.."). Completing this quest allows you to enter Black Morass.";
...
L["Quest_11378_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11378_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nEpoch Hunter is at "..YELLOW.."[5]"..PREV..".";
...
L["Quest_12513_Location"] = "Don Carlos (Tanaris; "..YELLOW.."54,29"..PREV..")";
L["Quest_12513_Note"] = "Don Carlos patrols the road near "..YELLOW.."[??]"..PREV..".";
L["Quest_12513_RewardText"] = "1";

L["Quest_9840_Name"] = "Assessing the Situation";
L["Quest_9840_Objective"] = "Find Koren inside Karazhan.";
L["Quest_9840_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9840_Note"] = "Koren is located inside Karazhan, just past Attumen the Huntsman at "..YELLOW.."[6]"..PREV..".";
...
L["Quest_9843_Location"] = "Koren (Karazhan; "..YELLOW.."[6]"..PREV..")";
L["Quest_9843_Note"] = "The log is in the second room in the hall leading to Maiden of Virtue at "..YELLOW.."[10]"..PREV..", on a table. Archmage Alturus is at (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..").";
...
L["Quest_9844_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9844_Note"] = "Prince Malchezaar is at "..YELLOW.."[26]"..PREV..".";
...
L["Quest_9860_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9860_Note"] = "Archmage Cedric is at (Alterac Mountains - Dalaran; "..YELLOW.."15,54"..PREV..")";
L["Quest_9860_RewardText"] = "1";
...
L["Quest_9630_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9630_Note"] = "Requires Honored with The Violet Eye. Wravien is located in the Guardians Library beyond The Curator at "..YELLOW.."[17]"..PREV..".";
...
L["Quest_9638_Location"] = "Wravien (Karazhan; "..YELLOW.."[17]"..PREV..")";
L["Quest_9638_Note"] = "Gradav is in the same room as Wravien at "..YELLOW.."[18]"..PREV..".";
...
L["Quest_9639_Location"] = "Gradav (Karazhan; "..YELLOW.."[18]"..PREV..")";
L["Quest_9639_Note"] = "Kamsis is in the same room as Gradav at "..YELLOW.."[19]"..PREV..".";
...
L["Quest_9640_Location"] = "Kamsis (Karazhan; "..YELLOW.."[19]"..PREV..")";
L["Quest_9640_Note"] = "Shade of Aran drops the journal at "..YELLOW.."[21]"..PREV..".";
...
L["Quest_9645_Location"] = "Kamsis (Karazhan; "..YELLOW.."[19]"..PREV..")";
L["Quest_9645_Note"] = "Archmage Alturus is at (Deadwind Pass; "..YELLOW.."47,75"..PREV.."). No combat involved. Enjoy the show.";
...
L["Quest_9680_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9680_Note"] = "The Charred Bone Fragment is located at "..YELLOW.."44,78"..PREV.." in Deadwind Pass";
...
L["Quest_9631_Location"] = "Archmage Alturus (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..")";
L["Quest_9631_Note"] = "Kalynna Lathred is at (Netherstorm - Area 52; "..YELLOW.."32,63"..PREV..").";
...
L["Quest_9644_Location"] = "Kalynna Lathred (Netherstorm - Area 52; "..YELLOW.."32,63"..PREV..")";
L["Quest_9644_Note"] = "Nightbane is summoned at "..YELLOW.."[15]"..PREV..". Return to Archmage Alturus at (Deadwind Pass - Karazhan; "..YELLOW.."47,75"..PREV..") to turn in.";
L["Quest_9644_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_12616_Note"] = "This quest was only available during the Scourge Invasion Event in Late October and Early November of 2008.\n\nTo complete the quest, use the scrolls behind Prince Tenris Mirkblood, who is in the Servants Chambers above Attumen the Huntsmen ("..YELLOW.."[5]"..PREV.."). As with opening a chest, if another player is using the scrolls your quest might not complete. Try again until it does.";
L["Quest_12616_RewardText"] = "1";
...
L["Quest_10882_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
L["Quest_10882_Note"] = "There is a chain quest that starts in Netherstorm from Nether-Stalker Khay'ji located at (Netherstorm - Area 52; "..YELLOW.."32,64"..PREV..").";
L["Quest_10882_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_10705_Location"] = "Akama (Shadowmoon Valley - Warden's Cage; "..YELLOW.."58,48"..PREV..")";
L["Quest_10705_Note"] = "Seer Udalo is at "..YELLOW.."[5]"..PREV..", just before the room with the final boss.\n\nThis is part of the Black Temple attunement questline that starts from Anchorite Ceyla (Shadowmoon Valley - Altar of Sha'tar; "..YELLOW.."62,38"..PREV..") for Aldor and Arcanist Thelis (Shadowmoon Valley - Sanctum of the Stars; "..YELLOW.."56,59"..PREV..") for Scryers.";
...
L["Quest_10886_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
L["Quest_10886_Note"] = "This quest must be completed in Heroic dungeon difficulty. Millhouse Manastorm is in the room with Warden Mellichar at "..YELLOW.."[6]"..PREV..".\n\nThis quest used to be required to enter Tempest Keep: The Eye, but is no longer necessary.";
...
L["Quest_11388_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11388_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nHarbinger Skyriss is at "..YELLOW.."[6]"..PREV..".";
L["Quest_11388_RewardText"] = "1(x2)";
...
L["Quest_10704_Location"] = "A'dal (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..")";
...
L["Quest_10704_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_10257_Location"] = "Archmage Vargoth (Netherstorm - Kirin'Var Village; "..YELLOW.."58,86"..PREV..")";
L["Quest_10257_Note"] = "Commander Sarannis is at "..YELLOW.."[1]"..PREV..". The keystone will drop on Normal and Heroic.";
...
L["Quest_10897_Location"] = "Lauranna Thar'well (Zangarmarsh - Cenarion Refuge; "..YELLOW.."80,64"..PREV..")";
L["Quest_10897_Note"] = "Alchemist quest. High Botanist Freywinn is at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_11384_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_10665_Location"] = "David Wayne (Terokkar Forest - Wayne's Refuge; "..YELLOW.."78,39"..PREV..").";
...
L["Quest_11386_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
...
L["Quest_11337_Location"] = "Alliance Brigadier General:\n   Shattrath: Lower City - "..YELLOW.."66.6, 34.6"..PREV.."\n   Stormwind: Stormwind Keep - "..YELLOW.."79.4, 18.0"..PREV.."\n   Ironforge: Military Ward - "..YELLOW.."69.8, 90.0"..PREV.."\n   Darnassus: Warrior's Terrace - "..YELLOW.."57.8, 34.6"..PREV.."\n   Exodar: The Vault of Lights - "..YELLOW.."24.6, 55.4";
...
L["Quest_11341_Location"] = "Horde Warbringer:\n   Shattrath: Lower City - "..YELLOW.."67.0, 56.7"..PREV.."\n   Orgrimmar: Valley of Honor - "..YELLOW.."79.8, 30.3"..PREV.."\n   Thunder Bluff: The Hunter Rise - "..YELLOW.."55.8, 76.6"..PREV.."\n   Undercity: The Royal Quarter - "..YELLOW.."60.7, 87.8"..PREV.."\n   Silvermoon: Farstriders Square - "..YELLOW.."97.0, 38.3";
...
L["Quest_10946_Location"] = "Akama (Shadowmoon Valley - Warden's Cage; "..YELLOW.."58,48"..PREV..")";
...
L["Quest_11007_Note"] = "A'dal is at (Shattrath City - Terrace of Light; "..YELLOW.."53,43"..PREV..").";
...
L["Quest_10958_Location"] = "Xi'ri (Shadowmoon Valley; "..YELLOW.."65,44"..PREV..").";
L["Quest_10958_Note"] = "Spirit of Olum is up and to your left once you enter the Black Temple at "..YELLOW.."[1]"..PREV..". He will teleport you to Seer Kanai once you've High Warlord Naj'entus at "..YELLOW.."[2]"..PREV.." and Supremus at "..YELLOW.."[3]"..PREV..".";
...
L["Quest_10957_Location"] = "Seer Kanai (Black Temple; "..YELLOW.."[5]"..PREV..").";
L["Quest_10957_Note"] = "Shade of Akama is at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_10959_Location"] = "Seer Kanai (Black Temple; "..YELLOW.."[5]"..PREV..").";
L["Quest_10959_Note"] = "Illidan Stormrage is at "..YELLOW.."[11]"..PREV..".";
...
L["Quest_11132_Location"] = "Budd Nedreck (Ghostlands - Hatchet Hills; "..YELLOW.."70,67"..PREV..")";
L["Quest_11132_Note"] = "Found on the right ramp near High Priest Nalorakk at "..YELLOW.."[1]"..PREV..". The prequest is optional and starts from Griftah at (Shattrath City - Lower City; "..YELLOW.."65,69"..PREV..").";
L["Quest_11132_RewardText"] = "1";
...
L["Quest_11166_Location"] = "Budd Nedreck (Ghostlands - Hatchet Hills; "..YELLOW.."70,67"..PREV..")";
L["Quest_11166_Note"] = "Halazzi's Chamber is at "..YELLOW.."[4]"..PREV..", Jan'alai's Platform is at "..YELLOW.."[3]"..PREV.." and Akil'zon's Platform is at "..YELLOW.."[2]"..PREV..". \n\nReportedly, the bosses do not need to be faught in order to get quest credit. Just get near them without aggroing.";
...
L["Quest_11171_Location"] = "Budd Nedreck (Ghostlands - Hatchet Hills; "..YELLOW.."70,67"..PREV..")";
L["Quest_11171_Note"] = "Hex Lord Malacrass is at "..YELLOW.."[6]"..PREV..".";
L["Quest_11171_RewardText"] = "1(x5)";
...
L["Quest_11164_Location"] = "Prigmon (Ghostlands - Hatchet Hills; "..YELLOW.."71,68"..PREV..")";
...
L["Quest_11165_Location"] = "Prigmon (Ghostlands - Hatchet Hills; "..YELLOW.."71,68"..PREV..")";
L["Quest_11165_Note"] = "Zungam is in a hut at "..YELLOW.."[5]"..PREV..". After you release him, he gives you the followup quest.";
...
L["Quest_11195_Location"] = "Zungam (Zul'Aman; "..YELLOW.."[5]"..PREV..")";
L["Quest_11195_Note"] = "Griftah is at (Shattrath City - Lower City; "..YELLOW.."65,69"..PREV..").";
L["Quest_11195_RewardText"] = "1";
...
L["Quest_11178_Location"] = "Blood of Zul'jin (drops from Zul'jin; "..YELLOW.."[7]"..PREV..")";
...
L["Quest_11163_Location"] = "Donna Brascoe (Ghostlands - Hatchet Hills; "..YELLOW.."70,68"..PREV..")";
L["Quest_11163_Note"] = "";
L["Quest_11163_RewardText"] = "1(x10)";
...
L["Quest_11098_Location"] = "Yuula (Shattrath City; "..YELLOW.."65,42"..PREV..")";
...
L["Quest_11008_Location"] = "Sky Sergeant Doryn (Terrokar Forest - Blackwing Landing; "..YELLOW.."65,66"..PREV..")";
...
L["Quest_11093_Location"] = "Skyguard Handler Deesak (Terrokar Forest - Blackwing Landing; "..YELLOW.."63,66"..PREV..")";
...
L["Quest_11004_Location"] = "Severin (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11005_Location"] = "Sky Commander Adaris (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11021_Note"] = "Sky Commander Adaris is at Terrokar Forest - Blackwing Landing ("..YELLOW.."64,66"..PREV..").";
...
L["Quest_11024_Location"] = "Sky Commander Adaris (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
L["Quest_11024_Note"] = "Rilak the Redeemed is at Shattrath City - Lower City ("..YELLOW.."52,20"..PREV..").";
...
L["Quest_11028_Location"] = "Rilak the Redeemed (Shattrath City - Lower City; "..YELLOW.."52,20"..PREV..")";
L["Quest_11028_Note"] = "Sky Commander Adaris is at Terrokar Forest - Blackwing Landing ("..YELLOW.."64,66"..PREV.."). Hazzik, who is nearby, will give you the followup quest.";
...
L["Quest_11056_Location"] = "Hazzik (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11029_Location"] = "Hazzik (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11885_Location"] = "Hazzik (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11073_Location"] = "Sky Commander Adaris (Terrokar Forest - Blackwing Landing; "..YELLOW.."64,66"..PREV..")";
...
L["Quest_11073_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11499_Location"] = "Wind Trader Zhareem (Shattrath City - Lower City; "..YELLOW.."75.0, 36.8"..PREV..")";
L["Quest_11499_Note"] = "One of many Daily Quests that can be available each day from this NPC.  Requires Heroic Difficulty.\n\nPrince Kael'thas Sunstrider is at "..YELLOW.."[6]"..PREV..".";
...
L["Quest_11488_Location"] = "Exarch Larethor (Isle of Quel'Danas - Shattered Sun Staging Area; "..YELLOW.."47,31"..PREV..")";
L["Quest_11488_Note"] = "Tyrith is inside the instance at "..YELLOW.."[2]"..PREV..". This questline unlocks heroic mode.\n\nThe prequest is available from either Adyen the Lightwarden (Shattrath City - Aldor Rise; "..YELLOW.."35,36"..PREV..") or Dathris Sunstriker (Shattrath City - Scryers Tier; "..YELLOW.."55,80"..PREV..").";
...
L["Quest_11490_Location"] = "Tyrith (Magisters' Terrace; "..YELLOW.."[2]"..PREV..")";
L["Quest_11490_Note"] = "The Scrying Orb is at "..YELLOW.."[4]"..PREV..". After the 'movie' clip, Kalecgos will appear to start the next quest.";
...
L["Quest_11492_Location"] = "Kalecgos (Magisters' Terrace; "..YELLOW.."[4]"..PREV..")";
L["Quest_11492_Note"] = "Prince Kael'thas Sunstrider is at "..YELLOW.."[6]"..PREV..". Completing this quest also enables you to do Magisters' Terrace on Heroic mode.\n\nLarethor is at (Isle of Quel'Danas - Shattered Sun Staging Area; "..YELLOW.."47,31"..PREV..").";
...
L["Quest_13149_Location"] = "Chromie (Stratholme Past; "..GREEN.."[1']"..PREV..")";
...
L["Quest_13151_Location"] = "Chromie (Stratholme Past; "..GREEN.."[1']"..PREV..")";
...
L["Quest_13243_Location"] = "Archmage Timear (Dalaran - The Violet Hold; "..YELLOW.."64.2, 54.7"..PREV..")";
...
L["Quest_13243_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13251_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13251_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nMal'Ganis is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13251_RewardText"] = "1(x2)";
...
L["Quest_11252_Location"] = "Defender Mordun (Howling Fjord - Wyrmskull Village; "..YELLOW.."59.3, 48.8"..PREV..")";
L["Quest_11252_Note"] = "Ingvar the Plunderer is at "..YELLOW.."[3]"..PREV..".\n\nThe prequest is optional. The quest turns in to Vice Admiral Keller at (Howling Fjord - Valgarde; "..YELLOW.."60.4, 61.0"..PREV..").";
L["Quest_11252_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";
...
L["Quest_13205_Location"] = "Defender Mordun (Howling Fjord - Wyrmskull Village; "..YELLOW.."59.3, 48.8"..PREV..")";
L["Quest_13205_Note"] = "The Vrykul Weapons can be found along walls scattered around the instance. The prequest comes from Scout Valory (Howling Fjord - Wyrmskull Village; "..YELLOW.."56.0, 55.8"..PREV..") and is optional.";
L["Quest_13205_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11272_Location"] = "High Executor Anselm (Howling Fjord - Vengeance Landing; "..YELLOW.."78.5, 31.1"..PREV..")";
L["Quest_11272_Note"] = "Prince Keleseth is at "..YELLOW.."[1]"..PREV..".\n\nThe prequest line starts at the same NPC.";
L["Quest_11272_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_11262_Location"] = "Dark Ranger Marrah (Utgarde Keep; "..YELLOW.."[A] Entrance"..PREV..")";
L["Quest_11262_Note"] = "Dark Ranger Marrah will appear just inside the portal a few seconds after you enter the instance.\n\nIngvar the Plunderer is at "..YELLOW.."[3]"..PREV..".\n\nThe quest turns in to High Executor Anselm at (Howling Fjord - Vengeance Landing; "..YELLOW.."78.5, 31.1"..PREV..").";
...
L["Quest_13206_Location"] = "Dark Ranger Marrah (Utgarde Keep; "..YELLOW.."[A] Entrance"..PREV..")";
...
L["Quest_13131_Location"] = "Brigg Smallshanks (Utgarde Pinnacle; "..YELLOW.."[A]"..PREV..")";
...
L["Quest_13132_Location"] = "Brigg Smallshanks (Utgarde Pinnacle; "..YELLOW.."[A]"..PREV..")";
...
L["Quest_13241_Location"] = "Archmage Timear (Dalaran - The Violet Hold; "..YELLOW.."64.2, 54.7"..PREV..")";
L["Quest_13241_Note"] = "This is a daily quest.";
L["Quest_13241_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13248_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13248_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nKing Ymiron is at "..YELLOW.."[4]"..PREV..".";
L["Quest_13248_RewardText"] = "1(x2)";
...
L["Quest_13094_Location"] = "Librarian Serrah (Borean Tundra - Transitus Shield; "..YELLOW.."33.4, 34.3"..PREV..")";
L["Quest_13094_Note"] = "The Research Book is on the ground in the hall with the frozen NPCs at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_11905_Location"] = "Archmage Berinand (Borean Tundra - Transitus Shield; "..YELLOW.."32.9, 34.3"..PREV..")";
L["Quest_11905_Note"] = "Use the Interdimensional Refabricator on the edge of the platform where Anomalus is, at "..YELLOW.."[2]"..PREV..".";
...
L["Quest_11973_Location"] = "Raelorasz (Borean Tundra - Transitus Shield; "..YELLOW.."33.2, 34.4"..PREV..")";
...
L["Quest_11911_Location"] = "Archmage Berinand (Borean Tundra - Transitus Shield; "..YELLOW.."32.9, 34.3"..PREV..")";
...
L["Quest_13246_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13246_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nKeristrasza is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13246_RewardText"] = "1(x2)";
...
L["Quest_13095_Location"] = "Librarian Serrah (Borean Tundra - Transitus Shield; "..YELLOW.."33.4, 34.3"..PREV..")";
L["Quest_13095_Note"] = "The Research Book is on the ground in the hall with the frozen NPCs at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_13124_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13128_Note"] = "Ley-Guardian Eregos is at "..YELLOW.."[4]"..PREV..". Raelorasz is at (Borean Tundra - Transitus Shield; "..YELLOW.."33.2, 34.4"..PREV..").";
...
L["Quest_13240_Location"] = "Archmage Timear (Dalaran - The Violet Hold; "..YELLOW.."64.2, 54.7"..PREV..")";
L["Quest_13240_Note"] = "This is a daily quest. You find the Centrifuge Constructs in six different groups between the first and second bosses, at "..YELLOW.."1'"..PREV..".";
L["Quest_13240_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13247_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13247_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nThe Ley Line Tuner comes from the Cache of Eregos at "..YELLOW.."[5]"..PREV..".";
L["Quest_13247_RewardText"] = "1(x2)";
...
L["Quest_24584_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_13182_Location"] = "Kilix the Unraveler (Dragonblight - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13182_Note"] = "The Nerubian Scourge Eggs are in the room of the first boss, Krik'thir the Gatewatcher at "..YELLOW.."[1]"..PREV..".";
L["Quest_13182_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13167_Location"] = "Kilix the Unraveler (Dragonblight - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13167_Note"] = "Anub'arak is at "..YELLOW.."[3]"..PREV..".";
L["Quest_13167_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13254_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13254_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nAnub'arak is at "..YELLOW.."[3]"..PREV..".";
L["Quest_13254_RewardText"] = "1(x2)";
...
L["Quest_13190_Location"] = "Kilix the Unraveler (Dragonblight - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
L["Quest_13190_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nThe Ahn'kahet Brazier is behind Herald Volazj at "..YELLOW.."[6]"..PREV..". The corpse has a 1 hour duration timer and will disappear if you leave the instance while alive.";
...
L["Quest_13204_Note"] = "The Savage Cave Beasts that drop the items for the quest are in the area of the heroic-only boss, Amanitar, at "..YELLOW.."[3]"..PREV..".\n\nKilix the Unraveler is at (Dragonblight - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..").";
...
L["Quest_13187_Location"] = "Kilix the Unraveler (Dragonblight - Azjol-Nerub; "..YELLOW.."26.1, 50.0"..PREV..")";
...
L["Quest_13255_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13255_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nHerald Volazj is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13255_RewardText"] = "1(x2)";
...
L["Quest_13207_Location"] = "Brann Bronzebeard (Ulduar: Halls of Stone; "..YELLOW.."[3]"..PREV..")";
L["Quest_13207_Note"] = "Follow Brann Bronzebeard into the nearby chamber at "..YELLOW.."[4]"..PREV.." and protect him from waves of mobs while he works on the stone tablets there. Upon his success, the Tribunal Chest next to the tablets can be opened.\n\nTalk to him again and he'll run to the door outside "..YELLOW.."[5]"..PREV..". You do not need to follow him, he'll wait for you there. Once defeating Sjonnir the Ironshaper, the quest can be turned into Brahn Bronzebeard.";
...
L["Quest_13252_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13252_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nSjonnir the Ironshaper is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13252_RewardText"] = "1(x2)";
...
L["Quest_13108_Location"] = "King Jokkum (The Storm Peaks - Dun Niffelem; "..YELLOW.."65.3, 60.1"..PREV..")";
L["Quest_13108_Note"] = "Loken is at "..YELLOW.."[4]"..PREV..".\n\nThis quest becomes available after an extremely long questline that starts from Gretchen Fizzlespark (Storm Peaks - K3; "..YELLOW.."41.1, 86.1"..PREV..").";
L["Quest_13108_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13109_Location"] = "King Jokkum (The Storm Peaks - Dun Niffelem; "..YELLOW.."65.3, 60.1"..PREV..")";
L["Quest_13109_Note"] = "Volkhan is at "..YELLOW.."[2]"..PREV..".\n\nThis quest becomes available after an extremely long questline that starts from Gretchen Fizzlespark (Storm Peaks - K3; "..YELLOW.."41.1, 86.1"..PREV..").";
L["Quest_13109_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_13244_Location"] = "Archmage Timear (Dalaran - The Violet Hold; "..YELLOW.."64.2, 54.7"..PREV..")";
L["Quest_13244_Note"] = "This is a daily quest.";
L["Quest_13244_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5"..AQ_AND.."6";
...
L["Quest_13253_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13253_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nLoken is at "..YELLOW.."[4]"..PREV..".";
L["Quest_13253_RewardText"] = "1(x2)";
...
L["Quest_24579_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_12238_Note"] = "Drakuru's Brazier is behind The Prophet Tharon'ja at "..YELLOW.."[6]"..PREV..". Enduring Mojo drops inside Drak'Tharon Keep.";
L["Quest_12238_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_12037_Note"] = "Kurzel is one of the webbed victims at "..YELLOW.."[2]"..PREV..". Attack the webbed victims until you find her.";
...
L["Quest_13129_Location"] = "Kurzel (Drak'Tharon Keep; "..YELLOW.."[2]"..PREV..")";
L["Quest_13129_Note"] = "Novos the Summoner is at "..YELLOW.."[3]"..PREV..". Mack Fearsen is at (Grizzly Hills - Granite Springs; "..YELLOW.."16.6, 48.1"..PREV..")";
...
L["Quest_13249_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13249_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nThe Prophet Tharon'ja is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13249_RewardText"] = "1(x2)";
...
L["Quest_13098_Location"] = "Chronicler Bah'Kini (Zul'Drak - Dubra'Jin; "..YELLOW.."70.0, 20.9"..PREV..")";
...
L["Quest_13098_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13096_Note"] = "Gal'darah is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13096_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13111_Note"] = "The Drakkari Colossus Fragment drops from Drakkari Colossus at "..YELLOW.."[2]"..PREV..".";
L["Quest_13111_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
...
L["Quest_13250_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13250_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nGal'darah is at "..YELLOW.."[5]"..PREV..".";
L["Quest_13250_RewardText"] = "1(x2)";
...
L["Quest_13158_Location"] = "Rhonin (Dalaran - The Violet Citadel; "..YELLOW.."30.5, 48.4"..PREV..")";
L["Quest_13158_Note"] = "Warden Alturas is at (Dalaran - The Violet Hold; "..YELLOW.."60.8, 62.7"..PREV..")";
...
L["Quest_13159_Location"] = "Warden Alturas (Dalaran - The Violet Hold; "..YELLOW.."60.8, 62.7"..PREV..")";
L["Quest_13159_Note"] = "Cyanigosa is at "..YELLOW.."[6]"..PREV..".";
L["Quest_13159_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";
...
L["Quest_13256_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
L["Quest_13256_Note"] = "This daily quest can only be completed on Heroic difficulty.\n\nCyanigosa is at "..YELLOW.."[6]"..PREV..".";
L["Quest_13256_RewardText"] = "1(x2)";
...
L["Quest_13405_Location"] = "Alliance Brigadier General:\n   Wintergrasp: Wintergrasp Fortress - "..YELLOW.."50.0, 14.0"..PREV.." (patrols)\n   Dalaran: The Silver Enclave - "..YELLOW.."29.8, 75.8"..PREV.."\n   Shattrath: Lower City - "..YELLOW.."66.6, 34.6"..PREV.."\n   Stormwind: Stormwind Keep - "..YELLOW.."83.8, 35.4"..PREV.."\n   Ironforge: Military Ward - "..YELLOW.."69.9, 89.6"..PREV.."\n   Darnassus: Warrior's Terrace - "..YELLOW.."57.6, 34.1"..PREV.."\n   Exodar: The Vault of Lights - "..YELLOW.."24.6, 55.4";
...
L["Quest_13407_Location"] = "Horde Warbringer:\n   Wintergrasp: Wintergrasp Fortress - "..YELLOW.."50.0, 14.0"..PREV.." (patrols)\n   Dalaran: Sunreaver's Sanctuary - "..YELLOW.."58.0, 21.1"..PREV.."\n   Shattrath: Lower City - "..YELLOW.."67.0, 56.7"..PREV.."\n   Orgrimmar: Valley of Honor - "..YELLOW.."79.8, 30.3"..PREV.."\n   Thunder Bluff: The Hunter Rise - "..YELLOW.."55.8, 76.6"..PREV.."\n   Undercity: The Royal Quarter - "..YELLOW.."60.7, 87.8"..PREV.."\n   Silvermoon: Farstriders Square - "..YELLOW.."97.0, 38.3";
...
L["Quest_24580_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24582_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24581_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24583_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_13607_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13607_Note"] = "The Celestial Planetarium is at (Ulduar - The Antechamber; "..YELLOW.."[8]"..PREV..").\n\nAfter you turn the quest in to Prospector Doren, he will give you four more quests.";
...
L["Quest_13609_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13609_Note"] = "Hodir is at "..YELLOW.."The Keepers [10]"..PREV..".  He must be killed on Hard Mode for the Sigil to drop.";
...
L["Quest_13610_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13610_Note"] = "Thorim is at "..YELLOW.."The Keepers [11]"..PREV..".  He must be killed on Hard Mode for the Sigil to drop.";
...
L["Quest_13606_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13606_Note"] = "Freya is at "..YELLOW.."The Keepers [12]"..PREV..".  She must be killed on Hard Mode for the Sigil to drop.";
...
L["Quest_13611_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13611_Note"] = "Mimiron is at "..YELLOW.."Spark of Imagination [13]"..PREV..".  He must be killed on Hard Mode for the Sigil to drop.";
...
L["Quest_13614_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13614_Note"] = "Completing this quest allows you to fight Algalon the Observer in the Celestial Planetarium.";
L["Quest_13614_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_13816_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13816_Note"] = "The Celestial Planetarium is at (Ulduar - The Antechamber; "..YELLOW.."[8]"..PREV..").\n\nAfter you turn the quest in to Prospector Doren, he will give you four more quests.";
...
L["Quest_13822_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13822_Note"] = "Hodir is at "..YELLOW.."The Keepers [10]"..PREV..".  He must be killed on Heroic Hard Mode for the Sigil to drop.";
...
L["Quest_13823_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13823_Note"] = "Thorim is at "..YELLOW.."The Keepers [11]"..PREV..".  He must be killed on Heroic Hard Mode for the Sigil to drop.";
...
L["Quest_13821_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13821_Note"] = "Freya is at "..YELLOW.."The Keepers [12]"..PREV..".  She must be killed on Heroic Hard Mode for the Sigil to drop.";
...
L["Quest_13824_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13824_Note"] = "Mimiron is at "..YELLOW.."Spark of Imagination [13]"..PREV..".  He must be killed on Heroic Hard Mode for the Sigil to drop.";
...
L["Quest_13818_Location"] = "Prospector Doren (Ulduar - The Antechamber; "..YELLOW.."[6]"..PREV..")";
L["Quest_13818_Note"] = "Completing this quest allows you to fight Algalon the Observer in the Celestial Planetarium.";
L["Quest_13818_RewardText"] = "1"..AQ_AND.."2";
...
L["Quest_24585_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24587_Note"] = "Ignis the Furnace Master is at "..YELLOW.."The Siege [2]"..PREV..".\n\nRaid Weekly quests can be completed once a week and done on either 10 or 25 man.";
L["Quest_24587_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24586_Note"] = "Razorscale is at "..YELLOW.."The Siege [3]"..PREV..".\n\nRaid Weekly quests can be completed once a week and done on either 10 or 25 man.";
L["Quest_24586_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24588_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_14199_Location"] = "Archmage Lan'dalock (Dalaran - The Violet Hold; "..YELLOW.."57.6, 66.9"..PREV..")";
...
L["Quest_24589_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";
...
L["Quest_24499_Location"] = "Lady Jaina Proudmoore (Forge of Souls; "..YELLOW.."Entrance"..PREV..")";
L["Quest_24499_Note"] = "Turn the quest in to Lady Jaina Proudmoore before at "..YELLOW.."[3]"..PREV.." before you leave the instance.\n\nCompleting this quest is required to enter the Pit of Saron.";
L["Quest_24499_RewardText"] = "1(x2)";
...
L["Quest_24476_Note"] = "The Crucible of Souls is at "..YELLOW.."[3]"..PREV..", near the end of the instance.";
...
L["Quest_24511_Location"] = "Lady Sylvanas Windrunner (Forge of Souls; "..YELLOW.."Entrance"..PREV..")";
L["Quest_24511_Note"] = "Turn the quest in to Lady Sylvanas Windrunner before at "..YELLOW.."[3]"..PREV.." before you leave the instance.\n\nCompleting this quest is required to enter the Pit of Saron.";
L["Quest_24511_RewardText"] = "1(x2)";
...
L["Quest_24560_Note"] = "The Crucible of Souls is at "..YELLOW.."[3]"..PREV..", near the end of the instance.";
...
L["Quest_24683_Location"] = "Lady Jaina Proudmoore (Forge of Souls; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_24498_Location"] = "Lady Jaina Proudmoore (Pit of Saron; "..YELLOW.."[1]"..PREV..")";
L["Quest_24498_Note"] = "The slaves are all over the pit. The quest turns in to Martin Victus at "..YELLOW.."[2]"..PREV.." after Forgemaster Garfrost is slain.";
...
L["Quest_24682_Location"] = "Lady Sylvanas Windrunner (Forge of Souls; "..YELLOW.."[3]"..PREV..")";
...
L["Quest_24507_Location"] = "Lady Sylvanas Windrunner (Pit of Saron; "..YELLOW.."[1]"..PREV..")";
L["Quest_24507_Note"] = "The slaves are all over the pit. The quest turns in to Gorkun Ironskull at "..YELLOW.."[2]"..PREV.." after Forgemaster Garfrost is slain.";
...
L["Quest_24590_RewardText"] = "1(x5)"..AQ_AND.."2(x5)";

L["Quest_24875_Name"] = "Deprogramming";
L["Quest_24875_Objective"] = "Defeat Lady Deathwhisper while ensuring that Darnavan survives.";
L["Quest_24875_Location"] = "Infiltrator Minchar (Icecrown Citadel; "..YELLOW.."Near [1]"..PREV..")";
...
L["Quest_24875_RewardText"] = "1";

L["Quest_24876_Name"] = "Securing the Ramparts";
L["Quest_24876_Objective"] = "Slay the Rotting Frost Giant.";
L["Quest_24876_Location"] = "Skybreaker Lieutenant (Icecrown Citadel; "..GREEN.."[3']"..PREV..")";
...
L["Quest_24878_Location"] = "Alchemist Adrianna (Icecrown Citadel; "..GREEN.."[4']"..PREV..")";
...
L["Quest_24880_Location"] = "Valithria Dreamwalker (Icecrown Citadel; "..YELLOW.."[11]"..PREV..")";
...
L["Quest_24877_Location"] = "Kor'kron Lieutenant (Icecrown Citadel; "..GREEN.."[3']"..PREV..")";
...
L["Quest_26013_Note"] = "Sanctum Guardian Xerestrasza is inside the Ruby Sanctum and appears after you slay the second sub-boss, Baltharius the Warborn at "..YELLOW.."[4]"..PREV..".";
...
L["Quest_26034_Location"] = "Sanctum Guardian Xerestrasza (Ruby Sanctum; "..YELLOW.."[A] Entrance"..PREV..")";
L["Quest_26034_Note"] = "Halion is the main boss, located at "..YELLOW.."[1]"..PREV..".";
L["Quest_26034_RewardText"] = "1(x5)";
