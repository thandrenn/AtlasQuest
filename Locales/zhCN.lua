...
L["Quest_3802_Location"] = "弗兰克罗恩·铸铁（黑石山; "..YELLOW.."副本入口地图[3]"..PREV.."）";
L["Quest_3802_Note"] = "弗兰克罗恩在黑石的中心，在他的墓上方。你必须死亡后才能见到他！和他交谈2次，激活任务。\n弗诺斯·达克维尔在 "..YELLOW.."[9]"..PREV.."。你会在 "..YELLOW.."[7]"..PREV.." 找到神殿。";
...
L["Quest_4136_Location"] = "尤卡·斯库比格特（燃烧平原 - 烈焰峰; "..YELLOW.."65,22"..PREV.."）";
L["Quest_4136_Note"] = "可以直接接到任务，也可以接到前置任务从尤卡·斯库比格特（塔纳利斯 - 热砂港; "..YELLOW.."67,23"..PREV.."）那儿得到。\n雷布里位于 "..YELLOW.."[15]"..PREV.."。";
...
L["Quest_4201_Location"] = "娜玛拉小姐（黑石深渊; "..YELLOW.."[15]"..PREV.."）";
L["Quest_4201_Note"] = "巨型银矿可从艾萨拉的巨人们那里得到。格罗姆之血可以请学习了草药学的玩家帮助寻找。你可以在（安戈洛环形山 - 葛拉卡温泉; "..YELLOW.."31,50"..PREV.."）为瓶子装满水。\n完成任务后，你可以使用后门而不必杀死法拉克斯。";
L["Quest_4201_RewardText"] = "1"..AQ_OR.."2";

L["Quest_4126_Name"] = "霍尔雷·黑须";
L["Quest_4126_Objective"] = "把遗失的雷酒秘方带给卡拉诺斯的拉格纳·雷酒。";
L["Quest_4126_Location"] = "拉格纳·雷酒（丹莫罗 - 卡拉诺斯; "..YELLOW.."46,52"..PREV.."）";
L["Quest_4126_Note"] = "前置任务从恩诺哈尔·雷酒（诅咒之地 - 守望堡; "..YELLOW.."61,18"..PREV.."）处获得。\n如果你在 "..YELLOW.."[15]"..PREV.." 摧毁装有雷霆啤酒的桶，守卫就会出现。秘方就在这其中一个守卫身上。";
...
L["Quest_4262_Location"] = "加琳达（燃烧平原 - 摩根的岗哨; "..YELLOW.."85,69"..PREV.."）";
L["Quest_4262_Note"] = "征服者派隆是副本门口外面的一个火元素精英。在黑石深渊地图的 "..YELLOW.."[24]"..PREV.."，黑石深渊副本入口地图的 "..YELLOW.."[1]"..PREV.."。";
L["Quest_4262_FollowQuest"] = "伊森迪奥斯！";

L["Quest_4263_Name"] = "伊森迪奥斯！";
L["Quest_4263_Objective"] = "在黑石深渊里找到伊森迪奥斯，然后把他干掉！";
L["Quest_4263_Location"] = "加琳达（燃烧平原 - 摩根的岗哨; "..YELLOW.."85,69"..PREV.."）";
L["Quest_4263_Note"] = "在加琳达处获得前置任务。伊森迪奥斯在 "..YELLOW.."[10]"..PREV.."。";
...
L["Quest_4123_Location"] = "麦克斯沃特·尤博格林（燃烧平原 - 烈焰峰; "..YELLOW.."65,23"..PREV.."）";
L["Quest_4123_Note"] = "你可以从 "..YELLOW.."[8]"..PREV.." 的宝箱里找到山脉之心。你必须打开黑色宝库所有的小宝箱出来 Boss 之后才能拿到钥匙。";

L["Quest_4286_Name"] = "好东西";
L["Quest_4286_Objective"] = "到黑石深渊去找到20个黑铁挎包。当你完成任务之后，回到奥拉留斯那里复命。你认为黑石深渊里的黑铁矮人应该会有这些黑铁挎包。";
L["Quest_4286_Location"] = "奥拉留斯（燃烧平原 - 摩根的岗哨; "..YELLOW.."84,68"..PREV.."）";
...
L["Quest_4024_Location"] = "塞勒斯·萨雷芬图斯（燃烧平原; "..YELLOW.."95,31"..PREV.."）";
L["Quest_4024_Note"] = "此系列任务始于卡拉然·温布雷（灼热峡谷; "..YELLOW.."39,38"..PREV.."）。\n 贝尔加在 "..YELLOW.."[11]"..PREV.."。";
...
L["Quest_4341_Location"] = "国王麦格尼·铜须（铁炉堡; "..YELLOW.."39,55"..PREV.."）";
L["Quest_4341_Note"] = "前置任务始于皇家历史学家阿克瑟努斯（铁炉堡; "..YELLOW.."38,55"..PREV.."）。卡兰·巨锤位于 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_4362_Location"] = "国王麦格尼·铜须（铁炉堡; "..YELLOW.."39,55"..PREV.."）";
L["Quest_4362_Note"] = "公主茉艾拉·铜须位于 "..YELLOW.."[21]"..PREV.."。战斗中她可能会治疗达格兰。试着尽可能打断她。但是一定不能让她死掉，否则你的任务将会失败！与她交谈过后，你还要回到麦格尼·铜须那儿去。";
...
L["Quest_7848_Location"] = "洛索斯·天痕（黑石山; "..YELLOW.."副本入口地图[2]"..PREV.."）";
...
L["Quest_9015_Location"] = "法尔林·树影（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1]"..PREV.."）";
...
L["Quest_4083_Location"] = "塞娜尼·雷心（黑石深渊; "..YELLOW.."[18]"..PREV.."）";
L["Quest_4083_Note"] = "只有采矿技能大于230才能接到此任务，这个任务会是你学会如何熔炼黑铁矿石。材料如下：2个[红宝石]，20个[金锭]，10个[真银锭]。完成之后，如果你有[黑铁矿石]你可以在黑熔炉"..YELLOW.."[22]"..PREV.."熔炼黑铁。";
...
L["Quest_4241_Note"] = "这个任务只能在美酒节期间可以接到。任务物品每个角色只可获取一次。\n\n埃菲库格·铁桶在美酒节营地（丹莫罗; "..YELLOW.."47,39"..PREV.."）。";

L["Quest_4134_Name"] = "遗失的雷酒秘方";
L["Quest_4134_Objective"] = "把遗失的雷酒秘方交给卡加斯的薇薇安·拉格雷。";
L["Quest_4134_Location"] = "暗法师薇薇安·拉格雷（荒芜之地 - 卡加斯; "..YELLOW.."2,47"..PREV.."）";
L["Quest_4134_Note"] = "前置任务由药剂师金格（幽暗城 - 炼金房; "..YELLOW.."50,68"..PREV.."）给予。\n秘方在某个守卫身上，只要你破坏 "..YELLOW.."[15]"..PREV.."的酒桶这些守卫就会出现。";
...
L["Quest_4081_Location"] = "通缉（荒芜之地 - 卡加斯; "..YELLOW.."3,47"..PREV.."）";
L["Quest_4081_Note"] = "矮人可在黑石深渊第一部分找到。\n卡加斯的高图斯在瞭望塔顶（荒芜之地; "..YELLOW.."5,47"..PREV.."）。";
...
L["Quest_4082_Location"] = "通缉（荒芜之地 - 卡加斯; "..YELLOW.."3,47"..PREV.."）";
L["Quest_4082_Note"] = "矮人可以在"..YELLOW.."[11]"..PREV.."贝尔加附近被找到。卡加斯的高图斯在瞭望塔顶（荒芜之地; "..YELLOW.."5,47"..PREV.."）。\n任务开始于雷克斯洛特（荒芜之地 - 卡加斯; "..YELLOW.."5,47"..PREV.."）。格拉克·洛克鲁布位置在燃烧平原（"..YELLOW.."38,35"..PREV.."）。要绑定他并开始护送任务（精英），他的生命需要减少到低于50%。";
...
L["Quest_4132_Location"] = "军官高图斯（荒芜之地 - 卡加斯; "..YELLOW.."5,47"..PREV.."）";
L["Quest_4132_Note"] = "安格弗将军位置在 "..YELLOW.."[13]"..PREV.."。注意：当他生命低于30%时，他会召唤帮手！";
...
L["Quest_4063_Location"] = "鲁特维尔·沃拉图斯（荒芜之地; "..YELLOW.."25,44"..PREV.."）";
L["Quest_4063_Note"] = "前置任务来自圣者塞朵拉·穆瓦丹尼（荒芜之地 - 卡加斯; "..YELLOW.."3,47"..PREV.."）。\n你可以在 "..YELLOW.."[14]"..PREV.." 发现阿格曼奇。";
...
L["Quest_3906_Location"] = "桑德哈特（荒芜之地 - 卡加斯; "..YELLOW.."3,48"..PREV.."）";
L["Quest_3906_Note"] = "征服者派隆是副本门口外面的一个火元素精英。在黑石深渊 "..YELLOW.."副本入口地图[1]"..PREV.."。";
L["Quest_3906_FollowQuest"] = "不和谐的火焰";

L["Quest_3907_Name"] = "不和谐的火焰";
L["Quest_3907_Objective"] = "进入黑石深渊并找到伊森迪奥斯。杀掉它，然后把你找到的信息汇报给桑德哈特。";
L["Quest_3907_Location"] = "桑德哈特（荒芜之地 - 卡加斯; "..YELLOW.."3,48"..PREV.."）";
L["Quest_3907_Note"] = "前置任务从塞娜尼·雷心获得，伊森迪奥斯在 "..YELLOW.."[10]"..PREV.."。";
...
L["Quest_7201_Location"] = "暗法师薇薇安·拉格雷（荒芜之地 - 卡加斯; "..YELLOW.."2,47"..PREV.."）";
L["Quest_7201_Note"] = "前置任务来自桑德哈特（荒芜之地 - 卡加斯; "..YELLOW.."3,48"..PREV.."）。派隆就在副本入口处前。\n 每个元素生物都可能会掉落精华。";
...
L["Quest_3981_Location"] = "神射手贾拉玛弗（荒芜之地 - 卡加斯; "..YELLOW.."5,47"..PREV.."）";
...
L["Quest_4003_Location"] = "萨尔（奥格瑞玛; "..YELLOW.."31,37"..PREV.."）";
L["Quest_4003_Note"] = "与卡兰·巨锤和萨尔交谈后，你将得到这个任务。\n达格兰·索瑞森大帝在 "..YELLOW.."[21]"..PREV.."。虽然公主会治疗达格兰，但是如果想完成任务，就一定不要杀死公主。切记，切记！！！尝试打断公主的治疗施法。";
...
L["Quest_8730_Location"] = "堕落的瓦拉斯塔兹（黑翼之巢; "..YELLOW.."[2]"..PREV.."）";
L["Quest_8730_Note"] = "只有一人能拾取碎片。阿纳克洛斯（塔纳利斯 - 时光之穴; "..YELLOW.."65,49"..PREV.."）";
L["Quest_8730_RewardText"] = "1"..AQ_OR.."2";

L["Quest_7781_Name"] = "黑石之王";
L["Quest_7781_Objective"] = "将奈法利安的头颅交给暴风城的瓦里安·乌瑞恩国王。";
L["Quest_7781_Location"] = "奈法利安的头颅掉落自（奈法利安; "..YELLOW.."[10]"..PREV.."）";
L["Quest_7781_Note"] = "瓦里安·乌瑞恩国王（暴风城 - 暴风要塞; "..YELLOW.."80,38"..PREV.."）。接下来前往艾法希比元帅（暴风城 - 英雄谷; "..YELLOW.."71,80"..PREV.."）领取奖励。";
...
L["Quest_8288_Location"] = "勒什雷尔的头颅掉落自（勒什雷尔; "..YELLOW.."[3]"..PREV.."）";
...
L["Quest_7783_Location"] = "奈法利安的头颅掉落自（奈法利安; "..YELLOW.."[9]"..PREV.."）";
L["Quest_7783_Note"] = "下一步前往萨鲁法尔大王（奥格瑞玛 - 力量谷; "..YELLOW.."51,76"..PREV.."）领取奖励。";
...
L["Quest_4788_Location"] = "勘查员詹斯·铁靴（塔纳利斯 - 热砂港; "..YELLOW.."66,23"..PREV.."）";
...
L["Quest_4729_Location"] = "基布雷尔（燃烧平原 - 烈焰峰; "..YELLOW.."65,22"..PREV.."）";
...
L["Quest_4862_Location"] = "基布雷尔（燃烧平原 - 烈焰峰; "..YELLOW.."65,22"..PREV.."）";
...
L["Quest_4866_Location"] = "狼狈不堪的约翰（燃烧平原 - 烈焰峰; "..YELLOW.."65,23"..PREV.."）";
L["Quest_4866_Note"] = "烟网蛛后在 "..YELLOW.."[13]"..PREV.."。如果中毒后解除，那么任务就会失败。";
...
L["Quest_4701_Location"] = "赫林迪斯·河角（燃烧平原 - 摩根的岗哨; "..YELLOW.."5,47"..PREV.."）";
...
L["Quest_4867_Location"] = "瓦罗什（下层黑石塔; "..YELLOW.."[2]"..PREV.."）";
L["Quest_4867_Note"] = "要得到瓦罗什的蟑螂，你必须首先杀死乌洛克 "..YELLOW.."[15]"..PREV.."。要完成召唤，你需要长矛和欧莫克大王的头颅 "..YELLOW.."[5]"..PREV.."。长矛在 "..YELLOW.."[3]"..PREV.."。在召唤出乌洛克之前，会出现几群食人魔，你可以用长矛来伤害它们。";
L["Quest_4867_RewardText"] = "1";

L["Quest_5001_Name"] = "比修的装置";
L["Quest_5001_Objective"] = "找到比修的装置并把它们还给她。祝你好运！";
L["Quest_5001_Location"] = "比修（下层黑石塔; "..YELLOW.."[3]"..PREV.."）";
L["Quest_5001_Note"] = "你可以在前往烟网蛛后的路上找到比修的装置 "..YELLOW.."[13]"..PREV.."。\n麦克斯韦元帅（燃烧平原 - 摩根的岗哨; "..YELLOW.."84,58"..PREV.."）。";
...
L["Quest_5081_Location"] = "麦克斯韦尔（燃烧平原 - 摩根的岗哨; "..YELLOW.."84,58"..PREV.."）";
L["Quest_5081_Note"] = "指挥官沃恩在 "..YELLOW.."[9]"..PREV.."，欧莫克大王在 "..YELLOW.."[5]"..PREV.."，维姆萨拉克在 "..YELLOW.."[19]"..PREV.."。";
...
L["Quest_4742_Location"] = "维埃兰（下层黑石塔; "..YELLOW.."[1]"..PREV.."）";
L["Quest_4742_Note"] = "燃棘宝钻从欧莫克大王 "..YELLOW.."[5]"..PREV.."，尖石宝钻从指挥官沃恩 "..YELLOW.."[9]"..PREV.."，血斧宝钻从维姆萨拉克 "..YELLOW.."[19]"..PREV.."获得。原始晋升印章是黑石塔所有小怪掉落，完成这个之后你就能得到上层黑石塔的钥匙。";
L["Quest_4742_FollowQuest"] = "晋升印章";

L["Quest_5089_Name"] = "达基萨斯将军的命令";
L["Quest_5089_Objective"] = "把达基萨斯将军的命令交给燃烧平原的麦克斯韦尔元帅。";
L["Quest_5089_Location"] = "达基萨斯将军的命令掉落自（维姆萨拉克; "..YELLOW.."[19]"..PREV.."）";
L["Quest_5089_Note"] = "麦克斯韦尔元帅（燃烧平原 - 摩根的岗哨; "..YELLOW.."84,58"..PREV.."）";
L["Quest_5089_FollowQuest"] = "达基萨斯将军之死（"..YELLOW.."上层黑石塔"..PREV.."）";

L["Quest_8966_Name"] = "瓦塔拉克饰品的左瓣";
L["Quest_8966_Objective"] = "使用召唤火盆召唤出莫尔·灰蹄的灵魂，然后杀掉他。完成之后，将召唤火盆与瓦塔拉克饰品的左瓣还给黑石山的伯德雷。";
L["Quest_8966_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
L["Quest_8966_Note"] = "你需要超维度幽灵显形器才能看到伯德雷，你可以从《寻找安泰恩》任务得到它。\n\n莫尔·灰蹄在 "..YELLOW.."[9]"..PREV.." 召唤。";
...
L["Quest_8989_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
L["Quest_8989_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n莫尔·灰蹄在 "..YELLOW.."[9]"..PREV.." 召唤。";
L["Quest_8989_PreQuest"] = "true";
L["Quest_8989_FollowQuest"] = "最后的准备（"..YELLOW.."上层黑石塔"..PREV.."）";

L["Quest_5306_Name"] = "沃什加斯的蛇石";
L["Quest_5306_Objective"] = "到黑石塔去杀死暗影猎手沃什加斯，将沃什加斯的蛇石交给基尔拉姆。";
L["Quest_5306_Location"] = "基尔拉姆（冬泉谷 - 永望镇; "..YELLOW.."61,37"..PREV.."）";
L["Quest_5306_Note"] = "暗影猎手沃什加斯在 "..YELLOW.."[7]"..PREV.."。";
L["Quest_5306_RewardText"] = "1";

L["Quest_5103_Name"] = "火热的死亡";
L["Quest_5103_Objective"] = "世界上一定有人知道关于这副手套的事情，祝你好运！";
L["Quest_5103_Location"] = "人类的残骸（下层黑石塔; "..YELLOW.."[9]"..PREV.."）";
L["Quest_5103_Note"] = "煅造任务。确保从人类残骸 "..YELLOW.."[11]"..PREV.." 附近拿到这个板甲手套，交给玛雷弗斯·暗锤（冬泉谷 - 永望镇; "..YELLOW.."61,39"..PREV.."）。";
...
L["Quest_4724_Location"] = "神射手贾拉玛弗（荒芜之地 - 卡加斯; "..YELLOW.."5,47"..PREV.."）";
...
L["Quest_4981_Location"] = "雷克斯洛特（荒芜之地 - 卡加斯; "..YELLOW.."5,47"..PREV.."）";
...
L["Quest_4982_Location"] = "比修（下层黑石塔; "..YELLOW.."[3]"..PREV.."）";
L["Quest_4982_Note"] = "你可以在在通往烟网蛛后的路上找到比修的装置 "..YELLOW.."[13]"..PREV.."。";
...
L["Quest_4903_Location"] = "高图斯（荒芜之地 - 卡加斯; "..YELLOW.."65,22"..PREV.."）";
L["Quest_4903_Note"] = "欧莫克大王在 "..YELLOW.."[5]"..PREV.."，指挥官沃恩在 "..YELLOW.."[9]"..PREV.."，维姆萨拉克在 "..YELLOW.."[19]"..PREV.."。黑石文件在3个 Boss 的其中一个边上。";
L["Quest_4903_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4"..AQ_OR.."5";
L["Quest_4903_FollowQuest"] = "伊崔格的智慧 -> 为部落而战（"..YELLOW.."上层黑石塔"..PREV.."）";

L["Quest_5160_Name"] = "监护者";
L["Quest_5160_Objective"] = "到冬泉谷去找到哈尔琳，把奥比的鳞片交给她。";
L["Quest_5160_Location"] = "奥比（上层黑石塔; "..YELLOW.."[7]"..PREV.."）";
L["Quest_5160_Note"] = "你可以在竞技场边上的房间找到奥比 "..YELLOW.."[7]"..PREV.."。它呆在一个突出物上面。\n哈尔琳在冬泉谷（"..YELLOW.."54,51"..PREV.."）。在冬泉谷的洞里的最里面通过站在传送符文上从而到她身边。";
L["Quest_5160_FollowQuest"] = "蓝龙之怒";

L["Quest_5047_Name"] = "芬克·恩霍尔，为您效劳！";
L["Quest_5047_Objective"] = "与永望镇的玛雷弗斯·暗锤谈一谈。";
L["Quest_5047_Location"] = "芬克·恩霍尔（上层黑石塔; "..YELLOW.."[8]"..PREV.."）";
L["Quest_5047_Note"] = "芬克·恩霍尔会在拨完比斯巨兽的皮后出现。玛雷弗斯·暗锤（冬泉谷 - 永望镇; "..YELLOW.."61,38"..PREV.."）。";
L["Quest_5047_FollowQuest"] = "阿卡纳护腿，血色学者之帽，嗜血胸甲";

L["Quest_4734_Name"] = "冷冻龙蛋";
L["Quest_4734_Objective"] = "在孵化间对着某颗龙蛋使用龙蛋冷冻器初号机。";
L["Quest_4734_Location"] = "丁奇·斯迪波尔（燃烧平原 - 烈焰峰; "..YELLOW.."65,24"..PREV.."）";
L["Quest_4734_Note"] = "你可以在烈焰之父的房间找到龙蛋 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_6821_Location"] = "海达克西斯公爵（艾萨拉; "..YELLOW.."79,73"..PREV.."）";
L["Quest_6821_Note"] = "你可以找到艾博希尔在 "..YELLOW.."[1]"..PREV.."。\n\n补丁3.0.8之后，将不能开始这个任务线。如果你已经有了这个任务，依然可以完成。";
...
L["Quest_5102_Location"] = "麦克斯韦尔元帅（燃烧平原 - 摩根的岗哨; "..YELLOW.."82,68"..PREV.."）";
L["Quest_5102_Note"] = "达基萨斯将军在 "..YELLOW.."[9]"..PREV.."。";
...
L["Quest_4764_Location"] = "玛亚拉·布莱特文（燃烧平原 - 摩根的岗哨; "..YELLOW.."84,69"..PREV.."）";
L["Quest_4764_Note"] = "你可以接到这个任务的前置任务，从雷明顿·瑞治维尔伯爵（暴风城 - 暴风要塞; "..YELLOW.."77,47"..PREV.."）。末日扣环在烈焰之父的房间 "..YELLOW.."[3]"..PREV.." 的一个箱子里。";
...
L["Quest_7761_Location"] = "黑手的命令掉落自（"..YELLOW.."副本入口地图[7]"..PREV.."）裂盾军需官。";
L["Quest_7761_Note"] = "黑翼之巢的进门任务。你可以在黑石塔副本的门口右侧附近找到裂盾军需官，宝珠就在达基萨斯将军 "..YELLOW.."[9]"..PREV.." 身后。";

L["Quest_8994_Name"] = "最后的准备";
L["Quest_8994_Objective"] = "从黑石塔的兽人那儿收集40副黑石护腕，把它们和一瓶超级能量合剂一起交给黑石山的伯德雷。";
L["Quest_8994_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
...
L["Quest_8995_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
L["Quest_8995_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。召唤瓦塔拉克公爵在 "..YELLOW.."[8]"..PREV.."。向伯德雷回复领取奖励。";
...
L["Quest_5127_Location"] = "罗拉克斯（冬泉谷; "..YELLOW.."64,74"..PREV.."）";
L["Quest_5127_Note"] = "煅造任务。古拉鲁克在 "..YELLOW.."[5]"..PREV.."。";
...
L["Quest_4735_Location"] = "丁奇·斯迪波尔（燃烧平原 - 烈焰峰; "..YELLOW.."65,24"..PREV.."）";
L["Quest_4735_Note"] = "这些龙蛋就在烈焰之父"..YELLOW.."[2]"..PREV.."的房间里。";
L["Quest_4735_PreQuest"] = "true";
L["Quest_4735_FollowQuest"] = "莱尼德·巴萨罗梅 -> 黎明先锋（"..YELLOW.."通灵学院"..PREV.."）";

L["Quest_4768_Name"] = "黑暗石板";
L["Quest_4768_Objective"] = "将黑暗石板交给卡加斯的暗法师薇薇安·拉格雷。";
L["Quest_4768_Location"] = "薇薇安·拉格雷（荒芜之地 - 卡加斯; "..YELLOW.."2,47"..PREV.."）";
L["Quest_4768_Note"] = "你可以接到前置任务从药剂师金格（幽暗城 - 炼金房; "..YELLOW.."50,68"..PREV.."）。黑暗石板在烈焰之父的房间（"..YELLOW.."[3]"..PREV.."）。";
...
L["Quest_4974_Location"] = "萨尔（奥格瑞玛; "..YELLOW.."31,38"..PREV.."）";
L["Quest_4974_Note"] = "大酋长雷德·黑手在 "..YELLOW.."[6]"..PREV.."。";
...
L["Quest_6569_Location"] = "巫女麦兰达（西瘟疫之地; "..YELLOW.."50,77"..PREV.."）";
...
L["Quest_6602_Location"] = "罗卡鲁（凄凉之地 - 葬影村; "..YELLOW.."25,71"..PREV.."）";
L["Quest_6602_Note"] = "奥妮克西亚前置任务最后一步。达基萨斯将军在 "..YELLOW.."[9]"..PREV.."。";
...
L["Quest_214_Location"] = "哨兵瑞尔（西部荒野 - 哨兵岭; "..YELLOW.."56, 47"..PREV.."）";
...
L["Quest_168_Location"] = "维尔德·蓟草（暴风城 - 矮人区; "..YELLOW.."70,41"..PREV.."）";
L["Quest_168_Note"] = "就在你刚要进入副本之前的亡灵 "..YELLOW.."副本入口地图[3]"..PREV.." 掉落矿工工会会员卡。";
L["Quest_168_RewardText"] = "1"..AQ_OR.."2";

L["Quest_167_Name"] = "我的兄弟……";
L["Quest_167_Objective"] = "将工头希斯耐特的探险者协会徽章交给暴风城的维尔德·蓟草。";
L["Quest_167_Location"] = "维尔德·蓟草（暴风城 - 矮人区; "..YELLOW.."70,41"..PREV.."）";
L["Quest_167_Note"] = "就在你刚要进入副本之前的工头希斯奈特 "..YELLOW.."副本入口地图[3]"..PREV.." 掉落矿探险者协会徽章。";
L["Quest_167_RewardText"] = "1";

L["Quest_2040_Name"] = "地底突袭";
L["Quest_2040_Objective"] = "从死亡矿井中带回小型高能发动机，将其带给暴风城矮人区中的沉默的舒尼。";
L["Quest_2040_Location"] = "沉默的舒尼（暴风城 - 矮人区; "..YELLOW.."62,34"..PREV.."）";
L["Quest_2040_Note"] = "你可以直接接到这个任务，你也可以从诺恩那里接到此任务的引导任务（铁炉堡 - 侏儒区; "..YELLOW.."69,50"..PREV.."）。\n斯尼德的伐木机掉落小型高能发动机，位置在 "..YELLOW.."[3]"..PREV.."。";
...
L["Quest_166_Location"] = "格里安·斯托曼（西部荒野 - 哨兵岭 "..YELLOW.."56,47 "..PREV.."）";
L["Quest_166_Note"] = "此系列任务开始于格里安·斯托曼（西部荒野 - 哨兵岭; "..YELLOW.."56,47"..PREV.."）。\n艾德温·范克里夫是死亡矿井的最后一个 Boss。你可以在他的船的最上层找到他，位置在 "..YELLOW.."[6]"..PREV.."。";
...
L["Quest_1654_Location"] = "乔丹·斯迪威尔（丹莫罗 - 铁炉堡 "..YELLOW.."52,36 "..PREV.."）";
L["Quest_1654_Note"] = "点击 "..YELLOW.."[乔丹的武器材料单]"..PREV.." 查看乔丹的武器材料单。";
...
L["Quest_373_Location"] = "未寄出的信掉落自（艾德温·范克里夫; "..YELLOW.."[6]"..PREV.."）";
L["Quest_373_Note"] = "巴隆斯·阿历克斯顿在暴风城光明大教堂旁边 "..YELLOW.."58,49"..PREV.."。";
L["Quest_373_FollowQuest"] = "巴基尔·斯瑞德";

L["Quest_2922_Name"] = "拯救尖端机器人！";
L["Quest_2922_Objective"] = "将尖端机器人的存储器核心交给铁炉堡的工匠大师欧沃斯巴克。";
L["Quest_2922_Location"] = "工匠大师欧沃斯巴克（铁炉堡 - 侏儒区; "..YELLOW.."69,50 "..PREV.."）";
L["Quest_2922_Note"] = "你可以在萨尔努修士（暴风城 - 教堂广场; "..YELLOW.."51,48"..PREV.."）那儿接到此任务的前置任务。\n在你进入副本之前，后门附近 "..YELLOW.."副本入口地图[4]"..PREV.."，可以找到尖端机器人。";
L["Quest_2922_PreQuest"] = "true";

L["Quest_2926_Name"] = "诺恩";
L["Quest_2926_Objective"] = "用空铅瓶对着辐射入侵者或者辐射抢劫者，从它们身上收集放射尘。瓶子装满之后，把它交给卡拉诺斯的奥齐·电环。";
L["Quest_2926_Location"] = "奥齐·电环（丹莫罗 - 卡拉诺斯; "..YELLOW.."45,49 "..PREV.."）";
L["Quest_2926_Note"] = "你可以在诺恩（铁炉堡 - 侏儒区; "..YELLOW.."69,50"..PREV.."）那儿得到此任务的前置任务。\n要得到辐射尘，你必须对 "..RED.."活的"..PREV.." 辐射入侵者或者辐射抢劫者使用空铅瓶。";
...
L["Quest_2962_Location"] = "奥齐·电环（丹莫罗 - 卡拉诺斯; "..YELLOW.."45,49 "..PREV.."）";
L["Quest_2962_Note"] = "要得到辐射尘，你必须对 "..RED.."活的"..PREV.." 辐射泥浆怪，辐射潜伏者，辐射水元素使用沉重的铅瓶。";
L["Quest_2962_PreQuest"] = "诺恩";

L["Quest_2928_Name"] = "陀螺式挖掘机";
L["Quest_2928_Objective"] = "收集24副机械内胆，把它们交给暴风城的舒尼。";
L["Quest_2928_Location"] = "沉默的舒尼（暴风城 - 矮人区; "..YELLOW.."63,34"..PREV.."）";
...
L["Quest_2924_Location"] = "科劳莫特·钢尺（铁炉堡 - 侏儒区; "..YELLOW.."68,46 "..PREV.."）";
L["Quest_2924_Note"] = "你可以在玛希尔（达纳苏斯 - 战士区; "..YELLOW.."59,45"..PREV.."）那儿得到此任务的前置任务。\n每个诺莫瑞根的敌人都可能掉落基础模组。";
L["Quest_2924_PreQuest"] = "true";

L["Quest_2930_Name"] = "抢救数据";
L["Quest_2930_Objective"] = "将彩色穿孔卡片交给铁炉堡的大机械师卡斯派普。";
L["Quest_2930_Location"] = "大机械师卡斯派普（铁炉堡 - 侏儒区; "..YELLOW.."69,48 "..PREV.."）";
L["Quest_2930_Note"] = "你可以在加克希姆·尘链（石爪山脉; "..YELLOW.."59,67"..PREV.."）那儿得到此任务的前置任务。但这不是一个必要的任务。\n白色卡片随机掉落。你可以在进入副本之前紧靠后门入口处 "..YELLOW.."副本入口地图[3]"..PREV.." 找到第一终端。第二个在 "..YELLOW.."[3]"..PREV.."，第三个在 "..YELLOW.."[5]"..PREV.."，而第四个在 "..YELLOW.."[6]"..PREV.."。";
...
L["Quest_2904_Location"] = "克努比（诺莫瑞根 "..YELLOW.."[3]"..PREV.."）";
L["Quest_2904_Note"] = "护送任务！你可以在（荆棘谷 - 藏宝海湾; "..YELLOW.."27,77"..PREV.."）找到斯库提。";
L["Quest_2904_RewardText"] = "1"..AQ_OR.."2";

L["Quest_2929_Name"] = "大叛徒";
L["Quest_2929_Objective"] = "到诺莫瑞根去杀掉麦克尼尔·瑟玛普拉格。完成任务之后向大工匠梅卡托克报告。";
L["Quest_2929_Location"] = "大工匠梅卡托克（铁炉堡 - 侏儒区; "..YELLOW.."68,48"..PREV.."）";
L["Quest_2929_Note"] = "你可以在 "..YELLOW.."[8]"..PREV.." 找到麦克尼尔·瑟玛普拉格。他是诺莫瑞根最后一个 Boss。\n在战斗中你必须按下它旁边的按钮阻止他放炸弹。";
...
L["Quest_2945_Note"] = "这个戒指可以在清洁器5200型中清洁，位置在 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_2947_Note"] = "把它交给塔瓦斯德·基瑟尔（铁炉堡 - 秘法区; "..YELLOW.."36,3"..PREV.."）。奖励的戒指为随机属性。";
...
L["Quest_2951_Location"] = "超级清洁器5200型 （诺莫瑞根 - 清洁区; "..YELLOW.."[2]"..PREV.."）";
L["Quest_2951_Note"] = "所有脏兮兮的东西可以重复此任务。";
L["Quest_2951_RewardText"] = "1";

L["Quest_2843_Name"] = "出发！诺莫瑞根！";
L["Quest_2843_Objective"] = "等斯库提调整好地精传送器。";
L["Quest_2843_Location"] = "斯库提（荆棘谷 - 藏宝海湾; "..YELLOW.."27,77 "..PREV.."）";
L["Quest_2843_Note"] = "你可以在索维克（奥格瑞玛 - 荣誉谷; "..YELLOW.."75,25"..PREV.."）那儿得到此任务的前置任务。\n当你完成这个任务，你可以使用藏宝海湾的传送器。";
...
L["Quest_2841_Location"] = "诺格（奥格瑞玛 - 荣誉谷; "..YELLOW.."75,25 "..PREV.."）";
L["Quest_2841_Note"] = "你可以在 "..YELLOW.."[8]"..PREV.." 发现麦克尼尔·瑟玛普拉格。他是诺莫瑞根最后一个 Boss。\n在战斗中你必须按下它旁边的按钮阻止他放炸弹。";
...
L["Quest_2949_Note"] = "把戒指交给诺格（奥格瑞玛 - 荣誉谷; "..YELLOW.."75,25"..PREV.."）。奖励的戒指为随机属性。";
...
L["Quest_1050_Location"] = "图书馆员麦伊·苍尘（铁炉堡 - 探险者大厅; "..YELLOW.."74,12 "..PREV.."）";
L["Quest_1050_Note"] = "你可以在血色修道院的图书馆奥法师杜安之前左侧一个走廊的地板上（"..YELLOW.."[2]"..PREV.."）找到这本书。";
L["Quest_1050_RewardText"] = "1";

L["Quest_1951_Name"] = "能量仪祭（法师任务）";
L["Quest_1951_Objective"] = "将《能量仪祭》交给尘泥沼泽的塔贝萨。";
L["Quest_1951_Location"] = "塔贝萨（尘泥沼泽; "..YELLOW.."43,57"..PREV.."）";
L["Quest_1951_Note"] = "法师职业任务，你可以在血色修道院的图书馆奥法师杜安之前左侧一个走廊的地板上（"..YELLOW.."[2]"..PREV.."）找到这本书。";
...
L["Quest_1053_Location"] = "虔诚的莱雷恩（希尔斯布莱德丘陵 - 南海镇; "..YELLOW.."51,58 "..PREV.."）";
L["Quest_1053_Note"] = "此系列任务始于克罗雷修士（暴风城 - 光明大教堂; "..YELLOW.."52,43"..PREV.."），当然，你也可以直接从凄凉之地尼耶尔前哨站的血色十字军使者直接获得任务。\n大检察官怀特迈恩和血色十字军指挥官莫格莱尼在血色修道院 "..YELLOW.."教堂[2]"..PREV.."，赫洛德在血色修道院 "..YELLOW.."军械库[1]"..PREV.."，驯犬者洛克希在血色修道院 "..YELLOW.."图书馆[1]"..PREV.."。";
...
L["Quest_1113_Location"] = "大药剂师法拉尼尔（幽暗城 - 炼金房; "..YELLOW.."48,69 "..PREV.."）";
L["Quest_1113_Note"] = "血色所有的怪均掉落。";
L["Quest_1113_PreQuest"] = "蝙蝠的粪便（"..YELLOW.."[剃刀沼泽]"..PREV.."）";

L["Quest_1160_Name"] = "知识试炼";
L["Quest_1160_Objective"] = "找到《亡灵的起源》，把它交给幽暗城的帕科瓦·芬塔拉斯。";
L["Quest_1160_Location"] = "帕科瓦·芬塔拉斯（幽暗城 - 炼金房; "..YELLOW.."57,65 "..PREV.."）";
L["Quest_1160_Note"] = "此系列任务始于多恩·平原行者（千针石林; "..YELLOW.."53,41"..PREV.."）。\n书在血色修道院图书馆里。";
...
L["Quest_1049_Location"] = "圣者图希克（雷霆崖; "..YELLOW.."34,47"..PREV.."）";
...
L["Quest_1048_Location"] = "瓦里玛萨斯（幽暗城 - 皇家区; "..YELLOW.."56,92 "..PREV.."）";
L["Quest_1048_Note"] = "大检察官怀特迈恩和血色十字军指挥官莫格莱尼在血色修道院 "..YELLOW.."教堂[2]"..PREV.."，赫洛德在血色修道院 "..YELLOW.."军械库[1]"..PREV.."，驯犬者洛克希在血色修道院 "..YELLOW.."图书馆[1]"..PREV.."。";
L["Quest_1048_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3";

L["Quest_1051_Name"] = "沃瑞尔的复仇";
L["Quest_1051_Objective"] = "把沃瑞尔·森加斯的结婚戒指还给塔伦米尔的莫尼卡·森古特斯。";
L["Quest_1051_Location"] = "沃瑞尔·森加斯（血色修道院 - 墓地; "..YELLOW.."[1]"..PREV.."）";
L["Quest_1051_Note"] = "沃瑞尔·森加斯位于血色修道院墓地前部。南茜（奥特兰克山脉; "..YELLOW.."31,32"..PREV..")。她有任务需要的戒指。";
L["Quest_1051_RewardText"] = "1"..AQ_AND.."2"..AQ_OR.."3";

L["Quest_5529_Name"] = "瘟疫之龙";
L["Quest_5529_Objective"] = "杀掉20只瘟疫龙崽，然后向圣光之愿礼拜堂的贝蒂娜·比格辛克复命。";
L["Quest_5529_Location"] = "贝蒂娜·比格辛克（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,54"..PREV.."）";
...
L["Quest_5582_Note"] = "瘟疫龙崽掉落健康的龙鳞（8%掉率）。贝蒂娜·比格辛克（东瘟疫之地 - 圣光之愿礼拜堂;"..YELLOW.."76,54"..PREV.."）。";
...
L["Quest_5382_Location"] = "艾瓦·萨克霍夫（西瘟疫之地 - 凯尔达隆; "..YELLOW.."70,73"..PREV.."）";
L["Quest_5382_Note"] = "你可以在 "..YELLOW.."[9]"..PREV.." 找到瑟尔林·卡斯迪诺夫教授。";
...
L["Quest_5515_Location"] = "艾瓦·萨克霍夫（西瘟疫之地 - 凯尔达隆; "..YELLOW.."70,73"..PREV.."）";
L["Quest_5515_Note"] = "你可以在 "..YELLOW.."[3]"..PREV.." 詹迪斯·巴罗夫。";
...
L["Quest_5384_Location"] = "艾瓦·萨克霍夫（西瘟疫之地 - 凯尔达隆; "..YELLOW.."70,73"..PREV.."）";
L["Quest_5384_Note"] = "门廊就在 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_5466_Location"] = "马杜克镇长（西瘟疫之地 - 凯尔达隆; "..YELLOW.."70,73"..PREV.."）";
L["Quest_5466_Note"] = "你可以在 "..YELLOW.."[7]"..PREV.." 找到莱斯·霜语。";
...
L["Quest_5343_Location"] = "维尔顿·巴罗夫（西瘟疫之地 - 寒风营地; "..YELLOW.."43,83"..PREV.."）";
L["Quest_5343_Note"] = "你可以在 "..YELLOW.."[12]"..PREV.." 找到凯尔达隆地契，在 "..YELLOW.."[7]"..PREV.." 找到布瑞尔地契，在 "..YELLOW.."[4]"..PREV.." 找到塔伦米尔地契，在 "..YELLOW.."[1]"..PREV.." 找到南海镇地契。";
...
L["Quest_4771_Location"] = "贝蒂娜·比格辛克（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."77,54"..PREV.."）";
L["Quest_4771_Note"] = "雏龙精华开始于丁奇·斯迪波尔（燃烧平原 - 烈焰峰; "..YELLOW.."65,23"..PREV.."）。观察室在 "..YELLOW.."[6]"..PREV.."。";
...
L["Quest_7629_Location"] = "戈瑟奇·邪眼（燃烧平原; "..YELLOW.."12,31"..PREV.."）";
L["Quest_7629_Note"] = "只有术士才能得到这个任务！你可以在 "..YELLOW.."[7]"..PREV.." 找到炼金实验室。";
...
L["Quest_8969_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D] "..PREV.."）";
...
L["Quest_8992_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D] "..PREV.."）";
L["Quest_8992_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n库尔莫克在 "..YELLOW.."[7]"..PREV.."。";
L["Quest_8992_PreQuest"] = "true";
L["Quest_8992_FollowQuest"] = "最后的准备（"..YELLOW.."上层黑石塔"..PREV.."）";
...
L["Quest_5341_Location"] = "阿莱克斯·巴罗夫（提瑞斯法林地 - 亡灵壁垒; "..YELLOW.."80,73"..PREV.."）";
L["Quest_5341_Note"] = "你可以在 "..YELLOW.."[12]"..PREV.." 找到凯尔达隆地契，在 "..YELLOW.."[7]"..PREV.." 找到布瑞尔地契，在 "..YELLOW.."[4]"..PREV.." 找到塔伦米尔地契，在 "..YELLOW.."[1]"..PREV.." 找到南海镇地契。";
...
L["Quest_8258_Location"] = "萨格尼（奥格瑞玛 - 智慧谷; "..YELLOW.."38.6, 36.2"..PREV.."）";
L["Quest_8258_Note"] = "萨满祭司专属任务。前置任务接自同一 NPC。\n\n死亡骑士达克雷尔可以在 "..YELLOW.."[5]"..PREV.." 召唤。";
...
L["Quest_1740_Location"] = "杜安·卡汉（贫瘠之地; "..YELLOW.."49,57"..PREV.."）";
L["Quest_1740_Note"] = "只有术士才能得到这个任务！3块索兰鲁克宝珠的碎片，你可以从 "..YELLOW.."[黑暗深渊]"..PREV.." 的暮光侍僧那里得到。那块索兰鲁克宝珠的大碎片，你要去 "..YELLOW.."[影牙城堡]"..PREV.." 找影牙魔魂狼人。";
L["Quest_1740_RewardText"] = "1"..AQ_OR.."2";

L["Quest_1098_Name"] = "影牙城堡里的亡灵哨兵";
L["Quest_1098_Objective"] = "找到亡灵哨兵阿达曼特和亡灵哨兵文森特。";
L["Quest_1098_Location"] = "高级执行官哈德瑞克（银松森林 - 瑟伯切尔; "..YELLOW.."43,40"..PREV.."）";
L["Quest_1098_Note"] = "阿达曼特位于 "..YELLOW.."[1]"..PREV.."，文森特在你一进庭院的右侧 "..YELLOW.."[3]"..PREV.."。";
L["Quest_1098_RewardText"] = "1";

L["Quest_1013_Name"] = "乌尔之书";
L["Quest_1013_Objective"] = "把乌尔之书带给幽暗城炼金区里的看守者贝尔杜加。";
L["Quest_1013_Location"] = "看守者贝尔杜加（幽暗城 - 炼金房; "..YELLOW.."53,54"..PREV.."）";
L["Quest_1013_Note"] = "你可以找到书在进门的左边 "..YELLOW.."[11]"..PREV.."。";
L["Quest_1013_RewardText"] = "1"..AQ_OR.."2";

L["Quest_1014_Name"] = "除掉阿鲁高";
L["Quest_1014_Objective"] = "杀死阿鲁高，把他的头带给瑟伯切尔的达拉尔·道恩维沃尔。";
L["Quest_1014_Location"] = "达拉尔·道恩维沃尔（银松森林 - 瑟伯切尔; "..YELLOW.."44,39"..PREV.."）";
L["Quest_1014_Note"] = "你可以在 "..YELLOW.."[13]"..PREV.." 找到阿鲁高。";
L["Quest_1014_RewardText"] = "1";

L["Quest_386_Name"] = "伸张正义";
L["Quest_386_Objective"] = "把塔格尔的头颅带给湖畔镇的卫兵伯尔顿。";
L["Quest_386_Location"] = "卫兵伯尔顿（赤脊山 - 湖畔镇; "..YELLOW.."26,46 "..PREV.."）";
L["Quest_386_Note"] = "你可以在 "..YELLOW.."[1]"..PREV.." 找到塔格尔。";
L["Quest_386_RewardText"] = "1"..AQ_OR.."2";

L["Quest_377_Name"] = "罪与罚";
L["Quest_377_Objective"] = "夜色镇的米尔斯迪普议员要你杀死迪克斯特·瓦德，并把他的手带回来作为证明。";
L["Quest_377_Location"] = "米尔斯迪普议员（暮色森林 - 夜色镇; "..YELLOW.."72,47 "..PREV.."）";
...
L["Quest_387_Location"] = "典狱官塞尔沃特（暴风城 - 监狱; "..YELLOW.."51,69 "..PREV.."）";
L["Quest_387_Note"] = "副本外的典狱官会给你这个任务。";

L["Quest_388_Name"] = "鲜血的颜色";
L["Quest_388_Objective"] = "暴风城的尼科瓦·拉斯克要你取得10条红色毛纺面罩。";
L["Quest_388_Location"] = "尼科瓦·拉斯克（暴风城 - 旧城区; "..YELLOW.."75,63"..PREV.."）";
L["Quest_388_Note"] = "尼科瓦·拉斯克在旧城区游走，副本里每个敌人都可能掉落面罩。";

L["Quest_378_Name"] = "卡姆·深怒";
L["Quest_378_Objective"] = "丹莫德的莫特雷·加玛森要求你把卡姆·深怒的头颅交给他。";
L["Quest_378_Location"] = "莫特雷·加玛森（湿地 - 丹莫德; "..YELLOW.."49,18 "..PREV.."）";
L["Quest_378_Note"] = "前置任务也从莫特雷·加玛森处得到。你可以在 "..YELLOW.."[2]"..PREV.." 找到卡姆·深怒。";
...
L["Quest_391_Location"] = "典狱官塞尔沃特（暴风城 - 监狱; "..YELLOW.."51,69"..PREV.."）";
L["Quest_391_Note"] = "前置任务详情请参见 "..YELLOW.."[死亡矿井][迪菲亚兄弟会]"..PREV.."。\n巴基尔·斯瑞德在 "..YELLOW.."[4]"..PREV.."。";
...
L["Quest_5212_Location"] = "贝蒂娜·比格辛克（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,54"..PREV.."）";
...
L["Quest_5213_Location"] = "贝蒂娜·比格辛克（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,54"..PREV.."）";
L["Quest_5213_Note"] = "天灾军团档案在三个塔中的一个里，这三个塔在 "..YELLOW.."[15]"..PREV.."，"..YELLOW.."[16]"..PREV.." 和 "..YELLOW.."[17]"..PREV.."。";
...
L["Quest_5243_Location"] = "莱尼德·巴萨罗梅（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,52"..PREV.."）";
...
L["Quest_5214_Location"] = "烟鬼拉鲁恩（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."75,52"..PREV.."）";
L["Quest_5214_Note"] = "烟草店在 "..YELLOW.."[1]"..PREV.." 附近。当你打开盒子，弗拉斯·希亚比会突然出现。";
...
L["Quest_5282_Location"] = "埃根（东瘟疫之地; "..YELLOW.."11,29"..PREV.."）";
L["Quest_5282_Note"] = "前置任务从护理者奥林处获得（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."74,58"..PREV.."）\n鬼魂居民在斯坦索姆到处走动。";
...
L["Quest_5848_Location"] = "画家瑞弗蕾（西瘟疫之地 - 凯尔达隆; "..YELLOW.."65,75"..PREV.."）";
L["Quest_5848_Note"] = "前置任务从提里奥·弗丁处获得（西瘟疫之地; "..YELLOW.."7,43"..PREV.."）。\n画在 "..YELLOW.."[10]"..PREV.."。";
...
L["Quest_5463_Location"] = "莱尼德·巴萨罗梅（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."75,52"..PREV.."）";
L["Quest_5463_Note"] = "前置任务从马杜克镇长（西瘟疫之地 - 凯尔达隆; "..YELLOW.."70,73"..PREV.."）处获得。\n你可以在 "..YELLOW.."[19]"..PREV.." 附近找到标志。也可以参见：通灵学院里的 "..YELLOW.."[巫妖莱斯·霜语]"..PREV.."。";
L["Quest_5463_PreQuest"] = "true";
L["Quest_5463_FollowQuest"] = "米奈希尔的礼物";

L["Quest_5125_Name"] = "奥里克斯的清算";
L["Quest_5125_Objective"] = "杀掉瑞文戴尔男爵。";
L["Quest_5125_Location"] = "奥里克斯（斯坦索姆; "..YELLOW.."[13]"..PREV.."）";
L["Quest_5125_Note"] = "要开始这个任务你需要给奥里克斯[信仰奖章]。你可以从玛洛尔的保险箱拿到这个奖章，箱子就在 "..YELLOW.."[7]"..PREV.." 附近。将奖章给了奥里克斯之后，他会在对抗男爵 "..YELLOW.."[19]"..PREV.." 的战斗中支持你。但是可怜的人还是会倒下，杀死男爵后，跟他尸体对话完成任务。";
L["Quest_5125_RewardText"] = "1"..AQ_OR.."2";

L["Quest_5251_Name"] = "档案管理员";
L["Quest_5251_Objective"] = "在斯坦索姆城中找到血色十字军的档案管理员加尔福特，杀掉他，然后烧毁血色十字军档案。";
L["Quest_5251_Location"] = "尼古拉斯·瑟伦霍夫公爵（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,52"..PREV.."）";
L["Quest_5251_Note"] = "档案和档案管理员在 "..YELLOW.."[10]"..PREV.."。";
L["Quest_5251_FollowQuest"] = "可怕的真相";

L["Quest_5262_Name"] = "可怕的真相";
L["Quest_5262_Objective"] = "将巴纳扎尔的头颅交给东瘟疫之地的尼古拉斯·瑟伦霍夫公爵。";
L["Quest_5262_Location"] = "巴纳扎尔（斯坦索姆; "..YELLOW.."[11]"..PREV.."）";
L["Quest_5262_Note"] = "尼古拉斯·瑟伦霍夫公爵（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,52"..PREV.."）。";
...
L["Quest_5263_Location"] = "尼古拉斯·瑟伦霍夫公爵（东瘟疫之地 - 圣光之愿礼拜堂; "..YELLOW.."76,52"..PREV.."）";
L["Quest_5263_Note"] = "瑞文戴尔男爵在 "..YELLOW.."[19]"..PREV.."。\n\n后续任务奖励物品。";
...
L["Quest_8945_Note"] = "伊思达·哈尔蒙就站在斯坦索姆副本门口。你需要超维度幽灵显形器才能看到伊思达·哈尔蒙。联盟这个任务的前置任务接自德莉亚娜（铁炉堡 "..YELLOW.."43,52"..PREV.."），部落的接自莫克瓦尔（奥格瑞玛 "..YELLOW.."38,37"..PREV.."）。\n这个同时也是著名的45分钟杀瑞文戴尔男爵任务。";
...
L["Quest_8968_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图中的[D]"..PREV.."）";
L["Quest_8968_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n召唤亚雷恩和索托斯在 "..YELLOW.."[11]"..PREV.."。";
...
L["Quest_8991_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图中的[D]"..PREV.."）";
L["Quest_8991_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n召唤亚雷恩和索托斯在 "..YELLOW.."[11]"..PREV.."。";
L["Quest_8991_PreQuest"] = "true";
L["Quest_8991_FollowQuest"] = "最后的准备（"..YELLOW.."上层黑石塔"..PREV.."）";
...
L["Quest_9257_Location"] = "阿纳克洛斯（塔纳利斯 - 时光之穴; "..YELLOW.."65,49"..PREV.."）";
L["Quest_9257_Note"] = "召唤位置在 "..YELLOW.."[2]"..PREV.."。\n\n在巫妖王之怒资料片中，不能再获得这个任务。只有能召唤出埃提耶什这一步任务可以被完成。";
...
L["Quest_5307_Location"] = "亡灵杀手瑟里尔（冬泉谷 - 永望镇; "..YELLOW.."61,37"..PREV.."）";
L["Quest_5307_Note"] = "召唤黑衣守卫铸剑师在 "..YELLOW.."[15]"..PREV.."。";
L["Quest_5307_RewardText"] = "1";

L["Quest_5305_Name"] = "甜美的平静（铸锤大师任务）";
L["Quest_5305_Objective"] = "到斯坦索姆去杀死红衣铸锤师。将红衣铸锤师的围裙交给莉莉丝。";
L["Quest_5305_Location"] = "轻盈的莉莉丝（冬泉谷 - 永望镇; "..YELLOW.."61,37"..PREV.."）";
L["Quest_5305_Note"] = "召唤红衣铸锤师在 "..YELLOW.."[8]"..PREV.."。";
...
L["Quest_7622_Location"] = "艾瑞斯·哈文法（东瘟疫之地; "..YELLOW.."17,14"..PREV.."）";
L["Quest_7622_Note"] = "如果要看到艾瑞斯·哈文法和接到任务，你需要神圣之眼（火焰之王的宝箱在 "..YELLOW.."[熔火之心]"..PREV.."）。\n\n完成后，将神圣之眼、诺达希尔碎片和暗影之眼（诅咒之地或冬泉谷随机恶魔掉落）组合，将得到牧师史诗法杖——祈福。";
...
L["Quest_6163_Location"] = "纳萨诺斯·凋零者（东瘟疫之地; "..YELLOW.."22,68"..PREV.."）";
L["Quest_6163_Note"] = "前置任务也是从他这里接。拉姆斯登在 "..YELLOW.."[18]"..PREV.."。";
...
L["Quest_1475_Location"] = "布罗哈恩·铁桶（暴风城 - 矮人区; "..YELLOW.."69,40"..PREV.."）";
...
L["Quest_3445_Location"] = "安吉拉斯·月风（菲拉斯 - 羽月要塞; "..YELLOW.."31,45"..PREV.."）";
L["Quest_3445_Note"] = "你可以在 "..YELLOW.."52,45"..PREV.." 处找到玛尔冯·瑞文斯克。";
L["Quest_3445_FollowQuest"] = "石环";

L["Quest_3446_Name"] = "深入神庙";
L["Quest_3446_Objective"] = "在悲伤沼泽沉没的神庙中找到哈卡祭坛。";
L["Quest_3446_Location"] = "玛尔冯·瑞文斯克（塔纳利斯; "..YELLOW.."52,45"..PREV.."）";
L["Quest_3446_Note"] = "祭坛就在图中 "..YELLOW.."[1]"..PREV.." 的位置。";
L["Quest_3446_PreQuest"] = "true";

L["Quest_3447_Name"] = "雕像群的秘密";
L["Quest_3447_Objective"] = "到沉没的神庙去，揭开雕像群中隐藏的秘密。";
L["Quest_3447_Location"] = "玛尔冯·瑞文斯克（塔纳利斯; "..YELLOW.."52,45"..PREV.."）";
L["Quest_3447_Note"] = "雕像群就在图中 "..YELLOW.."[1]"..PREV.." 所示位置，按照地图指示的顺序打开他们。";
...
L["Quest_4143_Note"] = "前置任务《穆尔金和拉瑞安》开始于穆尔金（安戈洛环形山 - 马绍尔营地; "..YELLOW.."42,9"..PREV.."）。你可以从阿塔哈卡神庙里的神庙深渊潜伏者、黑暗虫或者融合软泥怪那里得到阿塔莱之雾。";
L["Quest_4143_PreQuest"] = "true";

L["Quest_3528_Name"] = "神灵哈卡";
L["Quest_3528_Objective"] = "将装满的哈卡之卵交给塔纳利斯的叶基亚。";
L["Quest_3528_Location"] = "叶基亚（塔纳利斯 - 热砂港; "..YELLOW.."66,22"..PREV.."）";
L["Quest_3528_Note"] = "此系列任务始于《尖啸者的灵魂》（同样在此领取，见 "..YELLOW.."[祖尔法拉克]"..PREV.."）。\n你必须在 "..YELLOW.."[3]"..PREV.." 使用哈卡之卵，触发事件。一旦事件开始，敌人会像潮水般涌出来攻击你。其中一些敌人掉落哈卡莱之血。用这些血液熄灭包含哈卡灵魂能量的不灭火焰。当你熄灭所有的火焰时，哈卡的化身就可以进入我们的世界了。";
...
L["Quest_1446_Location"] = "阿塔莱流放者（辛特兰; "..YELLOW.."33,75"..PREV.."）";
L["Quest_1446_Note"] = "你可以在 "..YELLOW.."[4]"..PREV.." 找到迦玛兰。";
L["Quest_1446_RewardText"] = "1"..AQ_OR.."2";

L["Quest_3373_Name"] = "伊兰尼库斯精华";
L["Quest_3373_Objective"] = "把伊兰尼库斯精华放在精华之泉里，精华之泉就在沉没的神庙中，伊兰尼库斯的巢穴里。";
L["Quest_3373_Location"] = "伊兰尼库斯精华掉落自（伊兰尼库斯的阴影; "..YELLOW.."[6]"..PREV.."）";
L["Quest_3373_Note"] = "伊兰尼库斯精华要打伊兰尼库斯的阴影才能掉落。你可以在 "..YELLOW.."[6]"..PREV.." 找到他，精华之泉就在他旁边。";
L["Quest_3373_RewardText"] = "1";

L["Quest_8422_Name"] = "巨魔的羽毛（术士任务）";
L["Quest_8422_Objective"] = "到沉没的神庙去，从巨魔们身上获得6支巫毒羽毛。";
L["Quest_8422_Location"] = "伊普斯（费伍德森林; "..YELLOW.."42,45"..PREV.."）";
...
L["Quest_8425_Location"] = "部落英雄的灵魂（尘泥沼泽; "..YELLOW.."34,66"..PREV.."）";
...
L["Quest_9053_Location"] = "托尔瓦·寻路者（安戈洛环形山; "..YELLOW.."72,76"..PREV.."）";
L["Quest_9053_Note"] = "德鲁伊职业任务。腐烂藤蔓掉落自召唤的阿塔拉利恩 "..YELLOW.."[1]"..PREV.."，必须正确的破解雕像群的秘密。";
...
L["Quest_8232_Location"] = "奥汀克（艾萨拉; "..YELLOW.."42,43"..PREV.."）";
L["Quest_8232_Note"] = "猎人职业任务。摩弗拉斯在 "..YELLOW.."[5]"..PREV.."。";
...
L["Quest_8253_Location"] = "大法师克希雷姆，摩弗拉斯（艾萨拉; "..YELLOW.."29,40"..PREV.."）";
L["Quest_8253_Note"] = "法师职业任务。摩弗拉斯在 "..YELLOW.."[5]"..PREV.."。";
...
L["Quest_8257_Location"] = "奥汀克（艾萨拉; "..YELLOW.."42,43"..PREV.."）";
L["Quest_8257_Note"] = "牧师职业任务。摩弗拉斯在"..YELLOW.."[5]"..PREV.."。格雷塔·苔蹄（费伍德森林 - 翡翠圣地; "..YELLOW.."51,82"..PREV.."）。";
...
L["Quest_8236_Location"] = " 大法师克希雷姆（艾萨拉; "..YELLOW.."29,40"..PREV.."）";
L["Quest_8236_Note"] = "盗贼职业任务。摩弗拉斯 "..YELLOW.."[5]"..PREV.." 掉落钥匙。乔拉齐·拉文霍德公爵（奥特兰克山谷 - 拉文霍德; "..YELLOW.."86,79"..PREV.."）。";
...
L["Quest_8418_Location"] = "阿什拉姆·瓦罗菲斯特（西瘟疫之地 - 寒风营地; "..YELLOW.."43,85"..PREV.."）";
...
L["Quest_1445_Location"] = "费泽鲁尔（悲伤沼泽 - 斯通纳德; "..YELLOW.."47,54"..PREV.."）";
...
L["Quest_3380_Location"] = "巫医尤克里（菲拉斯; "..YELLOW.."74,43"..PREV.."）";
L["Quest_3380_Note"] = "玛尔冯·瑞文斯克的位置在 "..YELLOW.."52,45"..PREV.."。";
L["Quest_3380_FollowQuest"] = "石环";

L["Quest_4146_Name"] = "除草器的燃料";
L["Quest_4146_Objective"] = "收集5份阿塔莱之雾的样本，然后将它们送到马绍尔营地的拉瑞安那里。";
L["Quest_4146_Location"] = "莉芙·雷兹菲克斯（贫瘠之地; "..YELLOW.."62,38"..PREV.."）";
L["Quest_4146_Note"] = "前置任务《拉瑞安和穆尔金》开始于拉瑞安（安戈洛环形山; "..YELLOW.."45,8"..PREV.."）。沉没的神庙里的神庙深渊潜伏者、黑暗虫和软泥怪身上都有阿塔莱之雾。";
L["Quest_4146_PreQuest"] = "拉瑞安和穆尔金 > 玛尔冯的车间";

L["Quest_8413_Name"] = "巫毒羽毛（萨满任务）";
L["Quest_8413_Objective"] = "将巫毒羽毛交给捕风者巴斯拉。";
L["Quest_8413_Location"] = "捕风者巴斯拉（奥特兰克山脉; "..YELLOW.."80,67"..PREV.."）";
...
L["Quest_721_Location"] = "勘察员雷杜尔（荒芜之地; "..YELLOW.."53,43 "..PREV.."）";
L["Quest_721_Note"] = "前置任务始于弄皱的地图（荒芜之地; "..YELLOW.."53,33"..PREV.."）。\n你可以在进入 "..YELLOW.."副本入口地图[1]"..PREV.." 找到铁趾格雷兹。";
L["Quest_721_PreQuest"] = "true";
L["Quest_721_FollowQuest"] = "铁趾的护符";

L["Quest_722_Name"] = "铁趾的护符";
L["Quest_722_Objective"] = "找到铁趾的护符，把它交给奥达曼的铁趾。";
L["Quest_722_Location"] = "铁趾格雷兹（奥达曼; "..YELLOW.."副本入口地图[1]"..PREV.."）。";
L["Quest_722_Note"] = "马格雷甘·深影掉落铁趾的护符 "..YELLOW.."副本入口地图[2]"..PREV.."。";
...
L["Quest_1139_Location"] = "顾问贝尔格拉姆（铁炉堡 - 探险者大厅; "..YELLOW.."77,10 "..PREV.."）";
...
L["Quest_2418_Location"] = "里格弗兹（荒芜之地; "..YELLOW.."42,52 "..PREV.."）";
...
L["Quest_704_Location"] = "勘察员基恩萨·铁环（洛克莫丹 - 铁环挖掘场; "..YELLOW.."65,65 "..PREV.."）";
L["Quest_704_Note"] = "前置任务始于勘察员塔伯斯·雷矛（铁炉堡 - 探险者大厅; "..YELLOW.."74,12"..PREV.."）。\n雕纹石罐散布于副本前的山洞里。";
L["Quest_704_RewardText"] = "1";
L["Quest_704_PreQuest"] = "true";

L["Quest_709_Name"] = "化解灾难";
L["Quest_709_Objective"] = "把雷乌纳石板带给迷失者塞尔杜林。";
L["Quest_709_Location"] = "迷失者塞尔杜林（荒芜之地; "..YELLOW.."51,76 "..PREV.."）";
L["Quest_709_Note"] = "石板在洞穴北部，通道的东部尽头 "..YELLOW.."副本入口地图[3]"..PREV.."。";
L["Quest_709_RewardText"] = "1";
L["Quest_709_FollowQuest"] = "远赴幽暗城";

L["Quest_2398_Name"] = "失踪的矮人";
L["Quest_2398_Objective"] = "在奥达曼找到巴尔洛戈。";
L["Quest_2398_Location"] = "勘察员塔伯斯·雷矛（铁炉堡 - 探险者大厅; "..YELLOW.."75,12 "..PREV.."）";
L["Quest_2398_Note"] = "巴尔洛戈在 "..YELLOW.."[1]"..PREV.."。";
L["Quest_2398_FollowQuest"] = "密室";

L["Quest_2240_Name"] = "密室";
L["Quest_2240_Objective"] = "阅读巴尔洛戈的日记，探索密室，然后向铁炉堡的勘察员塔伯斯·雷矛汇报。";
L["Quest_2240_Location"] = "巴尔洛戈（奥达曼; "..YELLOW.."[1]"..PREV.."）";
L["Quest_2240_Note"] = "密室在 "..YELLOW.."[4]"..PREV.."。打开密室需要从鲁维罗什 "..YELLOW.."[3]"..PREV.." 得到索尔之杖，和从巴尔洛戈的箱子 "..YELLOW.."[1]"..PREV.." 得到尼基夫徽章，两者结合得到史前法杖。使用法杖在地图室在 "..YELLOW.."[3] 和 [4]"..PREV.." 之间召唤艾隆纳亚。杀死她后，进入密室得到任务奖励。";
...
L["Quest_2198_Note"] = "把项链带给铁炉堡的塔瓦斯德·基瑟尔（铁炉堡 - 秘法区; "..YELLOW.."36,3"..PREV.."）。";
L["Quest_2198_FollowQuest"] = "昂贵的知识";

L["Quest_2200_Name"] = "回到奥达曼";
L["Quest_2200_Objective"] = "去奥达曼寻找塔瓦斯的魔法项链，被杀的圣骑士是最后一个拿着它的人。";
L["Quest_2200_Location"] = "塔瓦斯德·基瑟尔（铁炉堡 - 秘法区; "..YELLOW.."36,3 "..PREV.."）";
L["Quest_2200_Note"] = "圣骑士在 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_2201_Location"] = "圣骑士的遗体（奥达曼; "..YELLOW.."[2]"..PREV.."）";
L["Quest_2201_Note"] = "宝石在 "..YELLOW.."[1]"..PREV.." 显眼的石罐内，"..YELLOW.."[8]"..PREV.." 暗影熔炉地窖内和 "..YELLOW.."[9]"..PREV.." 的格瑞姆洛克掉落。注意：打开暗影熔炉地窖会出现一些怪物。使用塔瓦斯德的占卜之碗完成和进行后续任务。";
...
L["Quest_1360_Location"] = "克罗姆·粗臂（铁炉堡 - 探险者大厅; "..YELLOW.."74,9 "..PREV.."）";
L["Quest_1360_Note"] = "你在进入副本前就找到克罗姆·粗臂的财产。它就在洞穴的北部，第一个通道的东南角尽头 "..YELLOW.."副本入口地图[4]"..PREV.."。";

L["Quest_2278_Name"] = "白金圆盘";
L["Quest_2278_Objective"] = "和石头守护者交谈，从他那里了解更多古代的知识。一旦你了解到了所有的内容之后就激活诺甘农圆盘。-> 把迷你版的诺甘农圆盘带到雷霆崖的贤者（圣者图希克）那里。";
L["Quest_2278_Location"] = "诺甘农圆盘（奥达曼; "..YELLOW.."[11]"..PREV.."）";
L["Quest_2278_Note"] = "接到任务后，和石头守护者交谈左边的盘子。然后再次使用白金圆盘，取得缩小版的圆盘，并把缩小版的白金圆盘带给圣者图希克（雷霆崖; "..YELLOW.."34,46"..PREV.."）。后续任务可以从旁边的 NPC 那里接到。";
...
L["Quest_1956_Location"] = "塔贝萨（尘泥沼泽; "..YELLOW.."46,57 "..PREV.."）";
...
L["Quest_1192_Location"] = "普兹克（千针石林 - 沙漠赛道; "..YELLOW.."80.1, 75.9"..PREV.."）";
...
L["Quest_2283_Location"] = "德兰·杜佛斯（奥格瑞玛 - 暗巷区; "..YELLOW.."59,36 "..PREV.."）";
...
L["Quest_2284_Location"] = "德兰·杜佛斯（奥格瑞玛 - 暗巷区; "..YELLOW.."59,36 "..PREV.."）";
L["Quest_2284_Note"] = "圣骑士在 "..YELLOW.."[2]"..PREV.."。";
...
L["Quest_2318_Location"] = "圣骑士的遗体（奥达曼; "..YELLOW.."[2]"..PREV.."）";
L["Quest_2318_Note"] = "翻译圣骑士日记的人加卡尔（荒芜之地 - 卡加斯; "..YELLOW.."2,46"..PREV.."） -> 将项链借给加卡尔，他帮你翻译日记。";
...
L["Quest_2339_Location"] = "加卡尔（荒芜之地 - 卡加斯; "..YELLOW.."2,46 "..PREV.."）";
L["Quest_2339_Note"] = "宝石在 "..YELLOW.."[1]"..PREV.." 显眼的石罐内，"..YELLOW.."[8]"..PREV.." 暗影熔炉地窖内和 "..YELLOW.."[9]"..PREV.." 的格瑞姆洛克掉落。注意：打开暗影熔炉地窖会出现一些怪物。使用塔瓦斯德的占卜之碗完成和进行下一步任务。";
...
L["Quest_2202_Location"] = "加卡尔（荒芜之地 - 卡加斯; "..YELLOW.."2,69 "..PREV.."）";
...
L["Quest_2342_Location"] = "帕特里克·加瑞特（幽暗城; "..YELLOW.."72,48 "..PREV.."）";
L["Quest_2342_Note"] = "你在进入副本之前就会找到加勒特的家族宝藏。它就在南部通道的尽头 "..YELLOW.."副本入口地图[5]"..PREV.."。";

L["Quest_971_Name"] = "深渊中的知识";
L["Quest_971_Objective"] = "把洛迦里斯手稿带给铁炉堡的葛利·硬骨。";
L["Quest_971_Location"] = "葛利·硬骨（铁炉堡 - 荒弃的洞穴; "..YELLOW.."50,5"..PREV.."）";
...
L["Quest_1275_Location"] = "戈沙拉·夜语（黑海岸 - 奥伯丁; "..YELLOW.."38,43"..PREV.."）";
L["Quest_1275_Note"] = "前置任务可以从阿古斯·夜语（暴风城 - 花园; "..YELLOW.."36,67"..PREV.."）处得到。\n\n黑暗深渊副本里面和门前的所有纳迦都可能掉落脑干。";
...
L["Quest_1198_Location"] = "哨兵山德拉斯（达纳苏斯 - 工匠区; "..YELLOW.."55,24"..PREV.."）";
L["Quest_1198_Note"] = "你可以在 "..YELLOW.."[4]"..PREV.." 找到银月守卫塞尔瑞德。";
L["Quest_1198_FollowQuest"] = "黑暗深渊中的恶魔";

L["Quest_1200_Name"] = "黑暗深渊中的恶魔";
L["Quest_1200_Objective"] = "把梦游者克尔里斯的头颅交给达纳苏斯的哨兵塞尔高姆。";
L["Quest_1200_Location"] = "哨兵塞尔瑞德（黑暗深渊; "..YELLOW.."[4]"..PREV.."）";
L["Quest_1200_Note"] = "克尔里斯在 "..YELLOW.."[8]"..PREV.."。你可以哨兵找到塞尔高姆（达纳苏斯 - 工匠区; "..YELLOW.."55,24"..PREV.."）。注意！如果你点燃了克尔里斯旁边的火焰，敌人会出现并攻击你。";
...
L["Quest_1199_Location"] = "银月守卫玛纳杜斯（达纳苏斯 - 工匠区; "..YELLOW.."55,23"..PREV.."）";
...
L["Quest_6563_Location"] = "耶努萨克雷（灰谷 - 佐拉姆加前哨站; "..YELLOW.."11,33"..PREV.."）";
L["Quest_6563_Note"] = "前置任务《帮助耶努萨克雷》可以在苏纳曼（石爪山脉 - 烈日石居; "..YELLOW.."47,64"..PREV.."）接到。蓝宝石多生长在通往黑暗深渊入口的那条通道的洞穴墙壁上。";
...
L["Quest_6564_Note"] = "潮湿的便笺可从黑暗深渊海潮祭司处得到（5% 掉落几率）。然后去耶努萨克雷（灰谷 - 佐拉姆加前哨站; "..YELLOW.."11,33"..PREV.."）。洛古斯·杰特在 "..YELLOW.."[6]"..PREV.."。";
L["Quest_6564_RewardText"] = "1"..AQ_OR.."2";

L["Quest_6921_Name"] = "废墟之间";
L["Quest_6921_Objective"] = "把深渊之核交给灰谷佐拉姆加前哨站里的耶努萨克雷。";
L["Quest_6921_Location"] = "耶努萨克雷（灰谷 - 佐拉姆加前哨站; "..YELLOW.."11,33"..PREV.."）";
L["Quest_6921_Note"] = "深渊之核在 "..YELLOW.."[7]"..PREV.." 区水域里。当你得到深远之核后，阿奎尼斯男爵会出现并攻击你。他会掉落一件任务物品，你要把它带给耶努萨克雷。";

L["Quest_6561_Name"] = "黑暗深渊中的恶魔";
L["Quest_6561_Objective"] = "把梦游者克尔里斯的头颅带回雷霆崖交给巴珊娜·符文图腾 。";
L["Quest_6561_Location"] = "银月守卫塞尔瑞德（黑暗深渊; "..YELLOW.."[4]"..PREV.."）";
L["Quest_6561_Note"] = "克尔里斯在 "..YELLOW.."[8]"..PREV.."。巴珊娜·符文图腾可以在（雷霆崖 - 长者高地 "..YELLOW.."70,33"..PREV.."）处找到。注意！如果你点燃了克尔里斯身旁的火焰，会出现敌人攻击你。";
...
L["Quest_7441_Location"] = "埃斯托尔迪（菲拉斯 - 拉瑞斯小亭; "..YELLOW.."76,37"..PREV.."）";
L["Quest_7441_Note"] = "普希林在厄运之槌 "..YELLOW.."东"..PREV.." 的 "..YELLOW.."[1]"..PREV.."。你一和它说话它就跑，但是最后会停下并可以被攻击在 "..YELLOW.."[2]"..PREV.."。它还会掉落月牙钥匙，也就是厄运之槌北和西的钥匙。";
L["Quest_7441_RewardText"] = "1"..AQ_OR.."2";

L["Quest_7488_Name"] = "蕾瑟塔蒂丝的网";
L["Quest_7488_Objective"] = "把蕾瑟塔蒂丝的网交给菲拉斯羽月要塞的拉托尼库斯·月矛。";
L["Quest_7488_Location"] = "拉托尼库斯·月矛（菲拉斯 - 羽月要塞; "..YELLOW.."30,46"..PREV.."）";
L["Quest_7488_Note"] = "蕾瑟塔蒂丝在厄运之槌 "..YELLOW.."东"..PREV.." 的 "..YELLOW.."[3]"..PREV.."。前置任务可以从铁炉堡的信使考雷·落锤接到。";
...
L["Quest_5526_Location"] = "拉比恩·萨图纳（月光林地; "..YELLOW.."51,44"..PREV.."）";
L["Quest_5526_Note"] = "奥兹恩在厄运之槌 "..YELLOW.."东"..PREV.." 的 "..YELLOW.."[5]"..PREV.."。净化之匣在希利苏斯 "..YELLOW.."62,54"..PREV.."。前置任务同样来自拉比恩·萨图纳。";
...
L["Quest_8967_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
L["Quest_8967_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n召唤伊萨利恩在 "..YELLOW.."[5]"..PREV.."。";
...
L["Quest_8990_Location"] = "伯德雷（黑石山; "..YELLOW.."副本入口地图[D]"..PREV.."）";
L["Quest_8990_Note"] = "你需要超维度幽灵显形器才能看到伯德雷。你可以从《寻找安泰恩》任务得到它。\n\n召唤伊萨利恩在 "..YELLOW.."[5]"..PREV.."。";
L["Quest_8990_PreQuest"] = "true";
L["Quest_8990_FollowQuest"] = "最后的准备（"..YELLOW.."上层黑石塔"..PREV.."）";

L["Quest_7581_Name"] = "监牢之链（术士任务）";
L["Quest_7581_Objective"] = "到菲拉斯的厄运之槌去，从扭木广场的荒野萨特身上找到15份萨特之血，然后把它们交给腐烂之痕的戴奥。";
L["Quest_7581_Location"] = "衰老的戴奥（诅咒之地 - 腐烂之痕; "..YELLOW.."34,50"..PREV.."）";
L["Quest_7581_Note"] = "术士召唤末日守卫任务，你可以从衰老的戴奥那里接到相关的其他任务。最容易找到荒野萨特是从厄运之槌东的“后门”进入（菲拉斯 - 拉瑞斯小亭; "..YELLOW.."77,37"..PREV.."）。你需要有月牙钥匙才能开门。";

L["Quest_7489_Name"] = "蕾瑟塔蒂丝的网";
L["Quest_7489_Objective"] = "把蕾瑟塔蒂丝的网交给非拉斯莫沙彻营地的塔罗·刺蹄。";
L["Quest_7489_Location"] = "塔罗·刺蹄（菲拉斯 - 莫沙彻营地; "..YELLOW.."76,43"..PREV.."）";
L["Quest_7489_Note"] = "蕾瑟塔蒂丝在厄运之槌 "..YELLOW.."东"..PREV.." 的 "..YELLOW.."[3]"..PREV.."。前置任务接自奥格瑞玛的公告员高拉克。";
L["Quest_7489_RewardText"] = "1";
L["Quest_7489_PreQuest"] = "莫沙彻营地";

L["Quest_1193_Name"] = "破碎的陷阱 ";
L["Quest_1193_Objective"] = "修复这个陷阱。";
L["Quest_1193_Location"] = "破碎的陷阱（厄运之槌; "..YELLOW.."北"..PREV.."）";
...
L["Quest_5518_Location"] = "诺特·希姆加克（厄运之槌; "..YELLOW.."北，[4]"..PREV.."）";
L["Quest_5518_Note"] = "可重复任务，食人魔鞣酸可以从 "..YELLOW.."（上层）[4]"..PREV.." 附近得到。";
L["Quest_5518_RewardText"] = "1";

L["Quest_5525_Name"] = "救诺特出去！";
L["Quest_5525_Objective"] = "为诺特找到食人魔镣铐钥匙。";
L["Quest_5525_Location"] = "诺特·希姆加克（厄运之槌; "..YELLOW.."北，[4]"..PREV.."）";
L["Quest_5525_Note"] = "可重复任务，副本里任何食人魔都可能掉落镣铐钥匙。";

L["Quest_7703_Name"] = "戈多克食人魔的事务";
L["Quest_7703_Objective"] = "找到戈多克力量护手，并将它交给厄运之槌的克罗卡斯。";
L["Quest_7703_Location"] = "克罗卡斯（厄运之槌; "..YELLOW.."北，[5]"..PREV.."）";
L["Quest_7703_Note"] = "王子在厄运之槌 "..YELLOW.."西"..PREV.." 的 "..YELLOW.."[7]"..PREV.."。力量护手在王子附近的一个箱子里，交任务时你也必须确保你有“当国王真好”这个状态。";
L["Quest_7703_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_5528_Name"] = "戈多克好酒";
L["Quest_5528_Objective"] = "获取免费的酒。";
L["Quest_5528_Location"] = "践踏者克雷格（厄运之槌; "..YELLOW.."北，[2]"..PREV.."）";
...
L["Quest_7482_Location"] = "学者卢索恩·纹角（菲拉斯 - 羽月要塞; "..YELLOW.."31,43"..PREV.."）";
L["Quest_7482_Note"] = "卡里尔·温萨鲁斯在厄运之槌 "..YELLOW.."图书馆（西）"..PREV.."。";
...
L["Quest_7461_Location"] = "辛德拉古灵（厄运之槌; "..YELLOW.."西，（上层）[1]"..PREV.."）";
L["Quest_7461_Note"] = "水晶塔被标记为 "..BLUE.."[B]"..PREV.."。伊莫塔尔在 "..YELLOW.."[6]"..PREV.."，托塞德林王子在 "..YELLOW.."[7]"..PREV.."。";
L["Quest_7461_FollowQuest"] = "辛德拉的宝藏";

L["Quest_7877_Name"] = "辛德拉的宝藏";
L["Quest_7877_Objective"] = "返回图书馆去找到辛德拉的宝藏。拿取你的奖励吧！";
L["Quest_7877_Location"] = "辛德拉古灵（厄运之槌; "..YELLOW.."西，（上层）[1]"..PREV.."）";
L["Quest_7877_Note"] = "你可以在图书馆的梯子下面找到宝藏 "..YELLOW.."[7]"..PREV.."。";
...
L["Quest_7631_Location"] = "莫苏尔（燃烧平原; "..YELLOW.."12,31"..PREV.."）";
L["Quest_7631_Note"] = "术士的史诗战马任务的最后一步。首先必须关闭水晶塔 "..BLUE.."[B]"..PREV.."。和需要杀掉伊莫塔尔 "..YELLOW.."[6]"..PREV.."。然后你可以召唤。准备20个以上的灵魂碎片是必须的，你必须消耗碎片才能维持法阵。杀死恐惧战马后，和马的灵魂对话即可完成任务。";
...
L["Quest_7506_Note"] = "奖励德鲁伊的职业饰品。把书交给博学者亚沃（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7503_Note"] = "奖励猎人的职业饰品。把书交给博学者麦库斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7500_Note"] = "奖励法师的职业饰品。把书交给博学者基尔达斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7501_Note"] = "奖励圣骑士的职业饰品。把书交给博学者麦库斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7504_Note"] = "奖励牧师的职业饰品。把书交给博学者亚沃（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7498_Note"] = "奖励盗贼的职业饰品。把书交给博学者基尔达斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7502_Note"] = "奖励萨满祭司的职业饰品。把书交给博学者亚沃（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7499_Note"] = "奖励术士的职业饰品。把书交给博学者麦库斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7484_Note"] = "奖励战士的职业饰品。把书交给博学者基尔达斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";
...
L["Quest_7485_Location"] = "博学者莱德罗斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）";
L["Quest_7485_Note"] = "没有前置任务，但是精灵的传说任务必须完成后才能接到这个任务。\n\n厄运之槌随机掉落圣典并可被交易，所以可以从拍卖行获取。暗影之皮由 "..YELLOW.."通灵学院"..PREV.." 的复活的构造体和复活的骷髅守卫随机掉落并是拾取绑定的。";
...
L["Quest_7483_Location"] = "博学者莱德罗斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）";
L["Quest_7483_Note"] = "没有前置任务，但是精灵的传说任务必须完成后才能接到这个任务。\n\n厄运之槌随机掉落圣典并可被交易，所以可以从拍卖行获取。磨损的憎恶缝合线由 "..YELLOW.."斯坦索姆"..PREV.." 的吞咽者拉姆斯登、缝补憎恶、泼毒者和喷胆者随机掉落并是拾取绑定的。";
...
L["Quest_7507_Location"] = "博学者莱德罗斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）";
...
L["Quest_7481_Location"] = "先知科鲁拉克（菲拉斯 - 莫沙彻营地; "..YELLOW.."74,43"..PREV.."）";
L["Quest_7481_Note"] = "卡里尔·温萨鲁斯（厄运之槌; "..YELLOW.."西，"..GREEN.."图书馆[1']"..PREV.."）。";

L["Quest_7070_Name"] = "暗影残片";
L["Quest_7070_Objective"] = "从玛拉顿收集10块暗影残片，然后把它们交给尘泥沼泽塞拉摩岛上的大法师特沃什。";
L["Quest_7070_Location"] = "大法师特沃什（尘泥沼泽 - 塞拉摩岛; "..YELLOW.."66,49"..PREV.."）";
...
L["Quest_7041_Location"] = "塔琳德莉亚（凄凉之地 - 尼耶尔前哨站; "..YELLOW.."68,8"..PREV.."）";
...
L["Quest_7028_Location"] = "维洛（凄凉之地; "..YELLOW.."62,39"..PREV.."）";
...
L["Quest_7067_Location"] = "半人马贱民（凄凉之地; "..YELLOW.."45,86"..PREV.."）";
...
L["Quest_7044_Location"] = "凯雯德拉（凄凉之地 - 玛拉顿; "..YELLOW.."副本入口地图[4]"..PREV.."）";
L["Quest_7044_Note"] = "凯雯德拉就在进入副本之前的橙色部分的开始处。\n你可以从诺克塞恩那里得到塞雷布拉斯魔棒 "..YELLOW.."[2]"..PREV.."，从维利塔恩那里得到塞雷布拉斯钻石 "..YELLOW.."[5]"..PREV.."。塞雷布拉斯在 "..YELLOW.."[7]"..PREV.."。你需要打败他才能和他说话。";
L["Quest_7044_FollowQuest"] = "塞雷布拉斯节杖";

L["Quest_7046_Name"] = "塞雷布拉斯节杖";
L["Quest_7046_Objective"] = "帮助赎罪的塞雷布拉斯制作塞雷布拉斯节杖。\n当仪式完成之后再和他谈谈。";
L["Quest_7046_Location"] = "赎罪的塞雷布拉斯（玛拉顿 "..YELLOW.."[7]"..PREV.."）";
...
L["Quest_7065_Location"] = "守护者玛兰迪斯（凄凉之地 - 尼耶尔前哨站; "..YELLOW.."63,10"..PREV.."）";
L["Quest_7065_Note"] = "瑟莱德丝公主在 "..YELLOW.."[11]"..PREV.."。";
...
L["Quest_7066_Location"] = "扎尔塔的灵魂（玛拉顿 "..YELLOW.."[11]"..PREV.."）";
L["Quest_7066_Note"] = "杀死公主后，扎尔塔的灵魂就会出现（"..YELLOW.."[11]"..PREV.."）。守护者雷姆洛斯（月光林地 - 雷姆洛斯神殿; "..YELLOW.."36,41"..PREV.."）。";
L["Quest_7066_PreQuest"] = "大地的污染";

L["Quest_7068_Name"] = "暗影残片";
L["Quest_7068_Objective"] = "从玛拉顿收集10块暗影残片，然后把它们交给奥格瑞玛的尤塞尔奈。";
L["Quest_7068_Location"] = "尤塞尔奈（奥格瑞玛 - 精神谷; "..YELLOW.."39,86"..PREV.."）";
...
L["Quest_7029_Location"] = "瓦克·战痕（凄凉之地 - 葬影村; "..YELLOW.."23,70"..PREV.."）";
...
L["Quest_7064_Location"] = "瑟琳德拉（凄凉之地 - 葬影村; "..YELLOW.."27,77"..PREV.."）";
L["Quest_7064_Note"] = "瑟莱德丝公主在 "..YELLOW.."[11]"..PREV.."。";
...
L["Quest_5722_Location"] = "拉哈罗（雷霆崖 - 长者高地; "..YELLOW.."70,29 "..PREV.."）";
L["Quest_5722_Note"] = "你会在 "..YELLOW.."[1]"..PREV.." 发现玛尔·恐怖图腾。得到背包后你需要把它交回给雷霆崖的拉哈罗。";
...
L["Quest_5728_Location"] = "萨尔（奥格瑞玛 - 智慧谷; "..YELLOW.."31,37 "..PREV.."）";
L["Quest_5728_Note"] = "你会在 "..YELLOW.."[4]"..PREV.." 发现巴扎兰，在 "..YELLOW.."[3]"..PREV.." 发现祈求者耶戈什。";
...
L["Quest_3636_Location"] = "大主教本尼迪塔斯（暴风城 - 光明大教堂; "..YELLOW.."50,45 "..PREV.."）";
L["Quest_3636_Note"] = "寒冰之王亚门纳尔是剃刀高地的最后一个 Boss。你可以在 "..YELLOW.."[6]"..PREV.." 找到他。";
L["Quest_3636_RewardText"] = "1"..AQ_AND.."2";

L["Quest_6521_Name"] = "邪恶的盟友";
L["Quest_6521_Objective"] = "把玛克林大使的头颅带给幽暗城的瓦里玛萨斯。";
L["Quest_6521_Location"] = "瓦里玛萨斯（幽暗城 - 皇家区; "..YELLOW.."56,92 "..PREV.."）";
L["Quest_6521_Note"] = "剃刀沼泽最后的 Boss 给出前置任务。玛克林大使位置在进入副本前外面的空地上（贫瘠之地 - 剃刀高地; "..YELLOW.."48,92"..PREV.."）。";
...
L["Quest_3341_Location"] = "安德鲁·布隆奈尔（幽暗城 - 魔法区; "..YELLOW.."72,32 "..PREV.."）";
L["Quest_3341_Note"] = "寒冰之王亚门纳尔是剃刀高地最后一个 Boss。位于 "..YELLOW.."[6]"..PREV.."。";
...
L["Quest_1221_Location"] = "麦伯克·米希瑞克斯（贫瘠之地 - 棘齿城; "..YELLOW.."62,37"..PREV.."）";
...
L["Quest_1142_Location"] = "赫尔拉斯·静水（剃刀沼泽; "..YELLOW.." [8]"..PREV.."）";
L["Quest_1142_Note"] = "坠饰随机掉落。你必须把坠饰带给塔莎拉·静水（达纳苏斯 - 贸易区; "..YELLOW.."69,67"..PREV.."）。";
L["Quest_1142_RewardText"] = "1"..AQ_OR.."2";

L["Quest_1144_Name"] = "进口商威利克斯";
L["Quest_1144_Objective"] = "护送进口商威利克斯逃出剃刀沼泽。";
L["Quest_1144_Location"] = "进口商威利克斯（剃刀沼泽; "..YELLOW.." [8]"..PREV.."）";
...
L["Quest_1101_Location"] = "法芬德尔（菲拉斯 - 萨兰纳尔; "..YELLOW.."89,46"..PREV.."）";
L["Quest_1101_Note"] = "卡尔加·刺肋 "..YELLOW.."[7]"..PREV.." 掉落徽章。";
...
L["Quest_1701_Location"] = "弗伦·长须（暴风城 - 矮人区; "..YELLOW.."64,37"..PREV.."）";
L["Quest_1701_Note"] = "只有战士才能接到这个任务！\n你可以从鲁古格 "..YELLOW.."[1]"..PREV.." 得到燃素。\n\n湿地的蜘蛛掉落烧焦的蜘蛛牙，石爪山脉的奇美幼崽拉掉落烧焦的奇美拉角、雌奇美拉掉落光滑的奇美拉角。";
...
L["Quest_1109_Location"] = "法拉尼尔（幽暗城 - 炼金房; "..YELLOW.."48,69 "..PREV.."）";
L["Quest_1109_Note"] = "任何蝙蝠都会掉落沼泽蝙蝠的粪便。";
L["Quest_1109_FollowQuest"] = "狂热之心（"..YELLOW.."[剃刀高地]"..PREV.."）";

L["Quest_1102_Name"] = "奥尔德的报复";
L["Quest_1102_Objective"] = "把卡尔加·刺肋的心脏交给雷霆崖的奥尔德·石塔。";
L["Quest_1102_Location"] = "奥尔德·石塔（雷霆崖; "..YELLOW.."36,59 "..PREV.."）";
L["Quest_1102_Note"] = "卡尔加·刺肋在 "..YELLOW.."[7]"..PREV.."、";
...
L["Quest_1838_Location"] = "索恩格瑞姆·火眼（贫瘠之地; "..YELLOW.."57,30 "..PREV.."）";
...
L["Quest_1486_Location"] = "纳尔帕克（贫瘠之地 - 哀嚎洞穴; "..YELLOW.."47,36 "..PREV.."）";
...
L["Quest_959_Location"] = "起重机操作员比戈弗兹（贫瘠之地 - 棘齿城; "..YELLOW.."63,37 "..PREV.."）";
L["Quest_959_Note"] = "你进入副本杀死疯狂的马格利什，拿到酒瓶。当你进入洞穴后向右转，他就在一个凹进去的洞里 "..YELLOW.."副本入口地图[2]"..PREV.."。";

L["Quest_1491_Name"] = "智慧饮料";
L["Quest_1491_Objective"] = "收集6份哀嚎香精，把它们交给棘齿城的麦伯克·米希瑞克斯。";
L["Quest_1491_Location"] = "麦伯克·米希瑞克斯（贫瘠之地 - 棘齿城; "..YELLOW.."62,37 "..PREV.."）";
...
L["Quest_1487_Location"] = "厄布鲁（贫瘠之地 - 哀嚎洞穴; "..YELLOW.."47,36 "..PREV.."）";
...
L["Quest_6981_Location"] = "发光的碎片掉落自（『吞噬者』穆坦努斯"..YELLOW.."[9]"..PREV.."）";
...
L["Quest_962_Location"] = "药剂师扎玛（雷霆崖 -灵魂高地; "..YELLOW.."22,20 "..PREV.."）";
L["Quest_962_Note"] = "你可以在药剂师赫布瑞姆处领取前置任务（贫瘠之地 - 十字路口; "..YELLOW.."51,30"..PREV.."）。\n你可以在山洞里副本前或副本内采到毒蛇花。学习草药学的玩家打开寻找草药技能就可以在自己的小地图上看到毒蛇花的位置。";
...
L["Quest_914_Location"] = "纳拉·蛮鬃（雷霆崖; "..YELLOW.."75,31 "..PREV.."）";
L["Quest_914_Note"] = "系列任务始于哈缪尔·符文图腾（雷霆崖 - 长者高地; "..YELLOW.."78,28"..PREV.."）\n掉落宝石的4个德鲁伊位于 "..YELLOW.."[2]"..PREV.."，"..YELLOW.."[3]"..PREV.."，"..YELLOW.."[5]"..PREV.."，"..YELLOW.."[7]"..PREV.."。";
...
L["Quest_3042_Location"] = "特伦顿·轻锤（塔纳利斯 - 加基森; "..YELLOW.."51,28 "..PREV.."）";
L["Quest_3042_Note"] = "每个巨魔都可能掉落调和剂。";

L["Quest_2865_Name"] = "圣甲虫的壳";
L["Quest_2865_Objective"] = "给加基森的特兰雷克带去5个完整的圣甲虫壳。";
L["Quest_2865_Location"] = "特兰雷克（塔纳利斯 - 加基森; "..YELLOW.."51,26 "..PREV.."）";
L["Quest_2865_Note"] = "前置任务始于克拉兹克（荆棘谷 - 藏宝海湾; "..YELLOW.."25,77"..PREV.."）。\n每个圣甲虫都可能掉落壳儿。大量圣甲虫集中在 "..YELLOW.."[2]"..PREV.."。";
L["Quest_2865_PreQuest"] = "true";

L["Quest_2846_Name"] = "深渊皇冠";
L["Quest_2846_Objective"] = "将深渊皇冠交给尘泥沼泽的塔贝萨。";
L["Quest_2846_Location"] = "塔贝萨（尘泥沼泽; "..YELLOW.."46,57 "..PREV.."）";
L["Quest_2846_Note"] = "水占师维蕾萨掉落深渊皇冠。你可以在"..YELLOW.."[6]"..PREV.."找到她。";
...
L["Quest_2991_Location"] = "萨迪斯·格希德（诅咒之地 - 守望堡; "..YELLOW.."66,19 "..PREV.."）";
L["Quest_2991_Note"] = "此系列任务始于狮鹫管理员沙拉克·鹰斧（辛特兰 - 蛮锤城堡; "..YELLOW.."9,44"..PREV.."）。\n你可以在 "..YELLOW.."[4]"..PREV.." 找到耐克鲁姆。";
...
L["Quest_3527_Location"] = "叶基亚（塔纳利斯 - 热砂港; "..YELLOW.."66,22 "..PREV.."）";
L["Quest_3527_Note"] = "前置任务也是在此获得。\n两块石板分别由殉教者塞卡 "..YELLOW.."[2]"..PREV.." 和水占师维蕾萨 "..YELLOW.."[6]"..PREV.." 掉落。";
...
L["Quest_2768_Location"] = "比格维兹（塔纳利斯 - 加基森; "..YELLOW.."52,28 "..PREV.."）";
L["Quest_2768_Note"] = "你可以从布莱中士那里得到探水棒。你可以在 "..YELLOW.."[4]"..PREV.." 找到他。但要在神庙百人斩事件后后打败布莱中士，才能得到探水棒。";
L["Quest_2768_RewardText"] = "1"..AQ_OR.."2";

L["Quest_2770_Name"] = "加兹瑞拉";
L["Quest_2770_Objective"] = "把加兹瑞拉的鳞片交给闪光平原的维兹尔·铜栓。";
L["Quest_2770_Location"] = "维兹尔·铜栓（千针石林 - 闪光平原; "..YELLOW.."78,77 "..PREV.."）";
L["Quest_2770_Note"] = "你可以在"..YELLOW.."[6]"..PREV.."敲锣召唤加兹瑞拉。不再需要祖尔法拉克之槌。";
...
L["Quest_2936_Location"] = "加德林大师（杜隆塔尔 - 森金村; "..YELLOW.."55,74 "..PREV.."）";
L["Quest_2936_Note"] = "此任务始于辛特兰巨魔村庄的毒液瓶任务。\n你会在 "..YELLOW.."[2]"..PREV.." 发现石板。";
...
L["Quest_6822_Location"] = "海达克西斯公爵（艾萨拉; "..YELLOW.."79,73"..PREV.."）";
...
L["Quest_6824_Location"] = "海达克西斯公爵（艾萨拉; "..YELLOW.."79,73"..PREV.."）";
L["Quest_6824_Note"] = "鲁西弗隆在 "..YELLOW.."[1]"..PREV.."，萨弗隆先驱者在 "..YELLOW.."[8]"..PREV.."，基赫纳斯在 "..YELLOW.."[3]"..PREV.."，还有沙斯拉尔在 "..YELLOW.."[5]"..PREV.."。\n奖励物品在后续任务“英雄的奖赏”中。补丁3.0.8之后，将不能开始这个任务线。如果你已经有了这个任务，依然可以完成。";
...
L["Quest_7786_Location"] = "德米提恩（希利苏斯; "..YELLOW.."22,9"..PREV.."）";
L["Quest_7786_Note"] = "雷霆之怒，逐风者的祝福之剑部分任务，当你从加尔 "..YELLOW.."[4]"..PREV.." 拿到逐风者禁锢之颅右半和迦顿男爵 "..YELLOW.."[6]"..PREV.." 拿到逐风者禁锢之颅左半后，与德米提恩对话开启任务线。拉格纳罗斯 "..YELLOW.."[10]"..PREV.." 掉落火焰之王的精华。完成这些后，召唤并杀掉桑德兰王子，这是一个40人团队 Boss。";
...
L["Quest_7604_Location"] = "罗克图斯·暗契（黑石深渊; "..YELLOW.."[15]"..PREV.."）";
L["Quest_7604_Note"] = "你需要萨弗隆铁锭来与洛克图斯签订契约。熔火之心的焚化者古雷曼格 "..YELLOW.."[7]"..PREV.." 掉落铁锭。";
L["Quest_7604_RewardText"] = "1";

L["Quest_7632_Name"] = "远古石叶";
L["Quest_7632_Objective"] = "找到远古石叶的主人。";
L["Quest_7632_Location"] = "（火焰之王的宝箱; "..YELLOW.."[9]"..PREV.."）之中，可能有远古石叶。";
L["Quest_7632_Note"] = "把远古石叶交还给古树瓦特鲁斯（费伍德森林 - 铁木森林; "..YELLOW.."49,24"..PREV.."）。";
L["Quest_7632_FollowQuest"] = "龙筋箭袋（"..YELLOW.."艾索雷葛斯"..PREV.."）";

L["Quest_8578_Name"] = "占卜眼镜？没问题！";
L["Quest_8578_Objective"] = "找到纳瑞安的占卜眼镜。";
L["Quest_8578_Location"] = "不起眼的箱子（银松森林 - 格雷迈恩之墙; "..YELLOW.."46.2, 86.6"..PREV.."）";
L["Quest_8578_Note"] = "补丁3.0.2之后，熔火之心的任意怪物都会掉落占卜眼镜。完成后交给纳瑞安（塔纳利斯; "..YELLOW.."65.3, 18.6"..PREV.."），也是前置任务获得的地方。";
...
L["Quest_7509_Location"] = "博学者莱德罗斯（厄运之槌; "..YELLOW.."北，图书馆[1]"..PREV.."）";
...
L["Quest_7495_Location"] = "奥妮克希亚的头颅掉落自（奥妮克希亚; "..YELLOW.."[3]"..PREV.."）";
L["Quest_7495_Note"] = "瓦里安·乌瑞恩国王（暴风城 - 暴风要塞; "..YELLOW.."80,38"..PREV.."）。只有在团队中的一人可以拾取此物品并且只可完成一次。\n\n后续任务领取奖励。";
...
L["Quest_7490_Location"] = "奥妮克希亚的头颅（奥妮克希亚掉落; "..YELLOW.."[3]"..PREV.."）";
L["Quest_7490_Note"] = "萨尔（奥格瑞玛 - 智慧谷; "..YELLOW.."31,37"..PREV.."）。只有在团队中的一人可以拾取此物品并且只可完成一次。\n\n后续任务领取奖励。";
...
L["Quest_8201_Location"] = "伊克萨尔（荆棘谷 - 尤亚姆巴岛; "..YELLOW.."15,15"..PREV.."）";
...
L["Quest_8183_Note"] = "莫托尔（荆棘谷 - 尤亚姆巴岛; "..YELLOW.."15,15"..PREV.."）";
...
L["Quest_8227_Note"] = "找到纳特·帕格（尘泥沼泽; "..YELLOW.."59,60"..PREV.."）。完成任务后你可以从他那里购买哈卡之岛臭泥鱼诱饵，可以在祖尔格拉布召唤隐藏的加兹兰卡。";

L["Quest_9023_Name"] = "完美的毒药";
L["Quest_9023_Objective"] = "塞纳里奥要塞的德尔克·雷木让你把温诺希斯的毒囊和库林纳克斯的毒囊交给他。";
L["Quest_9023_Location"] = "德尔克·雷木（希利苏斯 - 塞纳里奥要塞; "..YELLOW.."52,39"..PREV.."）";
L["Quest_9023_Note"] = "高阶祭司温诺希斯 "..YELLOW.."祖尔格拉布"..PREV.." 掉落温诺希斯的毒囊。库林纳克斯 "..YELLOW.."安其拉废墟"..PREV..""..YELLOW.."[1]"..PREV.." 掉落库林纳克斯的毒囊。";
...
L["Quest_8791_Location"] = "无疤者奥斯里安的头颅掉落自（无疤者奥斯里安; "..YELLOW.."[6]"..PREV.."）";
L["Quest_8791_Note"] = "指挥官玛尔利斯（希利苏斯 - 塞纳里奥要塞; "..YELLOW.."49,34"..PREV.."）";
L["Quest_8791_RewardText"] = "1"..AQ_OR.."2"..AQ_OR.."3"..AQ_OR.."4";

L["Quest_8801_Name"] = "克苏恩的遗产";
L["Quest_8801_Objective"] = "将克苏恩之眼交给安其拉神殿的凯雷斯特拉兹。";
L["Quest_8801_Location"] = "克苏恩之眼掉落自（克苏恩; "..YELLOW.."[9]"..PREV.."）";
L["Quest_8801_Note"] = "凯雷斯特拉兹（安其拉神殿; "..YELLOW.."2'"..PREV.."）";
L["Quest_8801_FollowQuest"] = "卡利姆多的救世主";

L["Quest_8802_Name"] = "卡利姆多的救世主";
L["Quest_8802_Objective"] = "把克苏恩之眼交给时光之穴的阿纳克洛斯。";
L["Quest_8802_Location"] = "克苏恩之眼掉落自（克苏恩; "..YELLOW.."[9]"..PREV.."）";
L["Quest_8802_Note"] = "阿纳克洛斯（塔纳利斯 - 时光之穴; "..YELLOW.."65,49"..PREV.."）";
...
L["Quest_8784_Note"] = "交给安多葛斯（安其拉神殿; "..YELLOW.."1'"..PREV.."）。";

L["Quest_8579_Name"] = "凡人中的勇士";
L["Quest_8579_Objective"] = "交给位于安其拉神殿中的阿莱克丝塔萨的后裔 - 坎多斯特拉兹一枚其拉领主徽记。";
L["Quest_8579_Location"] = "坎多斯特拉兹（安其拉神殿; "..YELLOW.."[1']"..PREV.."）";
...
L["Quest_7261_Location"] = "洛泰姆中尉 (铁炉堡; "..YELLOW.."30,62"..PREV..")";
L["Quest_7261_Note"] = "哈格丁中尉 在(奥特兰克山脉; "..YELLOW.."39,81"..PREV..").";
L["Quest_7261_FollowQuest"] = "有，实验场";

L["Quest_7162_Name"] = "实验场";
L["Quest_7162_Objective"] = "到主基地东南边的冰翼洞穴中去找到雷矛军旗，然后把它交给哈格丁中尉.";
L["Quest_7162_Location"] = "哈格丁中尉 (奥特兰克山谷; "..YELLOW.."39,81"..PREV..")";
L["Quest_7162_Note"] = "雷矛军旗在 奥特兰克山谷北部地图 冰翼洞穴 "..YELLOW.."[11]"..PREV.." . 当你声望提升到一个新的等级后，你可以与同一个NPC交谈领取更高级的雷矛徽章.";
L["Quest_7162_RewardText"] = "1"..AQ_OR.."2";

L["Quest_7141_Name"] = "奥特兰克山谷的战斗";
L["Quest_7141_Objective"] = "进入奥特兰克山谷，击败部落将军德雷克塔尔。然后回到勘查员塔雷·石镐那里.";
L["Quest_7141_Location"] = "勘查员塔雷·石镐 (奥特兰克山脉; "..YELLOW.."41,78"..PREV..") and\n(奥特兰克山谷 - 北部地图; "..YELLOW.."[B]"..PREV..")";
L["Quest_7141_Note"] = "德雷克塔尔 在 (奥特兰克山谷 - 南部地图; "..YELLOW.."[B]"..PREV.."). 完成这个任务并不一定需要杀死德雷克塔尔，只要赢得奥特兰克山谷的战斗即可.";
...
L["Quest_7121_Location"] = "巡山人布比罗 (奥特兰克山谷 - 北部地图; "..YELLOW.."[** MISSING INFO **]"..PREV..")";
L["Quest_7121_Note"] = "雷矛军需官 在 (奥特兰克山谷 - 北部地图; "..YELLOW.."[7]"..PREV..").";

L["Quest_6982_Name"] = "冷齿矿洞的补给";
L["Quest_6982_Objective"] = "把10份冷齿矿洞补给品交给丹巴达尔的联盟军需官.";
L["Quest_6982_Location"] = "雷矛军需官 (奥特兰克山谷 - 北部地图; "..YELLOW.."[7]"..PREV..")";
L["Quest_6982_Note"] = "补给可以在冷齿矿洞找到 (奥特兰克山谷 - 南部地图; "..YELLOW.."[6]"..PREV..").";

L["Quest_5892_Name"] = "深铁矿洞的补给";
L["Quest_5892_Objective"] = "把10份深铁矿洞补给品交给丹巴达尔的联盟军需官.";
L["Quest_5892_Location"] = "雷矛军需官 (奥特兰克山谷 - 北部地图; "..YELLOW.."[7]"..PREV..")";
L["Quest_5892_Note"] = "补给可以在深铁矿洞找到 (奥特兰克山谷 - 北部地图; "..YELLOW.."[1]"..PREV..").";

L["Quest_7223_Name"] = "护甲碎片";
L["Quest_7223_Objective"] = "给丹巴达尔的莫高特·深炉带去20块护甲碎片.";
L["Quest_7223_Location"] = "莫高特·深炉 (奥特兰克山谷 - 北部地图; "..YELLOW.."[4]"..PREV..")";
...
L["Quest_7122_Location"] = "杜尔根·雷矛 (奥特兰克山谷; "..YELLOW.."37,78"..PREV..")";
L["Quest_7122_Note"] = "要完成这个任务，你需要杀死矿洞中的头目 (奥特兰克山谷 - 北部地图; "..YELLOW.."[1]"..PREV..")  (奥特兰克山谷 - 南部地图; "..YELLOW.."[6]"..PREV..") while the Horde control it.";

L["Quest_7102_Name"] = "哨塔和碉堡";
L["Quest_7102_Objective"] = "摧毁敌方的某座哨塔或者碉堡中的旗帜，然后向丹巴达尔的杜尔根·雷矛复命.";
L["Quest_7102_Location"] = "杜尔根·雷矛 (奥特兰克山谷; "..YELLOW.."37,78"..PREV..")";
L["Quest_7102_Note"] = "只需要烧毁旗帜即可，不需要一定摧毁哨塔或碉堡.";

L["Quest_7081_Name"] = "奥特兰克山谷的墓地";
L["Quest_7081_Objective"] = "占领一座墓地，然后向丹巴达尔的诺雷格·雷矛中尉复命.";
L["Quest_7081_Location"] = "诺雷格·雷矛 (奥特兰克山谷; "..YELLOW.."37,78"..PREV..")";
...
L["Quest_7027_Location"] = "兽栏管理员 (奥特兰克山谷 - 北部地图; "..YELLOW.."[6]"..PREV..")";
...
L["Quest_7026_Location"] = "雷矛山羊骑兵指挥官 (奥特兰克山谷 - 北部地图; "..YELLOW.."[6]"..PREV..")";
L["Quest_7026_Note"] = "霜狼可以在奥特兰克山谷的南部找到.";

L["Quest_7386_Name"] = "水晶簇";
L["Quest_7386_Objective"] = "你可以躲避硝烟弥漫的战场，激烈战斗之外，你可以帮助我收集霜狼氏族身上的风暴水晶..";
L["Quest_7386_Location"] = "大德鲁伊雷弗拉尔  (奥特兰克山谷 - 北部地图; "..YELLOW.."[2]"..PREV..")";
L["Quest_7386_Note"] = "在募集大约200个风暴水晶后，大德鲁伊伊类弗拉尔开始向（奥特兰克山谷 - 北部地图（ "..YELLOW.."[19]"..PREV.."）移动，他将启动召唤法阵需要10个玩家去协助召唤。如果成功，森林之王伊弗斯将被召唤出来帮助抵抗部落.";

L["Quest_6881_Name"] = "森林之王伊弗斯";
L["Quest_6881_Objective"] = "霜狼氏族的战士身上带着一种名叫暴风水晶的符咒，我们可以用这些符咒来召唤伊弗斯。快去拿来那些水晶吧.";
L["Quest_6881_Location"] = "大德鲁伊雷弗拉尔 (奥特兰克山谷 - 北部地图; "..YELLOW.."[2]"..PREV..")";
L["Quest_6881_Note"] = "在募集大约200个风暴水晶后，大德鲁伊伊类弗拉尔开始向（奥特兰克山谷 - 北部地图（ "..YELLOW.."[19]"..PREV.."）移动，他将启动召唤法阵需要10个玩家去协助召唤。如果成功，森林之王伊弗斯将被召唤出来帮助抵抗部落.";
...
L["Quest_6942_Location"] = "空军指挥官维波里 (奥特兰克山谷 - 北部地图; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6941_Location"] = "空军指挥官斯里多尔 (奥特兰克山谷 - 北部地图; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_6943_Location"] = "空军指挥官艾克曼 (奥特兰克山谷 - 北部地图; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_7241_Location"] = "霜狼大使 (奥格瑞玛 - 力量谷 "..YELLOW.."50,71"..PREV..")";
L["Quest_7241_Note"] = "拉格隆德 (奥特兰克山脉; "..YELLOW.."62,59"..PREV..").";
L["Quest_7241_FollowQuest"] = "有，实验场";

L["Quest_7161_Name"] = "实验场";
L["Quest_7161_Objective"] = "到主基地东南边的蛮爪洞穴中去找到霜狼军旗，然后把它交给拉格隆德.";
L["Quest_7161_Location"] = "拉格隆德 (奥特兰克山脉; "..YELLOW.."62,59"..PREV..")";
L["Quest_7161_Note"] = "霜狼军旗 在蛮爪洞穴 (奥特兰克山谷 - 南部地图; "..YELLOW.."[9]"..PREV.."). 每当声望到达一个级别，你可以在这个人这里得到升级的徽章.";
...
L["Quest_7142_Location"] = "沃加·死爪 (奥特兰克山脉; "..YELLOW.."64,60"..PREV..")";
L["Quest_7142_Note"] = "范达尔 雷矛 在 (奥特兰克山谷 - 北部地图; "..YELLOW.."[B]"..PREV.."). 不一定需要杀死范达尔才能完成任务，赢得胜利就行.";
...
L["Quest_7123_Location"] = "乔泰克 (奥特兰克山谷 - 南部地图; "..YELLOW.."[8]"..PREV..")";
L["Quest_7123_Note"] = "霜狼军需官 在 "..YELLOW.."[10]"..PREV.." .";

L["Quest_5893_Name"] = "冷齿矿洞的补给";
L["Quest_5893_Objective"] = "把10份冷齿矿洞补给品交给霜狼要塞的部落军需官.";
L["Quest_5893_Location"] = "霜狼军需官 (奥特兰克山谷 - 南部地图; "..YELLOW.."[10]"..PREV..")";
L["Quest_5893_Note"] = "补给品 可以在冷齿矿洞找到 (奥特兰克山谷 - 南部地图; "..YELLOW.."[6]"..PREV..").";

L["Quest_6985_Name"] = "深铁矿洞的补给";
L["Quest_6985_Objective"] = "把10份深铁矿洞补给品交给霜狼要塞的部落军需官.";
L["Quest_6985_Location"] = "霜狼军需官 (奥特兰克山谷 - 南部地图; "..YELLOW.."[10]"..PREV..")";
L["Quest_6985_Note"] = "补给品 可以在深铁矿洞找到 (奥特兰克山谷 - 北部地图; "..YELLOW.."[1]"..PREV..").";

L["Quest_7224_Name"] = "敌人的物资";
L["Quest_7224_Objective"] = "给霜狼村的铁匠雷格萨带去20块护甲碎片.";
L["Quest_7224_Location"] = "铁匠雷格萨 (奥特兰克山谷 - 南部地图; "..YELLOW.."[8]"..PREV..")";
...
L["Quest_8120_Location"] = "屠杀者杜维尔 (阿拉希高地 - 落槌镇; "..YELLOW.."74,35"..PREV..")";
...
L["Quest_7634_Location"] = "古树哈斯塔特 (费伍德森林 - 铁木树林; "..YELLOW.."48,24"..PREV..")";
L["Quest_7634_Note"] = "杀死艾索雷葛斯得到蓝龙肉，它在 艾萨拉 "..YELLOW.."[1]"..PREV..".";
